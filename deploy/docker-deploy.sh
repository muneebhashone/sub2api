...
main() {
    ...
    if command_exists curl; then
        curl -sSL "${GITHUB_RAW_URLplaceholder/docker-compose.local.yml" -o docker-compose.yml
    elif command_exists wget; then
        wget -q "${GITHUB_RAW_URLplaceholder/docker-compose.local.yml" -O docker-compose.yml
    else
