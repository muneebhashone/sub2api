...
go build -tags embed -ldflags="-X main.Version=${VERSIONplaceholder" -o sub2api ./cmd/server
...
- Public Responses targets: `/v1/responses`, `/responses`, and `/backend-api/codex/responses`, forwarded to `${XAI_BASE_URL:-https://api.x.ai/v1placeholder/responses`
...
- Public Chat Completions targets: `/v1/chat/completions` and `/chat/completions`, forwarded to `${XAI_BASE_URL:-https://api.x.ai/v1placeholder/chat/completions`
...
- Media targets for Grok groups: `/v1/images/generations`, `/images/generations`, `/v1/images/edits`, `/images/edits`, `/v1/videos/generations`, `/videos/generations`, `/v1/videos/{request_idplaceholder`, and `/videos/{request_idplaceholder`. Generation requests require the group image-generation permission.
