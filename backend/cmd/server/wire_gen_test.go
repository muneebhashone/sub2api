...
func TestProvideCleanup_WithMinimalDependencies_NoPanic(t *testing.T) {
	...
	cleanup := provideCleanup(
		nil, // entClient
		nil, // redis
		&service.OpsMetricsCollector{placeholder,
		&service.OpsAggregationService{placeholder,
		&service.OpsAlertEvaluatorService{placeholder,
		...
		&service.UsageCleanupService{placeholder,
		idempotencyCleanupSvc,
		&service.BatchImageCleanupService{placeholder,
		nil, // batchImageWorker
		pricingSvc,
		emailQueueSvc,
		billingCacheSvc,
		&service.UsageRecordWorkerPool{placeholder,
		&service.SubscriptionService{placeholder,
		oauthSvc,
		openAIOAuthSvc,
		geminiOAuthSvc,
		antigravityOAuthSvc,
