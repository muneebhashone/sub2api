...
func (_c *PaymentOrderCreate) SetProviderSnapshot(v map[string]interface{placeholder) *PaymentOrderCreate {
...
func (_c *PaymentOrderCreate) check() error {
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "PaymentOrder.user_id"`)placeholder
placeholder
	if _, ok := _c.mutation.UserEmail(); !ok {
		return &ValidationError{Name: "user_email", err: errors.New(`ent: missing required field "PaymentOrder.user_email"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.UserName(); !ok {
		return &ValidationError{Name: "user_name", err: errors.New(`ent: missing required field "PaymentOrder.user_name"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.Amount(); !ok {
		return &ValidationError{Name: "amount", err: errors.New(`ent: missing required field "PaymentOrder.amount"`)placeholder
placeholder
	if _, ok := _c.mutation.PayAmount(); !ok {
		return &ValidationError{Name: "pay_amount", err: errors.New(`ent: missing required field "PaymentOrder.pay_amount"`)placeholder
placeholder
	if _, ok := _c.mutation.FeeRate(); !ok {
		return &ValidationError{Name: "fee_rate", err: errors.New(`ent: missing required field "PaymentOrder.fee_rate"`)placeholder
placeholder
	if _, ok := _c.mutation.RechargeCode(); !ok {
		return &ValidationError{Name: "recharge_code", err: errors.New(`ent: missing required field "PaymentOrder.recharge_code"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.OutTradeNo(); !ok {
		return &ValidationError{Name: "out_trade_no", err: errors.New(`ent: missing required field "PaymentOrder.out_trade_no"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.PaymentType(); !ok {
		return &ValidationError{Name: "payment_type", err: errors.New(`ent: missing required field "PaymentOrder.payment_type"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.PaymentTradeNo(); !ok {
		return &ValidationError{Name: "payment_trade_no", err: errors.New(`ent: missing required field "PaymentOrder.payment_trade_no"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.OrderType(); !ok {
		return &ValidationError{Name: "order_type", err: errors.New(`ent: missing required field "PaymentOrder.order_type"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.RefundAmount(); !ok {
		return &ValidationError{Name: "refund_amount", err: errors.New(`ent: missing required field "PaymentOrder.refund_amount"`)placeholder
placeholder
	if _, ok := _c.mutation.ForceRefund(); !ok {
		return &ValidationError{Name: "force_refund", err: errors.New(`ent: missing required field "PaymentOrder.force_refund"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.ExpiresAt(); !ok {
		return &ValidationError{Name: "expires_at", err: errors.New(`ent: missing required field "PaymentOrder.expires_at"`)placeholder
placeholder
	if _, ok := _c.mutation.ClientIP(); !ok {
		return &ValidationError{Name: "client_ip", err: errors.New(`ent: missing required field "PaymentOrder.client_ip"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.SrcHost(); !ok {
		return &ValidationError{Name: "src_host", err: errors.New(`ent: missing required field "PaymentOrder.src_host"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "PaymentOrder.created_at"`)placeholder
placeholder
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "PaymentOrder.updated_at"`)placeholder
placeholder
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "PaymentOrder.user"`)placeholder
placeholder
	return nil
placeholder
...
func (_c *PaymentOrderCreate) createSpec() (*PaymentOrder, *sqlgraph.CreateSpec) {
	var (
		_node = &PaymentOrder{config: _c.configplaceholder
...
// SetProviderSnapshot sets the "provider_snapshot" field.
func (u *PaymentOrderUpsert) SetProviderSnapshot(v map[string]interface{placeholder) *PaymentOrderUpsert {
...
func (u *PaymentOrderUpsertOne) Update(set func(*PaymentOrderUpsert)) *PaymentOrderUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&PaymentOrderUpsert{UpdateSet: updateplaceholder)
placeholder))
	return u
placeholder
...
// SetProviderSnapshot sets the "provider_snapshot" field.
func (u *PaymentOrderUpsertOne) SetProviderSnapshot(v map[string]interface{placeholder) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetProviderSnapshot sets the "provider_snapshot" field.
func (u *PaymentOrderUpsertBulk) SetProviderSnapshot(v map[string]interface{placeholder) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetProviderSnapshot(v)
placeholder)
placeholder
