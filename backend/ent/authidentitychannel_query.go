...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{authidentitychannel.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{authidentitychannel.Labelplaceholder
	default:
		return nil, &NotSingularError{authidentitychannel.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{authidentitychannel.Labelplaceholder
	default:
		err = &NotSingularError{authidentitychannel.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &AuthIdentityChannelQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]authidentitychannel.OrderOption{placeholder, _q.order...),
		inters:       append([]Interceptor{placeholder, _q.inters...),
		predicates:   append([]predicate.AuthIdentityChannel{placeholder, _q.predicates...),
...
func (_q *AuthIdentityChannelQuery) GroupBy(field string, fields ...string) *AuthIdentityChannelGroupBy {
	...
	grbuild := &AuthIdentityChannelGroupBy{build: _qplaceholder
...
func (_q *AuthIdentityChannelQuery) Select(fields ...string) *AuthIdentityChannelSelect {
	...
	sbuild := &AuthIdentityChannelSelect{AuthIdentityChannelQuery: _qplaceholder
...
func (_q *AuthIdentityChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuthIdentityChannel, error) {
	var (
		nodes       = []*AuthIdentityChannel{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withIdentity != nil,
	placeholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &AuthIdentityChannel{config: _q.configplaceholder
...
placeholder
	if query := _q.withIdentity; query != nil {
		if err := _q.loadIdentity(ctx, query, nodes, nil,
			func(n *AuthIdentityChannel, e *AuthIdentity) { n.Edges.Identity = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
