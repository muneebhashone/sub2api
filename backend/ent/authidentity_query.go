...
func (_q *AuthIdentityQuery) QueryChannels() *AuthIdentityChannelQuery {
	query := (&AuthIdentityChannelClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *AuthIdentityQuery) QueryAdoptionDecisions() *IdentityAdoptionDecisionQuery {
	query := (&IdentityAdoptionDecisionClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{authidentity.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{authidentity.Labelplaceholder
	default:
		return nil, &NotSingularError{authidentity.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{authidentity.Labelplaceholder
	default:
		err = &NotSingularError{authidentity.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &AuthIdentityQuery{
		config:                _q.config,
		ctx:                   _q.ctx.Clone(),
		order:                 append([]authidentity.OrderOption{placeholder, _q.order...),
		inters:                append([]Interceptor{placeholder, _q.inters...),
		predicates:            append([]predicate.AuthIdentity{placeholder, _q.predicates...),
...
func (_q *AuthIdentityQuery) GroupBy(field string, fields ...string) *AuthIdentityGroupBy {
	...
	grbuild := &AuthIdentityGroupBy{build: _qplaceholder
...
func (_q *AuthIdentityQuery) Select(fields ...string) *AuthIdentitySelect {
	...
	sbuild := &AuthIdentitySelect{AuthIdentityQuery: _qplaceholder
...
func (_q *AuthIdentityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuthIdentity, error) {
	var (
		nodes       = []*AuthIdentity{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [3]bool{
			_q.withUser != nil,
			_q.withChannels != nil,
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &AuthIdentity{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *AuthIdentity, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withChannels; query != nil {
		if err := _q.loadChannels(ctx, query, nodes,
			func(n *AuthIdentity) { n.Edges.Channels = []*AuthIdentityChannel{placeholder placeholder,
			func(n *AuthIdentity, e *AuthIdentityChannel) { n.Edges.Channels = append(n.Edges.Channels, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAdoptionDecisions; query != nil {
		if err := _q.loadAdoptionDecisions(ctx, query, nodes,
			func(n *AuthIdentity) { n.Edges.AdoptionDecisions = []*IdentityAdoptionDecision{placeholder placeholder,
