...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{channelmonitorhistory.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{channelmonitorhistory.Labelplaceholder
	default:
		return nil, &NotSingularError{channelmonitorhistory.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{channelmonitorhistory.Labelplaceholder
	default:
		err = &NotSingularError{channelmonitorhistory.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &ChannelMonitorHistoryQuery{
		config:      _q.config,
		ctx:         _q.ctx.Clone(),
		order:       append([]channelmonitorhistory.OrderOption{placeholder, _q.order...),
		inters:      append([]Interceptor{placeholder, _q.inters...),
		predicates:  append([]predicate.ChannelMonitorHistory{placeholder, _q.predicates...),
...
func (_q *ChannelMonitorHistoryQuery) GroupBy(field string, fields ...string) *ChannelMonitorHistoryGroupBy {
	...
	grbuild := &ChannelMonitorHistoryGroupBy{build: _qplaceholder
...
func (_q *ChannelMonitorHistoryQuery) Select(fields ...string) *ChannelMonitorHistorySelect {
	...
	sbuild := &ChannelMonitorHistorySelect{ChannelMonitorHistoryQuery: _qplaceholder
...
func (_q *ChannelMonitorHistoryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChannelMonitorHistory, error) {
	var (
		nodes       = []*ChannelMonitorHistory{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withMonitor != nil,
	placeholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &ChannelMonitorHistory{config: _q.configplaceholder
...
placeholder
	if query := _q.withMonitor; query != nil {
		if err := _q.loadMonitor(ctx, query, nodes, nil,
			func(n *ChannelMonitorHistory, e *ChannelMonitor) { n.Edges.Monitor = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
