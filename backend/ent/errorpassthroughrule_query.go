...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{errorpassthroughrule.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{errorpassthroughrule.Labelplaceholder
	default:
		return nil, &NotSingularError{errorpassthroughrule.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{errorpassthroughrule.Labelplaceholder
	default:
		err = &NotSingularError{errorpassthroughrule.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &ErrorPassthroughRuleQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]errorpassthroughrule.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.ErrorPassthroughRule{placeholder, _q.predicates...),
...
func (_q *ErrorPassthroughRuleQuery) GroupBy(field string, fields ...string) *ErrorPassthroughRuleGroupBy {
	...
	grbuild := &ErrorPassthroughRuleGroupBy{build: _qplaceholder
...
func (_q *ErrorPassthroughRuleQuery) Select(fields ...string) *ErrorPassthroughRuleSelect {
	...
	sbuild := &ErrorPassthroughRuleSelect{ErrorPassthroughRuleQuery: _qplaceholder
...
func (_q *ErrorPassthroughRuleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ErrorPassthroughRule, error) {
	var (
		nodes = []*ErrorPassthroughRule{placeholder
		_spec = _q.querySpec()
	)
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &ErrorPassthroughRule{config: _q.configplaceholder
