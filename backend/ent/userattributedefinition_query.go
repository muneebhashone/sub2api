...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{userattributedefinition.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{userattributedefinition.Labelplaceholder
	default:
		return nil, &NotSingularError{userattributedefinition.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{userattributedefinition.Labelplaceholder
	default:
		err = &NotSingularError{userattributedefinition.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &UserAttributeDefinitionQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]userattributedefinition.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.UserAttributeDefinition{placeholder, _q.predicates...),
...
func (_q *UserAttributeDefinitionQuery) GroupBy(field string, fields ...string) *UserAttributeDefinitionGroupBy {
	...
	grbuild := &UserAttributeDefinitionGroupBy{build: _qplaceholder
...
func (_q *UserAttributeDefinitionQuery) Select(fields ...string) *UserAttributeDefinitionSelect {
	...
	sbuild := &UserAttributeDefinitionSelect{UserAttributeDefinitionQuery: _qplaceholder
...
func (_q *UserAttributeDefinitionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserAttributeDefinition, error) {
	var (
		nodes       = []*UserAttributeDefinition{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withValues != nil,
	placeholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserAttributeDefinition{config: _q.configplaceholder
...
placeholder
	if query := _q.withValues; query != nil {
		if err := _q.loadValues(ctx, query, nodes,
			func(n *UserAttributeDefinition) { n.Edges.Values = []*UserAttributeValue{placeholder placeholder,
			func(n *UserAttributeDefinition, e *UserAttributeValue) { n.Edges.Values = append(n.Edges.Values, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
