...
func (Account) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "accounts"placeholder,
placeholder
placeholder
...
func (Account) Fields() []ent.Field {
	return []ent.Field{
		...
		// 结构取决于 type 字段：
		// - api_key: {"api_key": "sk-xxx"placeholder
		// - oauth: {"access_token": "...", "refresh_token": "...", "expires_at": "..."placeholder
		// - cookie: {"session_key": "..."placeholder
		field.JSON("credentials", map[string]any{placeholder).
		...
		field.JSON("extra", map[string]any{placeholder).
			Default(func() map[string]any { return map[string]any{placeholder placeholder).
			SchemaType(map[string]string{dialect.Postgres: "jsonb"placeholder),
		...
		field.Float("rate_multiplier").
			SchemaType(map[string]string{dialect.Postgres: "decimal(10,4)"placeholder).
			Default(1.0),
