...
func (ChannelMonitorRequestTemplate) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "channel_monitor_request_templates"placeholder,
placeholder
placeholder
...
func (ChannelMonitorRequestTemplate) Fields() []ent.Field {
	return []ent.Field{
		...
		field.JSON("extra_headers", map[string]string{placeholder).
			Default(map[string]string{placeholder),
		...
		field.JSON("body_override", map[string]any{placeholder).
			Optional(),
placeholder
placeholder
