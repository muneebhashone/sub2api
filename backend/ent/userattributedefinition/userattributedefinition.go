...
var (
	...
	DefaultOptions []map[string]interface{placeholder
	...
	DefaultValidation map[string]interface{placeholder
...
func ByValues(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newValuesStep(), append([]sql.OrderTerm{termplaceholder, terms...)...)
placeholder
placeholder
