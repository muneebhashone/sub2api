...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{userplatformquota.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	if len(ids) == 0 {
		err = &NotFoundError{userplatformquota.Labelplaceholder
		return
placeholder
	return ids[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{userplatformquota.Labelplaceholder
	default:
		return nil, &NotSingularError{userplatformquota.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{userplatformquota.Labelplaceholder
	default:
		err = &NotSingularError{userplatformquota.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &UserPlatformQuotaQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]userplatformquota.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.UserPlatformQuota{placeholder, _q.predicates...),
...
func (_q *UserPlatformQuotaQuery) GroupBy(field string, fields ...string) *UserPlatformQuotaGroupBy {
	...
	grbuild := &UserPlatformQuotaGroupBy{build: _qplaceholder
...
func (_q *UserPlatformQuotaQuery) Select(fields ...string) *UserPlatformQuotaSelect {
	...
	sbuild := &UserPlatformQuotaSelect{UserPlatformQuotaQuery: _qplaceholder
...
func (_q *UserPlatformQuotaQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserPlatformQuota, error) {
	var (
		nodes       = []*UserPlatformQuota{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withUser != nil,
	placeholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserPlatformQuota{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserPlatformQuota, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
