...
type ChannelMonitor struct {
	...
	BodyOverride map[string]interface{placeholder `json:"body_override,omitempty"`
...
placeholder else if e.loadedTypes[2] {
		return nil, &NotFoundError{label: channelmonitorrequesttemplate.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "request_template"placeholder
placeholder
