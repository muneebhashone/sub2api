...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{batchimageevent.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{batchimageevent.Labelplaceholder
	default:
		return nil, &NotSingularError{batchimageevent.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{batchimageevent.Labelplaceholder
	default:
		err = &NotSingularError{batchimageevent.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &BatchImageEventQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]batchimageevent.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.BatchImageEvent{placeholder, _q.predicates...),
...
func (_q *BatchImageEventQuery) GroupBy(field string, fields ...string) *BatchImageEventGroupBy {
	...
	grbuild := &BatchImageEventGroupBy{build: _qplaceholder
...
func (_q *BatchImageEventQuery) Select(fields ...string) *BatchImageEventSelect {
	...
	sbuild := &BatchImageEventSelect{BatchImageEventQuery: _qplaceholder
...
func (_q *BatchImageEventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BatchImageEvent, error) {
	var (
		nodes = []*BatchImageEvent{placeholder
		_spec = _q.querySpec()
	)
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &BatchImageEvent{config: _q.configplaceholder
