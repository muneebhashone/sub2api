...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{group.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	if len(ids) == 0 {
		err = &NotFoundError{group.Labelplaceholder
		return
placeholder
	return ids[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{group.Labelplaceholder
	default:
		return nil, &NotSingularError{group.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{group.Labelplaceholder
	default:
		err = &NotSingularError{group.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &GroupQuery{
		config:                _q.config,
		ctx:                   _q.ctx.Clone(),
		order:                 append([]group.OrderOption{placeholder, _q.order...),
		inters:                append([]Interceptor{placeholder, _q.inters...),
		predicates:            append([]predicate.Group{placeholder, _q.predicates...),
...
func (_q *GroupQuery) GroupBy(field string, fields ...string) *GroupGroupBy {
	...
	grbuild := &GroupGroupBy{build: _qplaceholder
...
func (_q *GroupQuery) Select(fields ...string) *GroupSelect {
	...
	sbuild := &GroupSelect{GroupQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &Group{config: _q.configplaceholder
...
placeholder
	if query := _q.withAPIKeys; query != nil {
		if err := _q.loadAPIKeys(ctx, query, nodes,
			func(n *Group) { n.Edges.APIKeys = []*ApiKey{placeholder placeholder,
			func(n *Group, e *ApiKey) { n.Edges.APIKeys = append(n.Edges.APIKeys, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withRedeemCodes; query != nil {
		if err := _q.loadRedeemCodes(ctx, query, nodes,
			func(n *Group) { n.Edges.RedeemCodes = []*RedeemCode{placeholder placeholder,
			func(n *Group, e *RedeemCode) { n.Edges.RedeemCodes = append(n.Edges.RedeemCodes, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withSubscriptions; query != nil {
		if err := _q.loadSubscriptions(ctx, query, nodes,
			func(n *Group) { n.Edges.Subscriptions = []*UserSubscription{placeholder placeholder,
			func(n *Group, e *UserSubscription) { n.Edges.Subscriptions = append(n.Edges.Subscriptions, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUsageLogs; query != nil {
		if err := _q.loadUsageLogs(ctx, query, nodes,
			func(n *Group) { n.Edges.UsageLogs = []*UsageLog{placeholder placeholder,
			func(n *Group, e *UsageLog) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAccounts; query != nil {
		if err := _q.loadAccounts(ctx, query, nodes,
			func(n *Group) { n.Edges.Accounts = []*Account{placeholder placeholder,
			func(n *Group, e *Account) { n.Edges.Accounts = append(n.Edges.Accounts, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAllowedUsers; query != nil {
		if err := _q.loadAllowedUsers(ctx, query, nodes,
			func(n *Group) { n.Edges.AllowedUsers = []*User{placeholder placeholder,
			func(n *Group, e *User) { n.Edges.AllowedUsers = append(n.Edges.AllowedUsers, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAccountGroups; query != nil {
		if err := _q.loadAccountGroups(ctx, query, nodes,
			func(n *Group) { n.Edges.AccountGroups = []*AccountGroup{placeholder placeholder,
			func(n *Group, e *AccountGroup) { n.Edges.AccountGroups = append(n.Edges.AccountGroups, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUserAllowedGroups; query != nil {
		if err := _q.loadUserAllowedGroups(ctx, query, nodes,
			func(n *Group) { n.Edges.UserAllowedGroups = []*UserAllowedGroup{placeholder placeholder,
			func(n *Group, e *UserAllowedGroup) { n.Edges.UserAllowedGroups = append(n.Edges.UserAllowedGroups, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
...
func (_q *GroupQuery) loadAccounts(ctx context.Context, query *AccountQuery, nodes []*Group, init func(*Group), assign func(*Group, *Account)) error {
	...
	nids := make(map[int64]map[*Group]struct{placeholder)
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		...
		placeholder
			spec.Assign = func(columns []string, values []any) error {
				...
				if nids[inValue] == nil {
					nids[inValue] = map[*Group]struct{placeholder{byID[outValue]: {placeholderplaceholder
