...
placeholder
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "TLSFingerprintProfile.id" for update`)placeholder
placeholder
...
placeholder
	if _u.mutation.ExtensionsCleared() {
		_spec.ClearField(tlsfingerprintprofile.FieldExtensions, field.TypeJSON)
placeholder
	_node = &TLSFingerprintProfile{config: _u.configplaceholder
