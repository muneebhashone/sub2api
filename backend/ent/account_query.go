...
func (_q *AccountQuery) QueryAccountGroups() *AccountGroupQuery {
	query := (&AccountGroupClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{account.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{account.Labelplaceholder
	default:
		return nil, &NotSingularError{account.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{account.Labelplaceholder
	default:
		err = &NotSingularError{account.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &AccountQuery{
		config:            _q.config,
		ctx:               _q.ctx.Clone(),
		order:             append([]account.OrderOption{placeholder, _q.order...),
		inters:            append([]Interceptor{placeholder, _q.inters...),
		predicates:        append([]predicate.Account{placeholder, _q.predicates...),
...
func (_q *AccountQuery) GroupBy(field string, fields ...string) *AccountGroupBy {
	...
	grbuild := &AccountGroupBy{build: _qplaceholder
...
func (_q *AccountQuery) Select(fields ...string) *AccountSelect {
	...
	sbuild := &AccountSelect{AccountQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &Account{config: _q.configplaceholder
...
placeholder
	if query := _q.withGroups; query != nil {
		if err := _q.loadGroups(ctx, query, nodes,
			func(n *Account) { n.Edges.Groups = []*Group{placeholder placeholder,
			func(n *Account, e *Group) { n.Edges.Groups = append(n.Edges.Groups, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withProxy; query != nil {
		if err := _q.loadProxy(ctx, query, nodes, nil,
			func(n *Account, e *Proxy) { n.Edges.Proxy = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withParent; query != nil {
		if err := _q.loadParent(ctx, query, nodes, nil,
			func(n *Account, e *Account) { n.Edges.Parent = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withChildren; query != nil {
		if err := _q.loadChildren(ctx, query, nodes,
			func(n *Account) { n.Edges.Children = []*Account{placeholder placeholder,
			func(n *Account, e *Account) { n.Edges.Children = append(n.Edges.Children, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUsageLogs; query != nil {
		if err := _q.loadUsageLogs(ctx, query, nodes,
			func(n *Account) { n.Edges.UsageLogs = []*UsageLog{placeholder placeholder,
			func(n *Account, e *UsageLog) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAccountGroups; query != nil {
		if err := _q.loadAccountGroups(ctx, query, nodes,
			func(n *Account) { n.Edges.AccountGroups = []*AccountGroup{placeholder placeholder,
			func(n *Account, e *AccountGroup) { n.Edges.AccountGroups = append(n.Edges.AccountGroups, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
...
func (_q *AccountQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*Account, init func(*Account), assign func(*Account, *Group)) error {
	...
	nids := make(map[int64]map[*Account]struct{placeholder)
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		...
		placeholder
			spec.Assign = func(columns []string, values []any) error {
				...
				if nids[inValue] == nil {
					nids[inValue] = map[*Account]struct{placeholder{byID[outValue]: {placeholderplaceholder
