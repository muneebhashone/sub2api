...
func (_q *UserAttributeValueQuery) QueryDefinition() *UserAttributeDefinitionQuery {
	query := (&UserAttributeDefinitionClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{userattributevalue.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{userattributevalue.Labelplaceholder
	default:
		return nil, &NotSingularError{userattributevalue.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{userattributevalue.Labelplaceholder
	default:
		err = &NotSingularError{userattributevalue.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &UserAttributeValueQuery{
		config:         _q.config,
		ctx:            _q.ctx.Clone(),
		order:          append([]userattributevalue.OrderOption{placeholder, _q.order...),
		inters:         append([]Interceptor{placeholder, _q.inters...),
		predicates:     append([]predicate.UserAttributeValue{placeholder, _q.predicates...),
...
func (_q *UserAttributeValueQuery) GroupBy(field string, fields ...string) *UserAttributeValueGroupBy {
	...
	grbuild := &UserAttributeValueGroupBy{build: _qplaceholder
...
func (_q *UserAttributeValueQuery) Select(fields ...string) *UserAttributeValueSelect {
	...
	sbuild := &UserAttributeValueSelect{UserAttributeValueQuery: _qplaceholder
...
func (_q *UserAttributeValueQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserAttributeValue, error) {
	var (
		nodes       = []*UserAttributeValue{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.withUser != nil,
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserAttributeValue{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserAttributeValue, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withDefinition; query != nil {
		if err := _q.loadDefinition(ctx, query, nodes, nil,
			func(n *UserAttributeValue, e *UserAttributeDefinition) { n.Edges.Definition = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
