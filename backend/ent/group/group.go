...
var (
	...
	AccountsPrimaryKey = []string{"account_id", "group_id"placeholder
	...
	AllowedUsersPrimaryKey = []string{"user_id", "group_id"placeholder
)
...
func ByAllowedUsers(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAllowedUsersStep(), append([]sql.OrderTerm{termplaceholder, terms...)...)
placeholder
placeholder
...
func ByAccountGroups(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newAccountGroupsStep(), append([]sql.OrderTerm{termplaceholder, terms...)...)
placeholder
placeholder
