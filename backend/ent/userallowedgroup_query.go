...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{userallowedgroup.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{userallowedgroup.Labelplaceholder
	default:
		return nil, &NotSingularError{userallowedgroup.Labelplaceholder
placeholder
placeholder
...
placeholder
	return &UserAllowedGroupQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]userallowedgroup.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.UserAllowedGroup{placeholder, _q.predicates...),
...
func (_q *UserAllowedGroupQuery) GroupBy(field string, fields ...string) *UserAllowedGroupGroupBy {
	...
	grbuild := &UserAllowedGroupGroupBy{build: _qplaceholder
...
func (_q *UserAllowedGroupQuery) Select(fields ...string) *UserAllowedGroupSelect {
	...
	sbuild := &UserAllowedGroupSelect{UserAllowedGroupQuery: _qplaceholder
...
func (_q *UserAllowedGroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserAllowedGroup, error) {
	var (
		nodes       = []*UserAllowedGroup{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.withUser != nil,
			_q.withGroup != nil,
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserAllowedGroup{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserAllowedGroup, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *UserAllowedGroup, e *Group) { n.Edges.Group = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
