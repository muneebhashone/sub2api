...
placeholder else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: apikey.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "api_key"placeholder
placeholder
...
func (e UsageLogEdges) GroupOrErr() (*Group, error) {
	if e.Group != nil {
		return e.Group, nil
placeholder else if e.loadedTypes[3] {
...
placeholder else if e.loadedTypes[4] {
		return nil, &NotFoundError{label: usersubscription.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "subscription"placeholder
placeholder
