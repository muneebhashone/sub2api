...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{redeemcode.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{redeemcode.Labelplaceholder
	default:
		return nil, &NotSingularError{redeemcode.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{redeemcode.Labelplaceholder
	default:
		err = &NotSingularError{redeemcode.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &RedeemCodeQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]redeemcode.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.RedeemCode{placeholder, _q.predicates...),
...
func (_q *RedeemCodeQuery) GroupBy(field string, fields ...string) *RedeemCodeGroupBy {
	...
	grbuild := &RedeemCodeGroupBy{build: _qplaceholder
...
func (_q *RedeemCodeQuery) Select(fields ...string) *RedeemCodeSelect {
	...
	sbuild := &RedeemCodeSelect{RedeemCodeQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &RedeemCode{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *RedeemCode, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *RedeemCode, e *Group) { n.Edges.Group = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
