...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{soraaccount.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{soraaccount.Labelplaceholder
	default:
		return nil, &NotSingularError{soraaccount.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{soraaccount.Labelplaceholder
	default:
		err = &NotSingularError{soraaccount.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &SoraAccountQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]soraaccount.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.SoraAccount{placeholder, _q.predicates...),
...
func (_q *SoraAccountQuery) GroupBy(field string, fields ...string) *SoraAccountGroupBy {
	...
	grbuild := &SoraAccountGroupBy{build: _qplaceholder
...
func (_q *SoraAccountQuery) Select(fields ...string) *SoraAccountSelect {
	...
	sbuild := &SoraAccountSelect{SoraAccountQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &SoraAccount{config: _q.configplaceholder
