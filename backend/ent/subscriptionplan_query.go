...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{subscriptionplan.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{subscriptionplan.Labelplaceholder
	default:
		return nil, &NotSingularError{subscriptionplan.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{subscriptionplan.Labelplaceholder
	default:
		err = &NotSingularError{subscriptionplan.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &SubscriptionPlanQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]subscriptionplan.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.SubscriptionPlan{placeholder, _q.predicates...),
...
func (_q *SubscriptionPlanQuery) GroupBy(field string, fields ...string) *SubscriptionPlanGroupBy {
	...
	grbuild := &SubscriptionPlanGroupBy{build: _qplaceholder
...
func (_q *SubscriptionPlanQuery) Select(fields ...string) *SubscriptionPlanSelect {
	...
	sbuild := &SubscriptionPlanSelect{SubscriptionPlanQuery: _qplaceholder
...
func (_q *SubscriptionPlanQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SubscriptionPlan, error) {
	var (
		nodes = []*SubscriptionPlan{placeholder
		_spec = _q.querySpec()
	)
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &SubscriptionPlan{config: _q.configplaceholder
