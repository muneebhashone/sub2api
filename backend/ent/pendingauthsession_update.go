...
func (_u *PendingAuthSessionUpdate) SetUpstreamIdentityClaims(v map[string]interface{placeholder) *PendingAuthSessionUpdate {
	_u.mutation.SetUpstreamIdentityClaims(v)
	return _u
placeholder

// SetLocalFlowState sets the "local_flow_state" field.
func (_u *PendingAuthSessionUpdate) SetLocalFlowState(v map[string]interface{placeholder) *PendingAuthSessionUpdate {
...
placeholder
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{pendingauthsession.Labelplaceholder
...
// SetUpstreamIdentityClaims sets the "upstream_identity_claims" field.
func (_u *PendingAuthSessionUpdateOne) SetUpstreamIdentityClaims(v map[string]interface{placeholder) *PendingAuthSessionUpdateOne {
	_u.mutation.SetUpstreamIdentityClaims(v)
	return _u
placeholder

// SetLocalFlowState sets the "local_flow_state" field.
func (_u *PendingAuthSessionUpdateOne) SetLocalFlowState(v map[string]interface{placeholder) *PendingAuthSessionUpdateOne {
	_u.mutation.SetLocalFlowState(v)
	return _u
placeholder
...
placeholder
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "PendingAuthSession.id" for update`)placeholder
placeholder
...
placeholder
	...
	placeholder
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
placeholder
	_node = &PendingAuthSession{config: _u.configplaceholder
