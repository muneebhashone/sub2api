...
type AuthIdentity struct {
	...
	Metadata map[string]interface{placeholder `json:"metadata,omitempty"`
...
placeholder
	return nil, &NotLoadedError{edge: "channels"placeholder
placeholder
...
placeholder
	return nil, &NotLoadedError{edge: "adoption_decisions"placeholder
placeholder
