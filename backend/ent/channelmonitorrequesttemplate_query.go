...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{channelmonitorrequesttemplate.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{channelmonitorrequesttemplate.Labelplaceholder
	default:
		return nil, &NotSingularError{channelmonitorrequesttemplate.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{channelmonitorrequesttemplate.Labelplaceholder
	default:
		err = &NotSingularError{channelmonitorrequesttemplate.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &ChannelMonitorRequestTemplateQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]channelmonitorrequesttemplate.OrderOption{placeholder, _q.order...),
		inters:       append([]Interceptor{placeholder, _q.inters...),
		predicates:   append([]predicate.ChannelMonitorRequestTemplate{placeholder, _q.predicates...),
...
func (_q *ChannelMonitorRequestTemplateQuery) GroupBy(field string, fields ...string) *ChannelMonitorRequestTemplateGroupBy {
	...
	grbuild := &ChannelMonitorRequestTemplateGroupBy{build: _qplaceholder
...
func (_q *ChannelMonitorRequestTemplateQuery) Select(fields ...string) *ChannelMonitorRequestTemplateSelect {
	...
	sbuild := &ChannelMonitorRequestTemplateSelect{ChannelMonitorRequestTemplateQuery: _qplaceholder
...
func (_q *ChannelMonitorRequestTemplateQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChannelMonitorRequestTemplate, error) {
	var (
		nodes       = []*ChannelMonitorRequestTemplate{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
			_q.withMonitors != nil,
	placeholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &ChannelMonitorRequestTemplate{config: _q.configplaceholder
...
placeholder
	if query := _q.withMonitors; query != nil {
		if err := _q.loadMonitors(ctx, query, nodes,
			func(n *ChannelMonitorRequestTemplate) { n.Edges.Monitors = []*ChannelMonitor{placeholder placeholder,
