...
type PendingAuthSession struct {
	...
	UpstreamIdentityClaims map[string]interface{placeholder `json:"upstream_identity_claims,omitempty"`
	// LocalFlowState holds the value of the "local_flow_state" field.
	LocalFlowState map[string]interface{placeholder `json:"local_flow_state,omitempty"`
...
placeholder
	return nil, &NotLoadedError{edge: "target_user"placeholder
placeholder
...
placeholder else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: identityadoptiondecision.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "adoption_decision"placeholder
placeholder
