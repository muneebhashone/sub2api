...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{usersubscription.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{usersubscription.Labelplaceholder
	default:
		return nil, &NotSingularError{usersubscription.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{usersubscription.Labelplaceholder
	default:
		err = &NotSingularError{usersubscription.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &UserSubscriptionQuery{
		config:             _q.config,
		ctx:                _q.ctx.Clone(),
		order:              append([]usersubscription.OrderOption{placeholder, _q.order...),
		inters:             append([]Interceptor{placeholder, _q.inters...),
		predicates:         append([]predicate.UserSubscription{placeholder, _q.predicates...),
...
func (_q *UserSubscriptionQuery) GroupBy(field string, fields ...string) *UserSubscriptionGroupBy {
	...
	grbuild := &UserSubscriptionGroupBy{build: _qplaceholder
...
func (_q *UserSubscriptionQuery) Select(fields ...string) *UserSubscriptionSelect {
	...
	sbuild := &UserSubscriptionSelect{UserSubscriptionQuery: _qplaceholder
...
func (_q *UserSubscriptionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserSubscription, error) {
	var (
		nodes       = []*UserSubscription{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [4]bool{
			_q.withUser != nil,
			_q.withGroup != nil,
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserSubscription{config: _q.configplaceholder
...
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserSubscription, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *UserSubscription, e *Group) { n.Edges.Group = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAssignedByUser; query != nil {
		if err := _q.loadAssignedByUser(ctx, query, nodes, nil,
			func(n *UserSubscription, e *User) { n.Edges.AssignedByUser = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUsageLogs; query != nil {
		if err := _q.loadUsageLogs(ctx, query, nodes,
			func(n *UserSubscription) { n.Edges.UsageLogs = []*UsageLog{placeholder placeholder,
			func(n *UserSubscription, e *UsageLog) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
