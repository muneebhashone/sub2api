...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{proxy.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{proxy.Labelplaceholder
	default:
		return nil, &NotSingularError{proxy.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{proxy.Labelplaceholder
	default:
		err = &NotSingularError{proxy.Labelplaceholder
placeholder
	return
placeholder
...
func (_q *ProxyQuery) GroupBy(field string, fields ...string) *ProxyGroupBy {
	...
	grbuild := &ProxyGroupBy{build: _qplaceholder
...
func (_q *ProxyQuery) Select(fields ...string) *ProxySelect {
	...
	sbuild := &ProxySelect{ProxyQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &Proxy{config: _q.configplaceholder
