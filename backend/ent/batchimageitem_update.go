...
placeholder
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "BatchImageItem.id" for update`)placeholder
placeholder
...
placeholder
	if _u.mutation.IndexedAtCleared() {
		_spec.ClearField(batchimageitem.FieldIndexedAt, field.TypeTime)
placeholder
	_node = &BatchImageItem{config: _u.configplaceholder
