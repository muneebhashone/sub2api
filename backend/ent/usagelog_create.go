...
func (_c *UsageLogCreate) check() error {
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "UsageLog.user_id"`)placeholder
placeholder
	if _, ok := _c.mutation.APIKeyID(); !ok {
		return &ValidationError{Name: "api_key_id", err: errors.New(`ent: missing required field "UsageLog.api_key_id"`)placeholder
placeholder
	if _, ok := _c.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`ent: missing required field "UsageLog.account_id"`)placeholder
placeholder
	if _, ok := _c.mutation.RequestID(); !ok {
		return &ValidationError{Name: "request_id", err: errors.New(`ent: missing required field "UsageLog.request_id"`)placeholder
placeholder
	if v, ok := _c.mutation.RequestID(); ok {
		if err := usagelog.RequestIDValidator(v); err != nil {
			return &ValidationError{Name: "request_id", err: fmt.Errorf(`ent: validator failed for field "UsageLog.request_id": %w`, err)placeholder
	placeholder
placeholder
	if _, ok := _c.mutation.Model(); !ok {
		return &ValidationError{Name: "model", err: errors.New(`ent: missing required field "UsageLog.model"`)placeholder
placeholder
...
placeholder
	if v, ok := _c.mutation.UpstreamResponseModel(); ok {
		if err := usagelog.UpstreamResponseModelValidator(v); err != nil {
			return &ValidationError{Name: "upstream_response_model", err: fmt.Errorf(`ent: validator failed for field "UsageLog.upstream_response_model": %w`, err)placeholder
	placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.OutputTokens(); !ok {
		return &ValidationError{Name: "output_tokens", err: errors.New(`ent: missing required field "UsageLog.output_tokens"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheCreationTokens(); !ok {
		return &ValidationError{Name: "cache_creation_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_tokens"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheReadTokens(); !ok {
		return &ValidationError{Name: "cache_read_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_read_tokens"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheCreation5mTokens(); !ok {
		return &ValidationError{Name: "cache_creation_5m_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_5m_tokens"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheCreation1hTokens(); !ok {
		return &ValidationError{Name: "cache_creation_1h_tokens", err: errors.New(`ent: missing required field "UsageLog.cache_creation_1h_tokens"`)placeholder
placeholder
	if _, ok := _c.mutation.InputCost(); !ok {
		return &ValidationError{Name: "input_cost", err: errors.New(`ent: missing required field "UsageLog.input_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.OutputCost(); !ok {
		return &ValidationError{Name: "output_cost", err: errors.New(`ent: missing required field "UsageLog.output_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheCreationCost(); !ok {
		return &ValidationError{Name: "cache_creation_cost", err: errors.New(`ent: missing required field "UsageLog.cache_creation_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheReadCost(); !ok {
		return &ValidationError{Name: "cache_read_cost", err: errors.New(`ent: missing required field "UsageLog.cache_read_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.TotalCost(); !ok {
		return &ValidationError{Name: "total_cost", err: errors.New(`ent: missing required field "UsageLog.total_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.ActualCost(); !ok {
		return &ValidationError{Name: "actual_cost", err: errors.New(`ent: missing required field "UsageLog.actual_cost"`)placeholder
placeholder
	if _, ok := _c.mutation.RateMultiplier(); !ok {
...
placeholder
	if v, ok := _c.mutation.ImageInputSize(); ok {
		if err := usagelog.ImageInputSizeValidator(v); err != nil {
			return &ValidationError{Name: "image_input_size", err: fmt.Errorf(`ent: validator failed for field "UsageLog.image_input_size": %w`, err)placeholder
	placeholder
placeholder
	if v, ok := _c.mutation.ImageOutputSize(); ok {
		if err := usagelog.ImageOutputSizeValidator(v); err != nil {
			return &ValidationError{Name: "image_output_size", err: fmt.Errorf(`ent: validator failed for field "UsageLog.image_output_size": %w`, err)placeholder
	placeholder
placeholder
	if v, ok := _c.mutation.ImageSizeSource(); ok {
		if err := usagelog.ImageSizeSourceValidator(v); err != nil {
			return &ValidationError{Name: "image_size_source", err: fmt.Errorf(`ent: validator failed for field "UsageLog.image_size_source": %w`, err)placeholder
	placeholder
placeholder
	if _, ok := _c.mutation.VideoCount(); !ok {
		return &ValidationError{Name: "video_count", err: errors.New(`ent: missing required field "UsageLog.video_count"`)placeholder
placeholder
	if v, ok := _c.mutation.VideoResolution(); ok {
		if err := usagelog.VideoResolutionValidator(v); err != nil {
			return &ValidationError{Name: "video_resolution", err: fmt.Errorf(`ent: validator failed for field "UsageLog.video_resolution": %w`, err)placeholder
	placeholder
placeholder
	if _, ok := _c.mutation.CacheTTLOverridden(); !ok {
		return &ValidationError{Name: "cache_ttl_overridden", err: errors.New(`ent: missing required field "UsageLog.cache_ttl_overridden"`)placeholder
placeholder
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "UsageLog.created_at"`)placeholder
placeholder
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "UsageLog.user"`)placeholder
placeholder
	if len(_c.mutation.APIKeyIDs()) == 0 {
		return &ValidationError{Name: "api_key", err: errors.New(`ent: missing required edge "UsageLog.api_key"`)placeholder
placeholder
	if len(_c.mutation.AccountIDs()) == 0 {
		return &ValidationError{Name: "account", err: errors.New(`ent: missing required edge "UsageLog.account"`)placeholder
placeholder
	return nil
placeholder
...
func (_c *UsageLogCreate) createSpec() (*UsageLog, *sqlgraph.CreateSpec) {
	var (
		_node = &UsageLog{config: _c.configplaceholder
...
placeholder
	if nodes := _c.mutation.UserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.UserColumnplaceholder,
			Bidi:    false,
...
placeholder
	if nodes := _c.mutation.APIKeyIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.APIKeyColumnplaceholder,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
placeholder
	if nodes := _c.mutation.AccountIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.AccountColumnplaceholder,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
placeholder
	if nodes := _c.mutation.GroupIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.GroupColumnplaceholder,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
placeholder
	if nodes := _c.mutation.SubscriptionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{usagelog.SubscriptionColumnplaceholder,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
func (u *UsageLogUpsertOne) Update(set func(*UsageLogUpsert)) *UsageLogUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&UsageLogUpsert{UpdateSet: updateplaceholder)
placeholder))
	return u
placeholder
