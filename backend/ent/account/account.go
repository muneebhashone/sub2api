...
var (
	...
	GroupsPrimaryKey = []string{"account_id", "group_id"placeholder
)
...
var (
	...
	DefaultCredentials func() map[string]interface{placeholder
	// DefaultExtra holds the default value on creation for the "extra" field.
	DefaultExtra func() map[string]interface{placeholder
...
func ByGroups(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newGroupsStep(), append([]sql.OrderTerm{termplaceholder, terms...)...)
placeholder
placeholder
...
func ByChildren(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newChildrenStep(), append([]sql.OrderTerm{termplaceholder, terms...)...)
placeholder
placeholder
