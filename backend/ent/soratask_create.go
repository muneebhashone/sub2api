...
func (_c *SoraTaskCreate) check() error {
	if _, ok := _c.mutation.TaskID(); !ok {
		return &ValidationError{Name: "task_id", err: errors.New(`ent: missing required field "SoraTask.task_id"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`ent: missing required field "SoraTask.account_id"`)placeholder
placeholder
	if _, ok := _c.mutation.Model(); !ok {
		return &ValidationError{Name: "model", err: errors.New(`ent: missing required field "SoraTask.model"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.Prompt(); !ok {
		return &ValidationError{Name: "prompt", err: errors.New(`ent: missing required field "SoraTask.prompt"`)placeholder
placeholder
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "SoraTask.status"`)placeholder
placeholder
...
placeholder
	if _, ok := _c.mutation.Progress(); !ok {
		return &ValidationError{Name: "progress", err: errors.New(`ent: missing required field "SoraTask.progress"`)placeholder
placeholder
	if _, ok := _c.mutation.RetryCount(); !ok {
		return &ValidationError{Name: "retry_count", err: errors.New(`ent: missing required field "SoraTask.retry_count"`)placeholder
placeholder
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "SoraTask.created_at"`)placeholder
placeholder
	return nil
placeholder
...
func (_c *SoraTaskCreate) createSpec() (*SoraTask, *sqlgraph.CreateSpec) {
	var (
		_node = &SoraTask{config: _c.configplaceholder
...
func (u *SoraTaskUpsertOne) Update(set func(*SoraTaskUpsert)) *SoraTaskUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&SoraTaskUpsert{UpdateSet: updateplaceholder)
placeholder))
	return u
placeholder
