...
placeholder()
	...
	channelmonitordailyrollupMixin := schema.ChannelMonitorDailyRollup{placeholder.Mixin()
...
placeholder()
	...
	channelmonitorhistoryMixin := schema.ChannelMonitorHistory{placeholder.Mixin()
