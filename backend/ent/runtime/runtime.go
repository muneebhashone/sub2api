...
placeholder()
	...
	soraaccountMixin := schema.SoraAccount{placeholder.Mixin()
	soraaccountMixinFields0 := soraaccountMixin[0].Fields()
	_ = soraaccountMixinFields0
	soraaccountFields := schema.SoraAccount{placeholder.Fields()
	_ = soraaccountFields
	...
	soracachefileFields := schema.SoraCacheFile{placeholder.Fields()
	...
	sorataskFields := schema.SoraTask{placeholder.Fields()
	_ = sorataskFields
	...
	sorausagestatMixin := schema.SoraUsageStat{placeholder.Mixin()
	sorausagestatMixinFields0 := sorausagestatMixin[0].Fields()
	_ = sorausagestatMixinFields0
	sorausagestatFields := schema.SoraUsageStat{placeholder.Fields()
