...
placeholder else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: pendingauthsession.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "pending_auth_session"placeholder
placeholder
...
placeholder else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: authidentity.Labelplaceholder
placeholder
	return nil, &NotLoadedError{edge: "identity"placeholder
placeholder
