...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{pendingauthsession.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{pendingauthsession.Labelplaceholder
	default:
		return nil, &NotSingularError{pendingauthsession.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{pendingauthsession.Labelplaceholder
	default:
		err = &NotSingularError{pendingauthsession.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &PendingAuthSessionQuery{
		config:               _q.config,
		ctx:                  _q.ctx.Clone(),
		order:                append([]pendingauthsession.OrderOption{placeholder, _q.order...),
		inters:               append([]Interceptor{placeholder, _q.inters...),
		predicates:           append([]predicate.PendingAuthSession{placeholder, _q.predicates...),
...
func (_q *PendingAuthSessionQuery) GroupBy(field string, fields ...string) *PendingAuthSessionGroupBy {
	...
	grbuild := &PendingAuthSessionGroupBy{build: _qplaceholder
...
func (_q *PendingAuthSessionQuery) Select(fields ...string) *PendingAuthSessionSelect {
	...
	sbuild := &PendingAuthSessionSelect{PendingAuthSessionQuery: _qplaceholder
...
func (_q *PendingAuthSessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PendingAuthSession, error) {
	var (
		nodes       = []*PendingAuthSession{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &PendingAuthSession{config: _q.configplaceholder
...
placeholder
	if query := _q.withTargetUser; query != nil {
		if err := _q.loadTargetUser(ctx, query, nodes, nil,
			func(n *PendingAuthSession, e *User) { n.Edges.TargetUser = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAdoptionDecision; query != nil {
		if err := _q.loadAdoptionDecision(ctx, query, nodes, nil,
			func(n *PendingAuthSession, e *IdentityAdoptionDecision) { n.Edges.AdoptionDecision = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
