...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{paymentauditlog.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{paymentauditlog.Labelplaceholder
	default:
		return nil, &NotSingularError{paymentauditlog.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{paymentauditlog.Labelplaceholder
	default:
		err = &NotSingularError{paymentauditlog.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &PaymentAuditLogQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]paymentauditlog.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.PaymentAuditLog{placeholder, _q.predicates...),
...
func (_q *PaymentAuditLogQuery) GroupBy(field string, fields ...string) *PaymentAuditLogGroupBy {
	...
	grbuild := &PaymentAuditLogGroupBy{build: _qplaceholder
...
func (_q *PaymentAuditLogQuery) Select(fields ...string) *PaymentAuditLogSelect {
	...
	sbuild := &PaymentAuditLogSelect{PaymentAuditLogQuery: _qplaceholder
...
func (_q *PaymentAuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentAuditLog, error) {
	var (
		nodes = []*PaymentAuditLog{placeholder
		_spec = _q.querySpec()
	)
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &PaymentAuditLog{config: _q.configplaceholder
