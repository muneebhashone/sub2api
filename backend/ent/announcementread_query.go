...
func (_q *AnnouncementReadQuery) QueryAnnouncement() *AnnouncementQuery {
	query := (&AnnouncementClient{config: _q.configplaceholder).Query()
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{announcementread.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{announcementread.Labelplaceholder
	default:
		return nil, &NotSingularError{announcementread.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{announcementread.Labelplaceholder
	default:
		err = &NotSingularError{announcementread.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &AnnouncementReadQuery{
		config:           _q.config,
		ctx:              _q.ctx.Clone(),
		order:            append([]announcementread.OrderOption{placeholder, _q.order...),
		inters:           append([]Interceptor{placeholder, _q.inters...),
		predicates:       append([]predicate.AnnouncementRead{placeholder, _q.predicates...),
...
func (_q *AnnouncementReadQuery) GroupBy(field string, fields ...string) *AnnouncementReadGroupBy {
	...
	grbuild := &AnnouncementReadGroupBy{build: _qplaceholder
...
func (_q *AnnouncementReadQuery) Select(fields ...string) *AnnouncementReadSelect {
	...
	sbuild := &AnnouncementReadSelect{AnnouncementReadQuery: _qplaceholder
...
func (_q *AnnouncementReadQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AnnouncementRead, error) {
	var (
		nodes       = []*AnnouncementRead{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &AnnouncementRead{config: _q.configplaceholder
...
placeholder
	if query := _q.withAnnouncement; query != nil {
		if err := _q.loadAnnouncement(ctx, query, nodes, nil,
			func(n *AnnouncementRead, e *Announcement) { n.Edges.Announcement = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *AnnouncementRead, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
