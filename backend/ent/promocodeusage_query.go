...
func (_q *PromoCodeUsageQuery) QueryPromoCode() *PromoCodeQuery {
	query := (&PromoCodeClient{config: _q.configplaceholder).Query()
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{promocodeusage.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{promocodeusage.Labelplaceholder
	default:
		return nil, &NotSingularError{promocodeusage.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{promocodeusage.Labelplaceholder
	default:
		err = &NotSingularError{promocodeusage.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &PromoCodeUsageQuery{
		config:        _q.config,
		ctx:           _q.ctx.Clone(),
		order:         append([]promocodeusage.OrderOption{placeholder, _q.order...),
		inters:        append([]Interceptor{placeholder, _q.inters...),
		predicates:    append([]predicate.PromoCodeUsage{placeholder, _q.predicates...),
...
func (_q *PromoCodeUsageQuery) GroupBy(field string, fields ...string) *PromoCodeUsageGroupBy {
	...
	grbuild := &PromoCodeUsageGroupBy{build: _qplaceholder
...
func (_q *PromoCodeUsageQuery) Select(fields ...string) *PromoCodeUsageSelect {
	...
	sbuild := &PromoCodeUsageSelect{PromoCodeUsageQuery: _qplaceholder
...
func (_q *PromoCodeUsageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PromoCodeUsage, error) {
	var (
		nodes       = []*PromoCodeUsage{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &PromoCodeUsage{config: _q.configplaceholder
...
placeholder
	if query := _q.withPromoCode; query != nil {
		if err := _q.loadPromoCode(ctx, query, nodes, nil,
			func(n *PromoCodeUsage, e *PromoCode) { n.Edges.PromoCode = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *PromoCodeUsage, e *User) { n.Edges.User = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
