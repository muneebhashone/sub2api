...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{identityadoptiondecision.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{identityadoptiondecision.Labelplaceholder
	default:
		return nil, &NotSingularError{identityadoptiondecision.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{identityadoptiondecision.Labelplaceholder
	default:
		err = &NotSingularError{identityadoptiondecision.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &IdentityAdoptionDecisionQuery{
		config:                 _q.config,
		ctx:                    _q.ctx.Clone(),
		order:                  append([]identityadoptiondecision.OrderOption{placeholder, _q.order...),
		inters:                 append([]Interceptor{placeholder, _q.inters...),
		predicates:             append([]predicate.IdentityAdoptionDecision{placeholder, _q.predicates...),
...
func (_q *IdentityAdoptionDecisionQuery) GroupBy(field string, fields ...string) *IdentityAdoptionDecisionGroupBy {
	...
	grbuild := &IdentityAdoptionDecisionGroupBy{build: _qplaceholder
...
func (_q *IdentityAdoptionDecisionQuery) Select(fields ...string) *IdentityAdoptionDecisionSelect {
	...
	sbuild := &IdentityAdoptionDecisionSelect{IdentityAdoptionDecisionQuery: _qplaceholder
...
func (_q *IdentityAdoptionDecisionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*IdentityAdoptionDecision, error) {
	var (
		nodes       = []*IdentityAdoptionDecision{placeholder
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &IdentityAdoptionDecision{config: _q.configplaceholder
...
placeholder
	if query := _q.withPendingAuthSession; query != nil {
		if err := _q.loadPendingAuthSession(ctx, query, nodes, nil,
			func(n *IdentityAdoptionDecision, e *PendingAuthSession) { n.Edges.PendingAuthSession = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withIdentity; query != nil {
		if err := _q.loadIdentity(ctx, query, nodes, nil,
			func(n *IdentityAdoptionDecision, e *AuthIdentity) { n.Edges.Identity = e placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
