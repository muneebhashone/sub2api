...
func (_q *UserQuery) QueryRedeemCodes() *RedeemCodeQuery {
	query := (&RedeemCodeClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryAttributeValues() *UserAttributeValueQuery {
	query := (&UserAttributeValueClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryPromoCodeUsages() *PromoCodeUsageQuery {
	query := (&PromoCodeUsageClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryPaymentOrders() *PaymentOrderQuery {
	query := (&PaymentOrderClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryAuthIdentities() *AuthIdentityQuery {
	query := (&AuthIdentityClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryPendingAuthSessions() *PendingAuthSessionQuery {
	query := (&PendingAuthSessionClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryPlatformQuotas() *UserPlatformQuotaQuery {
	query := (&UserPlatformQuotaClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
func (_q *UserQuery) QueryUserAllowedGroups() *UserAllowedGroupQuery {
	query := (&UserAllowedGroupClient{config: _q.configplaceholder).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
	placeholder
...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{user.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{user.Labelplaceholder
	default:
		return nil, &NotSingularError{user.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{user.Labelplaceholder
	default:
		err = &NotSingularError{user.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &UserQuery{
		config:                    _q.config,
		ctx:                       _q.ctx.Clone(),
		order:                     append([]user.OrderOption{placeholder, _q.order...),
		inters:                    append([]Interceptor{placeholder, _q.inters...),
		predicates:                append([]predicate.User{placeholder, _q.predicates...),
...
func (_q *UserQuery) GroupBy(field string, fields ...string) *UserGroupBy {
	...
	grbuild := &UserGroupBy{build: _qplaceholder
...
func (_q *UserQuery) Select(fields ...string) *UserSelect {
	...
	sbuild := &UserSelect{UserQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &User{config: _q.configplaceholder
...
placeholder
	if query := _q.withRedeemCodes; query != nil {
		if err := _q.loadRedeemCodes(ctx, query, nodes,
			func(n *User) { n.Edges.RedeemCodes = []*RedeemCode{placeholder placeholder,
			func(n *User, e *RedeemCode) { n.Edges.RedeemCodes = append(n.Edges.RedeemCodes, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withSubscriptions; query != nil {
		if err := _q.loadSubscriptions(ctx, query, nodes,
			func(n *User) { n.Edges.Subscriptions = []*UserSubscription{placeholder placeholder,
			func(n *User, e *UserSubscription) { n.Edges.Subscriptions = append(n.Edges.Subscriptions, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAssignedSubscriptions; query != nil {
		if err := _q.loadAssignedSubscriptions(ctx, query, nodes,
			func(n *User) { n.Edges.AssignedSubscriptions = []*UserSubscription{placeholder placeholder,
...
placeholder
	if query := _q.withAnnouncementReads; query != nil {
		if err := _q.loadAnnouncementReads(ctx, query, nodes,
			func(n *User) { n.Edges.AnnouncementReads = []*AnnouncementRead{placeholder placeholder,
			func(n *User, e *AnnouncementRead) { n.Edges.AnnouncementReads = append(n.Edges.AnnouncementReads, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
...
placeholder
	if query := _q.withAttributeValues; query != nil {
		if err := _q.loadAttributeValues(ctx, query, nodes,
			func(n *User) { n.Edges.AttributeValues = []*UserAttributeValue{placeholder placeholder,
			func(n *User, e *UserAttributeValue) { n.Edges.AttributeValues = append(n.Edges.AttributeValues, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withPromoCodeUsages; query != nil {
		if err := _q.loadPromoCodeUsages(ctx, query, nodes,
			func(n *User) { n.Edges.PromoCodeUsages = []*PromoCodeUsage{placeholder placeholder,
			func(n *User, e *PromoCodeUsage) { n.Edges.PromoCodeUsages = append(n.Edges.PromoCodeUsages, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withPaymentOrders; query != nil {
		if err := _q.loadPaymentOrders(ctx, query, nodes,
			func(n *User) { n.Edges.PaymentOrders = []*PaymentOrder{placeholder placeholder,
			func(n *User, e *PaymentOrder) { n.Edges.PaymentOrders = append(n.Edges.PaymentOrders, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withAuthIdentities; query != nil {
		if err := _q.loadAuthIdentities(ctx, query, nodes,
			func(n *User) { n.Edges.AuthIdentities = []*AuthIdentity{placeholder placeholder,
			func(n *User, e *AuthIdentity) { n.Edges.AuthIdentities = append(n.Edges.AuthIdentities, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withPendingAuthSessions; query != nil {
		if err := _q.loadPendingAuthSessions(ctx, query, nodes,
			func(n *User) { n.Edges.PendingAuthSessions = []*PendingAuthSession{placeholder placeholder,
...
placeholder
	if query := _q.withPlatformQuotas; query != nil {
		if err := _q.loadPlatformQuotas(ctx, query, nodes,
			func(n *User) { n.Edges.PlatformQuotas = []*UserPlatformQuota{placeholder placeholder,
			func(n *User, e *UserPlatformQuota) { n.Edges.PlatformQuotas = append(n.Edges.PlatformQuotas, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	if query := _q.withUserAllowedGroups; query != nil {
		if err := _q.loadUserAllowedGroups(ctx, query, nodes,
			func(n *User) { n.Edges.UserAllowedGroups = []*UserAllowedGroup{placeholder placeholder,
			func(n *User, e *UserAllowedGroup) { n.Edges.UserAllowedGroups = append(n.Edges.UserAllowedGroups, e) placeholder); err != nil {
			return nil, err
	placeholder
placeholder
	return nodes, nil
...
func (_q *UserQuery) loadAllowedGroups(ctx context.Context, query *GroupQuery, nodes []*User, init func(*User), assign func(*User, *Group)) error {
	...
	nids := make(map[int64]map[*User]struct{placeholder)
		...
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.ScanValues = func(columns []string) ([]any, error) {
				...
				if err != nil {
					return nil, err
			placeholder
				return append([]any{new(sql.NullInt64)placeholder, values...), nil
		placeholder
			spec.Assign = func(columns []string, values []any) error {
				outValue := values[0].(*sql.NullInt64).Int64
				inValue := values[1].(*sql.NullInt64).Int64
				if nids[inValue] == nil {
					nids[inValue] = map[*User]struct{placeholder{byID[outValue]: {placeholderplaceholder
					return assign(columns[1:], values[1:])
			placeholder
				nids[inValue][byID[outValue]] = struct{placeholder{placeholder
				return nil
		placeholder
	placeholder)
placeholder)
