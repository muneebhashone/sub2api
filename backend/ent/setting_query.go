...
placeholder
	if len(nodes) == 0 {
		return nil, &NotFoundError{setting.Labelplaceholder
placeholder
	return nodes[0], nil
placeholder
...
placeholder
	...
	case 0:
		return nil, &NotFoundError{setting.Labelplaceholder
	default:
		return nil, &NotSingularError{setting.Labelplaceholder
placeholder
placeholder
...
placeholder
	...
	case 0:
		err = &NotFoundError{setting.Labelplaceholder
	default:
		err = &NotSingularError{setting.Labelplaceholder
placeholder
	return
placeholder
...
placeholder
	return &SettingQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]setting.OrderOption{placeholder, _q.order...),
		inters:     append([]Interceptor{placeholder, _q.inters...),
		predicates: append([]predicate.Setting{placeholder, _q.predicates...),
...
func (_q *SettingQuery) GroupBy(field string, fields ...string) *SettingGroupBy {
	...
	grbuild := &SettingGroupBy{build: _qplaceholder
...
func (_q *SettingQuery) Select(fields ...string) *SettingSelect {
	...
	sbuild := &SettingSelect{SettingQuery: _qplaceholder
...
placeholder
	_spec.Assign = func(columns []string, values []any) error {
		node := &Setting{config: _q.configplaceholder
