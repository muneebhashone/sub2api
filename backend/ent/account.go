...
type Account struct {
	...
	Credentials map[string]interface{placeholder `json:"credentials,omitempty"`
	// Extra holds the value of the "extra" field.
	Extra map[string]interface{placeholder `json:"extra,omitempty"`
...
placeholder
	return nil, &NotLoadedError{edge: "parent"placeholder
placeholder
...
placeholder
	return nil, &NotLoadedError{edge: "children"placeholder
placeholder
