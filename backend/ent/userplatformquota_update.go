...
placeholder
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "UserPlatformQuota.id" for update`)placeholder
placeholder
...
placeholder
	...
	placeholder
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
placeholder
	_node = &UserPlatformQuota{config: _u.configplaceholder
