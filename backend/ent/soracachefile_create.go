...
func (_c *SoraCacheFileCreate) check() error {
	if v, ok := _c.mutation.TaskID(); ok {
		if err := soracachefile.TaskIDValidator(v); err != nil {
			return &ValidationError{Name: "task_id", err: fmt.Errorf(`ent: validator failed for field "SoraCacheFile.task_id": %w`, err)placeholder
	placeholder
placeholder
	if _, ok := _c.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`ent: missing required field "SoraCacheFile.account_id"`)placeholder
placeholder
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "SoraCacheFile.user_id"`)placeholder
placeholder
	if _, ok := _c.mutation.MediaType(); !ok {
		return &ValidationError{Name: "media_type", err: errors.New(`ent: missing required field "SoraCacheFile.media_type"`)placeholder
placeholder
	if v, ok := _c.mutation.MediaType(); ok {
		if err := soracachefile.MediaTypeValidator(v); err != nil {
			return &ValidationError{Name: "media_type", err: fmt.Errorf(`ent: validator failed for field "SoraCacheFile.media_type": %w`, err)placeholder
	placeholder
placeholder
	if _, ok := _c.mutation.OriginalURL(); !ok {
		return &ValidationError{Name: "original_url", err: errors.New(`ent: missing required field "SoraCacheFile.original_url"`)placeholder
placeholder
	if _, ok := _c.mutation.CachePath(); !ok {
		return &ValidationError{Name: "cache_path", err: errors.New(`ent: missing required field "SoraCacheFile.cache_path"`)placeholder
placeholder
	if _, ok := _c.mutation.CacheURL(); !ok {
		return &ValidationError{Name: "cache_url", err: errors.New(`ent: missing required field "SoraCacheFile.cache_url"`)placeholder
placeholder
	if _, ok := _c.mutation.SizeBytes(); !ok {
		return &ValidationError{Name: "size_bytes", err: errors.New(`ent: missing required field "SoraCacheFile.size_bytes"`)placeholder
placeholder
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "SoraCacheFile.created_at"`)placeholder
placeholder
	return nil
placeholder
...
func (_c *SoraCacheFileCreate) createSpec() (*SoraCacheFile, *sqlgraph.CreateSpec) {
	var (
		_node = &SoraCacheFile{config: _c.configplaceholder
...
func (u *SoraCacheFileUpsertOne) Update(set func(*SoraCacheFileUpsert)) *SoraCacheFileUpsertOne {
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(update *sql.UpdateSet) {
		set(&SoraCacheFileUpsert{UpdateSet: updateplaceholder)
placeholder))
	return u
placeholder
