...
func (_u *ChannelMonitorUpdate) SetBodyOverride(v map[string]interface{placeholder) *ChannelMonitorUpdate {
...
// SetBodyOverride sets the "body_override" field.
func (_u *ChannelMonitorUpdateOne) SetBodyOverride(v map[string]interface{placeholder) *ChannelMonitorUpdateOne {
	_u.mutation.SetBodyOverride(v)
	return _u
placeholder
...
placeholder
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "ChannelMonitor.id" for update`)placeholder
placeholder
...
placeholder
	...
	placeholder
		_spec.Edges.Add = append(_spec.Edges.Add, edge)
placeholder
	_node = &ChannelMonitor{config: _u.configplaceholder
