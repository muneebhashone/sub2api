...
CREATE TABLE IF NOT EXISTS channel_monitor_v2_config (
    ...
    platforms JSONB NOT NULL DEFAULT '[{"platform":"anthropic","enabled":true,"models":[]placeholder,{"platform":"openai","enabled":true,"models":[]placeholder,{"platform":"grok","enabled":true,"models":[]placeholder,{"platform":"kiro","enabled":true,"models":[]placeholder,{"platform":"gemini","enabled":true,"models":[]placeholder,{"platform":"antigravity","enabled":true,"models":[]placeholder]'::jsonb,
    group_ids BIGINT[] NOT NULL DEFAULT '{placeholder',
    updated_by BIGINT,
