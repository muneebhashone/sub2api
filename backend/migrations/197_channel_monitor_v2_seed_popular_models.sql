...
WHERE id = 1
  ...
  AND platforms = '[{"platform":"anthropic","enabled":true,"models":[]placeholder,{"platform":"openai","enabled":true,"models":[]placeholder,{"platform":"grok","enabled":true,"models":[]placeholder,{"platform":"kiro","enabled":true,"models":[]placeholder,{"platform":"gemini","enabled":true,"models":[]placeholder,{"platform":"antigravity","enabled":true,"models":[]placeholder]'::jsonb;
