...
SET extra = jsonb_set(
    ...
    '{codex_fingerprint_seedplaceholder',
...
WHERE deleted_at IS NULL
  ...
  AND (
      ...
      OR NOT (
          extra->>'codex_fingerprint_seed' ~ '^[0-9a-f]{8placeholder-[0-9a-f]{4placeholder-[0-9a-f]{4placeholder-[0-9a-f]{4placeholder-[0-9a-f]{12placeholder$'
