...
func NewAnthropicProvider(gateway *service.GatewayService) *AnthropicProvider {
	return &AnthropicProvider{gateway: gatewayplaceholder
placeholder

// Platform 返回 service.PlatformAnthropic。
func (p *AnthropicProvider) Platform() string { return service.PlatformAnthropic placeholder
...
func NewAntigravityProvider(antigravity *service.AntigravityGatewayService) *AntigravityProvider {
	return &AntigravityProvider{antigravity: antigravityplaceholder
placeholder

// Platform 返回 service.PlatformAntigravity。
func (p *AntigravityProvider) Platform() string { return service.PlatformAntigravity placeholder
...
func NewGeminiProvider(antigravity *service.AntigravityGatewayService) *GeminiProvider {
	return &GeminiProvider{antigravity: antigravityplaceholder
placeholder

// Platform 返回 service.PlatformGemini。
func (p *GeminiProvider) Platform() string { return service.PlatformGemini placeholder
