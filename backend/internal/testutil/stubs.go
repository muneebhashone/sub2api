...
// 编译期接口断言
var _ service.ConcurrencyCache = StubConcurrencyCache{placeholder

// StubConcurrencyCache 是 ConcurrencyCache 的默认空实现，所有方法返回零值。
type StubConcurrencyCache struct{placeholder
...
func (c StubConcurrencyCache) IncrementWaitCount(_ context.Context, _ int64, _ int) (bool, error) {
	return true, nil
placeholder
func (c StubConcurrencyCache) DecrementWaitCount(_ context.Context, _ int64) error { return nil placeholder
func (c StubConcurrencyCache) GetAccountsLoadBatch(_ context.Context, accounts []service.AccountWithConcurrency) (map[int64]*service.AccountLoadInfo, error) {
	...
	for _, acc := range accounts {
		result[acc.ID] = &service.AccountLoadInfo{AccountID: acc.ID, LoadRate: 0placeholder
placeholder
	return result, nil
placeholder
func (c StubConcurrencyCache) GetUsersLoadBatch(_ context.Context, users []service.UserWithConcurrency) (map[int64]*service.UserLoadInfo, error) {
	...
	for _, u := range users {
		result[u.ID] = &service.UserLoadInfo{UserID: u.ID, LoadRate: 0placeholder
placeholder
	return result, nil
placeholder
...
var _ service.GatewayCache = StubGatewayCache{placeholder

type StubGatewayCache struct{placeholder
...
var _ service.SessionLimitCache = StubSessionLimitCache{placeholder

type StubSessionLimitCache struct{placeholder
