		...
		"input": []map[string]any{
			{
				...
				"content": []map[string]any{
					{"type": "input_text", "text": "Call the probe_ping function with ok=true to acknowledge readiness. You must use the tool."placeholder,
			placeholder,
		placeholder,
	placeholder,
		"tools": []map[string]any{
			{
				...
				"parameters": map[string]any{
					...
					"properties": map[string]any{
						"ok": map[string]any{"type": "boolean"placeholder,
				placeholder,
					"required": []string{"ok"placeholder,
			placeholder,
		placeholder,
	placeholder,
