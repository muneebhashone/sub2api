...
placeholder
	...
	placeholder else if currentPromptCacheKey, ok := decoded["prompt_cache_key"].(string); ok && currentPromptCacheKey != "" {
...
placeholder
	...
	placeholder
		...
		placeholder
	placeholder else if account.IsShadow() && account.ParentAccountID != nil {
