...
placeholder
	...
	tests := []struct {
		...
		expected       bool
placeholder{
		{"claude-fable-5", trueplaceholder,
		{"claude-fable-5[1m]", trueplaceholder,      // 家族 key 覆盖变体
		{"Claude-Fable-5-20260601", trueplaceholder, // 大小写不敏感
		{"claude-sonnet-4-6", falseplaceholder,      // 其他模型不受影响
		{"claude-opus-4-8", falseplaceholder,
placeholder
