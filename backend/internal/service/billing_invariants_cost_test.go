...
placeholder{
		{
			...
			serviceTier:    "flex",
			rateMultiplier: 1.5,
			tokens:         UsageTokens{InputTokens: 1000, OutputTokens: 500, CacheCreationTokens: 400, CacheReadTokens: 2000placeholder,
	...
	placeholder,
		{
			...
			rateMultiplier: 2.0,
			tokens:         UsageTokens{InputTokens: 1000, OutputTokens: 500, CacheCreationTokens: 1000, CacheReadTokens: 2000placeholder,
	...
	placeholder,
		{
			...
			serviceTier:    "priority",
			rateMultiplier: 1.5,
			tokens:         UsageTokens{InputTokens: 1000, OutputTokens: 500, CacheCreationTokens: 2000, CacheReadTokens: 3000placeholder,
...
func TestBillingInvariant_ZeroAndNegativeRateMultiplier(t *testing.T) {
	...
	for _, multiplier := range []float64{0, -2placeholder {
