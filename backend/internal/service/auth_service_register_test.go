...
type refreshTokenCacheStub struct{placeholder
...
placeholder
	return &UserSubscription{UserID: input.UserID, GroupID: input.GroupIDplaceholder, false, nil
placeholder
...
func TestAuthService_Register_SnapshotsPlatformQuotaDefaults(t *testing.T) {
	repo := &userRepoStub{nextID: 77placeholder
	quotaRepo := &userPlatformQuotaRepoStub{placeholder

	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:   "true",
		SettingKeyDefaultPlatformQuotas: `{"openai": {"weekly": 12.34placeholderplaceholder`,
placeholder, nil, quotaRepo)
...
func TestAuthService_Register_EmailSuffixNotAllowed(t *testing.T) {
	repo := &userRepoStub{domainCounts: map[string]int{"other.com": 1placeholderplaceholder
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                 "true",
...
func TestAuthService_Register_NonWhitelistDomainAllowsFirstAccount(t *testing.T) {
	repo := &userRepoStub{nextID: 9, domainCounts: map[string]int{"custom.example": 0placeholderplaceholder
...
func TestAuthService_Register_NonWhitelistDomainRejectsSecondAccount(t *testing.T) {
	repo := &userRepoStub{domainCounts: map[string]int{"custom.example": 1placeholderplaceholder
	svc := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                 "true",
		SettingKeyRegistrationEmailSuffixWhitelist:    `["@example.com"]`,
		SettingKeyRegistrationEmailDomainQuotaEnabled: "true",
...
func TestAuthService_SendVerifyCode_NonWhitelistDomainRejectedWhenQuotaDisabled(t *testing.T) {
	repo := &userRepoStub{domainCounts: map[string]int{"custom.example": 0placeholderplaceholder
	svc := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:              "true",
		SettingKeyRegistrationEmailSuffixWhitelist: `["@example.com"]`,
placeholder, nil, nil)
...
func TestAuthService_GetAccessTokenExpiresIn_FallbackToExpireHour(t *testing.T) {
	service := newAuthService(&userRepoStub{placeholder, nil, nil, nil)
...
func TestAuthService_Register_UsesEmailAuthSourceDefaultsWhenGrantEnabled(t *testing.T) {
	repo := &userRepoStub{nextID: 52placeholder
	assigner := &defaultSubscriptionAssignerStub{placeholder
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                 "true",
		SettingKeyDefaultSubscriptions:                `[{"group_id":91,"validity_days":3placeholder]`,
...
func TestAuthService_Register_GrantOnSignupFalseFallsBackToGlobalDefaults(t *testing.T) {
	repo := &userRepoStub{nextID: 53placeholder
	assigner := &defaultSubscriptionAssignerStub{placeholder
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                 "true",
		...
		SettingKeyAuthSourceDefaultEmailSubscriptions: `[{"group_id":32,"validity_days":9placeholder]`,
		SettingKeyAuthSourceDefaultEmailGrantOnSignup: "false",
placeholder, nil, nil)
	service.defaultSubAssigner = assigner
...
func TestAuthService_LoginOrRegisterOAuthWithTokenPair_UsesLinuxDoAuthSourceDefaultsOnSignup(t *testing.T) {
	...
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                   "true",
		SettingKeyDefaultSubscriptions:                  `[{"group_id":81,"validity_days":1placeholder]`,
		SettingKeyAuthSourceDefaultLinuxDoBalance:       "21.75",
		SettingKeyAuthSourceDefaultLinuxDoConcurrency:   "9",
		SettingKeyAuthSourceDefaultLinuxDoSubscriptions: `[{"group_id":22,"validity_days":14placeholder]`,
...
func TestAuthService_LoginOrRegisterOAuthWithTokenPair_ExistingUserDoesNotGrantAgain(t *testing.T) {
	existing := &User{
		...
		TokenVersion: 2,
placeholder
	repo := &userRepoStub{user: existingplaceholder
	assigner := &defaultSubscriptionAssignerStub{placeholder
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:                   "true",
		SettingKeyAuthSourceDefaultLinuxDoBalance:       "21.75",
