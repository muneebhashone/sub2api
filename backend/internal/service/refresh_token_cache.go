...
//
// Key 格式:
//   - refresh_token:{token_hashplaceholder     -> RefreshTokenData (JSON)
//   - user_refresh_tokens:{user_idplaceholder  -> Set<token_hash>
//   - token_family:{family_idplaceholder       -> Set<token_hash>
