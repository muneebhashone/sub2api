...
func TestAdminService_ListAccounts_WithSearch(t *testing.T) {
	...
	placeholder
		...
		require.Equal(t, pagination.PaginationParams{Page: 1, PageSize: 20, SortBy: "name", SortOrder: "ASC"placeholder, repo.listWithFiltersParams)
...
func TestAdminService_ListProxies_WithSearch(t *testing.T) {
	...
	placeholder
		...
		require.Equal(t, 1, repo.listWithFiltersCalls)
		require.Equal(t, pagination.PaginationParams{Page: 3, PageSize: 50, SortBy: "name", SortOrder: "ASC"placeholder, repo.listWithFiltersParams)
...
func TestAdminService_ListProxiesWithAccountCount_WithSearch(t *testing.T) {
	...
	placeholder
		...
		require.Equal(t, pagination.PaginationParams{Page: 2, PageSize: 10, SortBy: "account_count", SortOrder: "DESC"placeholder, repo.listWithFiltersAndAccountCountParams)
...
func TestAdminService_ListRedeemCodes_WithSearch(t *testing.T) {
	...
	placeholder
		...
		require.Equal(t, 1, repo.listWithFiltersCalls)
		require.Equal(t, pagination.PaginationParams{Page: 1, PageSize: 20, SortBy: "value", SortOrder: "ASC"placeholder, repo.listWithFiltersParams)
