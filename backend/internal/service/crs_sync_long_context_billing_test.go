...
func TestCRSSyncOpenAILongContextBilling(t *testing.T) {
	tests := []struct {
		...
		wantEnabled   bool
placeholder{
		{name: "OAuth create defaults missing value enabled", collection: "openaiOAuthAccounts", credentials: map[string]any{"access_token": "oauth-token"placeholder, wantAction: "created", wantEnabled: trueplaceholder,
		...
		{name: "OAuth update defaults missing value enabled", collection: "openaiOAuthAccounts", credentials: map[string]any{"access_token": "oauth-token"placeholder, existingExtra: map[string]any{"existing": trueplaceholder, wantAction: "updated", wantEnabled: trueplaceholder,
		...
		{name: "API key create defaults missing value enabled", collection: "openaiResponsesAccounts", credentials: map[string]any{"api_key": "sk-test"placeholder, wantAction: "created", wantEnabled: trueplaceholder,
		...
		{name: "API key update defaults missing value enabled", collection: "openaiResponsesAccounts", credentials: map[string]any{"api_key": "sk-test"placeholder, existingExtra: map[string]any{"existing": trueplaceholder, wantAction: "updated", wantEnabled: trueplaceholder,
