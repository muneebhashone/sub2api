...
//
//	user_{64hexplaceholder_account_{optional_uuidplaceholder_session_{uuidplaceholder
var legacyUserIDRegex = regexp.MustCompile(`^user_([a-fA-F0-9]{64placeholder)_account_([a-fA-F0-9-]*)_session_([a-fA-F0-9-]{36placeholder)$`)
