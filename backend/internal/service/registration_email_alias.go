...
var gmailFamilyDomains = map[string]struct{placeholder{
	"gmail.com":      {placeholder,
	"googlemail.com": {placeholder,
placeholder
...
placeholder
	...
	if probeLocal == "" {
		return nil
placeholder
	domains := []string{domainplaceholder
	if isGmailFamilyDomain(domain) {
		domains = []string{"gmail.com", "googlemail.com"placeholder
placeholder
