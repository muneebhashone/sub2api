...
placeholder
	credentials := map[string]any{
		...
		"openai_usage_channel_fields": []any{"custom"placeholder,
placeholder
	...
	require.Equal(t, map[string]any{"gpt-5": "gpt-5-codex"placeholder, got["model_mapping"])
	require.Equal(t, true, got["chatgpt_account_is_fedramp"])
	require.Equal(t, "2026-12-31T00:00:00Z", got["subscription_expires_at"])
	require.Equal(t, []any{"custom"placeholder, got["openai_usage_channel_fields"])
placeholder
