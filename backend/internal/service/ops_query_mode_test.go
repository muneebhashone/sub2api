...
func TestShouldFallbackOpsPreagg(t *testing.T) {
	...
	autoFilter := &OpsDashboardFilter{QueryMode: OpsQueryModeAutoplaceholder
	rawFilter := &OpsDashboardFilter{QueryMode: OpsQueryModeRawplaceholder
	preaggFilter := &OpsDashboardFilter{QueryMode: OpsQueryModePreaggplaceholder
	...
	tests := []struct {
		...
		want   bool
placeholder{
		{"auto mode + preagg error => fallback", autoFilter, preaggErr, trueplaceholder,
		{"auto mode + other error => no fallback", autoFilter, otherErr, falseplaceholder,
		{"auto mode + nil error => no fallback", autoFilter, nil, falseplaceholder,
		{"raw mode + preagg error => no fallback", rawFilter, preaggErr, falseplaceholder,
		{"preagg mode + preagg error => no fallback", preaggFilter, preaggErr, falseplaceholder,
		{"nil filter => no fallback", nil, preaggErr, falseplaceholder,
		{"wrapped preagg error => fallback", autoFilter, errors.Join(preaggErr, otherErr), trueplaceholder,
placeholder
