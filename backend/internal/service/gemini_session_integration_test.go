...
func newMockGeminiSessionCache() *mockGeminiSessionCache {
	return &mockGeminiSessionCache{sessions: make(map[string]string)placeholder
placeholder
...
func TestGeminiSessionContinuousConversation(t *testing.T) {
	...
	placeholder,
		Contents: []antigravity.GeminiContent{
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Hello, what's your name?"placeholderplaceholderplaceholder,
	placeholder,
placeholder
...
placeholder
	...
	placeholder,
		Contents: []antigravity.GeminiContent{
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Hello, what's your name?"placeholderplaceholderplaceholder,
			{Role: "model", Parts: []antigravity.GeminiPart{{Text: "I'm Claude, nice to meet you!"placeholderplaceholderplaceholder,
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "What can you do?"placeholderplaceholderplaceholder,
	placeholder,
placeholder
...
placeholder
	...
	placeholder,
		Contents: []antigravity.GeminiContent{
			...
			{Role: "model", Parts: []antigravity.GeminiPart{{Text: "I'm Claude, nice to meet you!"placeholderplaceholderplaceholder,
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "What can you do?"placeholderplaceholderplaceholder,
			{Role: "model", Parts: []antigravity.GeminiPart{{Text: "I can help with coding, writing, and more!"placeholderplaceholderplaceholder,
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Great, help me write some Go code"placeholderplaceholderplaceholder,
	placeholder,
placeholder
...
func TestGeminiSessionDifferentConversations(t *testing.T) {
	...
	req1 := &antigravity.GeminiRequest{
		Contents: []antigravity.GeminiContent{
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Tell me about Go programming"placeholderplaceholderplaceholder,
	placeholder,
placeholder
	chain1 := BuildGeminiDigestChain(req1)
	...
	req2 := &antigravity.GeminiRequest{
		Contents: []antigravity.GeminiContent{
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "What's the weather today?"placeholderplaceholderplaceholder,
	placeholder,
placeholder
	chain2 := BuildGeminiDigestChain(req2)
...
func TestGeminiSessionPrefixMatchingOrder(t *testing.T) {
	...
	placeholder,
		Contents: []antigravity.GeminiContent{
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Q1"placeholderplaceholderplaceholder,
			{Role: "model", Parts: []antigravity.GeminiPart{{Text: "A1"placeholderplaceholderplaceholder,
			{Role: "user", Parts: []antigravity.GeminiPart{{Text: "Q2"placeholderplaceholderplaceholder,
	placeholder,
placeholder
