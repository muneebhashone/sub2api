...
var auditBodySensitiveExactKeys = map[string]struct{placeholder{
	"code": {placeholder, "codes": {placeholder, "pin": {placeholder, "cvv": {placeholder,
	"authorization": {placeholder, "cookie": {placeholder, "x-api-key": {placeholder,
	"key": {placeholder,
placeholder
