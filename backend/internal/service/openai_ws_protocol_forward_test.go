...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_123","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_http_keep","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
		...
		responses: []*http.Response{
			{
				...
				Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
				Body: io.NopCloser(strings.NewReader(
					`{"error":{"code":"invalid_encrypted_content","type":"invalid_request_error","message":"The encrypted content could not be verified."placeholderplaceholder`,
				)),
		placeholder,
			{
				StatusCode: http.StatusOK,
				Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
				Body: io.NopCloser(strings.NewReader(
					`{"id":"resp_http_retry_ok","usage":{"input_tokens":1,"output_tokens":2,"input_tokens_details":{"cached_tokens":0placeholderplaceholderplaceholder`,
				)),
		placeholder,
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_http_retry","input":[{"type":"reasoning","encrypted_content":"gAAA","summary":[{"type":"summary_text","text":"keep me"placeholder]placeholder,{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.NotNil(t, result)
	require.False(t, result.OpenAIWSMode, "HTTP 入站应保持 HTTP 转发")
		...
		responses: []*http.Response{
			{
				...
				Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
				Body: io.NopCloser(strings.NewReader(
					`{"error":{"code":null,"message":"{\"error\":{\"message\":\"The encrypted content could not be verified.\",\"type\":\"invalid_request_error\",\"param\":null,\"code\":\"invalid_encrypted_content\"placeholderplaceholder（traceid: fb7ad1dbc7699c18f8a02f258f1af5ab）","param":null,"type":"invalid_request_error"placeholderplaceholder`,
				)),
		placeholder,
			{
				StatusCode: http.StatusOK,
				Header: http.Header{
					...
					"x-request-id": []string{"req_http_retry_wrapped_ok"placeholder,
			placeholder,
				Body: io.NopCloser(strings.NewReader(
					`{"id":"resp_http_retry_wrapped_ok","usage":{"input_tokens":1,"output_tokens":2,"input_tokens_details":{"cached_tokens":0placeholderplaceholderplaceholder`,
				)),
		placeholder,
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_http_retry_wrapped","input":[{"type":"reasoning","encrypted_content":"gAAA","summary":[{"type":"summary_text","text":"keep me too"placeholder]placeholder,{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.NotNil(t, result)
	require.False(t, result.OpenAIWSMode, "HTTP 入站应保持 HTTP 转发")
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			...
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body: io.NopCloser(strings.NewReader(
				`{"usage":{"input_tokens":8,"output_tokens":9,"input_tokens_details":{"cached_tokens":1placeholderplaceholderplaceholder`,
			)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_426","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			...
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body: io.NopCloser(strings.NewReader(
				`{"usage":{"input_tokens":2,"output_tokens":3,"input_tokens_details":{"cached_tokens":0placeholderplaceholderplaceholder`,
			)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_cooling","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
	require.Nil(t, upstream.lastReq, "WS 模式下不应再回退 HTTP")
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.1","stream":false,"previous_response_id":"resp_v1","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
		...
		resp: &http.Response{
			...
			Body: io.NopCloser(strings.NewReader(
				"data: {\"type\":\"response.output_text.delta\",\"delta\":\"ok\"placeholder\n\n" +
					"data: {\"type\":\"response.completed\",\"response\":{\"id\":\"resp_http_fallback\",\"usage\":{\"input_tokens\":2,\"output_tokens\":1placeholderplaceholderplaceholder\n\n" +
					"data: [DONE]\n\n",
			)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":true,"input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			...
			Body: io.NopCloser(strings.NewReader(
				"data: {\"type\":\"response.output_text.delta\",\"delta\":\"ok\"placeholder\n\n" +
					"data: {\"type\":\"response.completed\",\"response\":{\"id\":\"resp_retry_http_fallback\",\"usage\":{\"input_tokens\":2,\"output_tokens\":1placeholderplaceholderplaceholder\n\n" +
					"data: [DONE]\n\n",
			)),
	placeholder,
placeholder
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			StatusCode: http.StatusOK,
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body:       io.NopCloser(strings.NewReader(`{"id":"resp_policy_fallback","usage":{"input_tokens":1,"output_tokens":1placeholderplaceholder`)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			StatusCode: http.StatusOK,
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body:       io.NopCloser(strings.NewReader(`{"id":"resp_http_retry_limit","usage":{"input_tokens":1,"output_tokens":1placeholderplaceholder`)),
	placeholder,
placeholder
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			StatusCode: http.StatusOK,
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body:       io.NopCloser(strings.NewReader(`{"id":"resp_http_drop_prev","usage":{"input_tokens":1,"output_tokens":1placeholderplaceholder`)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"previous_response_id":"resp_prev_missing","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.NotNil(t, result)
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"previous_response_id":"resp_prev_missing","input":[{"type":"function_call_output","call_id":"call_1","output":"ok"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
	require.Nil(t, upstream.lastReq, "previous_response_not_found 不应回退 HTTP")
...
placeholder))
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			StatusCode: http.StatusOK,
			Header:     http.Header{"Content-Type": []string{"application/json"placeholderplaceholder,
			Body:       io.NopCloser(strings.NewReader(`{"id":"resp_http_drop_reasoning","usage":{"input_tokens":1,"output_tokens":1placeholderplaceholder`)),
	placeholder,
placeholder
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"previous_response_id":"resp_prev_encrypted","input":[{"type":"input_text","text":"hello"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.Nil(t, result)
	require.Nil(t, upstream.lastReq, "invalid_encrypted_content 不应回退 HTTP")
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"previous_response_id":"resp_prev_encrypted","input":{"type":"reasoning","encrypted_content":"gAAA","summary":[{"type":"summary_text","text":"keep me"placeholder]placeholderplaceholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.NotNil(t, result)
...
placeholder
	...
	body := []byte(`{"model":"gpt-5.3-codex","stream":false,"previous_response_id":"resp_prev_function_call","input":[{"type":"reasoning","encrypted_content":"gAAA"placeholder,{"type":"function_call_output","call_id":"call_123","output":"ok"placeholder]placeholder`)
	result, err := svc.Forward(context.Background(), c, account, body)
placeholder
	require.NotNil(t, result)
