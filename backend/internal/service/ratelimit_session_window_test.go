...
func (m *sessionWindowMockRepo) Create(context.Context, *Account) error { panic("unexpected") placeholder
...
func (m *sessionWindowMockRepo) ListCRSAccountIDs(context.Context) (map[string]int64, error) {
	panic("unexpected")
placeholder
func (m *sessionWindowMockRepo) Update(context.Context, *Account) error { panic("unexpected") placeholder
func (m *sessionWindowMockRepo) Delete(context.Context, int64) error    { panic("unexpected") placeholder
...
func (m *sessionWindowMockRepo) ListByPlatform(context.Context, string) ([]Account, error) {
	panic("unexpected")
placeholder
func (m *sessionWindowMockRepo) UpdateLastUsed(context.Context, int64) error { panic("unexpected") placeholder
...
func (m *sessionWindowMockRepo) SetError(context.Context, int64, string) error {
	panic("unexpected")
placeholder
func (m *sessionWindowMockRepo) ClearError(context.Context, int64) error { panic("unexpected") placeholder
...
func (m *sessionWindowMockRepo) IncrementQuotaUsed(context.Context, int64, float64) error {
	panic("unexpected")
placeholder
func (m *sessionWindowMockRepo) ResetQuotaUsed(context.Context, int64) error { panic("unexpected") placeholder
...
func newRateLimitServiceForTest(repo AccountRepository) *RateLimitService {
	return &RateLimitService{accountRepo: repoplaceholder
placeholder
...
func TestUpdateSessionWindow_UsesResetHeader(t *testing.T) {
	...
	repo := &sessionWindowMockRepo{placeholder
	svc := newRateLimitServiceForTest(repo)

	account := &Account{ID: 42placeholder // no existing window → needInitWindow=true
...
func TestUpdateSessionWindow_FallbackPredictionWhenNoResetHeader(t *testing.T) {
	...
	account := &Account{ID: 10placeholder // no existing window
	headers := http.Header{placeholder
...
func TestUpdateSessionWindow_ClearsUtilizationOnWindowReset(t *testing.T) {
	...
	account := &Account{ID: 33placeholder // no existing window → needInitWindow=true
	headers := http.Header{placeholder
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
	headers.Set("anthropic-ratelimit-unified-5h-reset", fmt.Sprintf("%d", resetUnix))
...
func TestUpdateSessionWindow_SamplesFable7dOiHeaders(t *testing.T) {
	...
	account := &Account{ID: 90, SessionWindowEnd: &existingEndplaceholder // needInitWindow=false
	headers := http.Header{placeholder
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
...
func TestUpdateSessionWindow_ClearsFable7dOiOnWindowReset(t *testing.T) {
	...
	account := &Account{ID: 91placeholder // no existing window → needInitWindow=true
	headers := http.Header{placeholder
	headers.Set("anthropic-ratelimit-unified-5h-status", "allowed")
	headers.Set("anthropic-ratelimit-unified-5h-reset", fmt.Sprintf("%d", resetUnix))
...
placeholder
	...
	for _, key := range []string{"passive_usage_7d_oi_utilization", "passive_usage_7d_oi_reset"placeholder {
...
func TestUpdateSessionWindow_NoStatusHeader(t *testing.T) {
	...
	svc.UpdateSessionWindow(context.Background(), account, http.Header{placeholder)
