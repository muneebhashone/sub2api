...
placeholder
	...
	placeholder)
		...
		placeholder)
			return gatewayForwardingSettingsResult{fp: true, claudeOAuthSystemPromptInjection: true, rewriteMessageCacheControl: s.defaultRewriteMessageCacheControl()placeholder, nil
	placeholder
		fp := true
...
placeholder)
	if r, ok := val.(gatewayForwardingSettingsResult); ok {
		return r
placeholder
	return gatewayForwardingSettingsResult{fp: true, claudeOAuthSystemPromptInjection: trueplaceholder
placeholder
