...
func CategoryToFilter(category string) (phases []string, errorTypes []string) {
	switch category {
	case "auth":
		return []string{"auth"placeholder, nil
	case "service_unavailable":
		return []string{"routing"placeholder, nil
	case "upstream":
		return []string{"account_auth", "upstream", "network"placeholder, nil
	case "internal":
		return []string{"internal"placeholder, nil
	case "rate_limit":
		return nil, []string{"rate_limit_error"placeholder
	case "quota":
		return nil, []string{"billing_error", "subscription_error"placeholder
	case "invalid_request":
		return nil, []string{"invalid_request_error"placeholder
	case "cyber":
		return []string{"request"placeholder, []string{"cyber_policy"placeholder
	default:
		return nil, nil
placeholder
placeholder
