...
func validTimePricingForTest() *ChannelTimePricing {
	return &ChannelTimePricing{Timezone: "Asia/Shanghai", Periods: []ChannelTimePricingPeriod{
		{StartTime: "09:00", EndTime: "12:00", Multiplier: 2placeholder,
placeholderplaceholder
placeholder

func TestValidatePricingTimePricing(t *testing.T) {
	token := []ChannelModelPricing{{BillingMode: BillingModeToken, TimePricing: validTimePricingForTest()placeholderplaceholder
	require.NoError(t, validatePricingTimePricing(token))

	implicitToken := []ChannelModelPricing{{TimePricing: validTimePricingForTest()placeholderplaceholder
	require.NoError(t, validatePricingTimePricing(implicitToken))

	image := []ChannelModelPricing{{BillingMode: BillingModeImage, TimePricing: validTimePricingForTest()placeholderplaceholder
	...
	invalid := []ChannelModelPricing{{
		...
		BillingMode: BillingModeToken,
		TimePricing: &ChannelTimePricing{Timezone: "UTC+8", Periods: validTimePricingForTest().Periodsplaceholder,
placeholderplaceholder
...
placeholderplaceholder
	...
	empty := []ChannelModelPricing{{BillingMode: BillingModeToken, TimePricing: &ChannelTimePricing{Timezone: "Asia/Shanghai"placeholderplaceholderplaceholder
