...
placeholder)
	...
	placeholder)
		t.Cleanup(func() { SetCodexCanonicalUserAgentResolver(nil) placeholder)
...
func TestEnforceCodexIdentityHeadersRejectsInvalidCanonicalUA(t *testing.T) {
	SetCodexCanonicalUserAgentResolver(func() string { return "not-a-codex-client" placeholder)
	t.Cleanup(func() { SetCodexCanonicalUserAgentResolver(nil) placeholder)
...
func TestCodexIdentityEnforcementZeroValueConfigKeepsItEnabled(t *testing.T) {
	...
	t.Cleanup(func() { SetCodexIdentityEnforcementEnabled(true) placeholder)
