...
func TestFilterCodexInput_DropsReasoningItemsRegardlessOfPreserveReferences(t *testing.T) {
	...
	build := func() []any {
		...
		placeholder,
			map[string]any{"type": "function_call", "id": "fc_1", "call_id": "call_1", "name": "tool"placeholder,
			map[string]any{"type": "function_call_output", "call_id": "call_1", "output": "{placeholder"placeholder,
	placeholder
placeholder
