...
func (e *codexModelsManifestUpstreamError) Unwrap() error { return e.err placeholder
...
placeholder
	...
	manifest := &CodexModelsManifest{Body: body, ETag: etagplaceholder
	if request.useAPIKeyUpstream {
...
var apiKeyCodexModelsWithoutResponsesLite = map[string]struct{placeholder{
