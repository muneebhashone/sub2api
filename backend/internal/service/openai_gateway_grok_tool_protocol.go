...
func adaptGrokResponsesClientTools(body []byte) ([]byte, apicompat.ResponsesClientToolMapping, error) {
	...
	if err := decoder.Decode(&requestBody); err != nil {
		return body, apicompat.ResponsesClientToolMapping{placeholder, fmt.Errorf("decode Grok Responses client tools: %w", err)
placeholder
...
placeholder
	...
	if err != nil {
		return body, apicompat.ResponsesClientToolMapping{placeholder, fmt.Errorf("encode Grok Responses client tools: %w", err)
placeholder
