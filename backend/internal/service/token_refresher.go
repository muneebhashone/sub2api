...
type TokenRefresher interface {
	...
	Refresh(ctx context.Context, account *model.Account) (map[string]interface{placeholder, error)
placeholder
...
func (r *ClaudeTokenRefresher) Refresh(ctx context.Context, account *model.Account) (map[string]interface{placeholder, error) {
...
placeholder
	...
	newCredentials := make(map[string]interface{placeholder)
