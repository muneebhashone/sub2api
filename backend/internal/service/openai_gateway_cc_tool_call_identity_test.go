...
func TestStripEmptyChatToolCallIdentity_FirstChunkIdentityUntouched(t *testing.T) {
	payload := []byte(`{"id":"chatcmpl_tool","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_example","type":"function","function":{"name":"web_search","arguments":""placeholderplaceholder]placeholderplaceholder]placeholder`)
...
// `"id":""` 与 `"function":{"name":""placeholder` 应被删除；arguments 碎片、
// index、type 保留。
func TestStripEmptyChatToolCallIdentity_FollowingDelta(t *testing.T) {
	payload := []byte(`{"id":"chatcmpl_tool","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"","type":"function","function":{"name":"","arguments":"{\"query\":"placeholderplaceholder]placeholderplaceholder]placeholder`)
	rewritten, changed := stripEmptyChatToolCallIdentity(payload)
...
func TestStripEmptyChatToolCallIdentity_OnlyEmptyName(t *testing.T) {
	payload := []byte(`{"id":"chatcmpl_tool","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_1","type":"function","function":{"name":"","arguments":"{placeholder"placeholderplaceholder]placeholderplaceholder]placeholder`)
	rewritten, changed := stripEmptyChatToolCallIdentity(payload)
	require.True(t, changed)
	require.Equal(t, "call_1", gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.id").String())
	require.False(t, gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.function.name").Exists())
	require.Equal(t, "{placeholder", gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.function.arguments").String())
placeholder
...
func TestStripEmptyChatToolCallIdentity_OnlyEmptyID(t *testing.T) {
	payload := []byte(`{"choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id" : "" , "type" : "function","function":{"name":"get_weather","arguments":"{placeholder"placeholderplaceholder]placeholderplaceholder]placeholder`)
	rewritten, changed := stripEmptyChatToolCallIdentity(payload)
	require.True(t, changed)
	require.False(t, gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.id").Exists())
...
func TestStripEmptyChatToolCallIdentity_EmptyArgumentsKept(t *testing.T) {
	payload := []byte(`{"choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"","type":"function","function":{"name":"","arguments":""placeholderplaceholder]placeholderplaceholder]placeholder`)
	rewritten, changed := stripEmptyChatToolCallIdentity(payload)
	require.True(t, changed)
	require.False(t, gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.id").Exists())
	require.False(t, gjson.GetBytes(rewritten, "choices.0.delta.tool_calls.0.function.name").Exists())
...
func TestStripEmptyChatToolCallIdentity_TwoParallelToolCalls(t *testing.T) {
	payload := []byte(`{"choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_a","type":"function","function":{"name":"tool_a","arguments":"{\"x\":"placeholderplaceholder,{"index":1,"id":"","type":"function","function":{"name":"","arguments":"{\"y\":"placeholderplaceholder]placeholderplaceholder]placeholder`)
	rewritten, changed := stripEmptyChatToolCallIdentity(payload)
	require.True(t, changed)
...
func TestStripEmptyChatToolCallIdentity_Passthrough(t *testing.T) {
	tests := []struct {
		...
		payload string
placeholder{
		{"no tool_calls", `{"choices":[{"index":0,"delta":{"content":"hi"placeholderplaceholder]placeholder`placeholder,
		{"no choices", `{"id":"chatcmpl_x"placeholder`placeholder,
		{"empty choices", `{"choices":[]placeholder`placeholder,
		{"tool_calls not array", `{"choices":[{"index":0,"delta":{"tool_calls":{"foo":1placeholderplaceholderplaceholder]placeholder`placeholder,
		{"invalid JSON", `{"choices":[{`placeholder,
...
func TestStripEmptyChatToolCallIdentityFromSSELine_Passthrough(t *testing.T) {
	tests := []struct {
		...
		line string
placeholder{
		{"done", "data: [DONE]"placeholder,
		{"non-data line", ": keep-alive"placeholder,
		{"empty line", ""placeholder,
		{"comment line", ":"placeholder,
		{"content chunk", `data: {"choices":[{"index":0,"delta":{"content":"hi"placeholderplaceholder]placeholder`placeholder,
placeholder
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestStripEmptyChatToolCallIdentityFromSSELine_KeepsDataPrefix(t *testing.T) {
	line := `data: {"id":"chatcmpl_tool","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"","type":"function","function":{"name":"","arguments":"{placeholder"placeholderplaceholder]placeholderplaceholder]placeholder`
	...
	require.Equal(t, "{placeholder", gjson.Get(payload, "choices.0.delta.tool_calls.0.function.arguments").String())
placeholder
...
func TestStripEmptyChatToolCallIdentity_DshClientMerge(t *testing.T) {
	lines := []string{
		`data: {"id":"chatcmpl_tool","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_example","type":"function","function":{"name":"web_search","arguments":""placeholderplaceholder]placeholderplaceholder]placeholder`,
		`data: {"id":"chatcmpl_tool","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"","type":"function","function":{"name":"","arguments":"{\"query\":"placeholderplaceholder]placeholderplaceholder]placeholder`,
		`data: {"id":"chatcmpl_tool","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"","type":"function","function":{"name":"","arguments":"\"example\"placeholder"placeholderplaceholder]placeholderplaceholder]placeholder`,
placeholder
...
placeholder
	...
	require.Equal(t, `{"query":"example"placeholder`, mergedArgs)
placeholder
