...
placeholder
	...
	require.JSONEq(t, `{"model":"gpt-5","stream":false,"reasoning":{"effort":"none"placeholder,"instructions":"You are a helpful coding assistant.","input":[{"type":"message","content":[{"type":"input_text","text":"hi","nonce":9007199254740993placeholder]placeholder]placeholder`, string(upstream.lastBody))
