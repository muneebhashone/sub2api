...
func accWithWindowEnd(id int64, end *time.Time) accountWithLoad {
	...
	placeholder,
		loadInfo: &AccountLoadInfo{AccountID: idplaceholder,
placeholder
placeholder
...
placeholder
	...
	ids := map[int64]bool{got[0].account.ID: true, got[1].account.ID: trueplaceholder
...
func TestFilterBySoonestReset_SingleOrEmptyUnchanged(t *testing.T) {
	...
	single := []accountWithLoad{accWithWindowEnd(1, nil)placeholder
