...
placeholder
	...
	allowed := map[string]map[string]struct{placeholder{
		BatchImageJobStatusCreated: {
			BatchImageJobStatusUploading: {placeholder,
			BatchImageJobStatusSubmitted: {placeholder,
			BatchImageJobStatusCancelled: {placeholder,
	placeholder,
	...
	placeholder,
		BatchImageJobStatusSubmitted: {
			BatchImageJobStatusRunning:   {placeholder,
			BatchImageJobStatusIndexing:  {placeholder,
			BatchImageJobStatusFailed:    {placeholder,
			BatchImageJobStatusCancelled: {placeholder,
	placeholder,
	...
	placeholder,
		BatchImageJobStatusIndexing: {
			BatchImageJobStatusSettling: {placeholder,
			BatchImageJobStatusFailed:   {placeholder,
	placeholder,
		BatchImageJobStatusSettling: {
			BatchImageJobStatusCompleted: {placeholder,
	placeholder,
placeholder
