...
placeholder)
	...
	t.Run("单模型配额耗尽不标记（积分对此无效）", func(t *testing.T) {
		resp := &http.Response{StatusCode: http.StatusTooManyRequestsplaceholder
		body := []byte(`{"error":{"code":429,"message":"You have exhausted your capacity on this model. Your quota will reset after 146h11m17s.","status":"RESOURCE_EXHAUSTED"placeholderplaceholder`)
	...
	placeholder,
		{
			...
			info: &UsageInfo{AICredits: []AICredit{placeholderplaceholder,
			want: false,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 18778, MinimumBalance: 50placeholder,
			placeholder,
		placeholder,
			want: true,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 3, MinimumBalance: 5placeholder,
			placeholder,
		placeholder,
			want: false,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 6, MinimumBalance: 0placeholder,
			placeholder,
		placeholder,
			want: true,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 4, MinimumBalance: 0placeholder,
			placeholder,
		placeholder,
			want: false,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 5, MinimumBalance: 5placeholder,
			placeholder,
		placeholder,
			want: true,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "OTHER_CREDIT", Amount: 10000, MinimumBalance: 5placeholder,
			placeholder,
		placeholder,
			want: false,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "OTHER_CREDIT", Amount: 0, MinimumBalance: 5placeholder,
					{CreditType: "GOOGLE_ONE_AI", Amount: 100, MinimumBalance: 10placeholder,
			placeholder,
		placeholder,
			want: true,
	placeholder,
		{
			...
			info: &UsageInfo{
				AICredits: []AICredit{
					{CreditType: "GOOGLE_ONE_AI", Amount: 6, MinimumBalance: -1placeholder,
			placeholder,
		placeholder,
			want: true,
	placeholder,
