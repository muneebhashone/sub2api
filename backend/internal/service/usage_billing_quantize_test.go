...
func TestQuantizeUsageBillingAmountBoundaries(t *testing.T) {
	cases := []struct {
		...
		in   float64
placeholder{
		{"below_half", 0.000078120placeholder,
		{"just_below_half", 0.000078124placeholder,
		{"exact_half", 0.000078125placeholder,
		{"just_above_half", 0.000078126placeholder,
		{"above_half", 0.000078130placeholder,
		{"long_tail", 0.0000781234567placeholder,
		{"already_quantized", 0.00007813placeholder,
placeholder
...
placeholder
	...
	for _, n := range []int64{1, 10, 100, 1000placeholder {
