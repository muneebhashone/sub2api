...
placeholder
	...
	placeholder
		...
		if resp != nil && resp.Body != nil {
			...
			_ = resp.Body.Close()
	placeholder
		return nil, status, respHeaders, &openAIWSHandshakeError{Body: body, Err: errplaceholder
placeholder
	...
	if resp != nil {
		respHeaders = cloneHeader(resp.Header)
placeholder
	return &coderOpenAIWSClientConn{conn: connplaceholder, 0, respHeaders, nil
placeholder
