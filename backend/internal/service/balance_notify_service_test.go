...
func TestResolvedThreshold_FixedNormal(t *testing.T) {
	...
	d := quotaDim{threshold: 400, thresholdType: thresholdTypeFixed, limit: 1000placeholder
...
func TestResolvedThreshold_FixedThresholdExceedsLimit(t *testing.T) {
	...
	d := quotaDim{threshold: 1200, thresholdType: thresholdTypeFixed, limit: 1000placeholder
...
func TestResolvedThreshold_FixedThresholdEqualsLimit(t *testing.T) {
	...
	d := quotaDim{threshold: 1000, thresholdType: thresholdTypeFixed, limit: 1000placeholder
...
func TestResolvedThreshold_PercentageNormal(t *testing.T) {
	...
	d := quotaDim{threshold: 30, thresholdType: thresholdTypePercentage, limit: 1000placeholder
...
func TestResolvedThreshold_PercentageZeroPercent(t *testing.T) {
	...
	d := quotaDim{threshold: 0, thresholdType: thresholdTypePercentage, limit: 1000placeholder
...
func TestResolvedThreshold_PercentageHundredPercent(t *testing.T) {
	...
	d := quotaDim{threshold: 100, thresholdType: thresholdTypePercentage, limit: 1000placeholder
...
func TestResolvedThreshold_PercentageOverHundred(t *testing.T) {
	...
	d := quotaDim{threshold: 150, thresholdType: thresholdTypePercentage, limit: 1000placeholder
...
func TestResolvedThreshold_ZeroLimit(t *testing.T) {
	...
	d := quotaDim{threshold: 100, thresholdType: thresholdTypeFixed, limit: 0placeholder
	require.Equal(t, 0.0, d.resolvedThreshold())
placeholder

func TestResolvedThreshold_NegativeLimit(t *testing.T) {
	// Negative limit treated as 0
	d := quotaDim{threshold: 100, thresholdType: thresholdTypeFixed, limit: -10placeholder
	require.Equal(t, 0.0, d.resolvedThreshold())
placeholder
...
func TestCollectBalanceNotifyRecipients_Empty(t *testing.T) {
	s := &BalanceNotifyService{placeholder
	u := &User{BalanceNotifyExtraEmails: nilplaceholder
...
func TestCollectBalanceNotifyRecipients_FiltersDisabledAndUnverified(t *testing.T) {
	...
	u := &User{
		BalanceNotifyExtraEmails: []NotifyEmailEntry{
			...
			{Email: "b@example.com", Verified: true, Disabled: trueplaceholder,   // disabled
			{Email: "c@example.com", Verified: false, Disabled: falseplaceholder, // unverified
			{Email: "d@example.com", Verified: true, Disabled: falseplaceholder,
	placeholder,
placeholder
	got := s.collectBalanceNotifyRecipients(u)
	require.Equal(t, []string{"a@example.com", "d@example.com"placeholder, got)
placeholder
...
func TestCollectBalanceNotifyRecipients_DeduplicatesCaseInsensitive(t *testing.T) {
	...
	u := &User{
		BalanceNotifyExtraEmails: []NotifyEmailEntry{
			{Email: "User@Example.com", Verified: trueplaceholder,
			{Email: "user@example.com", Verified: trueplaceholder,
			{Email: "USER@EXAMPLE.COM", Verified: trueplaceholder,
	placeholder,
placeholder
...
func TestCollectBalanceNotifyRecipients_SkipsEmpty(t *testing.T) {
	...
	u := &User{
		BalanceNotifyExtraEmails: []NotifyEmailEntry{
			{Email: "  ", Verified: trueplaceholder,
			{Email: "", Verified: trueplaceholder,
			{Email: "valid@example.com", Verified: trueplaceholder,
	placeholder,
placeholder
	got := s.collectBalanceNotifyRecipients(u)
	require.Equal(t, []string{"valid@example.com"placeholder, got)
placeholder
...
func TestCollectBalanceNotifyRecipients_TrimsWhitespace(t *testing.T) {
	...
	u := &User{
		BalanceNotifyExtraEmails: []NotifyEmailEntry{
			{Email: "  trimmed@example.com  ", Verified: trueplaceholder,
	placeholder,
placeholder
	got := s.collectBalanceNotifyRecipients(u)
	require.Equal(t, []string{"trimmed@example.com"placeholder, got)
placeholder
