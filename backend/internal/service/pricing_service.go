...
var (
	openAIModelDatePattern     = regexp.MustCompile(`-\d{8placeholder$`)
...
placeholder else {
		...
		candidates = append([]string{normalizedplaceholder, candidates...)
placeholder
	...
	placeholder
		if _, ok := seen[c]; ok {
			continue
	placeholder
		seen[c] = struct{placeholder{placeholder
		out = append(out, c)
placeholder
	if len(out) == 0 {
		return []string{modelLowerplaceholder
placeholder
	return out
placeholder
...
func normalizeGeminiThinkingTierAlias(model string) string {
	...
	for _, tier := range []string{"-high", "-low", "-medium", "-tiered"placeholder {
...
placeholder
	...
	families := []modelFamily{
		...
		{name: "opus-5", match: []string{"claude-opus-5"placeholder, pricing: []string{"claude-opus-5", "claude-opus-4-8"placeholderplaceholder,
		{name: "opus-4.8", match: []string{"claude-opus-4-8", "claude-opus-4.8"placeholder, pricing: []string{"claude-opus-4-8", "claude-opus-4.8", "claude-opus-4-7"placeholderplaceholder,
		{name: "opus-4.7", match: []string{"claude-opus-4-7", "claude-opus-4.7"placeholder, pricing: []string{"claude-opus-4-7", "claude-opus-4.7", "claude-opus-4-6"placeholderplaceholder,
		{name: "opus-4.6", match: []string{"claude-opus-4-6", "claude-opus-4.6"placeholderplaceholder,
		{name: "opus-4.5", match: []string{"claude-opus-4-5", "claude-opus-4.5"placeholderplaceholder,
		{name: "opus-4", match: []string{"claude-opus-4", "claude-3-opus"placeholderplaceholder,
		{name: "sonnet-4.5", match: []string{"claude-sonnet-4-5", "claude-sonnet-4.5"placeholderplaceholder,
		{name: "sonnet-4", match: []string{"claude-sonnet-4", "claude-3-5-sonnet"placeholderplaceholder,
		{name: "sonnet-3.5", match: []string{"claude-3-5-sonnet", "claude-3.5-sonnet"placeholderplaceholder,
		{name: "sonnet-3", match: []string{"claude-3-sonnet"placeholderplaceholder,
		{name: "haiku-3.5", match: []string{"claude-3-5-haiku", "claude-3.5-haiku"placeholderplaceholder,
		{name: "haiku-3", match: []string{"claude-3-haiku"placeholderplaceholder,
placeholder
