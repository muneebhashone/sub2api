...
type sessionBindingCtxKey struct{placeholder
...
func WithSessionBinding(ctx context.Context, binding *SessionBinding) context.Context {
	if binding == nil {
		return ctx
placeholder
	return context.WithValue(ctx, sessionBindingCtxKey{placeholder, binding)
placeholder
...
func SessionBindingFromContext(ctx context.Context) *SessionBinding {
	if ctx == nil {
		return nil
placeholder
	binding, _ := ctx.Value(sessionBindingCtxKey{placeholder).(*SessionBinding)
	return binding
placeholder
