...
var geminiAIStudioActions = map[string]struct{placeholder{
	"generateContent":       {placeholder,
	"streamGenerateContent": {placeholder,
	"countTokens":           {placeholder,
placeholder

// buildGeminiAIStudioModelActionURL 组装 AI Studio 的
// /v1beta/models/{modelplaceholder:{actionplaceholder 上游 URL。
//
