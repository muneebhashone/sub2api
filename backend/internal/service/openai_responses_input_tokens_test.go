...
placeholder
	...
	placeholder,
placeholder
	body := []byte(`{"model":"gpt-5.4","instructions":"Be concise.","input":"hello world","tools":[{"type":"function","name":"lookup","description":"Look up a value","parameters":{"type":"object"placeholderplaceholder]placeholder`)
...
func TestForwardResponsesInputTokensGrokOAuthUsesLocalEstimate(t *testing.T) {
	...
	account := &Account{ID: 160, Platform: PlatformGrok, Type: AccountTypeOAuthplaceholder
	body := []byte(`{"model":"grok-4.1","input":"hello world"placeholder`)
...
func TestForwardResponsesInputTokensUpstream404FallsBackLocally(t *testing.T) {
	...
	upstream := &httpUpstreamRecorder{resp: &http.Response{
		...
		Body:       io.NopCloser(strings.NewReader(`{"error":{"type":"invalid_request_error","message":"Invalid URL (POST /v1/responses/input_tokens)"placeholderplaceholder`)),
...
placeholder
	...
	placeholder,
placeholder
	body := []byte(`{"model":"gpt-5.4","instructions":"Be concise.","input":"hello world"placeholder`)
