...
func TestApplyOpenAIWSRetryPayloadStrategy_KeepPromptCacheKey(t *testing.T) {
	payload := map[string]any{
		...
		"include":          []any{"reasoning.encrypted_content"placeholder,
		"text": map[string]any{
			"verbosity": "low",
	placeholder,
		"tools": []any{map[string]any{"type": "function"placeholderplaceholder,
placeholder
...
func TestApplyOpenAIWSRetryPayloadStrategy_AttemptSixKeepsSemanticFields(t *testing.T) {
	payload := map[string]any{
		...
		"tool_choice":         "auto",
		"include":             []any{"reasoning.encrypted_content"placeholder,
		"text":                map[string]any{"verbosity": "high"placeholder,
placeholder
