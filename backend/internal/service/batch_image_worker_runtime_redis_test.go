...
placeholderplaceholder
	...
	worker := service.NewBatchImageWorker(queue, noopBatchImageProcessor{placeholder, service.NewBatchImageWorkerOptionsFromConfig(cfg))
...
type noopBatchImageProcessor struct{placeholder

func (noopBatchImageProcessor) Process(context.Context, string) (service.BatchImageProcessResult, error) {
	return service.BatchImageProcessResult{placeholder, nil
placeholder
