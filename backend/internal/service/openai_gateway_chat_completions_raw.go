...
// `{base_urlplaceholder/v1/chat/completions`，**不**做 CC↔Responses 协议转换。
//
...
placeholder else if account.Platform == PlatformGrok {
...
placeholder
	...
	placeholder
placeholder else if !clientDisconnected && !clientOutputStarted {
