...
func TestGetIntervalPricing_MatchesInterval(t *testing.T) {
	...
	resolved := &ResolvedPricing{
		...
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(128000), InputPrice: testPtrFloat64(1e-6), OutputPrice: testPtrFloat64(2e-6)placeholder,
			{MinTokens: 128000, MaxTokens: nil, InputPrice: testPtrFloat64(3e-6), OutputPrice: testPtrFloat64(6e-6)placeholder,
	placeholder,
placeholder
...
func TestGetIntervalPricing_NoMatch_FallsBackToBase(t *testing.T) {
	...
	resolved := &ResolvedPricing{
		...
		BasePricing: basePricing,
		Intervals: []PricingInterval{
			{MinTokens: 10000, MaxTokens: testPtrInt(50000), InputPrice: testPtrFloat64(1e-6)placeholder,
	placeholder,
placeholder
...
func TestGPT56ExplicitZeroCacheWritePriceIsPreserved(t *testing.T) {
	...
	t.Run("flat channel price", func(t *testing.T) {
		...
		placeholder,
	placeholder
		resolver.applyTokenOverrides(&ChannelModelPricing{CacheWritePrice: &zeroplaceholder, resolved)

		require.True(t, resolved.BasePricing.CacheCreationPriceExplicit)
		cost, err := bs.CalculateCostUnified(CostInput{
			Model:          "gpt-5.6-sol",
			Tokens:         UsageTokens{CacheCreationTokens: 100placeholder,
			RateMultiplier: 1,
			Resolver:       resolver,
			Resolved:       resolved,
	placeholder)
...
placeholder)
	...
	t.Run("interval price", func(t *testing.T) {
		pricing := intervalToModelPricing(&PricingInterval{CacheWritePrice: &zeroplaceholder, false, nil)
...
func TestGetRequestTierPriceByContext(t *testing.T) {
	...
	resolved := &ResolvedPricing{
		Mode: BillingModePerRequest,
		RequestTiers: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(128000), PerRequestPrice: testPtrFloat64(0.05)placeholder,
			{MinTokens: 128000, MaxTokens: nil, PerRequestPrice: testPtrFloat64(0.10)placeholder,
	placeholder,
placeholder
...
func groupIDPtr() *int64 { v := int64(100); return &v placeholder
...
func TestResolve_WithChannelOverride_TokenWithIntervals(t *testing.T) {
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		BillingMode: BillingModeToken,
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(128000), InputPrice: testPtrFloat64(2e-6), OutputPrice: testPtrFloat64(8e-6)placeholder,
			{MinTokens: 128000, MaxTokens: nil, InputPrice: testPtrFloat64(4e-6), OutputPrice: testPtrFloat64(16e-6)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestResolve_WithChannelOverride_TokenNilBasePricing(t *testing.T) {
	...
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		Platform:    "anthropic",
		Models:      []string{"unknown-model-xyz"placeholder,
		BillingMode: BillingModeToken,
...
func TestResolve_WithChannelOverride_PerRequest(t *testing.T) {
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(128000), PerRequestPrice: testPtrFloat64(0.03)placeholder,
			{MinTokens: 128000, MaxTokens: nil, PerRequestPrice: testPtrFloat64(0.10)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestResolve_WithChannelOverride_PerRequestNilPrice(t *testing.T) {
	...
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(128000), PerRequestPrice: testPtrFloat64(0.02)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestResolve_WithChannelOverride_Image(t *testing.T) {
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		Intervals: []PricingInterval{
			{TierLabel: "1K", PerRequestPrice: testPtrFloat64(0.04)placeholder,
			{TierLabel: "2K", PerRequestPrice: testPtrFloat64(0.08)placeholder,
			{TierLabel: "4K", PerRequestPrice: testPtrFloat64(0.16)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestGetIntervalPricing_WithChannelIntervals(t *testing.T) {
	...
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		BillingMode: BillingModeToken,
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(100000), InputPrice: testPtrFloat64(1e-6), OutputPrice: testPtrFloat64(5e-6)placeholder,
			{MinTokens: 100000, MaxTokens: nil, InputPrice: testPtrFloat64(2e-6), OutputPrice: testPtrFloat64(10e-6)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestGetIntervalPricing_ChannelIntervalsNoMatch(t *testing.T) {
	...
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		Intervals: []PricingInterval{
			...
			{MinTokens: 50000, MaxTokens: testPtrInt(200000), InputPrice: testPtrFloat64(9e-6)placeholder,
	placeholder,
placeholderplaceholder)
...
placeholder
	...
	resolved2 := &ResolvedPricing{
		Mode:         BillingModePerRequest,
		RequestTiers: []PricingInterval{placeholder,
placeholder
	...
	placeholder,
		{
			...
			intervals: []PricingInterval{
				{MinTokens: 0, MaxTokens: testPtrInt(128000)placeholder,
		placeholder,
			wantLen: 0,
	placeholder,
		{
	...
	placeholder,
		{
			...
			intervals: []PricingInterval{
				{MinTokens: 0, MaxTokens: testPtrInt(128000), OutputPrice: testPtrFloat64(2e-6)placeholder,
		placeholder,
			wantLen: 1,
	placeholder,
		{
			...
			intervals: []PricingInterval{
				{MinTokens: 0, CacheWritePrice: testPtrFloat64(3e-6)placeholder,
		placeholder,
			wantLen: 1,
	placeholder,
		{
			...
			intervals: []PricingInterval{
				{MinTokens: 0, CacheReadPrice: testPtrFloat64(0.5e-6)placeholder,
		placeholder,
			wantLen: 1,
	placeholder,
		{
	...
	placeholder,
		{
			...
			intervals: []PricingInterval{
				{MinTokens: 0, MaxTokens: testPtrInt(128000), InputPrice: testPtrFloat64(1e-6)placeholder,
				{MinTokens: 128000, MaxTokens: nilplaceholder, // all-nil → filtered out
				{MinTokens: 256000, OutputPrice: testPtrFloat64(5e-6)placeholder,
		placeholder,
			wantLen: 2,
	placeholder,
placeholder
...
func TestApplyTokenOverrides_IntervalDoesNotPolluteFallbackPrices(t *testing.T) {
	r := newResolverWithChannel(t, []ChannelModelPricing{{
		...
		BillingMode: BillingModeToken,
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(100000), InputPrice: testPtrFloat64(2e-6), OutputPrice: testPtrFloat64(8e-6)placeholder,
	placeholder,
placeholderplaceholder)
...
func TestResolve_GroupLongContextToggleControlsIntervals(t *testing.T) {
	...
	group := &Group{ID: 100, ModelPricing: []ChannelModelPricing{{
		...
		Intervals: []PricingInterval{
			{MinTokens: 0, MaxTokens: testPtrInt(200000), InputPrice: testPtrFloat64(1e-6)placeholder,
			{MinTokens: 200000, InputPrice: testPtrFloat64(2e-6)placeholder,
	placeholder,
placeholderplaceholderplaceholder
