...
func TestShouldClearStickySession(t *testing.T) {
	...
	tests := []struct {
		...
		want           bool
placeholder{
		{name: "nil account", account: nil, requestedModel: "", want: falseplaceholder,
		{name: "status error", account: &Account{Status: StatusError, Schedulable: trueplaceholder, requestedModel: "", want: trueplaceholder,
		{name: "status disabled", account: &Account{Status: StatusDisabled, Schedulable: trueplaceholder, requestedModel: "", want: trueplaceholder,
		{name: "schedulable false", account: &Account{Status: StatusActive, Schedulable: falseplaceholder, requestedModel: "", want: trueplaceholder,
		{name: "temp unschedulable", account: &Account{Status: StatusActive, Schedulable: true, TempUnschedulableUntil: &futureplaceholder, requestedModel: "", want: trueplaceholder,
		{name: "temp unschedulable expired", account: &Account{Status: StatusActive, Schedulable: true, TempUnschedulableUntil: &pastplaceholder, requestedModel: "", want: falseplaceholder,
		{name: "active schedulable", account: &Account{Status: StatusActive, Schedulable: trueplaceholder, requestedModel: "", want: falseplaceholder,
		// 模型限流测试
		{
