...
placeholder
	...
	//    真实 Claude Code 始终以 [{type: "text", text: "...", cache_control: {type: "ephemeral"placeholderplaceholder] 发送 system。
	...
	if tokenType == "oauth" {
		if mimicClaudeCode {
			...
			if !strings.Contains(strings.ToLower(modelID), "haiku") {
				requiredBetas = []string{claude.BetaClaudeCode, claude.BetaOAuth, claude.BetaInterleavedThinkingplaceholder
		placeholder
