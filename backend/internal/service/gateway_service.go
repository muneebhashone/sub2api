...
var (
	...
	// 格式: user_{64位hexplaceholder_account_...
	clientIDFromMetadataRegex = regexp.MustCompile(`^user_([a-f0-9]{64placeholder)_account_`)
...
type GatewayCache interface {
	...
	// 返回值成员格式为 {userIDplaceholder/{clientIDplaceholder
...
// 格式: user_{64位hexplaceholder_account_..._session_...
