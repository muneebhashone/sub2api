...
placeholder
	...
	placeholder else {
		...
		placeholder
			newSystem = []any{claudeCodeBlock, map[string]any{"type": "text", "text": mergedplaceholderplaceholder
	placeholder
	case []any:
...
func filterBetaTokensFromHeader(header string, filterSet map[string]struct{placeholder) string {
