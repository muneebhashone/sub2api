	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			p := &postUsageBillingParams{
				Cost:               &CostBreakdown{TotalCost: tt.totalCost, ActualCost: tt.actualCostplaceholder,
				User:               &User{ID: 1placeholder,
				APIKey:             &APIKey{ID: 2, GroupID: &groupIDplaceholder,
				Account:            &Account{ID: 3placeholder,
				Subscription:       &UserSubscription{ID: subIDplaceholder,
