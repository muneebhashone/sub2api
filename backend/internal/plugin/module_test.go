...
func TestModuleIDNamespaceAndName(t *testing.T) {
	tests := []struct {
		...
		name      string
placeholder{
		{id: "job.hello", namespace: "job", name: "hello"placeholder,
		{id: "gateway.platform.anthropic", namespace: "gateway.platform", name: "anthropic"placeholder,
		{id: "hello", namespace: "", name: "hello"placeholder,
		{id: "payment.provider.stripe-checkout", namespace: "payment.provider", name: "stripe-checkout"placeholder,
placeholder
