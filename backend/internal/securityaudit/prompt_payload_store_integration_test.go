...
placeholder
	client := redis.NewClient(&redis.Options{Addr: addressplaceholder)
	t.Cleanup(func() { require.NoError(t, client.Close()) placeholder)
...
placeholderplaceholder
	...
	service.probes["guard-1"] = ProbeResult{OK: true, Status: "healthy", HTTPStatus: 200placeholder
