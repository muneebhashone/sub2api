		...
		placeholder,
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":nullplaceholder,"antigravity":{"daily":null,"weekly":null,"monthly":nullplaceholder,"gemini":{"daily":null,"weekly":null,"monthly":nullplaceholder,"openai":{"daily":null,"weekly":null,"monthly":nullplaceholderplaceholder,
