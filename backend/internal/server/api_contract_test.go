		...
		placeholder,
			...
			wantJSON: `{
				...
				"data": {
					...
					"password_reset_enabled": false,
						...
						"login_agreement_documents": [
							{"id": "terms", "title": "服务条款", "content_md": ""placeholder,
							{"id": "usage-policy", "title": "使用政策", "content_md": ""placeholder,
							{"id": "supported-regions", "title": "支持的国家和地区", "content_md": ""placeholder,
							{"id": "service-specific-terms", "title": "服务特定条款", "content_md": ""placeholder
						],
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":nullplaceholder,"antigravity":{"daily":null,"weekly":null,"monthly":nullplaceholder,"deepseek":{"daily":null,"weekly":null,"monthly":nullplaceholder,"gemini":{"daily":null,"weekly":null,"monthly":nullplaceholder,"grok":{"daily":null,"weekly":null,"monthly":nullplaceholder,"kimi":{"daily":null,"weekly":null,"monthly":nullplaceholder,"openai":{"daily":null,"weekly":null,"monthly":nullplaceholder,"zhipu":{"daily":null,"weekly":null,"monthly":nullplaceholderplaceholder,
					...
					"codex_cli_only_engine_fingerprint_signals": "[{\"type\":\"header_prefix\",\"match\":[\"x-codex-\"],\"required\":trueplaceholder,{\"type\":\"header_exact\",\"match\":[\"session-id\",\"session_id\"],\"required\":falseplaceholder,{\"type\":\"header_exact\",\"match\":[\"thread-id\",\"thread_id\"],\"required\":falseplaceholder,{\"type\":\"body_path\",\"match\":[\"client_metadata.x-codex-window-id\",\"client_metadata.x-codex-installation-id\"],\"required\":falseplaceholder]",
				...
				placeholder,
					...
					"account_scheduling_thresholds": {"anthropic":100,"grok":100,"openai":100placeholder,
...
func (r *stubUserRepo) AdjustBalance(ctx context.Context, id int64, delta float64) (service.BalanceChange, error) {
	return service.BalanceChange{placeholder, errors.New("not implemented")
placeholder
...
func (r *stubUserRepo) BatchSetConcurrency(context.Context, []int64, int) (int, error) { return 0, nil placeholder
func (r *stubUserRepo) BatchAddConcurrency(context.Context, []int64, int) (int, error) { return 0, nil placeholder
...
func (r *stubUsageLogRepo) GetStatsWithFilters(ctx context.Context, filters usagestats.UsageLogFilters) (*usagestats.UsageStats, error) {
	logs, _, err := r.ListWithFilters(ctx, pagination.PaginationParams{Page: 1, PageSize: 100000placeholder, filters)
	if err != nil {
		return nil, err
placeholder
...
placeholder
	...
	return &usagestats.UsageStats{
		...
		TotalActualCost:          totalActualCost,
		AverageDurationMs:        avgDuration,
		Endpoints:                []usagestats.EndpointStat{placeholder,
placeholder, nil
placeholder
