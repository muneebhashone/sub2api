...
placeholder
	apiKey := &service.APIKey{
		...
		Group:   apiKeyGroup,
placeholder
	cfg := &config.Config{RunMode: runModeplaceholder
	rateRepo := &keyBillingRouteRateRepo{placeholder
	apiKeyService := service.NewAPIKeyService(
		&keyBillingRouteAPIKeyRepo{apiKey: apiKeyplaceholder, nil, nil, nil, rateRepo, nil, cfg,
	)
