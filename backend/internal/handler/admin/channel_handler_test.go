...
placeholder
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := pricingRequestToService([]channelModelPricingRequest{tt.reqplaceholder)
...
func TestPricingRequestToService_EmptySlice(t *testing.T) {
	result := pricingRequestToService([]channelModelPricingRequest{placeholder)
...
placeholder{
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModeTokenplaceholder,
		placeholder,
			wantErr: false,
	placeholder,
		{
			...
			pricing: []service.ChannelModelPricing{
				{
					BillingMode: service.BillingModePerRequest,
					Intervals: []service.PricingInterval{
						{MinTokens: 0, MaxTokens: intPtr(1000), PerRequestPrice: float64Ptr(0.1)placeholder,
				placeholder,
			placeholder,
		placeholder,
			wantErr: false,
	placeholder,
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModePerRequestplaceholder,
		placeholder,
			wantErr: true,
	placeholder,
		{
	...
	placeholder,
		{
			...
			pricing: []service.ChannelModelPricing{
				{BillingMode: service.BillingModeImageplaceholder,
		placeholder,
			wantErr: true,
	placeholder,
		{
			name:    "empty list - valid",
			pricing: []service.ChannelModelPricing{placeholder,
			wantErr: false,
	placeholder,
		{
