...
func TestIsAllowedOpsWSOrigin_AllowsEmptyOrigin(t *testing.T) {
	...
	t.Cleanup(func() { opsWSProxyConfig = original placeholder)
	opsWSProxyConfig = OpsWSProxyConfig{OriginPolicy: OriginPolicyPermissiveplaceholder
...
func TestIsAllowedOpsWSOrigin_RejectsEmptyOrigin_WhenStrict(t *testing.T) {
	original := opsWSProxyConfig
	t.Cleanup(func() { opsWSProxyConfig = original placeholder)
	opsWSProxyConfig = OpsWSProxyConfig{OriginPolicy: OriginPolicyStrictplaceholder
