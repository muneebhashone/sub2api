...
func (h *GroupHandler) GetLiveCapability(c *gin.Context) {
	...
	result := gin.H{"supported": err == nilplaceholder
	if err != nil {
...
placeholder
	if err := h.adminService.DeleteCompositeRoute(c.Request.Context(), groupID, routeID); err != nil {
		...
		return
placeholder
	response.Success(c, gin.H{"message": "Composite route deleted"placeholder)
placeholder
...
placeholder
	...
	response.Success(c, gin.H{"models": modelsplaceholder)
placeholder
...
placeholder
	...
	placeholder{GroupID: groupIDplaceholder,
...
placeholder
	...
	response.Success(c, gin.H{"message": "Rate multipliers cleared successfully"placeholder)
placeholder
...
placeholder
	...
	response.Success(c, gin.H{"message": "Rate multipliers updated successfully"placeholder)
placeholder
...
placeholder
	...
	response.Success(c, gin.H{"message": "RPM overrides updated successfully"placeholder)
placeholder
...
placeholder
	...
	response.Success(c, gin.H{"message": "RPM overrides cleared successfully"placeholder)
placeholder
...
placeholder `json:"updates" binding:"required,min=1"`
placeholder
...
placeholder
	...
	response.Success(c, gin.H{"message": "Sort order updated successfully"placeholder)
placeholder
