...
func (h *OpenAIOAuthHandler) GenerateAuthURL(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&req); err != nil {
		// Allow empty body
		req = OpenAIGenerateAuthURLRequest{placeholder
placeholder
...
placeholder
	if tokenInfo != nil {
		for _, candidate := range []string{tokenInfo.Email, tokenInfo.ChatGPTAccountID, tokenInfo.ChatGPTUserIDplaceholder {
...
placeholder
	...
	refreshResponse := openAIQuotaRefreshResponse{OpenAIQuotaUsage: *usageplaceholder
...
placeholder
	...
	resetResponse := openAIQuotaResetResponse{OpenAIQuotaResetResult: *resultplaceholder
