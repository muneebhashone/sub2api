...
placeholder
	...
	for _, key := range oldKeys {
		if got, matchedKey := index.Find([]string{keyplaceholder, "user-old"); got != nil {
...
placeholder
	...
	for _, key := range newKeys {
		got, matchedKey := index.Find([]string{keyplaceholder, "user-new")
...
placeholder
	...
	placeholder,
placeholder
	index := buildCodexAccountIndex([]service.Account{first, secondplaceholder)

	first.Credentials["access_token"] = "access-first-new"
	index.Add(first)

	got, matchedKey := index.Find([]string{"account:team-shared"placeholder, "")
