...
placeholder
	...
	changed := diffSettings(before, after, nil, nil, UpdateSettingsRequest{placeholder)
	found := false
...
placeholder{
		...
		{&five, nil, falseplaceholder,
		{nil, &five, falseplaceholder,
		{&five, &five2, trueplaceholder,
		{&five, &ten, falseplaceholder,
placeholder
	for _, c := range cases {
...
placeholder
	...
	changed := appendAuthSourceDefaultChanges([]string{placeholder, before, after)
