...
func NewAvailableChannelHandler(channelService *service.ChannelService) *AvailableChannelHandler {
	return &AvailableChannelHandler{channelService: channelServiceplaceholder
placeholder
...
func availableChannelToAdminResponse(ch service.AvailableChannel) availableChannelResponse {
	...
	for _, g := range ch.Groups {
		groups = append(groups, availableGroupResponse{ID: g.ID, Name: g.Name, Platform: g.Platformplaceholder)
placeholder
