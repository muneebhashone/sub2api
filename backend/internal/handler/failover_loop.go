...
type FailoverState struct {
	SwitchCount           int
	MaxSwitches           int
	FailedAccountIDs      map[int64]struct{placeholder
	...
	profitVetoedAccountIDs map[int64]struct{placeholder
...
func NewFailoverState(maxSwitches int, hasBoundSession bool) *FailoverState {
	return &FailoverState{
		...
		profitVetoedAccountIDs: make(map[int64]struct{placeholder),
placeholder
placeholder
...
func (s *FailoverState) RecordProfitVeto(accountID int64) FailoverAction {
	...
	if s.profitVetoedAccountIDs == nil {
		s.profitVetoedAccountIDs = make(map[int64]struct{placeholder)
placeholder
	s.profitVetoedAccountIDs[accountID] = struct{placeholder{placeholder
	s.profitVetoCount++
...
placeholder
	...
	placeholder
		...
		for id := range s.profitVetoedAccountIDs {
			s.FailedAccountIDs[id] = struct{placeholder{placeholder
	placeholder
		return FailoverContinue
placeholder
	return FailoverExhausted
