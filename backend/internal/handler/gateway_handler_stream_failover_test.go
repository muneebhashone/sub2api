...
const partialMessageStartSSE = "event: message_start\ndata: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_01\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"claude-sonnet-4-5\",\"stop_reason\":null,\"stop_sequence\":null,\"usage\":{\"input_tokens\":10,\"output_tokens\":1placeholderplaceholderplaceholder\n\n" +
...
placeholder
	...
	failoverErr := &service.UpstreamFailoverError{
		...
		ResponseBody: []byte(`{"error":{"type":"permission_error","message":"forbidden"placeholderplaceholder`),
placeholder
	...
	// 断言 B：响应体以 SSE 错误事件结尾（data: {"type":"error",...placeholder\n\n）
