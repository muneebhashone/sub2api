...
func TestLooksLikeSystemKey(t *testing.T) {
	cases := []struct {
		...
		want bool
placeholder{
		{"sk-abcdef0123456789", trueplaceholder,
		{"ABCdef_-0123456789", trueplaceholder,
		{"short", falseplaceholder,
		{"with space xxxxxxxxxx", falseplaceholder,
		{"汉字key1234567890", falseplaceholder,
		{"", falseplaceholder,
placeholder
	for _, c := range cases {
...
placeholder{
		{
			...
			headers: map[string]string{"Authorization": "Bearer sk-testkey0123456789"placeholder,
	...
	placeholder,
		{
			...
			headers: map[string]string{"x-api-key": "sk-xapikey0123456789"placeholder,
			want:    "sk-xapikey0123456789",
	placeholder,
		{
			name:    "x-goog-api-key header",
			headers: map[string]string{"x-goog-api-key": "sk-goog0123456789"placeholder,
			want:    "sk-goog0123456789",
	placeholder,
		{
			name:    "Authorization takes priority over x-api-key",
			headers: map[string]string{"Authorization": "Bearer sk-auth0123456789", "x-api-key": "sk-xapi0123456789"placeholder,
			want:    "sk-auth0123456789",
	placeholder,
		{
			name:    "x-api-key takes priority over x-goog-api-key",
			headers: map[string]string{"x-api-key": "sk-xapi0123456789", "x-goog-api-key": "sk-goog0123456789"placeholder,
	...
	placeholder,
		{
			...
			headers: map[string]string{"Authorization": "Bearer   sk-trimmed0123456789  "placeholder,
	...
	placeholder,
		{
			...
			headers: map[string]string{"Authorization": "junk-not-bearer", "x-api-key": "sk-realkey1234567"placeholder,
