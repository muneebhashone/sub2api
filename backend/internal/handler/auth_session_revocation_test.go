...
placeholder
	...
	c.Set(string(middleware2.ContextKeyUser), middleware2.AuthSubject{UserID: 29placeholder)

	handler.RevokeAllSessions(c)

	require.Equal(t, http.StatusOK, recorder.Code)
	require.Equal(t, []int64{29placeholder, refreshTokenCache.revokedUserIDs)
