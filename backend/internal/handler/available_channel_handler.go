...
func collectGroupPlatforms(groups []userAvailableGroup) map[string]struct{placeholder {
	set := make(map[string]struct{placeholder, len(groups))
	for _, g := range groups {
		if g.Platform == "" {
			continue
	placeholder
		set[g.Platform] = struct{placeholder{placeholder
placeholder
	return set
placeholder
