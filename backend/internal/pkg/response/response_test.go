...
placeholder
	...
	return Response{Code: raw.Code, Message: raw.Message, Reason: raw.Reasonplaceholder, pd
placeholder
	...
	placeholder,
		{
			...
			message:    "no access",
			reason:     "FORBIDDEN",
			metadata:   map[string]string{"k": "v"placeholder,
			want: Response{
	...
	placeholder,
		{
			...
			err:          errors2.Forbidden("FORBIDDEN", "no access").WithMetadata(map[string]string{"scope": "admin"placeholder),
			wantWritten:  true,
			...
			wantBody: Response{
				...
				Message:  "no access",
				Reason:   "FORBIDDEN",
				Metadata: map[string]string{"scope": "admin"placeholder,
		placeholder,
	placeholder,
		{
...
placeholder{
		{
			...
			wantBody: Response{Code: 0, Message: "success", Data: "hello"placeholder,
	placeholder,
		{
			name:     "返回nil数据",
			data:     nil,
			wantCode: http.StatusOK,
			wantBody: Response{Code: 0, Message: "success"placeholder,
	placeholder,
		{
			name:     "返回map数据",
			data:     map[string]string{"key": "value"placeholder,
			wantCode: http.StatusOK,
			wantBody: Response{Code: 0, Message: "success"placeholder,
	placeholder,
placeholder
...
placeholder{
		{
			name:     "创建成功_返回数据",
			data:     map[string]int{"id": 42placeholder,
