...
placeholder
	return map[string]any{
		"type":        "output_text",
		"text":        text,
		"annotations": []any{placeholder,
		"logprobs":    []any{placeholder,
placeholder
placeholder
...
func messageContentWire(parts []ResponsesContentPart) []map[string]any {
	...
	for _, p := range parts {
		...
		if typ == "" {
			typ = "output_text"
	placeholder
		out = append(out, map[string]any{"type": typ, "text": p.Textplaceholder)
placeholder
	return out
placeholder
...
func reasoningSummaryWire(summary []ResponsesSummary) []map[string]any {
	...
	for _, s := range summary {
		...
		if typ == "" {
			typ = "summary_text"
	placeholder
		out = append(out, map[string]any{"type": typ, "text": s.Textplaceholder)
placeholder
	return out
placeholder
