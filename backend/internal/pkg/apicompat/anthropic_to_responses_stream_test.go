...
placeholder
	...
	idx := 0
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1", Model: "claude-sonnet-4-5"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "Hel"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "lo"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxplaceholder)
	feed(&AnthropicStreamEvent{Type: "message_stop"placeholder)
...
placeholder
	...
	idx := 0
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "Hello "placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "world"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxplaceholder)
...
placeholder
	...
	feed(&AnthropicStreamEvent{Type: "message_start", Message: &AnthropicResponse{ID: "msg_1"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_start", Index: &idx, ContentBlock: &AnthropicContentBlock{Type: "text"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{Type: "text_delta", Text: "4826"placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxplaceholder)
	feed(&AnthropicStreamEvent{Type: "message_stop"placeholder)
...
placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_delta", Index: &idx, Delta: &AnthropicDelta{
		Type: "input_json_delta", PartialJSON: `"SH"placeholder`,
placeholderplaceholder)
	feed(&AnthropicStreamEvent{Type: "content_block_stop", Index: &idxplaceholder)
	feed(&AnthropicStreamEvent{Type: "message_stop"placeholder)
...
placeholder
	if fc.Arguments != `{"city":"SH"placeholder` {
		t.Errorf("arguments = %q, want %q", fc.Arguments, `{"city":"SH"placeholder`)
placeholder
