...
placeholder{anthropicContentBlock: anthropicContentBlock(b)placeholder
	...
	case "text":
		return json.Marshal(struct {
			...
			anthropicContentBlock
	placeholder{Text: b.Text, anthropicContentBlock: anthropicContentBlock(b)placeholder)
	case "thinking":
		return json.Marshal(struct {
			Thinking string `json:"thinking"`
			anthropicContentBlock
	placeholder{Thinking: b.Thinking, anthropicContentBlock: anthropicContentBlock(b)placeholder)
	default:
...
placeholder
	...
	*i = ResponsesInputItem{placeholder
	wire.alias = (*alias)(i)
...
func (t *ResponsesTool) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &name); err == nil {
		*t = ResponsesTool{Type: "custom", Name: nameplaceholder
		return nil
placeholder
