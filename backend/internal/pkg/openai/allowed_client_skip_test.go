...
func TestMatchClientEntry_ReturnsHitEntry(t *testing.T) {
	entries := []AllowedClientEntry{
		{Originator: "opencode", UAContains: []string{"opencode/"placeholder, SkipEngineFingerprint: trueplaceholder,
		{Originator: "Claude Code", UAContains: []string{"Claude Code/"placeholderplaceholder,
placeholder
