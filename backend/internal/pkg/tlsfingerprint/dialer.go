...
placeholder
	...
	extensions = append(extensions,
		&utls.SupportedPointsExtension{SupportedPoints: pointFormatsplaceholder,
		&utls.SupportedCurvesExtension{Curves: curvesplaceholder,
		&utls.SessionTicketExtension{placeholder,
		&utls.ALPNExtension{AlpnProtocols: []string{"http/1.1"placeholderplaceholder,
		&utls.GenericExtension{Id: 22placeholder,
		&utls.ExtendedMasterSecretExtension{placeholder,
		&utls.SignatureAlgorithmsExtension{SupportedSignatureAlgorithms: defaultSignatureAlgorithmsplaceholder,
		&utls.SupportedVersionsExtension{Versions: []uint16{
			utls.VersionTLS13,
			utls.VersionTLS12,
placeholder
		&utls.PSKKeyExchangeModesExtension{Modes: []uint8{utls.PskModeDHEplaceholderplaceholder,
		&utls.KeyShareExtension{KeyShares: []utls.KeyShare{
			{Group: utls.X25519placeholder,
placeholder
	)
