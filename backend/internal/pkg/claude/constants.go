...
const (
	...
	BetaInterleavedThinking      = "placeholder"
...
var DroppedBetas = []string{placeholder
...
// 用于 billing attribution block 中的 cc_version=X.Y.Z.{fpplaceholder 前缀以及 fingerprint 计算。
