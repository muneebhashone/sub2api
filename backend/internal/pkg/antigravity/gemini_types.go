...
type GeminiFunctionCall struct {
	...
	Args interface{placeholder `json:"args,omitempty"`
...
type GeminiFunctionResponse struct {
	Name     string                 `json:"name"`
	Response map[string]interface{placeholder `json:"response"`
	ID       string                 `json:"id,omitempty"`
placeholder
...
type GeminiFunctionDecl struct {
	...
	Parameters  map[string]interface{placeholder `json:"parameters,omitempty"`
placeholder
...
var DefaultSafetySettings = []GeminiSafetySetting{
	{Category: "HARM_CATEGORY_HARASSMENT", Threshold: "OFF"placeholder,
	{Category: "HARM_CATEGORY_HATE_SPEECH", Threshold: "OFF"placeholder,
	{Category: "HARM_CATEGORY_SEXUALLY_EXPLICIT", Threshold: "OFF"placeholder,
	{Category: "HARM_CATEGORY_DANGEROUS_CONTENT", Threshold: "OFF"placeholder,
	{Category: "HARM_CATEGORY_CIVIC_INTEGRITY", Threshold: "OFF"placeholder,
placeholder
