...
func opsNullFloat64(v *float64) any {
	if v == nil {
		return sql.NullFloat64{placeholder
placeholder
	return sql.NullFloat64{Float64: *v, Valid: trueplaceholder
placeholder

func opsNullTime(v *time.Time) any {
	if v == nil || v.IsZero() {
		return sql.NullTime{placeholder
placeholder
	return sql.NullTime{Time: *v, Valid: trueplaceholder
placeholder
