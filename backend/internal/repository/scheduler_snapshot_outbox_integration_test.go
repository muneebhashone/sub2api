...
placeholder
	...
	bucket := service.SchedulerBucket{GroupID: 0, Platform: service.PlatformOpenAI, Mode: service.SchedulerModeSingleplaceholder
	...
	placeholder
		return false
placeholder, 5*time.Second, 100*time.Millisecond)
