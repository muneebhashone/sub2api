...
func NewHTTPUpstream(cfg *config.Config) service.HTTPUpstream {
	return &httpUpstreamService{
		defaultClient: &http.Client{Transport: buildUpstreamTransport(cfg, nil)placeholder,
		cfg:           cfg,
placeholder
placeholder
...
placeholder
	...
	client := &http.Client{Transport: buildUpstreamTransport(s.cfg, parsedURL)placeholder
