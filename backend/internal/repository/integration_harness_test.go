...
placeholder
	...
	if err != nil {
		...
		os.Exit(1)
placeholder
	defer func() { _ = pgContainer.Terminate(ctx) placeholder()
	...
	if err != nil {
		...
		os.Exit(1)
placeholder
	defer func() { _ = redisContainer.Terminate(ctx) placeholder()
...
placeholder
	...
	rdb.AddHook(prefixHook{prefix: prefixplaceholder)
...
func (h prefixHook) DialHook(next redisclient.DialHook) redisclient.DialHook { return next placeholder
