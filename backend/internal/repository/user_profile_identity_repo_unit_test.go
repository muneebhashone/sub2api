...
placeholder
	...
	legacyIdentity, err := client.AuthIdentity.Create().
		...
		SetMetadata(map[string]any{"source": "legacy-alias"placeholder).
		Save(ctx)
placeholder
	...
	legacyChannel, err := client.AuthIdentityChannel.Create().
		...
		SetMetadata(map[string]any{"scene": "legacy-alias"placeholder).
		Save(ctx)
placeholder
	...
	placeholder,
		Metadata:        map[string]any{"source": "canonical-bind"placeholder,
		ChannelMetadata: map[string]any{"scene": "canonical-bind"placeholder,
placeholder)
placeholder
...
placeholder
	...
	session, err := client.PendingAuthSession.Create().
		...
		SetUpstreamIdentityClaims(map[string]any{"provider_subject": "union-repo-adoption"placeholder).
		SetLocalFlowState(map[string]any{"step": "pending"placeholder).
		Save(ctx)
placeholder
...
placeholder
	...
	go func() {
		...
		results <- adoptionResult{decision: decision, err: errplaceholder
placeholder()
