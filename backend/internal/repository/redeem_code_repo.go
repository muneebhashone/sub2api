...
placeholder
	...
	if sortOrder == pagination.SortOrderAsc {
		return []func(*entsql.Selector){dbent.Asc(field), dbent.Asc(redeemcode.FieldID)placeholder
placeholder
	return []func(*entsql.Selector){dbent.Desc(field), dbent.Desc(redeemcode.FieldID)placeholder
placeholder
