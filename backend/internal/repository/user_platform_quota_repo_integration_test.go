...
func TestUserPlatformQuotaRepository_BulkInsertInitial_Idempotent(t *testing.T) {
	...
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "anthropic", DailyLimitUSD: &dailyplaceholder,
		{UserID: userID, Platform: "openai"placeholder,
placeholder
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_Empty(t *testing.T) {
	...
	require.NoError(t, repo.BulkInsertInitial(txCtx, []UserPlatformQuotaRecord{placeholder))
placeholder
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_GrokAllowed(t *testing.T) {
	...
	daily := 9.0
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "grok", DailyLimitUSD: &dailyplaceholder,
placeholder
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_CNProvidersAllowed(t *testing.T) {
	...
	daily := 12.0
	records := []UserPlatformQuotaRecord{
		{UserID: userID, Platform: "kimi", DailyLimitUSD: &dailyplaceholder,
		{UserID: userID, Platform: "zhipu"placeholder,
		{UserID: userID, Platform: "deepseek"placeholder,
placeholder
	require.NoError(t, repo.BulkInsertInitial(txCtx, records),
...
func TestUserPlatformQuotaRepository_BulkInsertInitial_MultiRow(t *testing.T) {
	...
	records := []UserPlatformQuotaRecord{
		...
		{UserID: userID, Platform: "openai", DailyLimitUSD: &d2placeholder,
		{UserID: userID, Platform: "gemini", DailyLimitUSD: &d3placeholder,
placeholder
...
placeholder
	...
	byPlatform := map[string]*UserPlatformQuotaRecord{placeholder
	for i := range list {
