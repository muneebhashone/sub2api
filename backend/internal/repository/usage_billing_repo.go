...
func NewUsageBillingRepository(_ *dbent.Client, sqlDB *sql.DB) service.UsageBillingRepository {
	return &usageBillingRepository{db: sqlDBplaceholder
placeholder

func (r *usageBillingRepository) Apply(ctx context.Context, cmd *service.UsageBillingCommand) (_ *service.UsageBillingApplyResult, err error) {
	if cmd == nil {
		return &service.UsageBillingApplyResult{placeholder, nil
placeholder
	if r == nil || r.db == nil {
...
placeholder
	if !applied {
		return &service.UsageBillingApplyResult{Applied: falseplaceholder, nil
placeholder
...
func (r *usageBillingRepository) applyBatchImageBalanceHold(
	...
	if cmd == nil {
		return &service.BatchImageBalanceHoldResult{placeholder, nil
placeholder
	if r == nil || r.db == nil {
		return nil, errors.New("usage billing repository db is nil")
placeholder
...
placeholder
	if !applied {
		return &service.BatchImageBalanceHoldResult{Applied: falseplaceholder, nil
placeholder
...
placeholder
	if result == nil {
		result = &service.BatchImageBalanceHoldResult{placeholder
placeholder
	result.Applied = true
...
placeholder
	...
	if err == nil {
		return &service.BatchImageBalanceHoldResult{NewBalance: &balance, FrozenBalance: &frozenplaceholder, nil
placeholder
	if !errors.Is(err, sql.ErrNoRows) {
		return nil, err
placeholder
