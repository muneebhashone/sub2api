...
func (s *EmailCacheSuite) TestSetAndGetVerificationCode() {
	...
	data := &service.VerificationCodeData{Code: "123456", Attempts: 1, CreatedAt: time.Now()placeholder
...
func (s *EmailCacheSuite) TestVerificationCode_TTL() {
	...
	emailTTL := 2 * time.Minute
	data := &service.VerificationCodeData{Code: "654321", Attempts: 0, CreatedAt: time.Now()placeholder
...
func (s *EmailCacheSuite) TestDeleteVerificationCode() {
	...
	data := &service.VerificationCodeData{Code: "999999", Attempts: 0, CreatedAt: time.Now()placeholder
