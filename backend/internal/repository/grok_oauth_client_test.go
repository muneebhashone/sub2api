...
func TestGrokOAuthEntitlementDenialRequiresExplicitEvidence(t *testing.T) {
	...
	require.False(t, grokOAuthHasExplicitEntitlementDenial(`{"error":"access_denied","message":"You have run out of credits"placeholder`))
	require.False(t, grokOAuthHasExplicitEntitlementDenial(`{"code":"subscription_required","message":"included free usage exhausted"placeholder`))
placeholder
