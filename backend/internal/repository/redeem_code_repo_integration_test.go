...
func (s *RedeemCodeRepoSuite) TestList() {
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "LIST-1", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "LIST-2", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
...
func (s *RedeemCodeRepoSuite) TestListWithFilters_Type() {
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "TYPE-BAL", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "TYPE-SUB", Type: service.RedeemTypeSubscription, Value: 0, Status: service.StatusUnusedplaceholder))
...
func (s *RedeemCodeRepoSuite) TestListWithFilters_Status() {
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "STAT-UNUSED", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "STAT-USED", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUsedplaceholder))
...
func (s *RedeemCodeRepoSuite) TestListWithFilters_Search() {
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "ALPHA-CODE", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
	s.Require().NoError(s.repo.Create(s.ctx, &service.RedeemCode{Code: "BETA-CODE", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder))
...
placeholder
	...
	updated, err := s.repo.BatchUpdate(s.ctx, []int64{codeA.ID, codeB.IDplaceholder, service.RedeemCodeBatchUpdateFields{
		Status:    &status,
		ExpiresAt: service.NullableTimeUpdate{Set: true, Value: &expiresAtplaceholder,
		Notes:     &notes,
		GroupID:   service.NullableInt64Update{Set: true, Value: &groupIDplaceholder,
placeholder)
	s.Require().NoError(err)
	...
	updated, err = s.repo.BatchUpdate(s.ctx, []int64{codeA.IDplaceholder, service.RedeemCodeBatchUpdateFields{
		ExpiresAt: service.NullableTimeUpdate{Set: trueplaceholder,
		GroupID:   service.NullableInt64Update{Set: trueplaceholder,
placeholder)
	s.Require().NoError(err)
...
placeholder
	...
	_, err := s.repo.BatchUpdate(s.ctx, []int64{code.ID, 999999placeholder, service.RedeemCodeBatchUpdateFields{Notes: &notesplaceholder)
	s.Require().Error(err)
...
placeholder
	...
	_, err := s.repo.BatchUpdate(s.ctx, []int64{code.IDplaceholder, service.RedeemCodeBatchUpdateFields{Status: &statusplaceholder)
	s.Require().Error(err)
...
func (s *RedeemCodeRepoSuite) TestUse() {
	...
	code := &service.RedeemCode{Code: "USE-ME", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder
	s.Require().NoError(s.repo.Create(s.ctx, code))
...
func (s *RedeemCodeRepoSuite) TestUse_Idempotency() {
	...
	code := &service.RedeemCode{Code: "IDEM-CODE", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUnusedplaceholder
	s.Require().NoError(s.repo.Create(s.ctx, code))
...
func (s *RedeemCodeRepoSuite) TestUse_AlreadyUsed() {
	...
	code := &service.RedeemCode{Code: "ALREADY-USED", Type: service.RedeemTypeBalance, Value: 0, Status: service.StatusUsedplaceholder
	s.Require().NoError(s.repo.Create(s.ctx, code))
...
func (s *RedeemCodeRepoSuite) TestCreateBatch_Filters_Use_Idempotency_ListByUser() {
	...
	codes := []service.RedeemCode{
		{Code: "CODEA", Type: service.RedeemTypeBalance, Value: 1, Status: service.StatusUnused, Notes: ""placeholder,
		{Code: "CODEB", Type: service.RedeemTypeSubscription, Value: 0, Status: service.StatusUnused, Notes: "", GroupID: &groupID, ValidityDays: 7placeholder,
placeholder
