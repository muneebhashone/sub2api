...
T1 :794 路由矩阵（antigravity×{OAuth,APIKeyplaceholder）/ T2 :444 ForwardGemini 参数逐一断言 / T3 session 选项不丢参 / T4 错误链（BetaBlockedError/PromptTooLong 经 errors.As）/ T5 antigravity forward bench。
