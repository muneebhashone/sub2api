  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ t('setup.title') placeholderplaceholder</h1>
        <p class="mt-2 text-gray-500 dark:text-dark-400">{{ t('setup.description') placeholderplaceholder</p>
      </div>
            ...
            <div class="flex items-center">
              ...
              >
                <Icon
                  ...
                  :stroke-width="2"
                />
                <span v-else>{{ index + 1 placeholderplaceholder</span>
              </div>
              <span
                ...
                "
              >
                {{ step.title placeholderplaceholder
              </span>
            </div>
            <div
      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-dark-800">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{ t('setup.database.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-dark-400">
              {{ t('setup.database.description') placeholderplaceholder
            </p>
          </div>

          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label class="input-label">{{ t('setup.database.host') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.database.port') placeholderplaceholder</label>
              <input
          ...
          <div class="flex items-center justify-between rounded-xl border border-gray-200 p-3 dark:border-dark-700">
            <div>
              <p class="text-sm font-medium text-gray-900 dark:text-white">
                {{ t("setup.redis.enableTls") placeholderplaceholder
              </p>
              <p class="text-xs text-gray-500 dark:text-dark-400">
                {{ t("setup.redis.enableTlsHint") placeholderplaceholder
              </p>
            </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label class="input-label">{{ t('setup.database.username') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.database.password') placeholderplaceholder</label>
              <input
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label class="input-label">{{ t('setup.database.databaseName') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.database.sslMode') placeholderplaceholder</label>
              <Select
                v-model="formData.database.sslmode"
                :options="[
                  { value: 'disable', label: t('setup.database.ssl.disable') placeholder,
                  { value: 'require', label: t('setup.database.ssl.require') placeholder,
                  { value: 'verify-ca', label: t('setup.database.ssl.verifyCa') placeholder,
                  { value: 'verify-full', label: t('setup.database.ssl.verifyFull') placeholder
                ]"
              />
            </div>
          </div>
        ...
        <div v-if="currentStep === 1" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{ t('setup.redis.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-dark-400">
              {{ t('setup.redis.description') placeholderplaceholder
            </p>
          </div>

          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label class="input-label">{{ t('setup.redis.host') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.port') placeholderplaceholder</label>
              <input
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label class="input-label">{{ t('setup.redis.username') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.password') placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t('setup.redis.database') placeholderplaceholder</label>
              <input
        ...
        <div v-if="currentStep === 2" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{ t('setup.admin.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-dark-400">
              {{ t('setup.admin.description') placeholderplaceholder
            </p>
          </div>

          <div>
            <label class="input-label">{{ t('setup.admin.email') placeholderplaceholder</label>
            <input
          ...
          <div>
            <label class="input-label">{{ t('setup.admin.password') placeholderplaceholder</label>
            <input
          ...
          <div>
            <label class="input-label">{{ t('setup.admin.confirmPassword') placeholderplaceholder</label>
            <input
            ...
            >
              {{ t('setup.admin.passwordMismatch') placeholderplaceholder
            </p>
          </div>
        </div>
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{ t('setup.ready.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-dark-400">
              {{ t('setup.ready.description') placeholderplaceholder
            </p>
          </div>
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.database') placeholderplaceholder
              </h3>
              <p class="text-gray-900 dark:text-white">
                {{ formData.database.user placeholderplaceholder@{{ formData.database.host placeholderplaceholder:{{
                  formData.database.port
                placeholderplaceholder/{{ formData.database.dbname placeholderplaceholder
              </p>
            </div>

            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.redis') placeholderplaceholder
              </h3>
              <p class="text-gray-900 dark:text-white">
                {{ formData.redis.host placeholderplaceholder:{{ formData.redis.port placeholderplaceholder
              </p>
            </div>

            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-700">
              <h3 class="mb-2 text-sm font-medium text-gray-500 dark:text-dark-400">
                {{ t('setup.ready.adminEmail') placeholderplaceholder
              </h3>
              <p class="text-gray-900 dark:text-white">{{ formData.admin.email placeholderplaceholder</p>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="text-sm font-medium text-green-700 dark:text-green-400">
                {{ t('setup.status.completed') placeholderplaceholder
              </p>
        ...
        <div class="mt-8 flex justify-between">
          ...
          >
            ...
            {{ installing ? t('setup.status.installing') : t('setup.status.completeInstallation') placeholderplaceholder
          </button>
        </div>
      </div>
    </div>
...
import { testDatabase, testRedis, install, type InstallRequest placeholder from '@/api/setup'
...
const steps = computed(() => [
  { id: 'database', title: t('setup.database.title') placeholder,
  { id: 'redis', title: t('setup.redis.title') placeholder,
  { id: 'admin', title: t('setup.admin.title') placeholder,
  { id: 'complete', title: t('setup.ready.title') placeholder
])
