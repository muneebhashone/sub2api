      ...
      <template v-else-if="stats">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">${{ formatBalance(user?.balance || 0) placeholderplaceholder</p>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">${{ formatCost(stats.today_actual_cost) placeholderplaceholder</span>
                  <span class="text-sm font-normal text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / ${{ formatCost(stats.today_cost) placeholderplaceholder</span>
                </p>
                <p class="text-xs">
                  <span class="text-gray-500 dark:text-gray-400">{{ t('common.total') placeholderplaceholder: </span>
                  <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.actual')">${{ formatCost(stats.total_actual_cost) placeholderplaceholder</span>
                  <span class="text-gray-400 dark:text-gray-500" :title="t('dashboard.standard')"> / ${{ formatCost(stats.total_cost) placeholderplaceholder</span>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') placeholderplaceholder: {{ formatTokens(stats.today_input_tokens) placeholderplaceholder / {{ t('dashboard.output') placeholderplaceholder: {{ formatTokens(stats.today_output_tokens) placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') placeholderplaceholder: {{ formatTokens(stats.total_input_tokens) placeholderplaceholder / {{ t('dashboard.output') placeholderplaceholder: {{ formatTokens(stats.total_output_tokens) placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="card p-4">
              <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-4">{{ t('dashboard.modelDistribution') placeholderplaceholder</h3>
              <div class="flex items-center gap-6">
                <div class="w-48 h-48">
                  ...
                  <div v-else class="flex items-center justify-center h-full text-gray-500 dark:text-gray-400 text-sm">
                    {{ t('dashboard.noDataAvailable') placeholderplaceholder
                  </div>
                </div>
                  ...
                  <table class="w-full text-xs">
                    <thead>
                      <tr class="text-gray-500 dark:text-gray-400">
                        <th class="text-left pb-2">{{ t('dashboard.model') placeholderplaceholder</th>
                        <th class="text-right pb-2">{{ t('dashboard.requests') placeholderplaceholder</th>
                        <th class="text-right pb-2">{{ t('dashboard.tokens') placeholderplaceholder</th>
                        <th class="text-right pb-2">{{ t('dashboard.actual') placeholderplaceholder</th>
                        <th class="text-right pb-2">{{ t('dashboard.standard') placeholderplaceholder</th>
                      </tr>
                    </thead>
                    <tbody>
            ...
            <div class="card p-4">
              <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-4">{{ t('dashboard.tokenUsageTrend') placeholderplaceholder</h3>
              <div class="h-48">
          ...
          <div class="lg:col-span-2">
            <div class="card">
              <div class="px-6 py-4 border-b border-gray-100 dark:border-dark-700 flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('dashboard.recentUsage') placeholderplaceholder</h2>
                <span class="badge badge-gray">{{ t('dashboard.last7Days') placeholderplaceholder</span>
              </div>
              <div class="p-6">
                ...
                <div v-else class="space-y-3">
                  ...
                  >
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ log.model placeholderplaceholder</p>
                    ...
                    <div class="text-right">
                      <p class="text-sm font-semibold">
                        <span class="text-green-600 dark:text-green-400" title="实际扣除">${{ formatCost(log.actual_cost) placeholderplaceholder</span>
                        <span class="text-gray-400 dark:text-gray-500 font-normal" title="标准计费"> / ${{ formatCost(log.total_cost) placeholderplaceholder</span>
                      </p>
                      <p class="text-xs text-gray-500 dark:text-dark-400">
                        {{ (log.input_tokens + log.output_tokens).toLocaleString() placeholderplaceholder tokens
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    {{ t('dashboard.viewAllUsage') placeholderplaceholder
          ...
          <div class="lg:col-span-1">
            <div class="card">
              <div class="px-6 py-4 border-b border-gray-100 dark:border-dark-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('dashboard.quickActions') placeholderplaceholder</h2>
              </div>
              <div class="p-4 space-y-3">
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ t('dashboard.createApiKey') placeholderplaceholder</p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">{{ t('dashboard.generateNewKey') placeholderplaceholder</p>
                  </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ t('dashboard.viewUsage') placeholderplaceholder</p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">{{ t('dashboard.checkDetailedLogs') placeholderplaceholder</p>
                  </div>
...
const granularityOptions = computed(() => [
  { value: 'day', label: t('dashboard.day') placeholder,
  { value: 'hour', label: t('dashboard.hour') placeholder,
])
...
const loadChartData = async () => {
  try {
    ...
    const [trendResponse, modelResponse] = await Promise.all([
      ...
      usageAPI.getDashboardModels({ start_date: startDate.value, end_date: endDate.value placeholder),
    ])
