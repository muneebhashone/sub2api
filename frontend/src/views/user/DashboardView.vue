        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.balance') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">
                  ${{ formatBalance(user?.balance || 0) placeholderplaceholder
                </p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.apiKeys') placeholderplaceholder
                </p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.todayRequests') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.todayCost') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.todayTokens') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  {{ formatTokens(stats.today_tokens) placeholderplaceholder
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') placeholderplaceholder: {{ formatTokens(stats.today_input_tokens) placeholderplaceholder /
                  {{ t('dashboard.output') placeholderplaceholder: {{ formatTokens(stats.today_output_tokens) placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.totalTokens') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  {{ formatTokens(stats.total_tokens) placeholderplaceholder
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.input') placeholderplaceholder: {{ formatTokens(stats.total_input_tokens) placeholderplaceholder /
                  {{ t('dashboard.output') placeholderplaceholder: {{ formatTokens(stats.total_output_tokens) placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.performance') placeholderplaceholder
                </p>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.avgResponse') placeholderplaceholder
                </p>
                <p class="text-xl font-bold text-gray-900 dark:text-white">
                  {{ formatDuration(stats.average_duration_ms) placeholderplaceholder
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('dashboard.averageTime') placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="flex flex-wrap items-center gap-4">
              <div class="flex items-center gap-2">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t('dashboard.timeRange') placeholderplaceholder:</span
                >
                <DateRangePicker
              ...
              <div class="ml-auto flex items-center gap-2">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t('dashboard.granularity') placeholderplaceholder:</span
                >
                <div class="w-28">
                  <Select
                    v-model="granularity"
            ...
            <div class="card">
              ...
              >
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ t('dashboard.recentUsage') placeholderplaceholder
                </h2>
          ...
          <div class="lg:col-span-1">
            <div class="card">
              <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ t('dashboard.quickActions') placeholderplaceholder
                </h2>
              </div>
              <div class="space-y-3 p-4">
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ t('dashboard.createApiKey') placeholderplaceholder
                    </p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">
                      {{ t('dashboard.generateNewKey') placeholderplaceholder
                    </p>
                  </div>
                  <svg
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ t('dashboard.viewUsage') placeholderplaceholder
                    </p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">
                      {{ t('dashboard.checkDetailedLogs') placeholderplaceholder
                    </p>
                  </div>
                  <svg
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ t('dashboard.redeemCode') placeholderplaceholder
                    </p>
                    <p class="text-xs text-gray-500 dark:text-dark-400">
                      {{ t('dashboard.addBalanceWithCode') placeholderplaceholder
                    </p>
                  </div>
                  <svg
...
const loadRecentUsage = async () => {
  ...
  try {
    ...
    const now = new Date()
    const endDate = `${now.getFullYear()placeholder-${String(now.getMonth() + 1).padStart(2, '0')placeholder-${String(now.getDate()).padStart(2, '0')placeholder`
    const weekAgo = new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)
    const startDate = `${weekAgo.getFullYear()placeholder-${String(weekAgo.getMonth() + 1).padStart(2, '0')placeholder-${String(weekAgo.getDate()).padStart(2, '0')placeholder`
