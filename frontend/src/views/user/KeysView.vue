          ...
          <template #cell-group="{ row placeholder">
            <div class="relative group/dropdown">
              ...
              >
                ...
                />
                <span v-else class="text-sm text-gray-400 dark:text-dark-500">{{ t('keys.noGroup') placeholderplaceholder</span>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ submitting ? t('keys.saving') : (showEditModal ? t('common.update') : t('common.create')) placeholderplaceholder
          </button>
        </div>
      </form>
    </Modal>
...
import type { ApiKey, Group, PublicSettings, SubscriptionType placeholder from '@/types'
