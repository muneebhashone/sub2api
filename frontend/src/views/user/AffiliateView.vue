        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900">
                <code class="flex-1 truncate text-sm font-semibold text-gray-900 dark:text-white">{{ detail.aff_code placeholderplaceholder</code>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900">
                <code class="flex-1 truncate text-sm text-gray-700 dark:text-gray-300">{{ inviteLink placeholderplaceholder</code>
          ...
          <div class="mt-5 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/40 dark:bg-primary-900/20">
            ...
            <ul class="mt-2 space-y-1 text-sm text-primary-700 dark:text-primary-300">
              ...
              <li>2. {{ t('affiliate.tips.line2') placeholderplaceholder</li>
