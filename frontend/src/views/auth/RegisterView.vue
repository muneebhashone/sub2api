...
import { computed, ref, reactive, onMounted, onUnmounted, watch placeholder from 'vue'
...
import { extractApiErrorCode, extractI18nErrorMessage placeholder from '@/utils/apiError'
import {
    ...
    if (emailVerifyEnabled.value) {
      ...
      sessionStorage.setItem(
        ...
        JSON.stringify({
          ...
          ...(affCode ? { aff_code: affCode placeholder : {placeholder)
        placeholder)
      )
