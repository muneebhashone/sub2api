          ...
          <template #cell-proxy="{ row placeholder">
            <div class="flex flex-col gap-1">
              ...
              <div v-if="row.proxy_fallback_origin_id" class="flex items-center gap-1">
                ...
                <button class="text-xs px-1.5 py-0.5 rounded border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700" @click="onRevertFallback(row)">{{ t('admin.accounts.revertProxy') placeholderplaceholder</button>
              </div>
            </div>
          </template>
