        ...
        <DataTable :columns="columns" :data="accounts" :loading="loading">
          ...
          <template #cell-platform="{ value placeholder">
            ...
            >
              ...
              {{ value === 'anthropic' ? 'Anthropic' : 'OpenAI' placeholderplaceholder
            </span>
          </template>

          <template #cell-type="{ value placeholder">
            <span
              :class="[
                'badge',
            ...
            >
              {{ value === 'oauth' ? 'Oauth' : value === 'setup-token' ? t('admin.accounts.setupToken') : t('admin.accounts.apiKey') placeholderplaceholder
            </span>
          </template>
...
import { CreateAccountModal, EditAccountModal, ReAuthAccountModal, AccountStatsModal placeholder from '@/components/account'
...
const columns = computed<Column[]>(() => [
  ...
  { key: 'platform', label: t('admin.accounts.columns.platform'), sortable: true placeholder,
  { key: 'type', label: t('admin.accounts.columns.type'), sortable: true placeholder,
