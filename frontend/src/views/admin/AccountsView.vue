          ...
          <template #cell-actions="{ row, expanded placeholder">
            <div class="flex items-center gap-1">
              ...
              <template v-if="expanded">
                ...
                <span class="text-xs">{{ t('admin.accounts.resetStatus') placeholderplaceholder</span>
                </button>
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.accounts.clearRateLimit') placeholderplaceholder</span>
                </button>
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.accounts.testConnection') placeholderplaceholder</span>
                </button>
                <!-- View Stats button -->
                <button
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.accounts.viewStats') placeholderplaceholder</span>
                </button>
                <button
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.accounts.reAuthorize') placeholderplaceholder</span>
                </button>
                <button
                  v-if="row.type === 'oauth' || row.type === 'setup-token'"
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.accounts.refreshToken') placeholderplaceholder</span>
                </button>
              </template>
            </div>
          </template>
...
const columns = computed<Column[]>(() => [
  ...
  { key: 'groups', label: t('admin.accounts.columns.groups'), sortable: false placeholder,
