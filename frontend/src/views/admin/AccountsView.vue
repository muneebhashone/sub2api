        ...
        >
          ...
          <template #cell-platform_type="{ row placeholder">
            <div class="flex flex-wrap items-center gap-1">
              ...
              >
                {{ getOpenAICompactLabel(row) placeholderplaceholder
              </span>
              <span
...
function getOpenAICompactTitle(row: any): string {
  ...
  return `${getOpenAICompactLabel(row)placeholder | ${t('admin.accounts.openai.compactLastChecked')placeholder: ${formatDateTime(new Date(checkedAt))placeholder`
placeholder
