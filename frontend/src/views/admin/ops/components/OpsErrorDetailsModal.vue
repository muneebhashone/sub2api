...
const ownerSelectOptions = computed(() => {
  return [
    ...
    { value: 'provider', label: 'provider' placeholder,
    { value: 'client', label: 'client' placeholder,
    { value: 'platform', label: 'platform' placeholder
  ]
placeholder)
...
const phaseSelectOptions = computed(() => {
  const options = [
    { value: '', label: t('common.all') placeholder,
    { value: 'request', label: 'request' placeholder,
    { value: 'auth', label: 'auth' placeholder,
    { value: 'routing', label: 'routing' placeholder,
    { value: 'upstream', label: 'upstream' placeholder,
    { value: 'network', label: 'network' placeholder,
    { value: 'internal', label: 'internal' placeholder
  ]
  return options
placeholder)
