...
const resolvedSelectOptions = computed(() => {
  return [
    { value: 'unresolved', label: t('admin.ops.errorDetails.unresolved') || 'unresolved' placeholder,
    { value: 'all', label: t('common.all') placeholder,
    { value: 'resolved', label: t('admin.ops.errorDetails.resolved') || 'resolved' placeholder
  ]
placeholder)
