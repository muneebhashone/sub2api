...
import type { OpsThroughputTrendPoint placeholder from '@/api/admin/ops'
      ...
      tooltip: {
        ...
        callbacks: {
          label: (context: any) => {
            ...
            return `${t('admin.ops.switchRate')placeholder: ${value.toFixed(3)placeholder`
          placeholder
        placeholder
      placeholder
    placeholder,
  ...
  <div class="flex h-full flex-col rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      <h3 class="flex items-center gap-2 text-sm font-bold text-gray-900 dark:text-white">
        ...
        {{ t('admin.ops.switchRateTrend') placeholderplaceholder
