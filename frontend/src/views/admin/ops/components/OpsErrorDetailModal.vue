          ...
          <div v-if="upstreamErrors.length" class="space-y-3">
            ...
            >
              ...
              <div class="mt-2 grid grid-cols-1 gap-2 text-xs text-gray-600 dark:text-gray-300 sm:grid-cols-3">
                <div><span class="text-gray-400">account_id:</span> <span class="font-mono">{{ ev.account_id ?? '—' placeholderplaceholder</span></div>
                <div><span class="text-gray-400">status:</span> <span class="font-mono">{{ ev.upstream_status_code ?? '—' placeholderplaceholder</span></div>
                <div class="break-all">
                  <span class="text-gray-400">request_id:</span> <span class="font-mono">{{ ev.upstream_request_id || '—' placeholderplaceholder</span>
                </div>
              </div>
