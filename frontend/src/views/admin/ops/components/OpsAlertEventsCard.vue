      ...
      <div class="max-h-[600px] overflow-y-auto" @scroll="onScroll">
        <div v-if="!isDesktopViewport" class="divide-y divide-gray-100 dark:divide-dark-800">
          ...
          >
            ...
            <div class="text-xs font-semibold text-gray-900 dark:text-white">{{ row.title || '-' placeholderplaceholder</div>
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 text-[11px] text-gray-500 dark:text-gray-400">
              <span><span class="font-mono">#{{ row.rule_id placeholderplaceholder</span> · {{ formatDurationLabel(row) placeholderplaceholder</span>
            ...
            <div class="text-[11px] text-gray-400 dark:text-gray-500">{{ formatDimensionsSummary(row) placeholderplaceholder</div>
          </div>
        </div>
