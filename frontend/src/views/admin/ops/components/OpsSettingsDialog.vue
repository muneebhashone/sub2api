    ...
    <div v-else-if="runtimeSettings && emailConfig && advancedSettings" class="space-y-6">
      ...
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="input-label">{{ t('admin.ops.settings.latencyP99MaxMs') placeholderplaceholder</label>
            <input
              ...
              class="input"
            />
            <p class="mt-1 text-xs text-gray-500">{{ t('admin.ops.settings.latencyP99MaxMsHint') placeholderplaceholder</p>
          </div>
          ...
          <div class="space-y-3">
            ...
            <div v-if="advancedSettings.auto_refresh_enabled">
              ...
              <Select
                ...
                :options="[
                  { value: 15, label: '15 秒' placeholder,
                  { value: 30, label: '30 秒' placeholder,
                  { value: 60, label: '60 秒' placeholder
                ]"
              />
            </div>
          </div>
