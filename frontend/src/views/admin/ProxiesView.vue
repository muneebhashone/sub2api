...
useSwipeSelect(proxyTableRef, {
  ...
  select: (id) => { const next = new Set(selectedProxyIds.value); next.add(id); selectedProxyIds.value = next placeholder,
  deselect: (id) => { const next = new Set(selectedProxyIds.value); next.delete(id); selectedProxyIds.value = next placeholder
placeholder)
