      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
          ...
          >
            <div class="settings-tabs">
              <button
                ...
                :key="tab.key"
                :id="`settings-tab-${tab.keyplaceholder`"
                type="button"
                role="tab"
              ...
              >
                ...
                <span class="settings-tab-label">{{
                  t(`admin.settings.tabs.${tab.keyplaceholder`)
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.adminApiKey.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.adminApiKey.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-4 p-6">
              ...
              >
                <div class="flex items-start">
                  ...
                  <p class="ml-3 text-sm text-amber-700 dark:text-amber-300">
                    {{ t("admin.settings.adminApiKey.securityWarning") placeholderplaceholder
                  </p>
                </div>
              </div>
              ...
              >
                <span class="text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.adminApiKey.notConfigured") placeholderplaceholder
                </span>
                <button
                  type="button"
              ...
              <div v-else class="space-y-4">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex gap-2">
                    ...
                    >
                      {{ t("admin.settings.adminApiKey.delete") placeholderplaceholder
                    </button>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    {{ t("admin.settings.adminApiKey.keyWarning") placeholderplaceholder
                  </p>
                  <div class="flex items-center gap-2">
                    ...
                    >
                      {{ newAdminApiKey placeholderplaceholder
                    </code>
                    <button
                      type="button"
                      @click="copyNewKey"
                    ...
                    >
                      {{ t("admin.settings.adminApiKey.copyKey") placeholderplaceholder
                    </button>
                  </div>
                  <p class="text-xs text-green-600 dark:text-green-400">
                    {{ t("admin.settings.adminApiKey.usage") placeholderplaceholder
                  </p>
                </div>
              </div>
            </div>
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.overloadCooldown.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.overloadCooldown.description") placeholderplaceholder
              </p>
            </div>
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.overloadCooldown.enabledHint") placeholderplaceholder
                    </p>
                  </div>
                ...
                >
                  <div>
                    ...
                    >
                      {{ t("admin.settings.overloadCooldown.cooldownMinutes") placeholderplaceholder
                    </label>
                    <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.rateLimit429Cooldown.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.rateLimit429Cooldown.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    placeholderplaceholder</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.rateLimit429Cooldown.enabledHint") placeholderplaceholder
                    </p>
                  </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.streamTimeout.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.streamTimeout.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Loading State -->
              ...
              <template v-else>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    placeholderplaceholder</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.streamTimeout.enabledHint") placeholderplaceholder
                    </p>
                  </div>
                ...
                >
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.streamTimeout.action") placeholderplaceholder
                    </label>
                    <select
                    ...
                    >
                      ...
                      <option value="error">
                        {{ t("admin.settings.streamTimeout.actionError") placeholderplaceholder
                      </option>
                      <option value="none">
                        {{ t("admin.settings.streamTimeout.actionNone") placeholderplaceholder
                      </option>
                    </select>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.streamTimeout.actionHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div v-if="streamTimeoutForm.action === 'temp_unsched'">
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.streamTimeout.tempUnschedMinutes") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.streamTimeout.thresholdCount") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.streamTimeout.thresholdCountHint") placeholderplaceholder
                    </p>
                  </div>
                ...
                >
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      >
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.rectifier.apikeySignatureHint") placeholderplaceholder
                      </p>
                    </div>
                  ...
                  >
                    <div>
                      ...
                      >
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.rectifier.apikeyPatternsHint") placeholderplaceholder
                      </p>
                    </div>
                    <div
                      v-for="(
                    ...
                    >
                      + {{ t("admin.settings.rectifier.addPattern") placeholderplaceholder
                    </button>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.betaPolicy.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.betaPolicy.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Loading State -->
              ...
              <template v-else>
                ...
                >
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    >
                      {{ getBetaDisplayName(rule.beta_token) placeholderplaceholder
                    </span>
                    <span
                      class="rounded bg-gray-100 px-2 py-0.5 text-xs text-gray-500 dark:bg-dark-700 dark:text-gray-400"
                    >
                      {{ rule.beta_token placeholderplaceholder
                    </span>
                  </div>
                  ...
                  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      >
                        {{ t("admin.settings.betaPolicy.action") placeholderplaceholder
                      </label>
                      <Select
                    ...
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                      >
                        {{ t("admin.settings.betaPolicy.scope") placeholderplaceholder
                      </label>
                      <Select
                  ...
                  <div v-if="rule.action === 'block'" class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.errorMessage") placeholderplaceholder
                    </label>
                    <input
                    ...
                    <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.errorMessageHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div v-if="betaPresets[rule.beta_token]?.length" class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.quickPresets") placeholderplaceholder
                    </label>
                  ...
                  <div class="mt-3">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.modelWhitelist") placeholderplaceholder
                    </label>
                    <p class="mb-2 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.modelWhitelistHint") placeholderplaceholder
                    </p>
                    <!-- Existing patterns -->
                    <div
                    ...
                    >
                      ...
                      {{ t("admin.settings.betaPolicy.addModelPattern") placeholderplaceholder
                    </button>
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                      ...
                      >
                        {{ pattern placeholderplaceholder
                      </button>
                    </div>
                  </div>
                  ...
                  >
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.betaPolicy.fallbackAction") placeholderplaceholder
                    </label>
                    <Select
                    ...
                    />
                    <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.betaPolicy.fallbackActionHint") placeholderplaceholder
                    </p>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.openaiFastPolicy.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.openaiFastPolicy.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Empty state -->
              ...
              >
                {{ t("admin.settings.openaiFastPolicy.empty") placeholderplaceholder
              </div>
              ...
              >
                ...
                <div
                  ...
                  :data-testid="`openai-fast-policy-summary-${ruleIndexplaceholder`"
                >
                  ...
                  >
                    {{ openaiFastPolicyActionSummary(rule.action) placeholderplaceholder
                  </span>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.serviceTier") placeholderplaceholder
                    </label>
                    <Select
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.action") placeholderplaceholder
                    </label>
                    <Select
                      :modelValue="rule.action"
                      @update:modelValue="
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.openaiFastPolicy.scope") placeholderplaceholder
                    </label>
                    <Select
                      :modelValue="rule.scope"
                      @update:modelValue="
                ...
                <div class="mt-3">
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.userIds") placeholderplaceholder
                  </label>
                  <p class="mb-2 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.openaiFastPolicy.userIdsHint") placeholderplaceholder
                  </p>
                ...
                <div v-if="rule.action === 'block'" class="mt-3">
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.errorMessage") placeholderplaceholder
                  </label>
                  <input
                    v-model="rule.error_message"
                    type="text"
                  ...
                  />
                  <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.openaiFastPolicy.errorMessageHint") placeholderplaceholder
                  </p>
                </div>
                ...
                <div
                  class="mt-3"
                  role="group"
                  :aria-labelledby="`openai-fast-policy-models-label-${ruleIndexplaceholder`"
                  :aria-describedby="`openai-fast-policy-models-hint-${ruleIndexplaceholder`"
                >
                  <label
                    :id="`openai-fast-policy-models-label-${ruleIndexplaceholder`"
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.modelWhitelist") placeholderplaceholder
                  </label>
                  <p
                    :id="`openai-fast-policy-models-hint-${ruleIndexplaceholder`"
                  ...
                  >
                    ...
                    {{ t("admin.settings.openaiFastPolicy.addModelPattern") placeholderplaceholder
                  </button>
                </div>
                ...
                >
                  <label
                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                  >
                    {{ t("admin.settings.openaiFastPolicy.fallbackAction") placeholderplaceholder
                  </label>
                  <Select
                    :modelValue="rule.fallback_action || 'pass'"
                    @update:modelValue="
              ...
              <div>
                ...
                >
                  ...
                  {{ t("admin.settings.openaiFastPolicy.addRule") placeholderplaceholder
                </button>
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                  {{ t("admin.settings.openaiFastPolicy.saveHint") placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.registration.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.registration.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Enable Registration -->
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.emailVerificationHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.emailDomainQuotaHint") placeholderplaceholder
                  </p>
                </div>
                <Toggle
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.promoCodeHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.invitationCodeHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.passwordResetHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.registration.frontendUrl") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.registration.frontendUrlHint") placeholderplaceholder
                </p>
              </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.registration.totpHint") placeholderplaceholder
                  </p>
                  ...
                  >
                    {{ t("admin.settings.registration.totpKeyNotConfigured") placeholderplaceholder
                  </p>
                </div>
                <Toggle
              ...
              >
                <div class="flex items-start justify-between gap-4">
                  <div>
                    ...
                    placeholderplaceholder</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.security.passkeyHint") placeholderplaceholder
                    </p>
                  </div>
                  <Toggle
                ...
                >
                  ...
                  <p class="mt-1 break-all">
                    {{ t("admin.settings.security.passkeyRPID") placeholderplaceholder:
                    {{
                      form.passkey_rp_id ||
                  ...
                  <p class="mt-1 break-all">
                    {{ t("admin.settings.security.passkeyOrigins") placeholderplaceholder:
                    {{
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.stepUpHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.sessionBindingHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.security.auditRetentionHint") placeholderplaceholder
                  </p>
                </div>
                <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.apiKeyAcl.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.apiKeyAcl.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.apiKeyAcl.trustForwardedIp") placeholderplaceholder
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.apiKeyAcl.trustForwardedIpHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                ...
                >
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeaders") placeholderplaceholder
                </label>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeadersHint") placeholderplaceholder
                </p>
                <div
                  class="mt-3 rounded-lg border border-gray-300 bg-white p-2 dark:border-dark-500 dark:bg-dark-700"
                >
                  <div class="flex flex-wrap items-center gap-2">
                    <span
                      ...
                      class="inline-flex items-center gap-1 rounded bg-gray-100 px-2 py-1 text-xs font-mono text-gray-700 dark:bg-dark-600 dark:text-gray-200"
                    >
                      <span>{{ header placeholderplaceholder</span>
                      <button
                        type="button"
                        class="rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-dark-500 dark:hover:text-white"
                        :aria-label="t('admin.settings.apiKeyAcl.removeForwardedClientIpHeader', { header placeholder)"
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.apiKeyAcl.forwardedClientIpHeadersRiskHint") placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ t("admin.settings.panelRateLimit.title") placeholderplaceholder
                </h2>
              </div>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.panelRateLimit.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                ...
                >
                  <div class="flex items-start">
                    ...
                    <p class="ml-3 text-sm text-sky-700 dark:text-sky-300">
                      {{ t("admin.settings.panelRateLimit.proxySafeNote") placeholderplaceholder
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    placeholderplaceholder</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.panelRateLimit.enabledHint") placeholderplaceholder
                    </p>
                  </div>
                ...
                >
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.userRpm") placeholderplaceholder
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.panelRateLimit.perMinute") placeholderplaceholder
                        </span>
                      </div>
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.userRpmHint") placeholderplaceholder
                      </p>
                    </div>
                    ...
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.heavyRpm") placeholderplaceholder
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                      ...
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.heavyRpmHint") placeholderplaceholder
                      </p>
                    </div>
                    ...
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.panelRateLimit.publicIpRpm") placeholderplaceholder
                      </label>
                      <div class="flex items-center gap-2">
                        <input
                      ...
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.publicIpRpmHint") placeholderplaceholder
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      placeholderplaceholder</label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.panelRateLimit.exemptAdminHint") placeholderplaceholder
                      </p>
                    </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.captcha.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.captcha.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Enable Captcha -->
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.captcha.enableHint") placeholderplaceholder
                  </p>
                </div>
                <Toggle
              ...
              >
                ...
                <div class="mb-6">
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.captcha.provider") placeholderplaceholder
                  </label>
                  <div
                  ...
                  >
                    ...
                    >
                      {{ t("admin.settings.captcha.providerTurnstile") placeholderplaceholder
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.captcha.providerTencent") placeholderplaceholder
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.captcha.providerAliyun") placeholderplaceholder
                    </button>
                  </div>
                </div>
                ...
                >
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.turnstile.siteKey") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.turnstile.siteKeyHint") placeholderplaceholder
                      <a
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.turnstile.secretKey") placeholderplaceholder
                    </label>
                    <input
                ...
                <div v-else-if="captchaProviderSelection === 'tencent'">
                  <div class="mb-6 max-w-sm">
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.tencentCaptcha.region") placeholderplaceholder
                    </label>
                    <div class="grid grid-cols-2 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
                      ...
                      >
                        {{ t("admin.settings.tencentCaptcha.regionCn") placeholderplaceholder
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        {{ t("admin.settings.tencentCaptcha.regionIntl") placeholderplaceholder
                      </button>
                    </div>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.tencentCaptcha.regionHint") placeholderplaceholder
                    </p>
                  </div>
                  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="md:col-span-2">
                      <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                        {{ t("admin.settings.tencentCaptcha.appCredentialsTitle") placeholderplaceholder
                      </h3>
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.tencentCaptcha.appCredentialsHint") placeholderplaceholder
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.appId") placeholderplaceholder
                      </label>
                      <input
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.appSecretKey") placeholderplaceholder
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_app_secret_key_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") placeholderplaceholder
                      </p>
                    </div>
                    <div class="border-t border-gray-100 pt-5 md:col-span-2 dark:border-dark-700">
                      <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                        {{ t("admin.settings.tencentCaptcha.cloudCredentialsTitle") placeholderplaceholder
                      </h3>
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.tencentCaptcha.cloudCredentialsHint") placeholderplaceholder
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.cloudSecretId") placeholderplaceholder
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_cloud_secret_id_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") placeholderplaceholder
                      </p>
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ t("admin.settings.tencentCaptcha.cloudSecretKey") placeholderplaceholder
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ form.tencent_captcha_cloud_secret_key_configured ? t("admin.settings.tencentCaptcha.configured") : t("admin.settings.tencentCaptcha.required") placeholderplaceholder
                      </p>
                    </div>
                  </div>
                  <p class="mt-5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.tencentCaptcha.camPermissionHint") placeholderplaceholder
                  </p>
                  <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.tencentCaptcha.aidEncryptedHint") placeholderplaceholder
                  </p>
                  <div class="mt-3 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.openCaptchaConsole") placeholderplaceholder
                    </a>
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.createCloudKeys") placeholderplaceholder
                    </a>
                    <a
                      ...
                      class="text-primary-600 hover:text-primary-500"
                    >
                      {{ t("admin.settings.tencentCaptcha.openWebDocs") placeholderplaceholder
                    </a>
                  </div>
                </div>
                  ...
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.aliyunCaptcha.region") placeholderplaceholder
                      </label>
                      <div
                      ...
                      >
                        ...
                        >
                          {{ t("admin.settings.aliyunCaptcha.regionCn") placeholderplaceholder
                        </button>
                        <button
                          type="button"
                          class="inline-flex items-center justify-center rounded-md px-3 py-1.5 text-sm font-medium transition"
                        ...
                        >
                          {{ t("admin.settings.aliyunCaptcha.regionSgp") placeholderplaceholder
                        </button>
                      </div>
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.aliyunCaptcha.regionHint") placeholderplaceholder
                      </p>
                    </div>
                    <div>
                      <label
                        class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >
                        {{ t("admin.settings.aliyunCaptcha.prefix") placeholderplaceholder
                      </label>
                      <input
                      ...
                      />
                      <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.aliyunCaptcha.prefixHint") placeholderplaceholder
                      </p>
                    </div>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.sceneId") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.aliyunCaptcha.sceneIdHint") placeholderplaceholder
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.accessKeyId") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.aliyunCaptcha.accessKeyIdHint") placeholderplaceholder
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.aliyunCaptcha.accessKeySecret") placeholderplaceholder
                    </label>
                    <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.linuxdo.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.linuxdo.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.linuxdo.enableHint") placeholderplaceholder
                  </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.linuxdo.clientId") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.linuxdo.clientIdHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.linuxdo.clientSecret") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.linuxdo.redirectUrl") placeholderplaceholder
                    </label>
                    <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ localText("邮箱快捷登录", "Email OAuth Sign-in") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{
                  localText(
              ...
              <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-700">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ localText("后端回调地址", "Backend Callback URL") placeholderplaceholder
                      </label>
                      <input
                      ...
                      <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        >
                          {{ localText("生成并复制", "Generate and copy") placeholderplaceholder
                        </button>
                        <code
                          v-if="githubOAuthRedirectUrlSuggestion"
                          class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                        >
                          {{ githubOAuthRedirectUrlSuggestion placeholderplaceholder
                        </code>
                      </div>
                    </div>
                    ...
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ localText("前端回跳地址", "Frontend Callback URL") placeholderplaceholder
                      </label>
                      <input
                    ...
                    <div>
                      ...
                      <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        <code
                          ...
                          class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                        >
                          {{ googleOAuthRedirectUrlSuggestion placeholderplaceholder
                        </code>
                      </div>
                    </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.wechatConnect.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.wechatConnect.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.wechatConnect.enabledHint") placeholderplaceholder
                  </p>
                </div>
                <Toggle
              ...
              >
                <div class="space-y-4">
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("PC 应用", "PC App") placeholderplaceholder
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("PC AppID", "PC App ID") placeholderplaceholder
                        </label>
                        <input
                      ...
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("PC AppSecret", "PC App Secret") placeholderplaceholder
                        </label>
                        <input
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("公众号", "Official Account") placeholderplaceholder
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("公众号 AppID", "Official Account App ID") placeholderplaceholder
                        </label>
                        <input
                  ...
                  >
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        <h3 class="font-medium text-gray-900 dark:text-white">
                          {{ localText("移动应用", "Mobile App") placeholderplaceholder
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          {{
                            localText(
                    ...
                    >
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("移动应用 AppID", "Mobile App ID") placeholderplaceholder
                        </label>
                        <input
                      ...
                      <div>
                        <label
                          class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                          {{ localText("移动应用 AppSecret", "Mobile App Secret") placeholderplaceholder
                        </label>
                        <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    ...
                    >
                      ...
                      >
                        {{ t("admin.settings.wechatConnect.generateAndCopy") placeholderplaceholder
                      </button>
                      <code
                        v-if="wechatRedirectUrlSuggestion"
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                      >
                        {{ wechatRedirectUrlSuggestion placeholderplaceholder
                      </code>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.wechatConnect.frontendRedirectUrlLabel") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.wechatConnect.frontendRedirectUrlHint") placeholderplaceholder
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.dingtalk.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.dingtalk.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.dingtalk.enableHint") placeholderplaceholder
                  </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.clientId") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.clientIdHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.clientSecret") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.dingtalk.redirectUrl") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.redirectUrlHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.dingtalk.corpPolicy.label") placeholderplaceholder
                    </label>
                    <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.dingtalk.corpPolicy.hint") placeholderplaceholder
                    </p>
                    <div class="space-y-2">
                      <label class="flex cursor-pointer items-center gap-3">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                          {{ t("admin.settings.dingtalk.corpPolicy.none") placeholderplaceholder
                        </span>
                      </label>
                      <label class="flex cursor-pointer items-center gap-3">
                        <input
                        ...
                        />
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                          {{ t("admin.settings.dingtalk.corpPolicy.internalOnly") placeholderplaceholder
                        </span>
                      </label>
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      placeholderplaceholder</label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ t("admin.settings.dingtalk.bypassRegistrationHint") placeholderplaceholder
                      </p>
                    </div>
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        placeholderplaceholder</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncDisplayNameHint") placeholderplaceholder
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncDisplayNameTarget") placeholderplaceholder
                        </label>
                        <input
                      ...
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncAttrDisplayName") placeholderplaceholder
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncDisplayNameTargetHint") placeholderplaceholder
                    </p>
                  </div>
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        placeholderplaceholder</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncCorpEmailHint") placeholderplaceholder
                        </p>
                        <p class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                          {{ t("admin.settings.dingtalk.syncCorpEmailPermissionHint") placeholderplaceholder
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_corp_email" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncCorpEmailTarget") placeholderplaceholder
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncCorpEmailTargetHint") placeholderplaceholder
                    </p>
                  </div>
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        placeholderplaceholder</label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.dingtalk.syncDeptHint") placeholderplaceholder
                        </p>
                        <p class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                          {{ t("admin.settings.dingtalk.syncDeptPermissionHint") placeholderplaceholder
                        </p>
                      </div>
                    ...
                    <div v-if="form.dingtalk_connect_sync_dept" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap min-w-[5rem]">
                          {{ t("admin.settings.dingtalk.syncDeptTarget") placeholderplaceholder
                        </label>
                        <input
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-gray-400 dark:text-gray-500">
                      {{ t("admin.settings.dingtalk.syncDeptTargetHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.oidc.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.oidc.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.oidc.enableHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.providerName") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clientId") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clientSecret") placeholderplaceholder
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.issuerUrl") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.discoveryUrl") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.authorizeUrl") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.tokenUrl") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoUrl") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.jwksUrl") placeholderplaceholder
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.scopes") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.scopesHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.redirectUrl") placeholderplaceholder
                    </label>
                    <input
                    ...
                    >
                      ...
                      >
                        {{ t("admin.settings.oidc.quickSetCopy") placeholderplaceholder
                      </button>
                      <code
                        v-if="oidcRedirectUrlSuggestion"
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300"
                      >
                        {{ oidcRedirectUrlSuggestion placeholderplaceholder
                      </code>
                    </div>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.redirectUrlHint") placeholderplaceholder
                    </p>
                  </div>
                  ...
                  <div class="lg:col-span-2">
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.frontendRedirectUrl") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.oidc.frontendRedirectUrlHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.tokenAuthMethod") placeholderplaceholder
                    </label>
                    <select
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.clockSkewSeconds") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.allowedSigningAlgs") placeholderplaceholder
                    </label>
                    <input
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.usePkce") placeholderplaceholder
                      </label>
                    </div>
                    <Toggle
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.validateIdToken") placeholderplaceholder
                      </label>
                    </div>
                    <Toggle
                  ...
                  >
                    <div>
                      <label class="font-medium text-gray-900 dark:text-white">
                        {{ t("admin.settings.oidc.requireEmailVerified") placeholderplaceholder
                      </label>
                    </div>
                    <Toggle
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoEmailPath") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoIdPath") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.oidc.userinfoUsernamePath") placeholderplaceholder
                    </label>
                    <input
        ...
        <div v-show="activeTab === 'users'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.defaults.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.defaults.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.defaults.defaultBalance") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultBalanceHint") placeholderplaceholder
                  </p>
                </div>
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.defaults.defaultConcurrency") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultConcurrencyHint") placeholderplaceholder
                  </p>
                </div>
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.defaults.defaultUserRpmLimit") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultUserRpmLimitHint") placeholderplaceholder
                  </p>
                </div>
              </div>
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="mb-3 flex items-center justify-between">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.defaults.defaultSubscriptions") placeholderplaceholder
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{
                  ...
                  >
                    {{ t("admin.settings.defaults.addDefaultSubscription") placeholderplaceholder
                  </button>
                </div>
                ...
                >
                  {{ t("admin.settings.defaults.defaultSubscriptionsEmpty") placeholderplaceholder
                </div>

                <div v-else class="space-y-3">
                  <div
                    v-for="(item, index) in form.default_subscriptions"
                    :key="`default-sub-${indexplaceholder`"
                  ...
                  >
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                      >
                        {{ t("admin.settings.defaults.subscriptionGroup") placeholderplaceholder
                      </label>
                      <Select
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="mb-3">
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.defaults.defaultPlatformQuotas") placeholderplaceholder
                  </label>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.defaults.defaultPlatformQuotasHint") placeholderplaceholder
                  </p>
                  <p class="mt-0.5 text-xs text-amber-600 dark:text-amber-400">
                    {{ t("admin.settings.defaults.platformQuotaNotice") placeholderplaceholder
                  </p>
                </div>
                  ...
                  <table class="min-w-full text-sm">
                    <thead>
                      <tr class="text-left text-xs text-gray-500 dark:text-gray-400">
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.platform") placeholderplaceholder</th>
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.daily") placeholderplaceholder</th>
                        <th class="pb-2 pr-4 font-medium">{{ t("admin.settings.platformQuota.weekly") placeholderplaceholder</th>
                        <th class="pb-2 font-medium">{{ t("admin.settings.platformQuota.monthly") placeholderplaceholder</th>
                      </tr>
                    </thead>
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                          <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p placeholderplaceholder</span>
                        </td>
                        <td class="pr-4 py-1">
                          <input
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.authSourceDefaults.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.authSourceDefaults.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-6 p-6">
              <div
              ...
              >
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.authSourceDefaults.requireEmailLabel") placeholderplaceholder
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.authSourceDefaults.requireEmailHint") placeholderplaceholder
                  </p>
                </div>
                  ...
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      <div class="font-medium text-gray-900 dark:text-white">
                        {{ authSource.title placeholderplaceholder
                      </div>
                      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ authSource.description placeholderplaceholder
                      </p>
                    </div>
                    <Toggle
                      v-model="
                      ...
                      "
                      :data-testid="`auth-source-${authSource.sourceplaceholder-enabled`"
                    />
                  </div>

                  <div
                    v-if="authSourceDefaults[authSource.source].grant_on_signup"
                    :data-testid="`auth-source-${authSource.sourceplaceholder-panel`"
                    class="mt-4 space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700"
                  >
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.authSourceDefaults.enabledHint") placeholderplaceholder
                    </p>
                    ...
                    >
                      <div>
                        <label
                          class="font-medium text-gray-900 dark:text-white"
                        >
                          {{ t("admin.settings.authSourceDefaults.grantOnFirstBindLabel") placeholderplaceholder
                        </label>
                        <p
                          class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                        >
                          {{ t("admin.settings.authSourceDefaults.grantOnFirstBindHint") placeholderplaceholder
                        </p>
                      </div>
                      <Toggle
                        v-model="
                    ...
                    <div class="mb-3 flex items-center justify-between">
                      <div>
                        <label
                          class="font-medium text-gray-900 dark:text-white"
                        >
                          {{ t("admin.settings.authSourceDefaults.defaultSubscriptionsLabel") placeholderplaceholder
                        </label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.authSourceDefaults.defaultSubscriptionsHint") placeholderplaceholder
                        </p>
                      </div>
                      <button
                        type="button"
                    ...
                    <div
                      ...
                      class="rounded border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-500 dark:border-dark-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.authSourceDefaults.noSourceSubscriptions") placeholderplaceholder
                    </div>
                    ...
                    <div v-else class="space-y-3">
                      <div
                        ...
                        :key="`${authSource.sourceplaceholder-sub-${indexplaceholder`"
                        class="grid grid-cols-1 gap-3 rounded border border-gray-200 p-3 md:grid-cols-[1fr_160px_auto] dark:border-dark-600"
                      >
                        <div>
                          <label
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      <div class="mb-3">
                        <label class="font-medium text-gray-900 dark:text-white">
                          {{ t("admin.settings.authSourceDefaults.platformQuotasOverride") placeholderplaceholder
                        </label>
                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.authSourceDefaults.platformQuotasOverrideHint") placeholderplaceholder
                        </p>
                      </div>
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="`${authSource.sourceplaceholder-pq-${pplaceholder`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p placeholderplaceholder</span>
                              </td>
                              <td class="pr-4 py-1">
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.claudeCode.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.claudeCode.description") placeholderplaceholder
              </p>
            </div>
            <div class="p-6">
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.claudeCode.minVersion") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.claudeCode.minVersionHint") placeholderplaceholder
                </p>
              </div>
              <div class="mt-4">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.claudeCode.maxVersion") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.claudeCode.maxVersionHint") placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.gatewayForwarding.codexHardeningTitle") placeholderplaceholder
              </h2>
            </div>
            <div class="p-6 space-y-4">
                <div>
                  <h3 class="text-base font-semibold text-gray-900 dark:text-white">
                    {{ t("admin.settings.gatewayForwarding.codexClientRestrictionTitle") placeholderplaceholder
                  </h3>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexHardeningDesc") placeholderplaceholder
                  </p>
                </div>
                <div class="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.gatewayForwarding.minCodexVersion") placeholderplaceholder
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.gatewayForwarding.maxCodexVersion") placeholderplaceholder
                    </label>
                    <input
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.gatewayForwarding.codexVersionHint") placeholderplaceholder
                </p>

                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignals") placeholderplaceholder
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintSignalsDesc") placeholderplaceholder
                  </p>
                  <div
                    v-for="(row, i) in codexFingerprintRows"
                    :key="`codex-fp-${iplaceholder`"
                    class="mb-2 flex items-center gap-2"
                  >
                    <select v-model="row.type" class="input w-32 text-sm">
                      <option value="header_exact">{{ t("admin.settings.gatewayForwarding.codexFpTypeHeaderExact") placeholderplaceholder</option>
                      <option value="header_prefix">{{ t("admin.settings.gatewayForwarding.codexFpTypeHeaderPrefix") placeholderplaceholder</option>
                      <option value="body_path">{{ t("admin.settings.gatewayForwarding.codexFpTypeBodyPath") placeholderplaceholder</option>
                    </select>
                    <input
                      v-model="row.match"
                      type="text"
                    ...
                    <label class="flex shrink-0 items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
                      ...
                      {{ t("admin.settings.gatewayForwarding.codexFpRequired") placeholderplaceholder
                    </label>
                    <button
                      type="button"
                    ...
                    >
                      {{ t("admin.settings.gatewayForwarding.codexRemoveRow") placeholderplaceholder
                    </button>
                  </div>
                  <button type="button" class="btn btn-secondary btn-sm" @click="addCodexFingerprintRow">
                    {{ t("admin.settings.gatewayForwarding.codexAddRow") placeholderplaceholder
                  </button>
                  <p
                    v-if="codexFingerprintNoRequired"
                    class="mt-2 text-xs text-amber-600 dark:text-amber-500"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexFingerprintNoRequiredWarn") placeholderplaceholder
                  </p>
                </div>
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexBlacklist") placeholderplaceholder
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexBlacklistDesc") placeholderplaceholder
                  </p>
                  <div
                    v-for="(row, i) in codexBlacklistRows"
                    :key="`codex-bl-${iplaceholder`"
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.codexWhitelist") placeholderplaceholder
                  </label>
                  <p class="mb-2 mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.codexWhitelistDesc") placeholderplaceholder
                  </p>
                  <div
                    v-for="(row, i) in codexWhitelistRows"
                    :key="`codex-wl-${iplaceholder`"
                    class="mb-2 flex gap-2"
                  >
                    <input
                      v-model="row.originator"
          ...
          <div class="card" data-testid="upstream-billing-probe-settings">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.upstreamBillingProbe.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.upstreamBillingProbe.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div
              ...
              <template v-else>
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.upstreamBillingProbe.enabled") placeholderplaceholder
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.upstreamBillingProbe.enabledHint") placeholderplaceholder
                    </p>
                  </div>
                  <Toggle
                ...
                >
                  ...
                  >
                    {{ t("admin.settings.upstreamBillingProbe.intervalMinutes") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.upstreamBillingProbe.intervalHint") placeholderplaceholder
                  </p>
                </div>
          ...
          <div class="card" data-testid="ollama-cloud-usage-global-settings">
            <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.ollamaCloudUsage.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.ollamaCloudUsage.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.ollamaCloudUsage.enabled") placeholderplaceholder
                    </label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.enabledHint") placeholderplaceholder
                    </p>
                  </div>
                  <Toggle
                ...
                <div v-if="ollamaCloudUsageForm.enabled" class="space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300" for="ollama-cloud-usage-debounce">
                      {{ t("admin.settings.ollamaCloudUsage.debounceMinutes") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.debounceHint") placeholderplaceholder
                    </p>
                  </div>
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300" for="ollama-cloud-usage-interval">
                      {{ t("admin.settings.ollamaCloudUsage.intervalMinutes") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.ollamaCloudUsage.intervalHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
                <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-dark-700">
                  ...
                  >
                    {{ ollamaCloudUsageSaving ? t("common.saving") : t("common.save") placeholderplaceholder
                  </button>
                </div>
              </template>
            </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.scheduling.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.scheduling.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.scheduling.allowUngroupedKey") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.scheduling.allowUngroupedKeyHint") placeholderplaceholder
                  </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  >
                    ...
                    <input
                      ...
                      step="1"
                      class="input mt-3"
                      :data-testid="`account-scheduling-threshold-${platformplaceholder`"
                      placeholder="100"
                    />
                  </div>
                </div>
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.lowRatePriorityTitle") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div class="min-w-0">
                  ...
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRateTitle") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRatePriorityDescription") placeholderplaceholder
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between border-t border-gray-100 pt-5 dark:border-dark-700">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.title") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.stickyWeightedTitle") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.subscriptionPriorityTitle") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
              ...
              >
                <div class="min-w-0">
                  ...
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.openaiExperimentalScheduler.oauthRateWeightedDescription") placeholderplaceholder
                  </p>
                </div>
                <div class="relative w-full shrink-0 sm:w-32">
                  <input
              ...
              >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.openaiExperimentalScheduler.weightsTitle") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.gatewayForwarding.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.gatewayForwarding.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <div class="grid gap-5 border-b border-gray-100 pb-5 dark:border-dark-700 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
                <div>
                  <label
                    ...
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.grokDefaultTextModel") placeholderplaceholder
                  </label>
                  <input
                  ...
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.grokDefaultTextModelHint") placeholderplaceholder
                  </p>
                </div>
                <div class="flex items-center justify-between gap-5 md:min-w-72">
                  <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t("admin.settings.gatewayForwarding.grokCrossClientMap") placeholderplaceholder
                    </label>
                    <p class="mt-0.5 max-w-sm text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.gatewayForwarding.grokCrossClientMapHint") placeholderplaceholder
                    </p>
                  </div>
                  <Toggle
                ...
                <div class="md:col-span-2">
                  <label
                    ...
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.grokDefaultBaseURLMode") placeholderplaceholder
                  </label>
                  <select
                  ...
                  >
                    <option value="cli">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeCLI") placeholderplaceholder</option>
                    <option value="api">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeAPI") placeholderplaceholder</option>
                    <option value="us-east-1">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeUSEast1") placeholderplaceholder</option>
                    <option value="us-west-2">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeUSWest2") placeholderplaceholder</option>
                    <option value="eu-west-1">{{ t("admin.settings.gatewayForwarding.grokBaseURLModeEUWest1") placeholderplaceholder</option>
                  </select>
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.grokDefaultBaseURLModeHint") placeholderplaceholder
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.gatewayForwarding.cchSigning") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.gatewayForwarding.cchSigningHint") placeholderplaceholder
                  </p>
                </div>
              ...
              <div>
                    ...
                    >
                      <div class="min-w-0">
                        ...
                        <div
                          class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                        >
                          {{ getClaudeOAuthPresetLabel(block.preset) placeholderplaceholder
                        </div>
                      </div>
                      <div class="flex items-center gap-2">
                        <button
                    ...
                    <div v-show="block.expanded">
                      ...
                      <div class="mt-3">
                        <label
                          class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-300"
                        >
                          {{ t("admin.settings.gatewayForwarding.systemBlockText") placeholderplaceholder
                        </label>
                        <textarea
                          v-model="block.text"
                          rows="6"
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  ...
                  >
                    ...
                    {{ t("admin.settings.gatewayForwarding.addSystemBlock") placeholderplaceholder
                  </button>
                  <button
                    type="button"
                    class="btn btn-secondary btn-sm"
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p
                    ...
                    class="mt-0.5 text-xs text-gray-500 dark:text-gray-400"
                  >
                    {{ codexSyncedVersionLabel placeholderplaceholder
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.webSearchEmulation.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.webSearchEmulation.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-5 p-6">
              <!-- Global Toggle -->
              <div class="flex items-center justify-between">
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.webSearchEmulation.enabled") placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.webSearchEmulation.enabledHint") placeholderplaceholder
                  </p>
                </div>
              ...
              <div v-if="webSearchConfig.enabled" class="space-y-4">
                <div class="flex items-center justify-between">
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.webSearchEmulation.providers") placeholderplaceholder
                  </label>
                  <button
                    type="button"
                    class="btn btn-secondary btn-sm"
                  ...
                  >
                    {{ t("admin.settings.webSearchEmulation.addProvider") placeholderplaceholder
                  </button>
                </div>
                ...
                >
                  {{ t("admin.settings.webSearchEmulation.noProviders") placeholderplaceholder
                </div>
                ...
                >
                  ...
                  >
                    <div class="flex items-center gap-3">
                      <svg
                        ...
                        :class="{ 'rotate-90': expandedProviders[pIdx] placeholder"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                      ...
                      <Select
                        ...
                        :options="[
                          { value: 'brave', label: 'Brave Search' placeholder,
                          { value: 'tavily', label: 'Tavily' placeholder,
                        ]"
                        class="w-36"
                        @click.stop
                      />
                      ...
                      <span class="text-xs text-gray-400">
                        {{ provider.quota_used ?? 0 placeholderplaceholder /
                        {{
                  ...
                  >
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      >
                        {{ t("admin.settings.webSearchEmulation.resetUsage") placeholderplaceholder
                      </button>
                    </div>
                    ...
                    <div class="flex items-end gap-3">
                      ...
                      >
                        {{ t("admin.settings.webSearchEmulation.test") placeholderplaceholder
                      </button>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              >
                {{ t("admin.settings.webSearchEmulation.testResultTitle") placeholderplaceholder
              </h3>
              <div class="flex items-center gap-2">
                <input
                  v-model="wsTestQuery"
              ...
              >
                ...
                >
                  ...
                  placeholderplaceholder: {{ wsTestResult.provider placeholderplaceholder
                </p>
                <div
                  v-if="wsTestResult.results.length === 0"
                  class="text-sm text-gray-400"
                >
                  {{ t("admin.settings.webSearchEmulation.testNoResults") placeholderplaceholder
                </div>
                <div
                ...
                >
                  <a
                    ...
                    >{{ r.title placeholderplaceholder</a
                  >
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ r.snippet placeholderplaceholder
                  </p>
                </div>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.usageRecords.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.usageRecords.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-4 p-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.user_error_view.label') placeholderplaceholder
                </label>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.user_error_view.description') placeholderplaceholder
                </p>
              </div>
              <label class="toggle">
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.site.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.site.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-6 p-6">
              <!-- Backend Mode -->
              ...
              >
                <div>
                  <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.site.backendMode") placeholderplaceholder
                  </h3>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.backendModeDescription") placeholderplaceholder
                  </p>
	                </div>
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.site.siteName") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.siteNameHint") placeholderplaceholder
                  </p>
                </div>
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.site.siteSubtitle") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.siteSubtitleHint") placeholderplaceholder
                  </p>
                </div>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.apiBaseUrl") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.apiBaseUrlHint") placeholderplaceholder
                </p>
              </div>
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                  {{ t("admin.settings.site.tablePreferencesTitle") placeholderplaceholder
                </h3>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.tablePreferencesDescription") placeholderplaceholder
                </p>
                <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.site.tableDefaultPageSize") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.site.tableDefaultPageSizeHint") placeholderplaceholder
                    </p>
                  </div>
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                      {{ t("admin.settings.site.tablePageSizeOptions") placeholderplaceholder
                    </label>
                    <input
                    ...
                    />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.site.tablePageSizeOptionsHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.customEndpoints.title") placeholderplaceholder
                </label>
                <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.customEndpoints.description") placeholderplaceholder
                </p>
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                      <div>
                        <label
                          class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                        >
                          {{ t("admin.settings.site.customEndpoints.name") placeholderplaceholder
                        </label>
                        <input
                          v-model="ep.name"
                          type="text"
                ...
                >
                  ...
                  {{ t("admin.settings.site.customEndpoints.add") placeholderplaceholder
                </button>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.contactInfo") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.contactInfoHint") placeholderplaceholder
                </p>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.docUrl") placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.docUrlHint") placeholderplaceholder
                </p>
              </div>
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.siteLogo") placeholderplaceholder
                </label>
                <ImageUpload
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.homeContent") placeholderplaceholder
                </label>
                <textarea
                ...
                ></textarea>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.homeContentHint") placeholderplaceholder
                </p>
                <!-- iframe CSP Warning -->
                <p class="mt-2 text-xs text-amber-600 dark:text-amber-400">
                  {{ t("admin.settings.site.homeContentIframeWarning") placeholderplaceholder
                </p>
              </div>
              ...
              <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.compactHomeHint") placeholderplaceholder
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.hideCcsImportButtonHint") placeholderplaceholder
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.customMenu.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.customMenu.description") placeholderplaceholder
              </p>
            </div>
            <div class="space-y-4 p-6">
              <!-- Existing menu items -->
              ...
              >
                <div class="mb-3 flex items-center justify-between">
                  ...
                  >
                    {{
                      t("admin.settings.customMenu.itemLabel", { n: index + 1 placeholder)
                    placeholderplaceholder
                  </span>
                  <div class="flex items-center gap-2">
                    <!-- Move up -->
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.name") placeholderplaceholder
                    </label>
                    <input
                      v-model="item.label"
                      type="text"
                  ...
                  <div>
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.visibility") placeholderplaceholder
                    </label>
                    <select v-model="item.visibility" class="input text-sm">
                      <option value="user">
                        {{ t("admin.settings.customMenu.visibilityUser") placeholderplaceholder
                      </option>
                      <option value="admin">
                        {{ t("admin.settings.customMenu.visibilityAdmin") placeholderplaceholder
                      </option>
                    </select>
                  </div>
                  ...
                  <div class="sm:col-span-2">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.url") placeholderplaceholder
                    </label>
                    <input
                      v-model="item.url"
                      type="url"
                  ...
                  <div class="sm:col-span-2">
                    <label
                      class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400"
                    >
                      {{ t("admin.settings.customMenu.iconSvg") placeholderplaceholder
                    </label>
                    <ImageUpload
              ...
              >
                ...
                {{ t("admin.settings.customMenu.add") placeholderplaceholder
              </button>
            </div>
          </div>
	        </div>
	        ...
	        <div v-show="activeTab === 'agreement'" class="space-y-6">
	          <div class="card">
	            <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
	              <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
	                <div>
	                  <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
	                    {{ localText("登录条款确认", "Login agreement") placeholderplaceholder
	                  </h2>
	                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
	                    {{
	                      localText(
	                ...
	                <div class="flex items-center gap-3">
	                  <span class="text-sm text-gray-600 dark:text-gray-300">
	                    {{ form.login_agreement_enabled ? localText("已启用", "Enabled") : localText("未启用", "Disabled") placeholderplaceholder
	                  </span>
	            ...
	            <div class="space-y-6 p-6">
	              <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_220px]">
	                <div>
	                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
	                    {{ localText("展示形式", "Display mode") placeholderplaceholder
	                  </label>
	                  <div class="grid grid-cols-2 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      {{ localText("弹窗", "Modal") placeholderplaceholder
                    </button>
                    <button
                      type="button"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                    ...
                    >
                      ...
                      {{ localText("复选框", "Checkbox") placeholderplaceholder
                    </button>
                  </div>
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                ...
                <div>
                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ localText("条款更新日期", "Updated date") placeholderplaceholder
                  </label>
                  <input
                  ...
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ localText("日期或文档内容变化后，用户需要重新同意。", "Changing the date or content requires fresh consent.") placeholderplaceholder
                  </p>
                </div>
              </div>
              ...
              <div>
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ localText("协议文档", "Agreement documents") placeholderplaceholder
                    </h3>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      {{
                        localText(
                  ...
                  >
                    ...
                    {{ localText("添加文档", "Add document") placeholderplaceholder
                  </button>
                </div>
                ...
                <div class="mt-4 space-y-3">
                  ...
                  >
                      ...
                      <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div class="min-w-0">
                          <p class="truncate text-sm font-semibold text-gray-900 dark:text-white">
                            {{ doc.title || localText("未命名文档", "Untitled document") placeholderplaceholder
                          </p>
                          <p class="truncate text-xs text-gray-500 dark:text-gray-400">
                            {{ loginAgreementRoutePath(doc, index) placeholderplaceholder
                          </p>
                        </div>
                      </div>
                      <button
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      <div>
                        <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                          {{ localText("文档名称", "Document title") placeholderplaceholder
                        </label>
                        <input
                          v-model="doc.title"
                          type="text"
                      ...
                      <div>
                        <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                          {{ localText("路由标识", "Route slug") placeholderplaceholder
                        </label>
                    ...
                    <div class="mt-3">
                      <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">
                        {{ localText("Markdown 内容", "Markdown content") placeholderplaceholder
                      </label>
                        <textarea
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.channelMonitor.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.channelMonitor.description') placeholderplaceholder
            </p>
            <p class="mt-1.5 text-xs">
              ...
              >
                {{ t('admin.settings.features.channelMonitor.configureLink') placeholderplaceholder
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.channelMonitor.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.channelMonitor.enabledHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div v-if="form.channel_monitor_enabled" class="space-y-5">
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.channelMonitor.mode') placeholderplaceholder
                </label>
                <div class="mt-1.5 inline-flex w-full max-w-md rounded-lg border border-gray-200 bg-gray-50 p-1 dark:border-dark-600 dark:bg-dark-900/40">
                  ...
                  >
                    {{ t('admin.settings.features.channelMonitor.modeV2') placeholderplaceholder
                  </button>
                  <button
                    type="button"
                    class="inline-flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                  ...
                  >
                    {{ t('admin.settings.features.channelMonitor.modeV1') placeholderplaceholder
                  </button>
                </div>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{
                ...
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                  {{ t('admin.settings.features.channelMonitor.modeHint') placeholderplaceholder
                </p>
              </div>

              <div v-if="form.channel_monitor_mode === 'v1'">
                <label class="input-label">
                  {{ t('admin.settings.features.channelMonitor.defaultInterval') placeholderplaceholder
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.channelMonitor.defaultIntervalHint') placeholderplaceholder
                </p>
              </div>
              ...
              <div v-if="form.channel_monitor_mode === 'v2'" class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                  <p class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t('admin.settings.features.channelMonitor.hideThroughput') placeholderplaceholder
                  </p>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.channelMonitor.hideThroughputHint') placeholderplaceholder
                  </p>
                </div>
              ...
              <div v-if="form.channel_monitor_mode === 'v1'" class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                  <p class="text-sm font-medium text-gray-900 dark:text-white">
                    {{ t('admin.settings.features.channelMonitor.showQuota') placeholderplaceholder
                  </p>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.channelMonitor.showQuotaHint') placeholderplaceholder
                  </p>
                </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.availableChannels.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.availableChannels.description') placeholderplaceholder
            </p>
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.availableChannels.configureLink') placeholderplaceholder
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.availableChannels.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.availableChannels.enabledHint') placeholderplaceholder
                </p>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.modelPlaza.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.modelPlaza.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.modelPlaza.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.modelPlaza.enabledHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div v-if="form.model_plaza_enabled" class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.modelPlaza.requireAuth') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.modelPlaza.requireAuthHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div v-if="form.model_plaza_enabled">
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.features.modelPlaza.priceDescription') placeholderplaceholder
              </label>
              <p class="mb-2 mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.features.modelPlaza.priceDescriptionHint') placeholderplaceholder
              </p>
              <textarea
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.pluginManagement.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.pluginManagement.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between gap-4">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.pluginManagement.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.pluginManagement.enabledHint') placeholderplaceholder
                </p>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.riskControl.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.riskControl.description') placeholderplaceholder
            </p>
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.riskControl.configureLink') placeholderplaceholder
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.riskControl.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.riskControl.enabledHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.riskControl.cyberSessionBlock') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.riskControl.cyberSessionBlockHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div v-if="form.cyber_session_block_enabled">
              <label class="input-label">
                {{ t('admin.settings.features.riskControl.cyberSessionBlockTTL') placeholderplaceholder
                <span class="text-red-500">*</span>
              </label>
              <input
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.affiliate.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.affiliate.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.features.affiliate.enabled') placeholderplaceholder
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.features.affiliate.enabledHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              <div class="flex items-center justify-between">
                <div>
                  <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ t('admin.settings.features.affiliate.adminRechargeRebate') placeholderplaceholder
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.features.affiliate.adminRechargeRebateHint') placeholderplaceholder
                  </p>
                </div>
              ...
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.rebateRate') placeholderplaceholder
                </label>
                <div class="relative">
                  <input
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.rebateRateHint') placeholderplaceholder
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.freezeHours') placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.freezeHoursDesc') placeholderplaceholder
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.durationDays') placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.durationDaysDesc') placeholderplaceholder
                </p>
              </div>

              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.perInviteeCap') placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.perInviteeCapDesc') placeholderplaceholder
                </p>
              </div>
              ...
              <div class="border-t border-gray-100 pt-6 dark:border-dark-700">
                <div class="mb-3 flex items-center justify-between">
                  <div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                      {{ t('admin.settings.features.affiliate.customUsers.title') placeholderplaceholder
                    </h3>
                    <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.features.affiliate.customUsers.description') placeholderplaceholder
                    </p>
                  </div>
                  <button
                    type="button"
                  ...
                  >
                    + {{ t('admin.settings.features.affiliate.customUsers.addButton') placeholderplaceholder
                  </button>
                </div>
                ...
                <div class="mb-3 flex items-center gap-2">
                  ...
                  >
                    {{ t('admin.settings.features.affiliate.customUsers.batchButton', { count: affiliateState.selected.length placeholder) placeholderplaceholder
                  </button>
                </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
                    <thead class="bg-gray-50 dark:bg-dark-800">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.email') placeholderplaceholder</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.username') placeholderplaceholder</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.code') placeholderplaceholder</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.rate') placeholderplaceholder</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-gray-500">{{ t('admin.settings.features.affiliate.customUsers.col.actions') placeholderplaceholder</th>
                      </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
                      ...
                      <tr v-else-if="affiliateState.entries.length === 0">
                        <td colspan="6" class="px-3 py-6 text-center text-sm text-gray-500">
                          {{ t('admin.settings.features.affiliate.customUsers.empty') placeholderplaceholder
                        </td>
                      </tr>
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-gray-900 dark:text-white">{{ entry.email placeholderplaceholder</td>
                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-gray-300">{{ entry.username placeholderplaceholder</td>
                        <td class="px-3 py-2 text-sm font-mono">
                          {{ entry.aff_code placeholderplaceholder
                          <span
                          ...
                          >{{ t('admin.settings.features.affiliate.customUsers.customBadge') placeholderplaceholder</span>
                        </td>
                        <td class="px-3 py-2 text-sm">
                          <span v-if="entry.aff_rebate_rate_percent != null">{{ entry.aff_rebate_rate_percent placeholderplaceholder%</span>
                          <span v-else class="text-gray-400">{{ t('admin.settings.features.affiliate.customUsers.useGlobal') placeholderplaceholder</span>
                        </td>
                        <td class="px-3 py-2 text-sm">
                          <div class="flex items-center gap-2">
                ...
                <div v-if="affiliateState.total > affiliateState.pageSize" class="mt-3 flex items-center justify-between text-sm">
                  <span class="text-gray-500">
                    {{ t('admin.settings.features.affiliate.customUsers.totalLabel', { total: affiliateState.total placeholder) placeholderplaceholder
                  </span>
                  <div class="flex items-center gap-2">
                    <button
                      type="button"
                    ...
                    <span class="text-gray-500">{{ affiliateState.page placeholderplaceholder / {{ Math.max(1, Math.ceil(affiliateState.total / affiliateState.pageSize)) placeholderplaceholder</span>
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm"
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            <h3 class="mb-4 text-lg font-semibold">
              {{ affiliateModal.mode === 'add' ? t('admin.settings.features.affiliate.modal.addTitle') : t('admin.settings.features.affiliate.modal.editTitle') placeholderplaceholder
            </h3>
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.userLabel') placeholderplaceholder</label>
                ...
                >
                  <div class="text-sm">
                    <span class="font-medium text-gray-900 dark:text-white">{{ affiliateModal.selectedUser.email placeholderplaceholder</span>
                    <span class="ml-1 text-xs text-gray-500">({{ affiliateModal.selectedUser.username placeholderplaceholder)</span>
                  </div>
                  <button
                    type="button"
                ...
                <template v-else>
                  ...
                  >
                    ...
                    >
                      {{ u.email placeholderplaceholder <span class="text-xs text-gray-500">({{ u.username placeholderplaceholder)</span>
                    </button>
                  </div>
                </template>
              </div>
              ...
              <div>
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.codeLabel') placeholderplaceholder</label>
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.modal.codeHint') placeholderplaceholder
                </p>
              </div>

              <div>
                <label class="input-label">{{ t('admin.settings.features.affiliate.modal.rateLabel') placeholderplaceholder</label>
                <div class="relative">
                  <input
                ...
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.modal.rateHint') placeholderplaceholder
                </p>
              </div>
            </div>
            ...
            <div class="mt-6 flex items-center justify-between gap-3">
              ...
              >
                {{ t('admin.settings.features.affiliate.modal.errorEmpty') placeholderplaceholder
              </p>
              <span v-else></span>
              <div class="flex gap-2">
                ...
                >
                  {{ affiliateModal.saving ? t('common.saving') : t('common.save') placeholderplaceholder
                </button>
              </div>
            </div>
          </div>
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            <h3 class="mb-4 text-lg font-semibold">
              {{ t('admin.settings.features.affiliate.batchModal.title', { count: affiliateState.selected.length placeholder) placeholderplaceholder
            </h3>
            <p class="mb-4 text-sm text-gray-500">
              {{ t('admin.settings.features.affiliate.batchModal.hint') placeholderplaceholder
            </p>
            <div class="relative">
              <input
            ...
            <p class="mt-2 text-xs text-gray-400">
              {{ t('admin.settings.features.affiliate.batchModal.clearHint') placeholderplaceholder
            </p>
            <div class="mt-6 flex justify-end gap-2">
              ...
              >
                {{ affiliateBatchModal.saving ? t('common.saving') : t('common.save') placeholderplaceholder
              </button>
            </div>
          </div>
        </div>
        ...
        <div v-show="activeTab === 'payment'" class="space-y-6">
          ...
          <div class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.payment.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.payment.description") placeholderplaceholder
                <a
                ...
                >
                  ...
                  {{ t("admin.settings.payment.configGuide") placeholderplaceholder
                </a>
              </p>
            </div>
            <div class="space-y-4 p-6">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.payment.enabledHint") placeholderplaceholder
                  </p>
                </div>
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-5">
                  ...
                  <div>
                    ...
                    <p class="mt-0.5 text-xs text-gray-400">
                      {{ t("admin.settings.payment.rechargeFeeRateHint") placeholderplaceholder
                    </p>
                    <p
                  ...
                  <div>
                    <label class="input-label"
                      >{{ t("admin.settings.payment.orderTimeout") placeholderplaceholder
                    ...
                    />
                    <p class="mt-0.5 text-xs text-gray-400">
                      {{ t("admin.settings.payment.orderTimeoutHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="mt-1.5 flex flex-wrap gap-2">
                    ...
                    >
                      {{ pt.label placeholderplaceholder
                    </button>
                  </div>
                  <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                    {{ t("admin.settings.payment.enabledPaymentTypesHint") placeholderplaceholder
                    <a
                    ...
                    >
                      {{ t("admin.settings.payment.findProvider") placeholderplaceholder
                      <svg
        ...
        <div v-show="activeTab === 'email'" class="space-y-6">
          ...
          <div v-if="!form.email_verify_enabled" class="card">
            <div class="p-6">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.emailTabDisabledTitle") placeholderplaceholder
                  </h3>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.emailTabDisabledHint") placeholderplaceholder
                  </p>
                </div>
              </div>
            </div>
          ...
          <div v-if="form.email_verify_enabled" class="card">
            ...
            >
              <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  {{ t("admin.settings.smtp.title") placeholderplaceholder
                </h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.smtp.description") placeholderplaceholder
                </p>
              </div>
              <button
                type="button"
            ...
            <div class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.host") placeholderplaceholder
                  </label>
                  <input
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.port") placeholderplaceholder
                  </label>
                  <input
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.username") placeholderplaceholder
                  </label>
                  <input
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.password") placeholderplaceholder
                  </label>
                  <input
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.fromEmail") placeholderplaceholder
                  </label>
                  <input
                ...
                <div>
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.smtp.fromName") placeholderplaceholder
                  </label>
                  <input
              ...
              >
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.smtp.useTlsHint") placeholderplaceholder
                  </p>
                </div>
          ...
          <div v-if="form.email_verify_enabled" class="card">
            ...
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.testEmail.title") placeholderplaceholder
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.testEmail.description") placeholderplaceholder
              </p>
            </div>
            <div class="p-6">
              <div class="flex items-end gap-4">
                <div class="flex-1">
                  <label
                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t("admin.settings.testEmail.recipientEmail") placeholderplaceholder
                  </label>
                  <input
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.subscriptionExpiryNotify.title") placeholderplaceholder
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.subscriptionExpiryNotify.description") placeholderplaceholder
              </p>
            </div>
            <div class="px-6 py-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  ...
                  >
                    {{ t("admin.settings.subscriptionExpiryNotify.enabled") placeholderplaceholder
                  </label>
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.subscriptionExpiryNotify.enabledHint") placeholderplaceholder
                  </p>
                </div>
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.balanceNotify.title") placeholderplaceholder
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.balanceNotify.description") placeholderplaceholder
              </p>
            </div>
            <div class="px-6 py-6 space-y-4">
              <div class="flex items-center justify-between">
                <label
                  class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.enabled") placeholderplaceholder</label
                >
              ...
              <div v-if="form.balance_low_notify_enabled">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.threshold") placeholderplaceholder</label
                >
                <div class="relative">
                  <span
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.balanceNotify.thresholdHint") placeholderplaceholder
                </p>
              </div>
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.balanceNotify.rechargeUrl") placeholderplaceholder</label
                >
                <input
                ...
                />
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.balanceNotify.rechargeUrlHint") placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-white">
                {{ t("admin.settings.quotaNotify.title") placeholderplaceholder
              </h3>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.quotaNotify.description") placeholderplaceholder
              </p>
            </div>
            <div class="px-6 py-6 space-y-4">
              <div class="flex items-center justify-between">
                <label
                  class="mb-0 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.quotaNotify.enabled") placeholderplaceholder</label
                >
              ...
              <div v-if="form.account_quota_notify_enabled">
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                  >{{ t("admin.settings.quotaNotify.emails") placeholderplaceholder</label
                >
                <div class="space-y-2">
                  <div
                  ...
                  <button
                    ...
                    type="button"
                  >
                    + {{ t("admin.settings.quotaNotify.addEmail") placeholderplaceholder
                  </button>
                </div>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.quotaNotify.emailsHint") placeholderplaceholder
                </p>
              </div>
            </div>
          </div>
...
import { affiliatesAPI, type AffiliateAdminEntry, type SimpleUser as AffiliateSimpleUser placeholder from "@/api/admin/affiliates";
...
const settingsTabs = [
  ...
  { key: "agreement" as SettingsTab, icon: "document" as const placeholder,
  { key: "features" as SettingsTab, icon: "bolt" as const placeholder,
  { key: "security" as SettingsTab, icon: "shield" as const placeholder,
  { key: "users" as SettingsTab, icon: "user" as const placeholder,
  { key: "gateway" as SettingsTab, icon: "server" as const placeholder,
  { key: "payment" as SettingsTab, icon: "creditCard" as const placeholder,
...
function focusSettingsTab(tab: SettingsTab): void {
  window.requestAnimationFrame(() => {
    document.getElementById(`settings-tab-${tabplaceholder`)?.focus();
  placeholder);
placeholder
...
function handleSettingsTabKeydown(event: KeyboardEvent, tab: SettingsTab): void {
  ...
  if (action === "first") {
    nextIndex = 0;
  placeholder else if (action === "last") {
...
function loginAgreementRoutePath(
  ...
  const id =
    normalizeLoginAgreementDocumentId(doc.id || doc.title) || `doc-${index + 1placeholder`;
  return `/legal/${idplaceholder`;
placeholder
...
function nextClaudeOAuthSystemPromptBlockID(): string {
  ...
  return `claude-oauth-system-prompt-block-${claudeOAuthSystemPromptBlockIDplaceholder`;
placeholder
...
function detectClaudeOAuthSystemPromptPreset(
  ...
  if (trimmed === "{billing_headerplaceholder") {
    return "billing";
  placeholder
  if (
    trimmed === "{claude_code_system_promptplaceholder" ||
    trimmed === defaultClaudeCodeSystemPrompt
  ) {
    return "system";
  placeholder
  if (
    trimmed === "{claude_code_expansion_promptplaceholder" ||
...
function normalizeClaudeOAuthSystemPromptBlockText(
  ...
  const trimmed = text.trim();
  if (trimmed === "{claude_code_system_promptplaceholder") {
    return defaultClaudeCodeSystemPrompt;
  placeholder
  if (trimmed === "{claude_code_expansion_promptplaceholder") {
...
function createClaudeOAuthSystemPromptBlock(
  overrides: Partial<ClaudeOAuthSystemPromptBlock> = {placeholder,
...
function createDefaultClaudeOAuthSystemPromptBlocks(
  ...
  return [
    createClaudeOAuthSystemPromptBlock({
      preset: "billing",
      text: "{billing_headerplaceholder",
    placeholder),
    createClaudeOAuthSystemPromptBlock({
      preset: "system",
...
placeholder {
  if (cacheControl === true) {
    return { enabled: true, ttl: "5m" placeholder;
  placeholder
  if (
    cacheControl &&
    ...
    placeholder;
  placeholder
  return { enabled: false, ttl: "5m" placeholder;
placeholder
...
function parseClaudeOAuthSystemPromptBlocks(
  ...
  try {
    const parsed = JSON.parse(trimmed) as
      ...
      | { blocks?: ClaudeOAuthSystemPromptRawBlock[] placeholder;
...
const claudeOAuthSystemPromptCacheTTLOptions = computed(() => [
  { value: "5m", label: t("admin.settings.gatewayForwarding.cacheTTL5m") placeholder,
  { value: "1h", label: t("admin.settings.gatewayForwarding.cacheTTL1h") placeholder,
]);
...
function applyClaudeOAuthSystemPromptPreset(
  ...
  block.type = "text";
  if (preset === "billing") {
    block.text = "{billing_headerplaceholder";
    block.cacheControlEnabled = false;
    block.cacheControlTTL = "5m";
  placeholder else if (preset === "system") {
    block.text = defaultClaudeCodeSystemPrompt;
    block.cacheControlEnabled = false;
    block.cacheControlTTL = "5m";
  placeholder else if (preset === "expansion") {
    block.text =
...
function syncCaptchaProviderSelection(): void {
  ...
  placeholder else if (form.aliyun_captcha_enabled) {
    captchaProviderSelection.value = "aliyun";
  placeholder else if (form.turnstile_enabled) {
...
const authSourceDefaults = reactive<AuthSourceDefaultsState>(
  buildAuthSourceDefaultsState({placeholder),
);
...
const expandedProviders = reactive<Record<number, boolean>>({placeholder);
const apiKeyVisible = reactive<Record<number, boolean>>({placeholder);
...
function removeWebSearchProvider(idx: number) {
  ...
  const newExpanded: Record<number, boolean> = {placeholder;
  const newVisible: Record<number, boolean> = {placeholder;
...
function addWebSearchProvider() {
  ...
  webSearchConfig.providers.push({
    ...
    proxy_id: null,
    expires_at: null,
  placeholder as WebSearchProviderConfig);
...
function formatSubscribedAt(ts: number | null): string {
  ...
  return `${yplaceholder-${mplaceholder-${dayplaceholder`;
placeholder
...
async function loadWebSearchConfig() {
  try {
    const [resp, proxiesResp] = await Promise.all([
      ...
      adminAPI.proxies.list().catch(() => ({ items: [] as Proxy[] placeholder)),
    ]);
    if (resp) {
  ...
  placeholder catch (err: unknown) {
    ...
    const status = (err as { status?: number placeholder)?.status;
...
function normalizeForwardedClientIpHeader(raw: string): string {
  ...
  return header
    .toLowerCase()
    .split("-")
    .map((part) => `${part.charAt(0).toUpperCase()placeholder${part.slice(1)placeholder`)
    .join("-");
placeholder
...
function showForwardedClientIpHeaderError(result: ForwardedClientIpHeaderResult) {
  ...
  placeholder else if (result === "full") {
    appStore.showError(
...
function addEndpoint() {
  form.custom_endpoints.push({ name: "", endpoint: "", description: "" placeholder);
placeholder
...
function addLoginAgreementDocument() {
  form.login_agreement_documents.push({
    id: `custom-${Date.now().toString(36)placeholder`,
    title: "",
    content_md: "",
  placeholder);
placeholder
...
function addCodexFingerprintRow(): void {
  codexFingerprintRows.value.push({ type: "header_exact", match: "", required: false placeholder);
placeholder
...
function addCodexBlacklistRow(): void {
  codexBlacklistRows.value.push({ originator: "", uaContains: "" placeholder);
placeholder
...
async function loadSubscriptionGroups() {
  ...
  placeholder catch (_error: unknown) {
...
async function saveSettings() {
  ...
  try {
    ...
    if (duplicateLoginAgreementDocumentId) {
      appStore.showError(
        localText(
          `登录条款文档路由不能重复：/legal/${duplicateLoginAgreementDocumentIdplaceholder`,
          `Login agreement document routes cannot be duplicated: /legal/${duplicateLoginAgreementDocumentIdplaceholder`,
        ),
      );
      return;
    placeholder
    ...
    const payload: UpdateSettingsRequest = {
      ...
      registration_email_suffix_whitelist:
        registrationEmailSuffixWhitelistTags.value.map((suffix) =>
          suffix.startsWith("*.") ? suffix : `@${suffixplaceholder`,
        ),
  ...
  placeholder catch (error: unknown) {
    ...
    if (
      (error as { reason?: string placeholder)?.reason === "STEP_UP_ENABLE_REQUIRES_TOTP"
    ) {
...
async function testSmtpConnection() {
  ...
  try {
    ...
    const result = await adminAPI.settings.testSmtpConnection({
      ...
      smtp_use_tls: form.smtp_use_tls,
    placeholder);
    // API returns { message: "..." placeholder on success, errors are thrown as exceptions
    appStore.showSuccess(
...
const betaPolicyActionOptions = computed(() => [
  { value: "pass", label: t("admin.settings.betaPolicy.actionPass") placeholder,
  { value: "filter", label: t("admin.settings.betaPolicy.actionFilter") placeholder,
  { value: "block", label: t("admin.settings.betaPolicy.actionBlock") placeholder,
]);

const betaPolicyScopeOptions = computed(() => [
  { value: "all", label: t("admin.settings.betaPolicy.scopeAll") placeholder,
  { value: "oauth", label: t("admin.settings.betaPolicy.scopeOAuth") placeholder,
  { value: "apikey", label: t("admin.settings.betaPolicy.scopeAPIKey") placeholder,
  { value: "bedrock", label: t("admin.settings.betaPolicy.scopeBedrock") placeholder,
]);
...
const openaiFastPolicyTierOptions = computed(() => [
  { value: "all", label: t("admin.settings.openaiFastPolicy.tierAll") placeholder,
  {
    value: "priority",
    label: t("admin.settings.openaiFastPolicy.tierPriority"),
  placeholder,
  { value: "flex", label: t("admin.settings.openaiFastPolicy.tierFlex") placeholder,
]);

const openaiFastPolicyActionOptions = computed(() => [
  { value: "pass", label: t("admin.settings.openaiFastPolicy.actionPass") placeholder,
  { value: "filter", label: t("admin.settings.openaiFastPolicy.actionFilter") placeholder,
  {
    value: "force_priority",
    label: t("admin.settings.openaiFastPolicy.actionForcePriority"),
  placeholder,
  { value: "block", label: t("admin.settings.openaiFastPolicy.actionBlock") placeholder,
]);

function openaiFastPolicyActionSummary(
  action: OpenAIFastPolicyRule["action"],
) {
  return t(`admin.settings.openaiFastPolicy.summaryAction.${actionplaceholder`);
placeholder
...
const openaiFastPolicyScopeOptions = computed(() => [
  { value: "all", label: t("admin.settings.openaiFastPolicy.scopeAll") placeholder,
  { value: "oauth", label: t("admin.settings.openaiFastPolicy.scopeOAuth") placeholder,
  { value: "apikey", label: t("admin.settings.openaiFastPolicy.scopeAPIKey") placeholder,
  {
    value: "bedrock",
...
const allPaymentTypes = computed(() => [
  { value: "easypay", label: t("payment.methods.easypay") placeholder,
...
async function disableProvidersByType(type: string) {
  ...
  for (const p of matching) {
    try {
      await adminAPI.payment.updateProvider(p.id, { enabled: false placeholder);
      p.enabled = false;
    placeholder catch (err: unknown) {
...
const providerKeyOptions = computed(() => [
  { value: "easypay", label: t("admin.settings.payment.providerEasypay") placeholder,
  { value: "alipay", label: t("admin.settings.payment.providerAlipay") placeholder,
  { value: "wxpay", label: t("admin.settings.payment.providerWxpay") placeholder,
  { value: "stripe", label: t("admin.settings.payment.providerStripe") placeholder,
  { value: "airwallex", label: t("admin.settings.payment.providerAirwallex") placeholder,
]);
...
const cancelRateLimitUnitOptions = computed(() => [
  ...
  placeholder,
  { value: "hour", label: t("admin.settings.payment.cancelRateLimitUnitHour") placeholder,
  { value: "day", label: t("admin.settings.payment.cancelRateLimitUnitDay") placeholder,
]);
...
function getProviderVisibleMethods(
  ...
  if (provider.provider_key === "alipay") {
    ...
    placeholder else {
      ...
      placeholder);
    placeholder
  placeholder else if (provider.provider_key === "wxpay") {
    if (supportedTypes.length === 0) {
      methods.add("wxpay");
    placeholder else {
      supportedTypes.forEach((type) => {
      ...
      placeholder);
    placeholder
  placeholder else if (provider.provider_key === "easypay") {
...
): { method: "alipay" | "wxpay"; conflicting: ProviderInstance placeholder | null {
...
function showProviderEnablementConflict(
  conflict: { method: "alipay" | "wxpay"; conflicting: ProviderInstance placeholder,
) {
  appStore.showError(
    t("admin.settings.payment.enableConflict", {
      method: t(`payment.methods.${conflict.methodplaceholder`),
...
async function handleToggleField(
  ...
  const payload: Record<string, boolean> = { [field]: newValue placeholder;
...
async function handleReorderProviders(
  updates: { id: number; sort_order: number placeholder[],
) {
  try {
    await Promise.all(
      updates.map((u) =>
        ...
        placeholder as Partial<ProviderInstance>),
      ),
    );
    await loadProviders();
  placeholder catch (err: unknown) {
...
function debounceTimer(slot: { searchTimer: number | null placeholder, delayMs: number, run: () => void) {
...
const affiliateModalCanSubmit = computed(() => {
  ...
  placeholder else if (!affiliateModal.editingEntry) {
    return false;
  placeholder
...
async function submitAffiliateModal() {
  ...
  const payload: Parameters<typeof affiliatesAPI.updateUserSettings>[1] = {placeholder;
...
function askResetAffiliateUser(entry: AffiliateAdminEntry) {
  openAffiliateConfirm(
    ...
    t("admin.settings.features.affiliate.customUsers.resetMessage", {
      email: entry.email || `#${entry.user_idplaceholder`,
    placeholder),
    t("common.delete"),
...
async function submitAffiliateBatchModal() {
  ...
  const payload: Parameters<typeof affiliatesAPI.batchSetRate>[0] =
    rateInput === null
      ? { user_ids: userIDs, clear: true placeholder
      : { user_ids: userIDs, aff_rebate_rate_percent: rateInput placeholder;
