    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6">
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.sora.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.sora.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-6 p-6">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.sora.baseUrl') placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.baseUrlHint') placeholderplaceholder
                </p>
              </div>
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.sora.callLogicMode') placeholderplaceholder
                </label>
                <select v-model="form.sora_call_logic_mode" class="input">
                  <option value="default">{{ t('admin.settings.sora.callLogicModeDefault') placeholderplaceholder</option>
                  <option value="native">{{ t('admin.settings.sora.callLogicModeNative') placeholderplaceholder</option>
                  <option value="proxy">{{ t('admin.settings.sora.callLogicModeProxy') placeholderplaceholder</option>
                </select>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.callLogicModeHint') placeholderplaceholder
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.sora.timeout') placeholderplaceholder
                </label>
                <input v-model.number="form.sora_timeout" type="number" min="1" class="input" />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.timeoutHint') placeholderplaceholder
                </p>
              </div>
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.sora.maxRetries') placeholderplaceholder
                </label>
                <input v-model.number="form.sora_max_retries" type="number" min="0" class="input" />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.maxRetriesHint') placeholderplaceholder
                </p>
              </div>
              <div>
                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.sora.pollInterval') placeholderplaceholder
                </label>
                <input
                ...
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.pollIntervalHint') placeholderplaceholder
                </p>
              </div>
            </div>
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.sora.cacheEnabledHint') placeholderplaceholder
                  </p>
                </div>
              ...
              <div v-if="form.sora_cache_enabled" class="space-y-4">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.cacheBaseDir') placeholderplaceholder
                    </label>
                    <input v-model="form.sora_cache_base_dir" type="text" class="input font-mono text-sm" />
                  </div>
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.cacheVideoDir') placeholderplaceholder
                    </label>
                    <input v-model="form.sora_cache_video_dir" type="text" class="input font-mono text-sm" />
                  </div>
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.cacheMaxBytes') placeholderplaceholder
                    </label>
                    <input v-model.number="form.sora_cache_max_bytes" type="number" min="0" class="input" />
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.sora.cacheMaxBytesHint') placeholderplaceholder
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    placeholderplaceholder</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.sora.cacheUserDirEnabledHint') placeholderplaceholder
                    </p>
                  </div>
                ...
                <div>
                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ t('admin.settings.sora.cacheAllowedHosts') placeholderplaceholder
                  </label>
                  <textarea
                  ...
                  ></textarea>
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.sora.cacheAllowedHostsHint') placeholderplaceholder
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  placeholderplaceholder</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.sora.watermarkFreeEnabledHint') placeholderplaceholder
                  </p>
                </div>
              ...
              <div v-if="form.sora_watermark_free_enabled" class="space-y-4">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.watermarkFreeParseMethod') placeholderplaceholder
                    </label>
                    <select v-model="form.sora_watermark_free_parse_method" class="input">
                      <option value="third_party">{{ t('admin.settings.sora.watermarkFreeParseMethodThirdParty') placeholderplaceholder</option>
                      <option value="custom">{{ t('admin.settings.sora.watermarkFreeParseMethodCustom') placeholderplaceholder</option>
                    </select>
                    <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                      {{ t('admin.settings.sora.watermarkFreeParseMethodHint') placeholderplaceholder
                    </p>
                  </div>
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      placeholderplaceholder</label>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ t('admin.settings.sora.watermarkFreeFallbackHint') placeholderplaceholder
                      </p>
                    </div>
                ...
                <div v-if="form.sora_watermark_free_parse_method === 'custom'" class="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.watermarkFreeCustomParseUrl') placeholderplaceholder
                    </label>
                    <input v-model="form.sora_watermark_free_custom_parse_url" type="text" class="input font-mono text-sm" />
                  </div>
                  <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {{ t('admin.settings.sora.watermarkFreeCustomParseToken') placeholderplaceholder
                    </label>
            ...
            <div class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700">
              <div>
                ...
                placeholderplaceholder</label>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.sora.tokenRefreshEnabledHint') placeholderplaceholder
                </p>
              </div>
