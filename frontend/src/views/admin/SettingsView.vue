    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.purchase.title') placeholderplaceholder
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.purchase.description') placeholderplaceholder
            </p>
          </div>
          <div class="space-y-6 p-6">
            <!-- Enable Toggle -->
            <div class="flex items-center justify-between">
              <div>
                ...
                placeholderplaceholder</label>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.purchase.enabledHint') placeholderplaceholder
                </p>
              </div>
            ...
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.purchase.url') placeholderplaceholder
              </label>
              <input
              ...
              />
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.purchase.urlHint') placeholderplaceholder
              </p>
              <p class="mt-2 text-xs text-amber-600 dark:text-amber-400">
                {{ t('admin.settings.purchase.iframeWarning') placeholderplaceholder
              </p>
            </div>
            ...
            <div class="flex items-center gap-2 text-sm">
              ...
              >
                {{ t('admin.settings.purchase.integrationDoc') placeholderplaceholder
              </a>
              <span class="text-gray-400 dark:text-gray-500">—</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.purchase.integrationDocHint') placeholderplaceholder
              </span>
            </div>
          </div>
        </div>
  ...
  try {
    ...
    if (form.purchase_subscription_enabled) {
      ...
      if (!isValidHttpUrl(form.purchase_subscription_url)) {
        ...
        return
      placeholder
    placeholder else if (!isValidHttpUrl(form.purchase_subscription_url)) {
