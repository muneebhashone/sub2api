              ...
              <div class="flex items-start gap-6">
                ...
                <div class="flex-shrink-0">
                  <div
                    ...
                    :class="{ 'border-solid': form.site_logo placeholder"
                  >
                    <img
                      v-if="form.site_logo"
                      :src="form.site_logo"
                ...
                <div class="flex-1 space-y-3">
                  <div class="flex items-center gap-3">
                    <label class="btn btn-secondary btn-sm cursor-pointer">
                      ...
                      {{ t('admin.settings.site.uploadImage') placeholderplaceholder
                    </label>
                    <button
                      v-if="form.site_logo"
                      type="button"
                    ...
                    >
                      ...
                      {{ t('admin.settings.site.remove') placeholderplaceholder
                    </button>
                  </div>
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ t('admin.settings.site.logoHint') placeholderplaceholder
                  </p>
                  <p v-if="logoError" class="text-xs text-red-500">{{ logoError placeholderplaceholder</p>
                </div>
              </div>
            </div>
