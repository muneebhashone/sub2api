  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div class="mb-4 flex gap-2 border-b border-gray-200 dark:border-dark-700">
        ...
        <button class="tab" :class="{ 'tab-active': activeTab === 'errors' placeholder" @click="switchToErrorsTab">
...
const switchToErrorsTab = () => { activeTab.value = 'errors'; if (errRows.value.length === 0) loadAdminErrors() placeholder
