  ...
  <AppLayout>
    ...
    >
      <form id="channel-form" @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <template v-else>
              ...
              >
                ...
                >
                  ...
                  >
                    {{ group.rate_multiplier placeholderplaceholderx
                  </span>
                  <span class="text-xs text-gray-400">
                    {{ group.account_count || 0 placeholderplaceholder
                  </span>
                  <span
        ...
        <div>
          <label class="input-label">{{ t('admin.channels.form.billingModelSource', 'Billing Model') placeholderplaceholder</label>
