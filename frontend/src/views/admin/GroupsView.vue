  ...
  <AppLayout>
        ...
        >
          ...
          >
            ...
            >
              ...
              {{ t("admin.groups.sortOrder") placeholderplaceholder
            </button>
            <button
        ...
        >
          ...
          <template #cell-id="{ value placeholder">
            <span class="font-mono text-xs text-gray-500 dark:text-gray-400"
              >#{{ value placeholderplaceholder</span
            >
          </template>
            ...
            <div class="space-y-1">
              ...
              >
                ...
                >
                  <span v-if="row.daily_limit_usd" class="whitespace-nowrap">
                    ...
                    <span class="text-gray-400 dark:text-gray-500">
                      / {{ formatUsd(row.daily_limit_usd) placeholderplaceholder/{{
                  ...
                  <span v-if="row.weekly_limit_usd" class="whitespace-nowrap"
                    >{{ formatUsd(row.weekly_limit_usd) placeholderplaceholder/{{
                  ...
                  <span v-if="row.monthly_limit_usd" class="whitespace-nowrap"
                    >{{ formatUsd(row.monthly_limit_usd) placeholderplaceholder/{{
                ...
                <div class="text-gray-400 dark:text-gray-500">
                  {{ t("admin.groups.usageTotal") placeholderplaceholder
          ...
          <template #cell-rate_multiplier="{ value placeholder">
            <span class="text-sm text-gray-700 dark:text-gray-300"
              >{{ value placeholderplaceholderx</span
            >
          </template>
          ...
          <template #cell-account_count="{ row placeholder">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                <span
                  ...
                  >{{ row.active_account_count || 0 placeholderplaceholder</span
                >
                <span
                  ...
                  >{{ t("admin.groups.accountsUnit") placeholderplaceholder</span
                >
              </div>
              <div v-if="row.rate_limited_account_count">
                ...
                <span
                  ...
                  >{{ row.rate_limited_account_count placeholderplaceholder</span
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 font-medium text-gray-800 dark:bg-dark-600 dark:text-gray-300"
                  >{{ t("admin.groups.accountsUnit") placeholderplaceholder</span
              ...
              <div>
                ...
                <span
                  ...
                  >{{ row.account_count || 0 placeholderplaceholder</span
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 font-medium text-gray-800 dark:bg-dark-600 dark:text-gray-300"
                  >{{ t("admin.groups.accountsUnit") placeholderplaceholder</span
    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.copyAccounts.title") placeholderplaceholder
            </label>
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.copyAccounts.tooltip") placeholderplaceholder
                  </p>
                  <div
          ...
          >
            <option value="">
              {{ t("admin.groups.copyAccounts.selectPlaceholder") placeholderplaceholder
            </option>
            <option
          ...
          <p class="input-hint">{{ t("admin.groups.copyAccounts.hint") placeholderplaceholder</p>
        </div>
        <div>
          <label class="input-label">{{
        ...
        <div>
          <label class="input-label">{{ t("admin.groups.form.rpmLimit") placeholderplaceholder</label>
          <input
          ...
          />
          <p class="input-hint">{{ t("admin.groups.form.rpmLimitHint") placeholderplaceholder</p>
        </div>
              ...
              >
                ...
                >
                  <p class="mb-2 text-xs font-medium">
                    {{ t("admin.groups.exclusiveTooltip.title") placeholderplaceholder
                  </p>
                  ...
                  <div class="rounded bg-gray-800 p-2 dark:bg-gray-700">
                    <p class="text-xs leading-relaxed text-gray-300">
                      <span
                        ...
                        {{ t("admin.groups.exclusiveTooltip.example") placeholderplaceholder</span
                      >
        ...
        <div class="mt-4 border-t pt-4">
          <div>
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.subscription.typeHint") placeholderplaceholder
            </p>
          </div>
        ...
        <div class="border-t pt-4">
          <div class="mb-3 flex items-center justify-between gap-3">
            <div>
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t("admin.groups.modelsList.title") placeholderplaceholder
              </label>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.modelsList.hint") placeholderplaceholder
              </p>
            </div>
            <button
              type="button"
          ...
          >
            ...
            >
              ...
              <div class="flex items-center gap-1.5">
                ...
                >
                  {{ t("admin.groups.modelsList.selectAll") placeholderplaceholder
                </button>
                <button
                  type="button"
                ...
                >
                  {{ t("admin.groups.modelsList.invertSelection") placeholderplaceholder
                </button>
              </div>
            </div>
            <div
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.modelsList.loading") placeholderplaceholder
              </p>
              <p
                v-else-if="createModelsListState.items.length === 0"
                class="text-xs text-gray-500 dark:text-gray-400"
              >
                {{ t("admin.groups.modelsList.empty") placeholderplaceholder
              </p>
              <div
              ...
              >
                ...
                <span class="min-w-0 flex-1 break-all text-sm text-gray-700 dark:text-gray-300">
                  {{ item.id placeholderplaceholder
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
        ...
        >
          ...
          >
            {{ t(imagePricingI18nKey(createForm.platform, "title")) placeholderplaceholder
          </label>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t(imagePricingI18nKey(createForm.platform, "description")) placeholderplaceholder
          </p>
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              ...
              />
              {{ t(imagePricingI18nKey(createForm.platform, "allowImageGeneration")) placeholderplaceholder
            </label>
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t(imagePricingI18nKey(createForm.platform, "independentMultiplier")) placeholderplaceholder
            </label>
          </div>
          <div
          ...
          <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
            {{ t(imagePricingI18nKey(createForm.platform, "modeHint")) placeholderplaceholder
          </p>
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <div class="mb-1 font-medium">
              {{ t(imagePricingI18nKey(createForm.platform, "finalPricePreview")) placeholderplaceholder
            </div>
            <div class="grid grid-cols-3 gap-2">
              <div
                ...
                :key="item.label"
              >
                {{ item.label placeholderplaceholder: {{ item.value placeholderplaceholder
              </div>
            </div>
          </div>
          <div v-if="createForm.platform === 'gemini' && createForm.allow_image_generation" class="mt-4 border-t border-dashed border-gray-200 pt-4 dark:border-dark-700">
            ...
            >
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t("admin.groups.imagePricing.allowBatchImageGeneration") placeholderplaceholder
            </label>
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
              {{ t("admin.groups.imagePricing.batchSectionHint") placeholderplaceholder
            </p>
            <div
          ...
          >
            {{ t("admin.groups.imagePricing.batchGeminiOnlyHint") placeholderplaceholder
          </p>
        </div>
        ...
        >
          <label
            class="block mb-2 font-medium text-gray-700 dark:text-gray-300"
          >
            {{ t(videoPricingI18nKey("title")) placeholderplaceholder
          </label>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t(videoPricingI18nKey("description")) placeholderplaceholder
          </p>
          <div class="mb-4">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t(videoPricingI18nKey("independentMultiplier")) placeholderplaceholder
            </label>
          </div>
          <div
          ...
          >
            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.videoPricing.modelOverridesTitle") placeholderplaceholder
            </p>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t("admin.groups.videoPricing.modelOverridesDescription") placeholderplaceholder
            </p>
            <div class="mt-3 space-y-3">
              ...
              >
                <div class="min-w-0 pb-1 font-mono text-xs text-gray-700 dark:text-gray-300">
                  {{ family.label placeholderplaceholder
                </div>
                <label
                ...
                >
                  <span class="mb-1 block text-xs text-gray-500 dark:text-gray-400">
                    {{ resolution.label placeholderplaceholder ($/s)
                  </span>
                  <input
                    ...
                    min="0"
                    class="input"
                    :data-testid="`create-grok-video-price-${family.keyplaceholder-${resolution.keyplaceholder`"
                  />
                </label>
              </div>
            </div>
          ...
          <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
            {{ t(videoPricingI18nKey("modeHint")) placeholderplaceholder
          </p>
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <div class="mb-1 font-medium">
              {{ t(videoPricingI18nKey("finalPricePreview")) placeholderplaceholder
            </div>
            <div class="grid grid-cols-3 gap-2">
              <div
        ...
        <div v-if="createForm.subscription_type === 'subscription'" class="border-t pt-4">
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span>{{ t("admin.groups.peakRate.enable") placeholderplaceholder</span>
            </label>
          </div>
          <div
          ...
          >
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakStart") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakEnd") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.peakRate.peakMultiplier") placeholderplaceholder</label>
              <input
        ...
        <div v-if="isProfitControlPlatform(createForm.platform)" class="border-t pt-4">
          <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            <input
              ...
              class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
            />
            <span>{{ t("admin.groups.profitControl.enable") placeholderplaceholder</span>
          </label>
          ...
          >
            <div>
              <label class="input-label">{{ t("admin.groups.profitControl.minMargin") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.profitControl.safetyBuffer") placeholderplaceholder</label>
              <input
        ...
        <div v-if="createForm.platform === 'antigravity'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.supportedScopes.title") placeholderplaceholder
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.supportedScopes.tooltip") placeholderplaceholder
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t("admin.groups.supportedScopes.hint") placeholderplaceholder
          </p>
        </div>
        ...
        <div v-if="createForm.platform === 'antigravity'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.mcpXml.title") placeholderplaceholder
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.mcpXml.tooltip") placeholderplaceholder
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <div v-if="createForm.claude_code_only" class="mt-3">
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.claudeCode.fallbackHint") placeholderplaceholder
            </p>
          </div>
        </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.webSearchPricing.title") placeholderplaceholder
          </h4>
          <div>
            <label class="input-label">{{
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.webSearchPricing.pricePerCallHint") placeholderplaceholder
            </p>
            <div
        ...
        <div class="border-t border-gray-200 pt-4 mt-4 dark:border-dark-400">
          <div class="flex items-start justify-between gap-4">
            <div>
              <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.title") placeholderplaceholder</h4>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t("admin.groups.modelPricing.description") placeholderplaceholder</p>
            </div>
            <button type="button" class="btn btn-secondary" @click="addGroupPricing(createForm.model_pricing)">
              <Icon name="plus" size="sm" class="mr-1" />{{ t("admin.groups.modelPricing.add") placeholderplaceholder
            </button>
          </div>
          <label class="mt-3 flex items-start gap-2">
            <input v-model="createForm.long_context_pricing_enabled" type="checkbox" class="mt-0.5" />
            <span><span class="block text-sm text-gray-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.longContext") placeholderplaceholder</span><span class="block text-xs text-gray-500">{{ t("admin.groups.modelPricing.longContextHint") placeholderplaceholder</span></span>
          </label>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            {{ t("admin.groups.explicitPricing.title") placeholderplaceholder
          </h4>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t("admin.groups.explicitPricing.description") placeholderplaceholder
          </p>
          <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div>
              <label class="input-label">{{ t("admin.groups.explicitPricing.searchPricePer1k") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioRealtimePerMin") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioTtsPerMillionChars") placeholderplaceholder</label>
              <input
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.voicePricing.audioSttPerHour") placeholderplaceholder</label>
              <input
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.openaiLive.title") placeholderplaceholder
          </h4>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {{ t("admin.groups.openaiLive.hint") placeholderplaceholder
          </p>
        </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.openaiMessages.title") placeholderplaceholder
          </h4>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {{ t("admin.groups.openaiMessages.allowDispatchHint") placeholderplaceholder
          </p>
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            ...
            >
              ...
              >
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.groups.openaiMessages.familyMappingHint") placeholderplaceholder
                </p>
              </div>
              <div class="p-4">
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    ...
                    >
                      {{ t("admin.groups.openaiMessages.exactMappingHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-4 bg-gray-50/30 dark:bg-dark-800/30">
                ...
                >
                  ...
                  >
                    ...
                    {{ t("admin.groups.openaiMessages.addExactMapping") placeholderplaceholder
                  </button>
                </div>
        ...
        >
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ t("admin.groups.accountFilters.title") placeholderplaceholder
          </h4>
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm text-gray-600 dark:text-gray-400"
                >{{ t("admin.groups.accountFilters.oauthOnly") placeholderplaceholder</label
              >
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm text-gray-600 dark:text-gray-400"
                >{{ t("admin.groups.accountFilters.privacySetOnly") placeholderplaceholder</label
              >
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                {{
        ...
        >
          ...
          />
          <p class="input-hint">
            {{ t("admin.groups.invalidRequestFallback.hint") placeholderplaceholder
          </p>
        </div>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t("admin.groups.modelRouting.title") placeholderplaceholder
            </label>
            <!-- Help Tooltip -->
            <div class="group relative inline-flex">
              <Icon
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.modelRouting.tooltip") placeholderplaceholder
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          >
            {{ t("admin.groups.modelRouting.disabledHint") placeholderplaceholder
          </p>
          <p v-else class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t("admin.groups.modelRouting.noRulesHint") placeholderplaceholder
          </p>
          <!-- 路由规则列表（仅在启用时显示） -->
                      ...
                      >
                        ...
                        >
                          ...
                          <span class="ml-2 text-xs text-gray-400"
                            >#{{ account.id placeholderplaceholder</span
                          >
                        </button>
                      </div>
                    </div>
                    <p class="text-xs text-gray-400 mt-1">
                      {{ t("admin.groups.modelRouting.accountsHint") placeholderplaceholder
                    </p>
                  </div>
                </div>
                <button
          ...
          >
            <Icon name="plus" size="sm" />
            {{ t("admin.groups.modelRouting.addRule") placeholderplaceholder
          </button>
        </div>
      </form>
    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptionsForEdit.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.copyAccounts.tooltipEdit") placeholderplaceholder
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"
                  ></div>
          ...
          <p class="input-hint">
            {{ t("admin.groups.copyAccounts.hintEdit") placeholderplaceholder
          </p>
        </div>
        <div>
          <label class="input-label">{{
        ...
        <div class="mt-4 border-t pt-4">
          <div>
            ...
            />
            <p class="input-hint">
              {{ t("admin.groups.subscription.typeNotEditable") placeholderplaceholder
            </p>
          </div>
        ...
        >
          <label
            class="block mb-2 font-medium text-gray-700 dark:text-gray-300"
          >
            {{ t(imagePricingI18nKey(editForm.platform, "title")) placeholderplaceholder
          </label>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t(imagePricingI18nKey(editForm.platform, "description")) placeholderplaceholder
          </p>
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t(imagePricingI18nKey(editForm.platform, "allowImageGeneration")) placeholderplaceholder
            </label>
            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input
                ...
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              {{ t(imagePricingI18nKey(editForm.platform, "independentMultiplier")) placeholderplaceholder
            </label>
          </div>
          <div
          ...
          <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
            {{ t(imagePricingI18nKey(editForm.platform, "modeHint")) placeholderplaceholder
          </p>
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <div class="mb-1 font-medium">
              {{ t(imagePricingI18nKey(editForm.platform, "finalPricePreview")) placeholderplaceholder
            </div>
            <div class="grid grid-cols-3 gap-2">
              <div
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    min="0"
                    class="input"
                    :data-testid="`edit-grok-video-price-${family.keyplaceholder-${resolution.keyplaceholder`"
                  />
                </label>
              </div>
            </div>
    ...
    >
      <div class="space-y-4">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          {{ t("admin.groups.sortOrderHint") placeholderplaceholder
        </p>
        <VueDraggable
        ...
        >
          ...
          >
            ...
            <div class="text-sm text-gray-400">#{{ group.id placeholderplaceholder</div>
          </div>
        </VueDraggable>
      </div>
      ...
      <template #footer>
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {{ sortSubmitting ? t("common.saving") : t("common.save") placeholderplaceholder
          </button>
        </div>
      </template>
    </BaseDialog>
        ...
        <section class="min-w-0">
          <div class="mb-3 flex items-center justify-between gap-3">
            <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
              {{ t("admin.groups.compositeRoutes.routes") placeholderplaceholder
            </h3>
            <button
              type="button"
          ...
          >
            ...
            <div
              ...
              class="flex h-36 items-center justify-center text-sm text-gray-500 dark:text-gray-400"
            >
              {{ t("admin.groups.compositeRoutes.empty") placeholderplaceholder
            </div>
            <div v-else class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-dark-600">
                <thead class="bg-gray-50 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:bg-dark-800 dark:text-gray-400">
                  <tr>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.publicModel") placeholderplaceholder
                    </th>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.target") placeholderplaceholder
                    </th>
                    <th class="px-3 py-2">
                      {{ t("admin.groups.compositeRoutes.scope") placeholderplaceholder
                    </th>
                    <th class="px-3 py-2 text-right">
                      {{ t("admin.groups.columns.actions") placeholderplaceholder
                    </th>
                  </tr>
                </thead>
                  ...
                  >
                    <td class="max-w-[15rem] px-3 py-2">
                      <div class="break-all font-medium text-gray-900 dark:text-white">
                        {{ route.public_model placeholderplaceholder
                      </div>
                      <div class="mt-1 flex flex-wrap items-center gap-1.5">
                        ...
                        >
                          {{ t("admin.accounts.status.inactive") placeholderplaceholder
                        </span>
                      </div>
                    </td>
                    <td class="px-3 py-2">
                      <div class="flex items-center gap-1.5 text-gray-900 dark:text-white">
                        ...
                        <span>{{ formatCompositePlatform(route.target_platform) placeholderplaceholder</span>
                      </div>
                      <div class="mt-1 break-all text-xs text-gray-500 dark:text-gray-400">
                        {{ route.upstream_model || route.public_model placeholderplaceholder
                      </div>
                    </td>
                    <td class="px-3 py-2">
                      <div class="text-gray-700 dark:text-gray-300">
                        {{ formatCompositeEndpoint(route.endpoint) placeholderplaceholder
                      </div>
                      <div class="text-xs text-gray-500 dark:text-gray-400">
                        {{ t("admin.groups.compositeRoutes.priority") placeholderplaceholder:
                        {{ route.priority placeholderplaceholder
                      </div>
                    </td>
                    <td class="px-3 py-2">
        ...
        <section class="space-y-5">
          <form class="space-y-3" @submit.prevent="saveCompositeRoute">
            ...
            <div>
              ...
              />
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t("admin.groups.compositeRoutes.upstreamModelHint") placeholderplaceholder
              </p>
            </div>
            ...
            <div class="flex items-center justify-between gap-3">
              <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                <input
                  ...
                  class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-dark-600 dark:bg-dark-700"
                />
                {{ t("admin.groups.compositeRoutes.enabled") placeholderplaceholder
              </label>
              <button
                type="submit"
                class="btn btn-primary"
              ...
              >
                <Icon
                  ...
                  class="mr-2"
                />
                {{ compositeRouteEditingId ? t("common.update") : t("common.create") placeholderplaceholder
              </button>
            </div>
          </form>
          ...
          <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
            <h3 class="mb-3 text-sm font-semibold text-gray-900 dark:text-white">
              {{ t("admin.groups.compositeRoutes.preview") placeholderplaceholder
            </h3>
            <div class="space-y-3">
              <input
              ...
              >
                ...
                >
                  <div>
                    {{ t("admin.groups.compositeRoutes.targetPlatform") placeholderplaceholder:
                    {{
                  ...
                  <div class="break-all">
                    {{ t("admin.groups.compositeRoutes.upstreamModel") placeholderplaceholder:
                    {{ compositePreviewDecision.upstream_model placeholderplaceholder
                  </div>
                </div>
                <div
                  v-else
                ...
                >
                  {{ compositePreviewDecision.reason placeholderplaceholder
                </div>
              </div>
            </div>
          </div>
...
import {
  ...
  perTokenToMTok,
  toNullableNumber,
placeholder from "@/components/admin/channel/types";
import type { ChannelModelPricing placeholder from "@/api/admin/channels";
...
import { createModelsListCandidatesTracker placeholder from "./groupsModelsListCandidates";
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: "id", label: t("admin.groups.columns.id"), sortable: true placeholder,
  {
    key: "platform",
...
const compositeRouteEndpointOptions = computed(() => [
  { value: "any", label: t("admin.groups.compositeRoutes.endpoints.any") placeholder,
  {
    value: "messages",
  ...
  placeholder,
  { value: "images", label: t("admin.groups.compositeRoutes.endpoints.images") placeholder,
  { value: "gemini", label: t("admin.groups.compositeRoutes.endpoints.gemini") placeholder,
]);

const compositeRouteMatchOptions = computed(() => [
  { value: "exact", label: t("admin.groups.compositeRoutes.match.exact") placeholder,
  { value: "prefix", label: t("admin.groups.compositeRoutes.match.prefix") placeholder,
]);
...
const invalidRequestFallbackOptions = computed(() => {
  const options: { value: number | null; label: string placeholder[] = [
    { value: null, label: t("admin.groups.invalidRequestFallback.noFallback") placeholder,
  ];
  const eligibleGroups = groups.value.filter(
    (g) =>
      g.platform === "anthropic" &&
...
const copyAccountsGroupLabel = (g: AdminGroup) => {
  ...
  return `${g.nameplaceholder - ${platformplaceholder (${t("admin.groups.accountsCount", { count placeholder)placeholder)`;
placeholder;
...
const liveCapability = ref<{ supported: boolean; reason?: string placeholder | null>(null);
...
const getCreateRuleSearchKey = (rule: ModelRoutingRule) =>
  `create-${resolveCreateRuleKey(rule)placeholder`;
const getEditRuleSearchKey = (rule: ModelRoutingRule) =>
  `edit-${resolveEditRuleKey(rule)placeholder`;
...
// 账号搜索相关状态
const accountSearchKeyword = ref<Record<string, string>>({placeholder);
const accountSearchResults = ref<Record<string, SimpleAccount[]>>({placeholder);
const showAccountDropdown = ref<Record<string, boolean>>({placeholder);
...
const clearAllAccountSearchState = () => {
  accountSearchKeyword.value = {placeholder;
  accountSearchResults.value = {placeholder;
  showAccountDropdown.value = {placeholder;
placeholder;

const accountSearchRunner = useKeyedDebouncedSearch<SimpleAccount[]>({
  delay: 300,
  search: async (keyword, { signal placeholder) => {
    ...
    return res.items.map((account) => ({ id: account.id, name: account.name placeholder));
  placeholder,
...
const addCreateRoutingRule = () => {
  createModelRoutingRules.value.push({ pattern: "", accounts: [] placeholder);
placeholder;
...
const addEditRoutingRule = () => {
  editModelRoutingRules.value.push({ pattern: "", accounts: [] placeholder);
placeholder;
...
const loadModelsListCandidates = async (
  ...
  const request = { mode, groupID, platform placeholder;
...
const convertRoutingRulesToApiFormat = (
  ...
  const result: Record<string, number[]> = {placeholder;
  ...
  for (const [pattern, accountIds] of Object.entries(apiFormat)) {
    ...
    for (const id of accountIds) {
      try {
        ...
        accounts.push({ id: account.id, name: account.name placeholder);
      placeholder catch {
        // 如果账号不存在，仍然显示 ID
        accounts.push({ id, name: `#${idplaceholder` placeholder);
      placeholder
    placeholder
    rules.push({ pattern, accounts placeholder);
  placeholder
  return rules;
placeholder;
...
const imagePricingTiers = [
  { key: "image_price_1k", label: "1K" placeholder,
  { key: "image_price_2k", label: "2K" placeholder,
  { key: "image_price_4k", label: "4K" placeholder,
] as const;

const videoPricingTiers = [
  { key: "video_price_480p", label: "480p" placeholder,
  { key: "video_price_720p", label: "720p" placeholder,
  { key: "video_price_1080p", label: "1080p" placeholder,
] as const;
...
const formatImagePricePreview = (value: number | string | null | undefined) => {
  ...
  if (!Number.isFinite(price) || price < 0) {
    return t("admin.groups.imagePricing.notConfigured");
  placeholder
  return `$${price.toFixed(6).replace(/0+$/, "").replace(/\.$/, "")placeholder`;
placeholder;
...
const loadLiveCapability = async () => {
  ...
  if (!liveCapabilityRequest) {
    liveCapabilityRequest = adminAPI.groups
      .getLiveCapability()
      .catch(() => ({ supported: false placeholder))
      .finally(() => {
        liveCapabilityRequest = null;
      placeholder);
  placeholder
  liveCapability.value = await liveCapabilityRequest;
  return liveCapability.value ?? { supported: false placeholder;
placeholder;
...
const validateProfitControlForm = (form: ProfitControlFormState): boolean => {
  ...
  if (errorKey) {
    appStore.showError(t(`admin.groups.profitControl.${errorKeyplaceholder`));
    return false;
  placeholder
  return true;
placeholder;
  ...
  try {
    ...
    const requestData = {
      ...
      ...(Object.keys(videoModelPrices).length > 0
        ? { video_model_prices: videoModelPrices placeholder
        : {placeholder),
...
const addCreateMessagesDispatchMapping = () => {
  createForm.exact_model_mappings.push({ claude_model: "", target_model: "" placeholder);
placeholder;
...
const addEditMessagesDispatchMapping = () => {
  editForm.exact_model_mappings.push({ claude_model: "", target_model: "" placeholder);
placeholder;
...
const handleDuplicate = async (group: AdminGroup) => {
  ...
  try {
    ...
    appStore.showSuccess(
      t("admin.groups.duplicateSuccess", { name: duplicate.name placeholder),
    );
    await loadGroups();
...
const formatCompositePlatform = (platform: string) => {
  if (!platform) return "—";
  return t(`admin.groups.platforms.${platformplaceholder`);
placeholder;
