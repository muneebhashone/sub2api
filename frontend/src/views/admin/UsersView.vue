    ...
    <TablePageLayout>
      ...
      <template #table>
        <DataTable :columns="columns" :data="users" :loading="loading">
          ...
          <template #cell-actions="{ row, expanded placeholder">
            <div class="flex items-center gap-1">
              ...
              <template v-if="expanded">
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.users.groups') placeholderplaceholder</span>
                </button>
                <!-- View API Keys -->
                <button
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.users.apiKeys') placeholderplaceholder</span>
                </button>
                <!-- Deposit -->
                <button
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.users.deposit') placeholderplaceholder</span>
                </button>
                <!-- Withdraw -->
                <button
                ...
                >
                  ...
                  <span class="text-xs">{{ t('admin.users.withdraw') placeholderplaceholder</span>
                </button>
              </template>
            </div>
          </template>
      ...
      <form v-if="editingUser" @submit.prevent="handleUpdateUser" class="space-y-5">
        ...
        <div>
          ...
          <p class="mb-1 text-xs text-gray-500 dark:text-dark-400">
            {{ t('admin.users.leaveEmptyToKeep') placeholderplaceholder
          </p>
          <div class="flex gap-2">
            <div class="relative flex-1">
              <input
      ...
      <div v-if="viewingUser" class="space-y-4">
        ...
        <div v-else-if="userApiKeys.length === 0" class="py-8 text-center">
          ...
          <p class="mt-2 text-sm text-gray-500 dark:text-dark-400">
            {{ t('admin.users.noApiKeys') placeholderplaceholder
          </p>
        </div>
          ...
          >
            ...
            <div class="mt-3 flex flex-wrap gap-4 text-xs text-gray-500 dark:text-dark-400">
              <div class="flex items-center gap-1">
                ...
                <span
                  >{{ t('admin.users.group') placeholderplaceholder:
                  {{ key.group?.name || t('admin.users.none') placeholderplaceholder</span
                >
              </div>
              <div class="flex items-center gap-1">
                <svg
                ...
                <span
                  >{{ t('admin.users.columns.created') placeholderplaceholder: {{ formatDateTime(key.created_at) placeholderplaceholder</span
                >
              </div>
            </div>
          </div>
      ...
      <div v-if="allowedGroupsUser" class="space-y-4">
        ...
        <div v-else>
          ...
          <div v-if="standardGroups.length === 0" class="py-6 text-center">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-dark-400">
              {{ t('admin.users.noStandardGroups') placeholderplaceholder
            </p>
          </div>
            ...
            >
              ...
              <div class="flex-1">
                <p class="font-medium text-gray-900 dark:text-white">
                  {{ t('admin.users.allowAllGroups') placeholderplaceholder
                </p>
                <p class="text-sm text-gray-500 dark:text-dark-400">
                  {{ t('admin.users.allowAllGroupsHint') placeholderplaceholder
                </p>
              </div>
            </label>
          </div>
