        ...
        <div class="card p-6">
          ...
          <div class="mt-8 border-t border-gray-200 pt-6 dark:border-dark-700">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">
              {{ copy.remediationTitle placeholderplaceholder
            </h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-dark-400">
              {{ copy.remediationSubtitle placeholderplaceholder
            </p>

            <div class="mt-6 space-y-4">
              <div>
                <label class="input-label" for="remediation-user-id">{{ copy.remediationUserID placeholderplaceholder</label>
                <input
              ...
              <div>
                <label class="input-label" for="remediation-provider-type">{{ copy.remediationProviderType placeholderplaceholder</label>
                <input
              ...
              <div>
                <label class="input-label" for="remediation-provider-key">{{ copy.remediationProviderKey placeholderplaceholder</label>
                <input
              ...
              <div>
                <label class="input-label" for="remediation-provider-subject">{{ copy.remediationProviderSubject placeholderplaceholder</label>
                <input
              ...
              <div>
                <label class="input-label" for="remediation-issuer">{{ copy.remediationIssuer placeholderplaceholder</label>
                <input
              ...
              >
                {{ binding ? copy.remediationSubmitting : copy.remediationAction placeholderplaceholder
              </button>
            </div>
          </div>
        </div>
