          ...
          <div>
            ...
            >
              <option
                ...
                :value="option.value"
              >
                {{ formatEventOptionLabel(option) placeholderplaceholder
              </option>
            </select>
          </div>
          <div>
        ...
        >
          <div class="flex flex-wrap items-center gap-2">
            <div class="text-sm font-semibold text-gray-900 dark:text-white">
              {{ selectedEventMeta.label placeholderplaceholder
            </div>
            <span
            ...
            >
              {{ selectedEventMeta.categoryLabel placeholderplaceholder
            </span>
            <span
              ...
              "
            >
              {{ selectedEventMeta.optional ? localText("可退订通知", "Optional") : localText("事务邮件", "Transactional") placeholderplaceholder
            </span>
          </div>
          <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
            {{ selectedEventMeta.timing placeholderplaceholder
          </p>
          <p
...
function formatCategory(category: string): string {
  ...
  const labels: Record<string, { zh: string; en: string placeholder> = {
    auth: { zh: "认证安全", en: "Auth" placeholder,
    subscription: { zh: "订阅", en: "Subscription" placeholder,
    billing: { zh: "计费", en: "Billing" placeholder,
    admin: { zh: "管理告警", en: "Admin" placeholder,
    risk_control: { zh: "风控", en: "Risk Control" placeholder,
    ops: { zh: "运维", en: "Ops" placeholder,
  placeholder;
