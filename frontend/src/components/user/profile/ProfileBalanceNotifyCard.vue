    ...
    <div class="px-6 py-6 space-y-6">
      ...
      <template v-if="notifyEnabled">
        ...
        <div>
          ...
          <p class="mb-2 text-xs text-yellow-600 dark:text-yellow-400">{{ t('profile.balanceNotify.extraEmailsHint') placeholderplaceholder</p>
          ...
          <p v-else class="text-xs text-gray-400">
            {{ t('profile.balanceNotify.maxEmailsReached') placeholderplaceholder
          </p>
        </div>
      </template>
    </div>
