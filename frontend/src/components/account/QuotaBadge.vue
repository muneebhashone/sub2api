...
<template>
  <span
    ...
    :title="tooltip"
  >
    <span v-if="label" class="font-semibold opacity-70">{{ label placeholderplaceholder</span>
    ...
    <span class="font-mono">${{ fmt(used) placeholderplaceholder</span>
    <span class="text-gray-400 dark:text-gray-500">/</span>
    <span class="font-mono">${{ fmt(limit) placeholderplaceholder</span>
  </span>
</template>
