  ...
  <div class="flex flex-col gap-1.5">
    ...
    <div class="flex items-center gap-1.5">
      ...
      >
        ...
        <span class="font-mono">{{ currentConcurrency placeholderplaceholder</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ account.concurrency placeholderplaceholder</span>
      </span>
    </div>
    ...
    <div v-if="showWindowCost" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">${{ formatCost(currentWindowCost) placeholderplaceholder</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">${{ formatCost(account.window_cost_limit) placeholderplaceholder</span>
      </span>
    </div>
    ...
    <div v-if="showSessionLimit" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">{{ activeSessions placeholderplaceholder</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ account.max_sessions placeholderplaceholder</span>
      </span>
    </div>
    ...
    <div v-if="showRpmLimit" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">{{ currentRPM placeholderplaceholder</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">{{ account.base_rpm placeholderplaceholder</span>
    ...
    <div v-if="showQuotaLimit" class="flex items-center gap-1">
      ...
      >
        ...
        <span class="font-mono">${{ formatCost(currentQuotaUsed) placeholderplaceholder</span>
        <span class="text-gray-400 dark:text-gray-500">/</span>
        <span class="font-mono">${{ formatCost(account.quota_limit) placeholderplaceholder</span>
      </span>
    </div>
  </div>
</template>
...
const sessionLimitTooltip = computed(() => {
  ...
  if (current >= max) {
    return t('admin.accounts.capacity.sessions.full', { idle placeholder)
  placeholder
  return t('admin.accounts.capacity.sessions.normal', { idle placeholder)
placeholder)
...
const rpmTooltip = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    if (current >= base + buffer) {
      return t('admin.accounts.capacity.rpm.tieredBlocked', { buffer placeholder)
    placeholder
    if (current >= base) {
      return t('admin.accounts.capacity.rpm.tieredStickyOnly', { buffer placeholder)
    placeholder
    if (current >= base * 0.8) {
