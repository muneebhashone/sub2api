        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.agentIdentity') placeholderplaceholder</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.codexPat') placeholderplaceholder</span>
            </div>
          </button>
...
watch(
  ...
  ([category, method, agType]) => {
    ...
    placeholder else if (category === 'oauth-based' || category === 'agent-identity' || category === 'codex-pat') {
