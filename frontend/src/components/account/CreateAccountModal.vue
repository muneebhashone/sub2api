        ...
        <div class="grid grid-cols-2 gap-3 mt-2">
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ t('admin.accounts.claudeCode') placeholderplaceholder</span>
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ t('admin.accounts.claudeConsole') placeholderplaceholder</span>
