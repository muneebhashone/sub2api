      ...
      <div v-if="form.platform === 'gemini'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">OAuth</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.googleOauth') placeholderplaceholder</span>
            </div>
          </button>
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t('admin.accounts.types.codeAssist') placeholderplaceholder</span>
                <span class="block text-xs font-medium text-blue-600 dark:text-blue-400">{{ t('admin.accounts.oauth.gemini.needsProjectId') placeholderplaceholder</span>
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.oauth.gemini.needsProjectIdDesc') placeholderplaceholder</span>
              </div>
            </button>
...
import { claudeModels, getPresetMappingsByPlatform, getModelsByPlatform, commonErrorCodes, buildModelMappingObject placeholder from '@/composables/useModelWhitelist'
