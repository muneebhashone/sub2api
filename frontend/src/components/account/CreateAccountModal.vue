    ...
    <div v-if="isOAuthFlow" class="mb-6 flex items-center justify-center">
      <div class="flex items-center space-x-4">
        <div class="flex items-center">
          ...
          <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.accounts.oauth.authMethod') placeholderplaceholder</span>
        </div>
        ...
        <div class="flex items-center">
          ...
          <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('admin.accounts.oauth.title') placeholderplaceholder</span>
        </div>
      </div>
    </div>
    ...
    <form v-if="step === 1" @submit.prevent="handleSubmit" class="space-y-5">
      ...
      <div v-if="form.platform === 'anthropic'">
        ...
        <div class="grid grid-cols-2 gap-3 mt-2">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t('admin.accounts.claudeCode') placeholderplaceholder</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.oauthSetupToken') placeholderplaceholder</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ t('admin.accounts.claudeConsole') placeholderplaceholder</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.apiKey') placeholderplaceholder</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="form.type === 'apikey'" class="space-y-4">
        ...
        <div>
          ...
          />
          <p class="input-hint">{{ t('admin.accounts.apiKeyHint') placeholderplaceholder</p>
        </div>
      ...
      <div class="flex justify-end gap-3 pt-4">
        ...
        >
          ...
          {{ isOAuthFlow ? t('common.next') : (submitting ? t('admin.accounts.creating') : t('common.create')) placeholderplaceholder
        </button>
      </div>
    </form>
    ...
    <div v-else class="space-y-5">
      ...
      <div class="flex justify-between gap-3 pt-4">
        ...
        >
          ...
          {{ currentOAuthLoading ? t('admin.accounts.oauth.verifying') : t('admin.accounts.oauth.completeAuth') placeholderplaceholder
        </button>
      </div>
    </div>
  </Modal>
...
const handleCookieAuth = async (sessionKey: string) => {
  ...
  try {
    ...
    for (let i = 0; i < keys.length; i++) {
      ...
      placeholder catch (error: any) {
        failedCount++
        errors.push(t('admin.accounts.oauth.keyAuthFailed', { index: i + 1, error: error.response?.data?.detail || t('admin.accounts.oauth.authFailed') placeholder))
      placeholder
    placeholder
