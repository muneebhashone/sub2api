            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.builtInRequirement') placeholderplaceholder
                  <a
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.recommended') placeholderplaceholder
                  </span>
                  <span
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.noAdmin') placeholderplaceholder
                  </span>
                </div>
              </div>
            </button>
