  ...
  >
      ...
      <div class="flex-1">
        ...
        <div v-if="inputMethod === 'codex_session'" class="space-y-4">
          ...
          >
            <p class="mb-3 text-sm text-blue-700 dark:text-blue-300">
              {{ t('admin.accounts.oauth.openai.codexSessionDesc') placeholderplaceholder
            </p>
            ...
            <div class="mb-4">
              ...
              >
                <Icon name="key" size="sm" class="text-blue-500" />
                {{ t('admin.accounts.oauth.openai.codexSessionInputLabel') placeholderplaceholder
                <span
              ...
              ></textarea>
              <p class="mt-1 text-xs text-blue-600 dark:text-blue-400">
                {{ t('admin.accounts.oauth.openai.codexSessionHint') placeholderplaceholder
              </p>
            </div>
