<template>
  <div class="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-700 dark:bg-blue-900/30 p-6">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.title') placeholderplaceholder</h4>
        ...
        <div class="mb-4">
          ...
          <div class="flex gap-4">
            <label class="flex cursor-pointer items-center gap-2">
              ...
              />
              <span class="text-sm text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.manualAuth') placeholderplaceholder</span>
            </label>
            <label class="flex cursor-pointer items-center gap-2">
              <input
                v-model="inputMethod"
                ...
                class="text-blue-600 focus:ring-blue-500"
              />
              <span class="text-sm text-blue-900 dark:text-blue-200">{{ t('admin.accounts.oauth.cookieAutoAuth') placeholderplaceholder</span>
            </label>
          </div>
        </div>
        ...
        <div v-if="inputMethod === 'cookie'" class="space-y-4">
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            ...
            >
              ...
              {{ loading ? t('admin.accounts.oauth.authorizing') : t('admin.accounts.oauth.startAutoAuth') placeholderplaceholder
            </button>
          </div>
        </div>
        ...
        <div v-else class="space-y-4">
          <p class="mb-4 text-sm text-blue-800 dark:text-blue-300">
            {{ t('admin.accounts.oauth.followSteps') placeholderplaceholder
          </p>
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step1GenerateUrl') placeholderplaceholder
                </p>
                <button
                  v-if="!authUrl"
                  type="button"
                ...
                >
                  ...
                  {{ loading ? t('admin.accounts.oauth.generating') : t('admin.accounts.oauth.generateAuthUrl') placeholderplaceholder
                </button>
          ...
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step2OpenUrl') placeholderplaceholder
                </p>
                <p class="text-sm text-blue-700 dark:text-blue-300">
                  {{ t('admin.accounts.oauth.openUrlDesc') placeholderplaceholder
                </p>
          ...
          <div class="rounded-lg border border-blue-300 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-blue-900 dark:text-blue-200">
                  {{ t('admin.accounts.oauth.step3EnterCode') placeholderplaceholder
                </p>
                ...
                <div>
                  <label class="input-label">
                    ...
                    {{ t('admin.accounts.oauth.authCode') placeholderplaceholder
                  </label>
                  <textarea
                  ...
                  <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    {{ t('admin.accounts.oauth.authCodeHint') placeholderplaceholder
                  </p>
                </div>
