  ...
  >
    <div class="space-y-4">
      ...
      <div v-else class="space-y-4">
        ...
        >
          {{ triggerEvidenceText placeholderplaceholder
        </div>
      </div>
    </div>
...
const triggerEvidenceText = computed(() => {
  ...
  if (threshold > 0 && minutes > 0) {
    return t('admin.accounts.tempUnschedulable.multipleErrorTrigger', { count, threshold, minutes placeholder)
  placeholder
  if (threshold > 0) {
    return t('admin.accounts.tempUnschedulable.multipleErrorTriggerNoWindow', { count, threshold placeholder)
  placeholder
  if (minutes > 0) {
    return t('admin.accounts.tempUnschedulable.multipleErrorCountInWindow', { count, minutes placeholder)
  placeholder
  return t('admin.accounts.tempUnschedulable.multipleErrorCount', { count placeholder)
placeholder)
