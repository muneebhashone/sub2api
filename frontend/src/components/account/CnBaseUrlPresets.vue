<template>
  <div class="flex flex-wrap gap-2">
    ...
    >
      {{ preset.label placeholderplaceholder ({{ displayUrl(preset.url) placeholderplaceholder)
    </button>
  </div>
</template>
...
import { CN_BASE_URL_PRESETS, type CnBaseUrlPreset placeholder from './credentialsBuilder'
