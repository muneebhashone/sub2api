    ...
    <div v-if="account" class="space-y-5">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ isOpenAI ? t('admin.accounts.openaiAccount') : t('admin.accounts.claudeCodeAccount') placeholderplaceholder
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-between gap-3 pt-4">
        ...
        >
          ...
          {{ currentLoading ? t('admin.accounts.oauth.verifying') : t('admin.accounts.oauth.completeAuth') placeholderplaceholder
        </button>
      </div>
    </div>
  </Modal>
