      ...
      global: {
        stubs: {
          OllamaCloudUsageCell: {
            props: ['account'],
            emits: ['updated'],
            template: '<button data-test="embedded-ollama" @click="$emit(\'updated\', { ...account.ollama_cloud_usage, auto_refresh_enabled: false placeholder)">{{ account.ollama_cloud_usage.snapshot.data.five_hour.used_percent placeholderplaceholder</button>'
          placeholder,
...
placeholder)
  ...
  it('Grok Free 24h bar shows rolling local usage chips', async () => {
    ...
    const wrapper = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4410, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: {
  ...
  it('Grok SuperGrok and Heavy bars show period-aligned local 7d and 30d usage', async () => {
    ...
    const wrapper = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4411, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: {
  ...
  it('Grok paid bars fall back to official seven_day and thirty_day window_stats', async () => {
    ...
    const wrapper = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4412, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: {
  ...
  it('Grok paid hides zero prepaid and hides used/limit when monthly limit is 0', async () => {
    ...
    const wrapper = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4413, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: true,
  ...
  it('Grok paid shows used/limit without prepaid, and prepaid without a zero monthly limit', async () => {
    ...
    const usedOnly = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4414, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: true,
    ...
    const prepaidOnly = mount(AccountUsageCell, {
      props: {
        account: makeAccount({ id: 4415, platform: 'grok', type: 'oauth', extra: {placeholder placeholder)
      placeholder,
      global: {
        stubs: {
          UsageProgressBar: true,
