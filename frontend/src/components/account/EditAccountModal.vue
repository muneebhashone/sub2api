      ...
      <div v-if="headerOverrideCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        <div v-if="headerOverrideEnabled" class="space-y-3">
          ...
          >
            ...
            {{ t('admin.accounts.headerOverride.addRow') placeholderplaceholder
          </button>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            >
              + {{ t('admin.accounts.headerOverride.fillTemplate') placeholderplaceholder
            </button>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.accounts.headerOverride.emptyValueHint') placeholderplaceholder
          </p>
        </div>
      </div>
...
const addHeaderOverrideRow = () => {
  headerOverrideRows.value.push({ name: '', value: '' placeholder)
placeholder
