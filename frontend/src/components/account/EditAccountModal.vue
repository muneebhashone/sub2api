  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.openai.codexCLIOnlyAllowClaudeCode') placeholderplaceholder</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.openai.codexCLIOnlyAllowClaudeCodeDesc') placeholderplaceholder
            </p>
          </div>
          <button
            type="button"
