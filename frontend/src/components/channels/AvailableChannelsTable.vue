<template>
  <div class="card">
    ...
    <div
      ...
      :style="gridStyle"
    >
      <div>{{ columns.name placeholderplaceholder</div>
      <div>{{ columns.platform placeholderplaceholder</div>
      <div>{{ columns.groups placeholderplaceholder</div>
      <div>{{ columns.supportedModels placeholderplaceholder</div>
    </div>
      ...
      >
        ...
        <div>
          <template v-if="secIdx === 0">
            <div class="font-medium text-gray-900 dark:text-white">{{ channel.name placeholderplaceholder</div>
            <div
