    ...
    <div class="mb-4 flex items-center justify-between gap-3">
      ...
      <div class="flex flex-wrap items-center justify-end gap-2">
        ...
        >
          ...
          >
            {{ t('usage.requestedModel') placeholderplaceholder
          </button>
          <button
            type="button"
            class="rounded-md px-2.5 py-1 text-xs font-medium transition-colors"
          ...
          >
            {{ t('usage.upstreamModel') placeholderplaceholder
          </button>
          <button
            type="button"
            class="rounded-md px-2.5 py-1 text-xs font-medium transition-colors"
          ...
          >
            {{ t('usage.mapping') placeholderplaceholder
          </button>
        </div>
        <div
              ...
              >
                ...
                >
                  <span class="inline-flex items-center gap-1">
                    <svg v-if="enableBreakdown && expandedKey === `model-${model.modelplaceholder`" class="h-3 w-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
