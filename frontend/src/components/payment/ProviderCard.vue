  ...
  >
    <div :class="[
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ provider.name placeholderplaceholder</span>
        <span class="text-xs text-gray-400 dark:text-gray-500">{{ keyLabel placeholderplaceholder</span>
        <span v-if="provider.payment_mode" class="text-xs text-gray-400 dark:text-gray-500">· {{ modeLabel placeholderplaceholder</span>
...
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_REDIRECT placeholder from './providerConfig'
