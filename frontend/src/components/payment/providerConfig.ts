...
export const PAYMENT_CURRENCY_OPTIONS: TypeOption[] = [
  { value: 'CNY', label: 'CNY' placeholder,
  { value: 'HKD', label: 'HKD' placeholder,
  { value: 'USD', label: 'USD' placeholder,
  { value: 'EUR', label: 'EUR' placeholder,
  { value: 'GBP', label: 'GBP' placeholder,
  { value: 'AUD', label: 'AUD' placeholder,
  { value: 'CAD', label: 'CAD' placeholder,
  { value: 'SGD', label: 'SGD' placeholder,
  { value: 'JPY', label: 'JPY' placeholder,
  { value: 'KRW', label: 'KRW' placeholder,
  { value: 'NZD', label: 'NZD' placeholder,
]
...
export function getPaymentPopupFeatures(): string {
  ...
  return `width=${widthplaceholder,height=${heightplaceholder,left=${leftplaceholder,top=${topplaceholder,scrollbars=yes,resizable=yes`
placeholder
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  wxpay: [
    ...
    { key: 'certSerial', label: '', sensitive: false placeholder,
    { key: 'publicKey', label: '', sensitive: true placeholder,
    { key: 'publicKeyId', label: '', sensitive: false placeholder,
  ],
  stripe: [
    ...
    { key: 'currency', label: '', sensitive: false, defaultValue: 'CNY', hintKey: 'admin.settings.payment.field_paymentCurrencyHint', options: PAYMENT_CURRENCY_OPTIONS placeholder,
  ],
  airwallex: [
    { key: 'clientId', label: '', sensitive: false placeholder,
    { key: 'apiKey', label: '', sensitive: true placeholder,
    { key: 'webhookSecret', label: '', sensitive: true placeholder,
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://api.airwallex.com/api/v1', hintKey: 'admin.settings.payment.field_airwallexApiBaseHint' placeholder,
    { key: 'countryCode', label: '', sensitive: false, defaultValue: 'CN' placeholder,
    { key: 'currency', label: '', sensitive: false, defaultValue: 'CNY', hintKey: 'admin.settings.payment.field_paymentCurrencyHint', options: PAYMENT_CURRENCY_OPTIONS placeholder,
    { key: 'accountId', label: '', sensitive: false, optional: true, clearable: true, hintKey: 'admin.settings.payment.field_accountIdHint' placeholder,
  ],
placeholder
