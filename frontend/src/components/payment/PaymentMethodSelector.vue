      ...
      >
        <span class="flex items-center gap-2">
          ...
          <span class="flex flex-col items-start leading-none">
            <span class="text-base font-semibold">{{ methodLabel(method) placeholderplaceholder</span>
            <span
...
import { METHOD_ORDER, isBuiltInAlipayMethod, isBuiltInWxpayMethod placeholder from './providerConfig'
...
function methodLabel(method: PaymentMethodOption): string {
  return method.display_name || t(`payment.methods.${method.typeplaceholder`, method.type)
placeholder
