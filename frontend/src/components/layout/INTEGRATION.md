...
```typescript
// In your view files
import { AppLayout, AuthLayout placeholder from '@/components/layout'
```
...
import type { RouteRecordRaw placeholder from 'vue-router'
...
const routes: RouteRecordRaw[] = [
  ...
  placeholder,
  {
    ...
    meta: { requiresAuth: true, title: 'API Keys' placeholder
  placeholder,
  {
    path: '/usage',
    name: 'Usage',
    component: () => import('@/views/UsageView.vue'),
    meta: { requiresAuth: true, title: 'Usage Statistics' placeholder
  placeholder,
  {
    path: '/redeem',
    name: 'Redeem',
    component: () => import('@/views/RedeemView.vue'),
    meta: { requiresAuth: true, title: 'Redeem Code' placeholder
  placeholder,
  {
    path: '/profile',
    name: 'Profile',
    component: () => import('@/views/ProfileView.vue'),
    meta: { requiresAuth: true, title: 'Profile Settings' placeholder
  placeholder,
  ...
  // Admin routes (use AppLayout, admin only)
  {
    ...
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Admin Dashboard' placeholder
  placeholder,
  {
    path: '/admin/users',
    name: 'AdminUsers',
    component: () => import('@/views/admin/UsersView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'User Management' placeholder
  placeholder,
  {
    path: '/admin/groups',
    name: 'AdminGroups',
    component: () => import('@/views/admin/GroupsView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Groups' placeholder
  placeholder,
  {
    path: '/admin/accounts',
    name: 'AdminAccounts',
    component: () => import('@/views/admin/AccountsView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Accounts' placeholder
  placeholder,
  {
    path: '/admin/proxies',
    name: 'AdminProxies',
    component: () => import('@/views/admin/ProxiesView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Proxies' placeholder
  placeholder,
  {
    path: '/admin/redeem-codes',
    name: 'AdminRedeemCodes',
    component: () => import('@/views/admin/RedeemCodesView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Redeem Codes' placeholder
  placeholder,
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.requiresAuth && !authStore.isAuthenticated) {
    ...
    next('/login')
  placeholder else if (to.meta.requiresAdmin && !authStore.isAdmin) {
...
const userNavItems = [
  { path: '/dashboard', label: 'Dashboard', icon: '&#128200;' placeholder,
  { path: '/new-page', label: 'New Page', icon: '&#128196;' placeholder // Add new item
  // ...
]
```
...
```typescript
// AppHeader.test.ts
import { describe, it, expect, beforeEach placeholder from 'vitest'
