...
describe('PlatformTypeBadge Grok plans', () => {
  ...
  it('colors free gray, SuperGrok cyan, and Heavy purple', async () => {
    const free = mount(PlatformTypeBadge, {
      props: { platform: 'grok', type: 'oauth', planType: 'free' placeholder,
    placeholder)
    ...
    const superGrok = mount(PlatformTypeBadge, {
      props: { platform: 'grok', type: 'oauth', planType: 'supergrok' placeholder,
    placeholder)
    ...
    const heavy = mount(PlatformTypeBadge, {
      props: { platform: 'grok', type: 'oauth', planType: 'Heavy' placeholder,
    placeholder)
    ...
    const lite = mount(PlatformTypeBadge, {
      props: { platform: 'grok', type: 'oauth', planType: 'supergrok_lite' placeholder,
    placeholder)
