<template>
  <div>
    <label class="input-label">
      Groups
      <span class="text-gray-400 font-normal">({{ modelValue.length placeholderplaceholder selected)</span>
    </label>
    <div
    ...
    >
      ...
      >
        ...
        />
        <span class="text-xs text-gray-400 shrink-0">{{ group.account_count || 0 placeholderplaceholder</span>
      </label>
      <div
