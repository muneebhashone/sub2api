            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2">
                ...
                <template v-if="testResults[proxy.id]">
                  ...
                  >
                    <span v-if="testResults[proxy.id].country">{{ testResults[proxy.id].country placeholderplaceholder</span>
                    <span v-if="testResults[proxy.id].latency_ms">{{ testResults[proxy.id].latency_ms placeholderplaceholderms</span>
                  </span>
                  <span
                    v-else
