  ...
  <div class="relative" ref="containerRef">
    ...
    >
      ...
      <span class="date-picker-value">
        {{ displayValue placeholderplaceholder
      </span>
    ...
    <Transition name="date-picker-dropdown">
      <div v-if="isOpen" class="date-picker-dropdown">
        ...
        <div class="date-picker-presets">
          ...
          >
            {{ t(preset.labelKey) placeholderplaceholder
          </button>
        </div>
        ...
        <div class="date-picker-custom">
          <div class="date-picker-field">
            <label class="date-picker-label">{{ t('dates.startDate') placeholderplaceholder</label>
            <input
              type="date"
          ...
          <div class="date-picker-field">
            <label class="date-picker-label">{{ t('dates.endDate') placeholderplaceholder</label>
            <input
              type="date"
        ...
        <div class="date-picker-actions">
          <button @click="apply" class="date-picker-apply">
            {{ t('dates.apply') placeholderplaceholder
          </button>
        </div>
      </div>
    </Transition>
...
interface DatePreset {
  labelKey: string
  value: string
  getRange: () => { start: string; end: string placeholder
placeholder
...
interface Emits {
  ...
  (e: 'change', range: { startDate: string; endDate: string; preset: string | null placeholder): void
placeholder
...
const presets: DatePreset[] = [
  {
    ...
    getRange: () => {
      const t = today.value
      return { start: t, end: t placeholder
    placeholder
  placeholder,
  {
    ...
    getRange: () => {
      ...
      return { start: yesterday, end: yesterday placeholder
    placeholder
  placeholder,
  {
  ...
  placeholder,
  {
    ...
    getRange: () => {
      ...
      return { start, end: today.value placeholder
    placeholder
  placeholder,
  {
...
const displayValue = computed(() => {
  ...
  if (localStartDate.value && localEndDate.value) {
    ...
    placeholder
    return `${formatDate(localStartDate.value)placeholder - ${formatDate(localEndDate.value)placeholder`
  placeholder
...
const formatDate = (dateStr: string): string => {
  ...
  return date.toLocaleDateString(dateLocale, { month: 'short', day: 'numeric' placeholder)
placeholder
