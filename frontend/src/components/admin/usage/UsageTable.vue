        ...
        <template #cell-cost="{ row placeholder">
          <div class="text-sm">
            ...
            <div v-if="row.account_rate_multiplier != null" class="mt-0.5 text-[11px] text-gray-400">
              A ${{ (row.total_cost * row.account_rate_multiplier).toFixed(6) placeholderplaceholder
            </div>
          </div>
        </template>
        ...
        <div class="space-y-1.5">
          ...
          <div class="flex items-center justify-between gap-6 border-t border-gray-700 pt-1.5">
            ...
            <span class="font-semibold text-green-400">
              ${{ (((tooltipData?.total_cost || 0) * (tooltipData?.account_rate_multiplier ?? 1)) || 0).toFixed(6) placeholderplaceholder
            </span>
          </div>
        </div>
        <div class="absolute right-full top-1/2 h-0 w-0 -translate-y-1/2 border-b-[6px] border-r-[6px] border-t-[6px] border-b-transparent border-r-gray-900 border-t-transparent dark:border-r-gray-800"></div>
