<template>
  <div class="flex items-center gap-1">
    ...
    >
      ...
      <span class="text-xs">{{ t('admin.channelMonitor.runNow') placeholderplaceholder</span>
    </button>
    <button
    ...
    >
      ...
      <span class="text-xs">
        {{ duplicating ? t('admin.channelMonitor.duplicating') : t('admin.channelMonitor.duplicate') placeholderplaceholder
      </span>
    </button>
    <button
      @click="$emit('edit', row)"
