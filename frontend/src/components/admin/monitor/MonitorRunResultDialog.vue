    ...
    <div class="space-y-2">
      ...
      >
        ...
        <div class="flex items-center gap-2">
          ...
          >
            {{ statusLabel(r.status) placeholderplaceholder
          </span>
          <span class="text-xs text-gray-500 dark:text-gray-400">{{ formatLatency(r.latency_ms) placeholderplaceholder ms</span>
        </div>
      </div>
    </div>
    <template #footer>
