    ...
    <div v-if="group" class="space-y-4">
      ...
      <div class="flex flex-wrap items-center gap-3 rounded-lg bg-gray-50 px-4 py-2.5 text-sm dark:bg-dark-700">
        ...
        <span class="text-gray-600 dark:text-gray-400">
          {{ t('admin.groups.groupRpmDefault') placeholderplaceholder: {{ group.rpm_limit || 0 placeholderplaceholder
        </span>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 p-3 dark:border-dark-600">
        <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
          {{ t('admin.groups.addUserRpm') placeholderplaceholder
        </h4>
      ...
      <div v-else>
        <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
          {{ t('admin.groups.rpmOverrides') placeholderplaceholder ({{ localEntries.length placeholderplaceholder)
        </h4>

        <div v-if="localEntries.length === 0" class="py-6 text-center text-sm text-gray-400 dark:text-gray-500">
          {{ t('admin.groups.noRpmOverrides') placeholderplaceholder
        </div>
              ...
              <table class="w-full min-w-max text-sm">
                <thead class="sticky top-0 z-[1]">
                  <tr class="border-b border-gray-200 bg-gray-50 dark:border-dark-600 dark:bg-dark-700">
                    ...
                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400" :title="t('admin.groups.columns.rpmOverrideHint')">{{ t('admin.groups.columns.rpmOverride') placeholderplaceholder</th>
...
import type { GroupRPMOverrideEntry placeholder from '@/api/admin/groups'
...
interface LocalEntry extends GroupRPMOverrideEntry {placeholder
...
const handleClickOutside = () => { showDropdown.value = false placeholder
