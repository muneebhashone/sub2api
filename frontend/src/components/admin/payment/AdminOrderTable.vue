...
const columns: Column[] = [
  ...
  { key: 'user_id', label: 'User' placeholder,
  { key: 'amount', label: 'Amount' placeholder,
  { key: 'payment_type', label: 'Method' placeholder,
  { key: 'status', label: 'Status' placeholder,
  { key: 'order_type', label: 'Type' placeholder,
  { key: 'created_at', label: 'Created' placeholder,
