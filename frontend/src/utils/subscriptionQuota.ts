...
export type RemainingExpiryDuration =
  | { unit: 'days'; days: number placeholder
  | { unit: 'hoursMinutes'; hours: number; minutes: number placeholder
...
export function getRemainingDurationParts(
  ...
  return { days, hours, minutes placeholder
placeholder
...
export function getRemainingExpiryDuration(
  ...
  if (diffMs >= ONE_DAY_MS) {
    return { unit: 'days', days: Math.ceil(diffMs / ONE_DAY_MS) placeholder
  placeholder
