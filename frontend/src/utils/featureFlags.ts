 ...
 * // ...
 * { path: '/available-channels', label: ..., featureFlag: flagAvailableChannels placeholder
 * ```
 *
...
import { DEFAULT_INTERVAL_SECONDS placeholder from '@/constants/channelMonitor'
...
function defineFlag<K extends keyof PublicSettings>(
  def: { key: K; mode: FeatureFlagMode; label: string placeholder,
