<template>
  ...
  >
    ...
    <span v-if="showTrophy" class="sr-only">{{ ariaLabel placeholderplaceholder</span>
    <span
...
const label = computed(() => {
  ...
  return `#${rankNum.valueplaceholder`
placeholder)
...
const ariaLabel = computed(() => {
  ...
  return t('channelMonitorV2.rank.place', { n: rankNum.value placeholder)
placeholder)
