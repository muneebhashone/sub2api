...
export async function list(): Promise<ErrorPassthroughRule[]> {
  const { data placeholder = await apiClient.get<ErrorPassthroughRule[]>('/admin/error-passthrough-rules')
  return data
placeholder
...
export async function getById(id: number): Promise<ErrorPassthroughRule> {
  const { data placeholder = await apiClient.get<ErrorPassthroughRule>(`/admin/error-passthrough-rules/${idplaceholder`)
  return data
placeholder
...
export async function create(ruleData: CreateRuleRequest): Promise<ErrorPassthroughRule> {
  const { data placeholder = await apiClient.post<ErrorPassthroughRule>('/admin/error-passthrough-rules', ruleData)
  return data
placeholder
...
export async function update(id: number, updates: UpdateRuleRequest): Promise<ErrorPassthroughRule> {
  const { data placeholder = await apiClient.put<ErrorPassthroughRule>(`/admin/error-passthrough-rules/${idplaceholder`, updates)
  return data
placeholder
 ...
 */
export async function deleteRule(id: number): Promise<{ message: string placeholder> {
  const { data placeholder = await apiClient.delete<{ message: string placeholder>(`/admin/error-passthrough-rules/${idplaceholder`)
  return data
placeholder
...
export async function toggleEnabled(id: number, enabled: boolean): Promise<ErrorPassthroughRule> {
  return update(id, { enabled placeholder)
placeholder
