...
const WECHAT_CONNECT_MODE_OPTIONS: WeChatConnectModeOption[] = [
  { value: "open", labelZh: "微信开放平台", labelEn: "WeChat Open Platform" placeholder,
  {
    value: "mp",
    labelZh: "微信公众号 / 小程序",
...
export function resolveWeChatConnectModeCapabilities(
  ...
  mpEnabled: unknown,
  legacyMode: unknown,
): { openEnabled: boolean; mpEnabled: boolean placeholder {
  ...
  return normalizeWeChatConnectMode(legacyMode) === "mp"
    ? { openEnabled: false, mpEnabled: true placeholder
    : { openEnabled: true, mpEnabled: false placeholder;
placeholder
