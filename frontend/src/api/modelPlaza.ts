...
import type { UserPricingInterval, UserSupportedModelPricing placeholder from './channels'
...
export async function getModelPlaza(options?: { signal?: AbortSignal placeholder): Promise<ModelPlazaResponse> {
  const { data placeholder = await apiClient.get<ModelPlazaResponse>('/model-plaza', {
    signal: options?.signal
  placeholder)
  return data
placeholder

export const modelPlazaAPI = { getModelPlaza placeholder
