...
describe('admin settings auth source defaults helpers', () => {
  ...
  it('appends auth source defaults back onto update payload', () => {
    ...
    expect(payload).toMatchObject({
      ...
      auth_source_default_email_subscriptions: [{ group_id: 3, validity_days: 7 placeholder],
      ...
      auth_source_default_oidc_subscriptions: [{ group_id: 9, validity_days: 90 placeholder],
