export default {
  ...
  admin: {
    ...
    channels: {
      ...
      modelConflict: "Model patterns '{model1placeholder' and '{model2placeholder' conflict: overlapping match range",
      mappingConflict: "Mapping source patterns '{model1placeholder' and '{model2placeholder' conflict: overlapping match range",
