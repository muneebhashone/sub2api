export default {
  ...
  sora: {
    ...
    download: 'Download',
    justNow: 'Just now',
    minutesAgo: '{nplaceholder min ago',
    hoursAgo: '{nplaceholder hr ago',
    ...
    notificationCompletedBody: 'Your {modelplaceholder task has completed',
    notificationFailedBody: 'Your {modelplaceholder task has failed',
    upstreamExpiresSoon: 'Expiring soon',
    upstreamExpired: 'Link expired',
    upstreamCountdown: '{timeplaceholder remaining',
    ...
    generatingCount: 'Generating {currentplaceholder/{maxplaceholder',
    ...
    galleryCount: '{countplaceholder works',
