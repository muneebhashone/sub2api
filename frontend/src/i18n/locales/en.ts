export default {
  ...
  common: {
    ...
    justNow: 'just now',
    peakRateTooltip: 'Peak rate: {windowplaceholder',
  ...
  legal: {
    ...
    updatedAt: 'Updated: {dateplaceholder',
    empty: 'No content',
    ...
    loginAgreementPrompt: {
      ...
      dialogDescription: 'Our service terms were updated on {dateplaceholder. Please read and accept the following terms before continuing.',
      recently: 'recently',
  ...
  auth: {
    ...
    emailSuffixNotAllowedWithAllowed:
      'This email domain is not allowed. Allowed domains: {suffixesplaceholder',
    emailSuffixAllowedMore: 'and {countplaceholder more',
    ...
    resendCountdown: 'Resend code in {countdownplaceholders',
    ...
    promoCodeValid: 'Valid! You will receive ${amountplaceholder bonus balance',
    ...
    placeholder,
    emailOAuth: {
      signIn: 'Continue with {providerNameplaceholder'
    placeholder,
    oidc: {
      signIn: 'Continue with {providerNameplaceholder',
      callbackTitle: 'Signing you in with {providerNameplaceholder',
      callbackProcessing: 'Completing login with {providerNameplaceholder, please wait...',
      callbackHint: 'If you are not redirected automatically, go back to the login page and try again.',
      callbackMissingToken: 'Missing login token, please try again.',
      backToLogin: 'Back to Login',
      invitationRequired:
        'This {providerNameplaceholder account is not yet registered. The site requires an invitation code — please enter one to complete registration.',
  ...
  admin: {
    ...
    dataManagement: {
      ...
      sourceProfiles: {
        ...
        deleteConfirm: 'Delete source profile {profileIDplaceholder?',
        columns: {
          profile: 'Profile',
          active: 'Active',
      ...
      s3Profiles: {
        ...
        deleteConfirm: 'Delete S3 profile {profileIDplaceholder?',
        columns: {
          profile: 'Profile',
          active: 'Active',
          storage: 'Storage',
      ...
      actions: {
        ...
        jobCreated: 'Backup job created: {jobIDplaceholder ({statusplaceholder)',
    ...
    users: {
      ...
      publicGroupCount: '+{countplaceholder public',
      ...
      groupChangedWithGrant: 'Group updated. User auto-granted access to "{groupplaceholder"',
      ...
      groupConfigHint: 'Configure custom rate multipliers for user {emailplaceholder (overrides group defaults)',
      ...
      replaceGroupHint: 'Select a new group to replace "{oldplaceholder". Keys will be migrated and permissions updated automatically.',
      replaceGroupConfirm: 'Confirm Replace',
      replaceGroupSuccess: 'Group replaced successfully, {countplaceholder key(s) migrated',
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily / weekly / monthly USD usage limits for each upstream platform for user {emailplaceholder',
        columns: {
          platform: 'Platform',
          daily: 'Daily (USD)',
          weekly: 'Weekly (USD)',
        ...
        reset: {
          button: 'Reset window',
          confirm: 'Reset the {windowplaceholder usage for {platformplaceholder for this user? This is effective immediately.',
          success: 'Reset {platformplaceholder {windowplaceholder usage',
          failed: 'Reset failed',
        placeholder,
        ...
        invalidNumber: 'The following fields contain invalid numbers. Please fix them before saving: {fieldsplaceholder',
      placeholder
    placeholder,
    ...
    groups: {
      ...
      modelsList: {
        ...
        selectedSummary: 'Selected {selectedplaceholder / {totalplaceholder',
        selectAll: 'Select all',
    ...
    channels: {
      ...
      duplicateModels: 'Model "{0placeholder" appears in multiple pricing entries',
      modelConflict: "Model patterns '{model1placeholder' and '{model2placeholder' conflict: overlapping match range. Model names are matched case-insensitively, so an existing entry already covers all case variants — no need to add the variant separately.",
      mappingConflict: "Mapping source patterns '{model1placeholder' and '{model2placeholder' conflict: overlapping match range. Source patterns are matched case-insensitively, so an existing entry already covers all case variants.",
      intervalValidation: {
        negativeMin: 'Interval #{indexplaceholder: minimum token count ({valueplaceholder) cannot be negative',
        maxPositive: 'Interval #{indexplaceholder: maximum token count ({valueplaceholder) must be greater than 0',
        maxGreaterThanMin: 'Interval #{indexplaceholder: maximum token count ({maxplaceholder) must be greater than minimum token count ({minplaceholder)',
        negativePrice: 'Interval #{indexplaceholder: {fieldplaceholder cannot be negative',
        unboundedLast: 'Interval #{indexplaceholder: an unbounded interval (empty maximum token count) must be last',
        overlap: 'Intervals #{previousIndexplaceholder and #{currentIndexplaceholder overlap: previous upper bound ({previousMaxplaceholder) is greater than current lower bound ({currentMinplaceholder)',
        price: {
        ...
        placeholder
      placeholder,
      deleteConfirm: 'Are you sure you want to delete channel "{nameplaceholder"? This cannot be undone.',
      columns: {
        name: 'Name',
        description: 'Description',
        status: 'Status',
      ...
      form: {
        ...
        noGroupsAvailable: 'No groups available',
        inOtherChannel: 'In "{nameplaceholder"',
    ...
    riskControl: {
      ...
      apiKeyCount: '{countplaceholder keys',
      ...
      apiKeysHint: '{countplaceholder keys are currently stored. This input only adds keys; save appends and de-duplicates them.',
      ...
      apiKeyPendingDeleteCount: '{countplaceholder keys pending deletion',
      deleteApiKey: 'Delete this key',
      undoDeleteApiKey: 'Undo delete',
      inputApiKeyCount: '{countplaceholder keys in input',
      storedApiKeyCount: '{countplaceholder stored keys',
      ...
      apiKeyTestDone: 'Key test completed for {countplaceholder keys',
      ...
      apiKeyRows: '{countplaceholder keys',
      apiKeyRowsCollapsed: '{countplaceholder keys hidden',
      apiKeyRowsExpanded: 'Showing all {countplaceholder keys',
      ...
      apiKeyFailureCount: '{countplaceholder failures',
      apiKeyLatency: '{msplaceholder ms',
      apiKeyHTTPStatus: 'HTTP {statusplaceholder',
      apiKeyFrozenUntil: 'Frozen until {timeplaceholder',
      apiKeyLastChecked: 'Checked at {timeplaceholder',
      ...
      auditTestImageLimit: 'You can add up to {countplaceholder test images',
      ...
      auditTestHighest: 'Top category {categoryplaceholder, score {scoreplaceholder',
      ...
      flaggedHashCount: 'Current hash collection size: {countplaceholder',
      ...
      flaggedHashesCleared: 'Cleared {countplaceholder risk hashes',
      ...
      violationCount: '{countplaceholder hits',
      ...
      queueDelay: 'Queued {msplaceholder ms',
      allGroups: 'All Groups',
      ...
      modelFilterModelCount: '{countplaceholder models configured',
      modelFilterModelsRequired: 'This model scope requires at least 1 model',
      modelFilterAllSummary: 'Applies to all models',
      modelFilterIncludeSummary: 'Applies to {countplaceholder models',
      modelFilterExcludeSummary: 'Excludes {countplaceholder models',
      ...
      preBlockAPIKeyLoadSummary: 'Sync active {activeplaceholder / usable keys {availableplaceholder, {totalplaceholder total, worker: {workerActiveplaceholder / {workerTotalplaceholder',
      preBlockAPIKeyTotals: 'Total {totalplaceholder, success {successplaceholder, errors {errorsplaceholder',
      ...
      workerPoolMeta: '{activeplaceholder processing, {idleplaceholder idle and ready, {totalplaceholder total',
      ...
      lastCleanup: 'Last cleanup: {timeplaceholder',
      cleanupStats: 'Last cleanup deleted {hitplaceholder hits and {nonHitplaceholder non-hits',
      ...
      riskThresholdDefault: 'Default {valueplaceholder',
      ...
      blockedKeywordsModeWarning: 'Current mode is "{modeplaceholder". Keyword blocking will not run until you switch to "Pre-block" mode.',
      blockedKeywordCount: '{countplaceholder keywords configured',
      blockedKeywordsLimit: 'Up to {maxplaceholder keywords, each no longer than 200 characters. Duplicates are removed automatically.',
    ...
    channelMonitor: {
      ...
      deleteConfirm: 'Are you sure you want to delete monitor "{nameplaceholder"? This action cannot be undone.',
      ...
      advanced: {
        ...
        headerNameInvalid: 'Header name cannot contain whitespace or colon: {nameplaceholder',
        headersHint: 'Merged on top of adapter defaults (user wins). Hop-by-hop headers (Host / Content-Length / ...) are ignored.',
        headersParseError: 'Cannot parse line: {lineplaceholder',
      ...
      template: {
        ...
        applyConfirm: 'Apply',
        applyConfirmMessage: 'Overwrite {nplaceholder associated monitor(s) with the current configuration of "{nameplaceholder"? Any local customizations on those monitors will be discarded.',
        applySuccess: 'Applied to {nplaceholder monitor(s)',
        applyPickerTitle: 'Apply template "{nameplaceholder"',
        ...
        applyPickerConfirm: 'Apply to {nplaceholder monitor(s)',
        selectNone: 'Select none',
        selectedCount: 'Selected {nplaceholder / {totalplaceholder',
        deleteConfirm: 'Delete template "{nameplaceholder"? {nplaceholder associated monitor(s) will be disassociated but keep their current snapshot and continue running.',
        associatedCount: '{nplaceholder associated monitor(s)',
        headersSummary: '{nplaceholder custom header(s)',
        form: {
          name: 'Template name',
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Reset the daily, weekly, and monthly usage quota for '{userplaceholder'? Usage will be zeroed and windows restarted from today.",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      ...
      revokeConfirm:
        "Are you sure you want to revoke the subscription for '{userplaceholder'? You can restore it later from the revoked list.",
      restoreConfirm:
        "Restore the subscription for '{userplaceholder'? If the original subscription has expired, it will be restored as expired.",
      guide: {
    ...
    proxies: {
      ...
      dataImportResult: 'Import Result',
      dataImportResultSummary: 'Created {proxy_createdplaceholder, reused {proxy_reusedplaceholder, failed {proxy_failedplaceholder',
      dataImportErrors: 'Failure Details',
      dataImportSuccess: 'Import completed: created {proxy_createdplaceholder, reused {proxy_reusedplaceholder',
      dataImportCompletedWithErrors: 'Import completed with errors: failed {proxy_failedplaceholder',
      dataExport: 'Export',
      ...
      batchTestDone: 'Batch test completed for {countplaceholder proxies',
      batchTestFailed: 'Batch test failed',
      batchDeleteAction: 'Delete',
      batchDelete: 'Batch delete',
      batchDeleteConfirm: 'Delete {countplaceholder selected proxies? In-use ones will be skipped.',
      batchDeleteDone: 'Deleted {deletedplaceholder proxies, skipped {skippedplaceholder',
      batchDeleteSkipped: 'Skipped {skippedplaceholder proxies',
      ...
      qualityCheckDone: 'Quality check completed: score {scoreplaceholder ({gradeplaceholder)',
      qualityCheckFailed: 'Failed to run proxy quality check',
      batchQualityDone:
        'Batch quality check completed for {countplaceholder proxies: healthy {healthyplaceholder, warn {warnplaceholder, challenge {challengeplaceholder, abnormal {failedplaceholder',
      ...
      qualityGrade: 'Grade {gradeplaceholder',
      ...
      qualityInline: 'Quality {gradeplaceholder/{scoreplaceholder',
    ...
    redeem: {
      ...
      selectedCount: '{countplaceholder redeem code(s) selected',
      clearSelection: 'Clear selection',
      selectCodesFirst: 'Select redeem codes first',
      noBatchFieldsSelected: 'Select at least one field to update',
      batchUpdateSuccess: 'Updated {countplaceholder redeem code(s)',
      ...
      expiryPresetDays: '{daysplaceholder days',
      customExpiry: 'Custom',
    ...
    announcements: {
      ...
      targetingSummaryCustom: 'Custom ({groupsplaceholder groups)',
    ...
    ops: {
      ...
      loadingText: 'loading',
      ready: 'ready',
      autoRefreshRemaining: 'Remaining {secondsplaceholders',
      systemLogs: {
        title: 'System Logs',
      ...
      openaiTokenStats: {
        ...
        prevPage: 'Previous',
        nextPage: 'Next',
        pageInfo: 'Page {pageplaceholder/{totalplaceholder',
        totalModels: 'Total models: {totalplaceholder',
      ...
      diagnosis: {
        ...
        cpuCritical: 'CPU usage critically high ({usageplaceholder%)',
        ...
        cpuHigh: 'CPU usage elevated ({usageplaceholder%)',
        cpuHighImpact: 'System load is high, needs attention',
        cpuHighAction: 'Monitor CPU trends, prepare scaling plan',
        memoryCritical: 'Memory usage critically high ({usageplaceholder%)',
        ...
        upstreamCritical: 'Upstream error rate critically high ({rateplaceholder%)',
        ...
        upstreamHigh: 'Upstream error rate elevated ({rateplaceholder%)',
        ...
        // SLA diagnostics
        slaCritical: 'SLA critically below target ({slaplaceholder%)',
        ...
        slaLow: 'SLA below target ({slaplaceholder%)',
        ...
        healthCritical: 'Overall health score critically low ({scoreplaceholder)',
        ...
        healthLow: 'Overall health score low ({scoreplaceholder)',
      ...
      errorDetail: {
        title: 'Error Detail',
        titleWithId: 'Error #{idplaceholder',
      ...
      requestDetails: {
        ...
        details: 'Details',
        rangeLabel: 'Window: {rangeplaceholder',
        rangeMinutes: '{nplaceholder minutes',
        rangeHours: '{nplaceholder hours',
      ...
      alertRules: {
        ...
        placeholder,
        hints: {
          recommended: 'Recommended: operator {operatorplaceholder, threshold {thresholdplaceholder{unitplaceholder',
      ...
      runtime: {
        ...
        validation: {
          ...
          lockKeyPrefix: 'Distributed lock key must start with "{prefixplaceholder"',
          lockKeyHint: 'Recommended: start with "{prefixplaceholder" to avoid conflicts',
      ...
      realtime: {
        ...
        reconnectIn: 'retry in {secondsplaceholders'
      placeholder,
      queryMode: {
        auto: 'Auto',
        raw: 'Raw',
  ...
  announcements: {
    ...
    newCount: '{countplaceholder new announcement | {countplaceholder new announcements',
    readAt: 'Read at',
    read: 'Read',
    unread: 'Unread',
    startsAt: 'Starts at',
  ...
  userSubscriptions: {
    ...
    quotaEndsIn: 'Quota ends in {timeplaceholder',
  ...
  payment: {
    ...
    amountTooLow: 'Minimum amount is {minplaceholder',
    amountTooHigh: 'Maximum amount is {maxplaceholder',
    amountNoMethod: 'No payment method available for this amount',
    rechargeRatePreview: 'Current rate: 1 CNY = {usdplaceholder USD',
    ...
    errors: {
      tooManyPending: 'Too many pending orders (max {maxplaceholder). Please complete or cancel existing orders first.',
      ...
      TOO_MANY_PENDING: 'Too many pending orders (max {maxplaceholder). Please complete or cancel existing orders first.',
      DAILY_LIMIT_EXCEEDED: 'Daily recharge limit reached. Remaining: {remainingplaceholder.',
      ...
      WXPAY_CONFIG_MISSING_KEY: 'WeChat Pay config missing required key: {keyplaceholder.',
      WXPAY_CONFIG_INVALID_KEY_LENGTH: 'WeChat Pay {keyplaceholder length is invalid (expected {expectedplaceholder bytes, got {actualplaceholder).',
      WXPAY_CONFIG_INVALID_KEY: 'WeChat Pay {keyplaceholder is malformed. Make sure you copied the full PEM content.',
    ...
    admin: {
      ...
      price: 'Price',
      subscriptionCnyPayPreview: 'CNY channel charge preview: {amountplaceholder',
      subscriptionCnyPayPreviewWithFee: '({feeRateplaceholder% fee included: {totalplaceholder)',
      validityDays: 'Validity (days)',
