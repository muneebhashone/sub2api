export default {
  ...
  common: {
    ...
    contactSupport: 'Contact Support',
        ...
        saving: 'Saving...', 
        selectedCount: '({countplaceholder selected)',    refresh: 'Refresh',
    notAvailable: 'N/A',
    now: 'Now',
    unknown: 'Unknown',
    time: {
  ...
  auth: {
    ...
    signUpToStart: 'Sign up to start using {siteNameplaceholder',
    signUp: 'Sign up',
    ...
    accountCreatedSuccess: 'Account created successfully! Welcome to {siteNameplaceholder.',
  ...
  admin: {
    ...
    users: {
      ...
      daysRemaining: '{daysplaceholderd',
      expired: 'Expired',
      disable: 'Disable',
      enable: 'Enable',
      ...
      deleteConfirm: "Are you sure you want to delete '{emailplaceholder'? This action cannot be undone.",
      ...
      attributes: {
        ...
        deleteConfirm: "Are you sure you want to delete attribute '{nameplaceholder'? All user values for this attribute will be deleted.",
    ...
    groups: {
      ...
      deleteConfirmSubscription:
        "Are you sure you want to delete subscription group '{nameplaceholder'? This will invalidate all API keys bound to this subscription and delete all related subscription records. This action cannot be undone.",
      subscription: {
    ...
    subscriptions: {
      ...
      revokeConfirm:
        "Are you sure you want to revoke the subscription for '{userplaceholder'? This action cannot be undone."
    placeholder,
    ...
    proxies: {
      ...
      batchInputHint:
        "Supports http, https, socks5 protocols. Format: protocol://[user:pass{'@'placeholder]host:port",
      parsedCount: '{countplaceholder valid',
      invalidCount: '{countplaceholder invalid',
      duplicateCount: '{countplaceholder duplicate',
      importing: 'Importing...',
      importProxies: 'Import {countplaceholder proxies',
      batchImportSuccess: 'Successfully imported {createdplaceholder proxies, skipped {skippedplaceholder duplicates',
      batchImportAllSkipped: 'All {skippedplaceholder proxies already exist, skipped import',
      ...
      proxyWorkingWithLatency: 'Proxy is working! Latency: {latencyplaceholderms',
    ...
    redeem: {
      ...
      codesCreated: '{countplaceholder redeem code(s) created',
      codeType: 'Code Type',
      amount: 'Amount ($)',
      value: 'Value',
      count: 'Count',
      ...
      codesDeleted: 'Successfully deleted {countplaceholder unused code(s)',
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyConfiguredHint: 'Secret key configured. Leave empty to keep the current value.'      placeholder,
      defaults: {
  ...
  subscriptionProgress: {
    ...
    activeCount: '{countplaceholder active subscription(s)',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    daysRemaining: '{daysplaceholder days left',
    expired: 'Expired',
