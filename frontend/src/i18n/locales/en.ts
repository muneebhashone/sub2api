  ...
  admin: {
    ...
    ops: {
      ...
      diagnosis: {
        ...
        // Latency diagnostics
        latencyCritical: 'Response latency critically high ({latencyplaceholderms)',
        ...
        latencyHigh: 'Response latency elevated ({latencyplaceholderms)',
        ...
        ttftHigh: 'Time to first byte elevated ({ttftplaceholderms)',
