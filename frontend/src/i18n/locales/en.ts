export default {
  ...
  llmTester: {
    ...
    modelCount: '{countplaceholder models fetched',
    lastFetched: 'Fetched {timeplaceholder',
    ...
    modelsFetched: 'Fetched {countplaceholder models',
    capabilities: {
      chat: 'Chat',
      vision: 'Vision chat',
    ...
    errors: {
      ...
      imageTooLarge: '{nameplaceholder is larger than the 5 MB image limit',
      textTooLarge: '{nameplaceholder is larger than the 240 KB text limit',
      fileReadFailed: 'Failed to read {nameplaceholder'
    placeholder
  placeholder,
