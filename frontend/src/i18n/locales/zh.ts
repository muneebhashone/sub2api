export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      syncErrors: '错误/跳过详情',
      syncCompleted: '同步完成：创建 {createdplaceholder，更新 {updatedplaceholder',
      syncCompletedWithErrors: '同步完成但有错误：失败 {failedplaceholder（创建 {createdplaceholder，更新 {updatedplaceholder）',
      syncFailed: '同步失败',
      editAccount: '编辑账号',
      deleteAccount: '删除账号',
      ...
      allGroups: '共 {countplaceholder 个分组',
      columns: {
        name: '名称',
        platformType: '平台/类型',
        platform: '平台',
