export default {
  ...
  dashboard: {
    ...
    platformCount: '{countplaceholder 个平台',
    platformOther: '其他',
    platformQuota: {
      title: '配额用量',
      daily: '日',
  ...
  keys: {
    ...
    editKey: '编辑密钥',
    deleteKey: '删除密钥',
    deleteConfirmMessage: "确定要删除 '{nameplaceholder' 吗？此操作无法撤销。",
    apiKey: 'API 密钥',
    group: '分组',
    ...
    resetQuotaConfirmMessage: '确定要将密钥 "{nameplaceholder" 的已用额度（${usedplaceholder）重置为 0 吗？此操作不可撤销。',
    ...
    resetRateLimitConfirmMessage: '确定要重置密钥 "{nameplaceholder" 的速率限制用量吗？所有时间窗口的已用额度将归零。此操作不可撤销。',
    rateLimitResetSuccess: '速率限制已重置',
    failedToResetRateLimit: '重置速率限制失败',
    resetNow: '即将重置',
    expiration: '密钥有效期',
    expiresInDays: '{daysplaceholder 天',
    extendDays: '+{daysplaceholder 天',
    customDate: '自定义',
    expirationDate: '过期时间',
  ...
  usage: {
    ...
    exportedCount: '已导出 {currentplaceholder/{totalplaceholder 条',
    estimatedTime: '预计剩余时间：{timeplaceholder',
    cancelExport: '取消导出',
    ...
    ipGeo: {
      ...
      batchFetch: '批量获取地区',
      batchFetching: '获取中...',
      pending: '{countplaceholder 个 IP 待获取地区',
    ...
    placeholder,
    tabs: { usage: '用量明细', errors: '错误请求' placeholder,
    errors: {
  ...
  monitorCommon: {
    ...
    history60pts: '近 {nplaceholder 次记录',
    nextUpdateIn: '{nplaceholders 后刷新',
    past: 'PAST',
    now: 'NOW',
    maintenancePaused: '维护中 · 已暂停时间线采集',
    extraModelsCount: '+ {nplaceholder 模型',
    pollEvery: '{nplaceholders 轮询',
    updatedAt: '更新于 {timeplaceholder',
    relativeSecondsAgo: '{nplaceholder 秒前',
    relativeMinutesAgo: '{nplaceholder 分钟前',
    relativeHoursAgo: '{nplaceholder 小时前',
    relativeDaysAgo: '{nplaceholder 天前'
  placeholder,
  ...
  affiliate: {
    ...
    transfer: {
      ...
      transferring: '转入中...',
      empty: '当前没有可转入额度',
      success: '已转入余额：{amountplaceholder'
    placeholder,
    invitees: {
      title: '已邀请用户',
      empty: '暂无邀请记录',
    ...
    tips: {
      ...
      line2: '被邀请用户充值后，你可获得 {rateplaceholder 的返利额度。',
      line3: '返利额度可随时转入账户余额。',
  ...
  redeem: {
    ...
    subscriptionAssignedDesc: '您已获得 {groupNameplaceholder 的访问权限',
    subscriptionDays: '{daysplaceholder 天',
    days: '天',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      resend: '重发',
      codeSent: '验证码已发送',
      codeSentTo: '验证码已发送到 {emailplaceholder',
      enterCode: '输入验证码',
    ...
    authBindings: {
      ...
      bindAction: '绑定 {providerNameplaceholder',
      bindSuccess: '账号绑定成功',
      emailPlaceholder: '输入邮箱地址',
      ...
      unbindAction: '解绑',
      unbindSuccess: '{providerNameplaceholder 已解绑',
      boundCount: '已关联 {countplaceholder 条记录',
      status: {
        bound: '已绑定',
        notBound: '未绑定',
      placeholder,
  ...
  pagination: {
    ...
    results: '条结果',
    page: '页',
    pageOf: '第 {pageplaceholder / {totalplaceholder 页',
    previous: '上一页',
    next: '下一页',
    perPage: '每页',
    goToPage: '跳转到第 {pageplaceholder 页',
    jumpTo: '跳转页',
    jumpPlaceholder: '页码',
    jumpAction: '跳转'
  placeholder,
  ...
  admin: {
    ...
    channels: {
      ...
      duplicateModels: '模型「{0placeholder」在多个定价条目中重复',
      modelConflict: "模型模式 '{model1placeholder' 和 '{model2placeholder' 冲突：匹配范围重叠。模型名称按大小写不敏感匹配，已有条目已覆盖其所有大小写变体，无需重复添加。",
      mappingConflict: "模型映射源 '{model1placeholder' 和 '{model2placeholder' 冲突：匹配范围重叠。源模式按大小写不敏感匹配，已有条目已覆盖其所有大小写变体。",
      intervalValidation: {
        negativeMin: '区间 #{indexplaceholder：最小 token 数（{valueplaceholder）不能为负数',
        maxPositive: '区间 #{indexplaceholder：最大 token 数（{valueplaceholder）必须大于 0',
        maxGreaterThanMin: '区间 #{indexplaceholder：最大 token 数（{maxplaceholder）必须大于最小 token 数（{minplaceholder）',
        negativePrice: '区间 #{indexplaceholder：{fieldplaceholder不能为负数',
        unboundedLast: '区间 #{indexplaceholder：无上限区间（最大 token 数为空）必须放在最后',
        overlap: '区间 #{previousIndexplaceholder 和 #{currentIndexplaceholder 重叠：前一个上界（{previousMaxplaceholder）大于当前下界（{currentMinplaceholder）',
        price: {
          inputPrice: '输入价格',
          outputPrice: '输出价格',
        ...
        placeholder
      placeholder,
      deleteConfirm: '确定要删除渠道「{nameplaceholder」吗？此操作不可撤销。',
      columns: {
        name: '名称',
        description: '描述',
        status: '状态',
      ...
      form: {
        ...
        inOtherChannel: '已属于「{nameplaceholder」',
        modelPricing: '模型定价',
        models: '模型列表',
        ...
        syncingModels: '同步中...',
        syncModelsSuccess: '已同步 {countplaceholder 个新模型',
    ...
    riskControl: {
      ...
      apiKeyCount: '{countplaceholder 个 Key',
      ...
      apiKeysHint: '当前已保存 {countplaceholder 个 Key；输入区只用于新增，保存时会增量追加并自动去重。',
      ...
      apiKeyPendingDeleteCount: '待删除 {countplaceholder 个 Key',
      deleteApiKey: '删除这个 Key',
      undoDeleteApiKey: '撤销删除',
      inputApiKeyCount: '输入区 {countplaceholder 个 Key',
      storedApiKeyCount: '已保存 {countplaceholder 个 Key',
      ...
      apiKeyTestDone: 'Key 测试完成，共 {countplaceholder 个',
      ...
      apiKeyRows: '{countplaceholder 个 Key',
      apiKeyRowsCollapsed: '已隐藏 {countplaceholder 个 Key',
      apiKeyRowsExpanded: '正在显示全部 {countplaceholder 个 Key',
      expandApiKeyRows: '展开',
      ...
      apiKeyFailureCount: '失败 {countplaceholder 次',
      apiKeyLatency: '{msplaceholder ms',
      apiKeyHTTPStatus: 'HTTP {statusplaceholder',
      apiKeyFrozenUntil: '冻结至 {timeplaceholder',
      apiKeyLastChecked: '检查于 {timeplaceholder',
      ...
      clearAuditTest: '清空试跑',
      auditTestImageLimit: '最多只能添加 {countplaceholder 张测试图片',
      auditTestImageTooLarge: '单张测试图片不能超过 8MB',
      auditTestImageReadFailed: '读取测试图片失败',
      auditTestResult: '审计试跑结果',
      auditTestHighest: '最高分类 {categoryplaceholder，分数 {scoreplaceholder',
      ...
      flaggedHashCount: '当前哈希集合数量：{countplaceholder 个',
      ...
      flaggedHashesCleared: '已清空 {countplaceholder 个风险哈希',
      ...
      violationCount: '{countplaceholder 次',
      emailSent: '已发邮件',
      emailNotSent: '未发邮件',
      autoBanned: '已封禁',
      unbanUser: '解封',
      ...
      queueDelay: '排队 {msplaceholder ms',
      allGroups: '全部分组',
      ...
      modelFilterModelCount: '已配置 {countplaceholder 个模型',
      modelFilterModelsRequired: '当前模型范围至少需要配置 1 个模型',
      modelFilterAllSummary: '全部模型生效',
      modelFilterIncludeSummary: '仅 {countplaceholder 个模型生效',
      modelFilterExcludeSummary: '排除 {countplaceholder 个模型',
      emptyLogs: '暂无审核记录',
      ...
      preBlockAPIKeyLoadSummary: '同步并发 {activeplaceholder / 可用 Key {availableplaceholder，累计 {totalplaceholder 次，worker：{workerActiveplaceholder / {workerTotalplaceholder',
      preBlockAPIKeyTotals: '累计 {totalplaceholder，成功 {successplaceholder，异常 {errorsplaceholder',
      ...
      workerPool: 'Worker 池',
      workerPoolMeta: '{activeplaceholder 个处理中，{idleplaceholder 个空闲可用，共 {totalplaceholder 个',
      queueUsage: '队列占用',
      activeWorkers: '处理中',
      idleWorkers: '空闲可用',
      ...
      lastCleanup: '上次清理：{timeplaceholder',
      cleanupStats: '上次清理删除命中 {hitplaceholder 条，未命中 {nonHitplaceholder 条',
      riskSwitchOff: '系统开关关闭',
      riskThresholds: '风险阈值',
      riskThresholdsHint: '按 OpenAI Moderations 分类调整命中阈值，分数达到或超过阈值即视为命中。',
      riskThresholdDefault: '默认 {valueplaceholder',
      ...
      blockedKeywordsModeWarning: '当前为「{modeplaceholder」模式，关键词拦截不会生效；请切换到「前置拦截」模式后再保存关键词。',
      blockedKeywordCount: '已配置 {countplaceholder 个关键词',
      blockedKeywordsLimit: '最多保存 {maxplaceholder 个关键词，单个长度不超过 200 个字符；重复项会自动去重。',
    ...
    channelMonitor: {
      ...
      loadError: '加载监控列表失败',
      deleteConfirm: '确定要删除监控「{nameplaceholder」吗？此操作不可撤销。',
      ...
      advanced: {
        ...
        headerNameInvalid: 'Header 名不能包含空格或冒号：{nameplaceholder',
        headersHint: '与默认请求头合并，用户值优先。hop-by-hop 类 header（Host/Content-Length/...）会被忽略。',
        headersParseError: '无法解析这一行：{lineplaceholder',
        bodyMode: '请求体处理',
        bodyModeOff: '默认',
        bodyModeMerge: '合并',
        bodyModeReplace: '覆盖',
      ...
      template: {
        ...
        applyTitle: '应用模板',
        applyConfirm: '确认应用',
        applyConfirmMessage: '将把模板「{nameplaceholder」的当前配置覆盖到 {nplaceholder 个关联监控。监控本地已编辑的自定义修改会被丢弃，是否继续？',
        applySuccess: '已应用到 {nplaceholder 个监控',
        applyPickerTitle: '应用模板「{nameplaceholder」',
        applyPickerHint: '勾选要覆盖请求头/请求体的监控（默认全选）。监控本地已编辑的自定义修改会被丢弃。',
        applyPickerEmpty: '当前模板没有关联监控',
        applyPickerConfirm: '应用到 {nplaceholder 个监控',
        selectNone: '全不选',
        selectedCount: '已选 {nplaceholder / {totalplaceholder',
        deleteConfirm: '确定要删除模板「{nameplaceholder」吗？{nplaceholder 个关联监控会解除关联但保留自己的快照继续工作。',
        associatedCount: '{nplaceholder 个关联监控',
        headersSummary: '{nplaceholder 个自定义请求头',
        form: {
          name: '模板名称',
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "确定要重置 '{userplaceholder' 的每日、每周和每月用量配额吗？用量将归零并从今天开始重新计算。",
      ...
      revokeConfirm: "确定要撤销 '{userplaceholder' 的订阅吗？可稍后在已撤销列表中恢复。",
      restoreConfirm: "确定要恢复 '{userplaceholder' 的订阅吗？如果原订阅已过期，恢复后将显示为已过期。",
      guide: {
        title: '订阅管理教程',
    ...
    ops: {
      ...
      loadingText: '加载中...',
      ready: '就绪',
      autoRefreshRemaining: '剩余 {secondsplaceholders',
      systemLogs: {
        title: '系统日志',
        ...
        cleanupSuccess: '清理完成，已删除 {countplaceholder 条日志。',
      ...
      openaiTokenStats: {
        ...
        prevPage: '上一页',
        nextPage: '下一页',
        pageInfo: '第 {pageplaceholder/{totalplaceholder 页',
        totalModels: '模型总数：{totalplaceholder',
      ...
      requestDetails: {
        title: '请求明细',
        details: '明细',
        rangeLabel: '窗口：{rangeplaceholder',
        rangeMinutes: '{nplaceholder 分钟',
        rangeHours: '{nplaceholder 小时',
        empty: '该窗口内暂无请求。',
      ...
      alertRules: {
        ...
        placeholder,
        hints: {
          recommended: '推荐：运算符 {operatorplaceholder，阈值 {thresholdplaceholder{unitplaceholder',
      ...
      runtime: {
        ...
        validation: {
          ...
          lockKeyPrefix: '分布式锁 Key 必须以「{prefixplaceholder」开头',
          lockKeyHint: '建议以「{prefixplaceholder」开头以避免冲突',
      ...
      concurrency: {
        ...
        totalRows: '共 {countplaceholder 项',
      ...
      realtime: {
        ...
        offline: '实时离线',
        closed: '实时已关闭',
        reconnectIn: '重连 {secondsplaceholders'
      placeholder,
      queryMode: {
        auto: 'Auto（自动）',
        raw: 'Raw（不聚合）',
