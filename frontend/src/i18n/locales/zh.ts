export default {
  ...
  llmTester: {
    ...
    fetchModels: '拉取模型',
    modelCount: '已拉取 {countplaceholder 个模型',
    lastFetched: '拉取时间 {timeplaceholder',
    ...
    modelsFetched: '已拉取 {countplaceholder 个模型',
    capabilities: {
      chat: '聊天',
      vision: '视觉聊天',
    ...
    errors: {
      ...
      cancelled: '请求已取消',
      imageTooLarge: '{nameplaceholder 超过 5 MB 图片限制',
      textTooLarge: '{nameplaceholder 超过 240 KB 文本限制',
      fileReadFailed: '读取 {nameplaceholder 失败'
    placeholder
  placeholder,
  ...
  admin: {
    ...
    subscriptions: {
      ...
      revokeConfirm: "确定要撤销 '{userplaceholder' 的订阅吗？此操作无法撤销。",
      guide: {
        title: '订阅管理教程',
