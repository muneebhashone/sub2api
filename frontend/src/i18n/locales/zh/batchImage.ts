export default {
  batchImage: {
    ...
    placeholder,
    list: {
      selectedJobs: '已选择 {countplaceholder 个任务',
      expandChildren: '展开 {nplaceholder 个子任务',
      collapseChildren: '收起子任务',
      childCount: '{nplaceholder 子任务',
      childBadge: '子任务',
      keyNotRecorded: '未记录',
      totalCount: '共 {nplaceholder',
      notDownloaded: '未下载',
      empty: '暂无批量任务',
      emptyHint: '点击右上角创建批量任务。',
    placeholder,
    pagination: {
      pageNumber: '第 {pageplaceholder 页',
      pageItems: '本页 {countplaceholder 条',
    placeholder,
    promptPopover: {
      title: '完整 Prompt',
      copied: 'Prompt 已复制',
    ...
    detail: {
      ...
      items: '明细',
      preview: '预览',
      previewZoom: '放大压缩预览 {idplaceholder',
      ...
      mainTask: '主任务：{nameplaceholder',
      childTask: '子任务：{nameplaceholder',
      holdCost: '冻结 {amountplaceholder',
    placeholder,
    itemResult: {
    ...
    create: {
      ...
      estimatedOutputValue: '{imagesplaceholder 张 / {promptsplaceholder 条',
      promptAdded: '已添加 {countplaceholder 条',
      promptPlaceholder: '粘贴 prompt，添加后进入下方列表',
      customIdPlaceholder: 'Custom ID 可选',
      outputCountPerPrompt: '每条生成张数',
      outputCountOption: '{nplaceholder 张',
      referenceImage: '参考图',
      removeReferenceImage: '移除参考图',
      limitsHint: '每条最多 {maxPerItemplaceholder 张，整组最多 {maxPerJobplaceholder 张；当前模型每条最多 {refLimitplaceholder 张参考图，参考图按生成张数重复消耗输入 token。',
      referenceCount: '{nplaceholder 参考图',
      ...
      refLimitReached: '当前模型每条最多 {limitplaceholder 张参考图。',
      refLimitExceededIgnored: '当前模型每条最多 {limitplaceholder 张参考图，已忽略超出的文件。',
      refFormatUnsupported: '参考图仅支持 PNG、JPEG 或 WebP。',
      refFileTooLarge: '{nameplaceholder 超过 10MB，已忽略。',
    placeholder,
    guide: {
      title: '批量生图使用说明',
      uiTitle: '当前界面如何使用',
    ...
    messages: {
      ...
      errorReference: '错误信息',
      errorCodeRef: '错误码：{codeplaceholder',
      requestIdRef: '请求 ID：{idplaceholder',
      httpStatusRef: 'HTTP 状态：{statusplaceholder',
    placeholder,
  placeholder,
placeholder
