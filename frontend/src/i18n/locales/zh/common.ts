export default {
  common: {
    ...
    submitting: '提交中...',
    justNow: '刚刚',
    peakRateTooltip: '高峰倍率：{windowplaceholder',
    ...
    unknownError: '发生未知错误',
    saving: '保存中...',
    selectedCount: '（已选 {countplaceholder 个）',
    refresh: '刷新',
    autoRefresh: {
      title: '自动刷新',
      enable: '启用自动刷新',
      countdown: '自动刷新: {secondsplaceholders',
      seconds: '{nplaceholder 秒',
    placeholder,
    view: '查看',
    settings: '设置',
    chooseFile: '选择文件',
    ...
    selectedFile: '已选：{nameplaceholder',
    fileReadFailed: '读取文件失败',
    selectImageFile: '请选择图片文件',
    fileTooLargeKb: '文件过大（{sizeplaceholder KB），上限 {maxplaceholder KB',
    copy: '复制',
    notAvailable: '不可用',
    now: '现在',
    today: '今天',
  ...
  legal: {
    ...
    updatedAt: '更新日期：{dateplaceholder',
    empty: '暂无正文内容',
    loginAgreement: '登录条款',
    ...
    loginAgreementPrompt: {
      ...
      viewTerms: '查看条款',
      dialogTitle: '条款更新通知',
      dialogDescription: '我们的服务条款已于 {dateplaceholder 更新。在继续使用服务之前，请仔细阅读并同意以下条款。',
      recently: '近期',
  ...
  auth: {
    ...
    createAccount: '创建账户',
    signUpToStart: '注册以开始使用 {siteNameplaceholder',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    emailSuffixNotAllowedWithAllowed: '该邮箱域名不被允许。可用域名：{suffixesplaceholder',
    emailSuffixAllowedMore: '等 {countplaceholder 项',
    loginSuccess: '登录成功！欢迎回来。',
    accountCreatedSuccess: '账户创建成功！欢迎使用 {siteNameplaceholder。',
    ...
    resendCountdown: '{countdownplaceholder秒后可重新发送',
    ...
    promoCodeValid: '有效！注册后将获得 ${amountplaceholder 赠送余额',
    ...
    placeholder,
    emailOAuth: {
      signIn: '使用 {providerNameplaceholder 登录'
    placeholder,
    oidc: {
      signIn: '使用 {providerNameplaceholder 登录',
      callbackTitle: '正在完成 {providerNameplaceholder 登录',
      callbackProcessing: '正在验证 {providerNameplaceholder 登录信息，请稍候...',
      callbackHint: '如果页面未自动跳转，请返回登录页重试。',
      callbackMissingToken: '登录信息缺失，请返回重试。',
      backToLogin: '返回登录',
      invitationRequired: '该 {providerNameplaceholder 账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
    ...
    placeholder,
    oauthFlow: {
      profileDetailsTitle: '使用 {providerNameplaceholder 资料',
      profileDetailsDescription: '选择是否将 {providerNameplaceholder 的昵称或头像应用到当前账户。',
      useDisplayName: '使用昵称',
      useAvatar: '使用头像',
      avatarAlt: '{providerNameplaceholder 头像',
      reviewProfileBeforeContinue: '请先确认 {providerNameplaceholder 资料后再继续。',
      chooseHowToContinue: '选择后续操作',
      chooseAccountActionHint: '请选择绑定已有账户，或创建一个新账户。',
      suggestedEmail: '建议邮箱：{emailplaceholder',
      bindExistingAccount: '绑定已有账户',
      createNewAccount: '创建新账户',
      createAccountHint: '请输入邮箱地址以创建账户并继续。',
      bindLoginHint: '登录一个已有账户以绑定此次 {providerNameplaceholder 登录。',
      signInThenBindDescription: '请先登录已有账户，再将此次 {providerNameplaceholder 登录绑定到该账户。',
      bindSignInToExistingAccount: '将此次 {providerNameplaceholder 登录绑定到已有账户。',
      bindCurrentAccountTitle: '绑定当前账户',
      bindCurrentAccountDescription: '将此次 {providerNameplaceholder 登录绑定到当前浏览器已登录的账户。',
      bindCurrentAccount: '绑定当前账户',
      logInAndBind: '登录并绑定',
      useDifferentEmail: '使用其他邮箱',
      backToOptions: '返回选项',
      yourAccount: '当前账户',
      totpHint: '请输入 {accountplaceholder 的 6 位验证码，以完成此次 {providerNameplaceholder 登录绑定。',
