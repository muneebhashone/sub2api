export default {
    ...
    proxies: {
      ...
      ad: {
        inline: '正在寻找合适的代理 IP？'
      placeholder,
      deleteConfirmMessage: "确定要删除代理 '{nameplaceholder' 吗？",
      testProxy: '测试代理',
      dataImport: '导入',
      ...
      dataImportResultSummary: '创建 {proxy_createdplaceholder，复用 {proxy_reusedplaceholder，失败 {proxy_failedplaceholder',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：创建 {proxy_createdplaceholder，复用 {proxy_reusedplaceholder',
      dataImportCompletedWithErrors: '导入完成但有错误：失败 {proxy_failedplaceholder',
      dataExport: '导出',
      ...
      batchTestDone: '批量测试完成，共测试 {countplaceholder 个代理',
      batchTestFailed: '批量测试失败',
      batchDeleteAction: '删除',
      batchDelete: '批量删除',
      batchDeleteConfirm: '确定删除选中的 {countplaceholder 个代理吗？已被账号使用的将自动跳过。',
      batchDeleteDone: '已删除 {deletedplaceholder 个代理，跳过 {skippedplaceholder 个',
      batchDeleteSkipped: '已跳过 {skippedplaceholder 个代理',
      ...
      batchInputPlaceholder:
        "每行输入一个代理，支持以下格式：\nsocks5://user:pass{'@'placeholder192.168.1.1:1080\nhttp://192.168.1.1:8080\nhttps://user:pass{'@'placeholderproxy.example.com:443",
      batchInputHint: "支持 http、https、socks5 协议，格式：协议://[用户名:密码{'@'placeholder]主机:端口",
      parsedCount: '有效 {countplaceholder 个',
      invalidCount: '无效 {countplaceholder 个',
      duplicateCount: '重复 {countplaceholder 个',
      importing: '导入中...',
      importProxies: '导入 {countplaceholder 个代理',
      batchImportSuccess: '成功导入 {createdplaceholder 个代理，跳过 {skippedplaceholder 个重复',
      batchImportAllSkipped: '全部 {skippedplaceholder 个代理已存在，跳过导入',
      ...
      proxyDeleted: '代理删除成功',
      proxyWorking: '代理连接正常',
      proxyWorkingWithLatency: '代理连接正常，延迟 {latencyplaceholderms',
      proxyTestFailed: '代理测试失败',
      qualityCheckDone: '质量检测完成：评分 {scoreplaceholder（{gradeplaceholder）',
      qualityCheckFailed: '代理质量检测失败',
      batchQualityDone: '批量质量检测完成，共检测 {countplaceholder 个；优质 {healthyplaceholder 个，告警 {warnplaceholder 个，挑战 {challengeplaceholder 个，异常 {failedplaceholder 个',
      batchQualityFailed: '批量质量检测失败',
      batchQualityEmpty: '暂无可检测质量的代理',
      qualityReportTitle: '代理质量检测报告',
      qualityGrade: '等级 {gradeplaceholder',
      qualityExitIP: '出口 IP',
      qualityCountry: '出口地区',
      ...
      qualityInline: '质量 {gradeplaceholder/{scoreplaceholder',
      ...
      deleteConfirm: "确定要删除代理 '{nameplaceholder' 吗？使用此代理的账号将被移除代理设置。",
      neverExpires: '永不过期',
      expired: '已过期',
      overdueDays: '已超期 {daysplaceholder 天',
      expiringInDays: '{daysplaceholder 天后到期',
      remainingDays: '剩余 {daysplaceholder 天',
      expiresAt: '有效期',
      nDays: '{daysplaceholder 天',
    ...
    redeem: {
      ...
      selectedCount: '已选择 {countplaceholder 个兑换码',
      clearSelection: '清空选择',
      selectCodesFirst: '请先选择兑换码',
      noBatchFieldsSelected: '请至少勾选一个要修改的字段',
      batchUpdateSuccess: '成功修改 {countplaceholder 个兑换码',
      ...
      codesCreated: '已创建 {countplaceholder 个兑换码',
      codeType: '类型',
      amount: '金额 ($)',
      value: '面值',
      count: '数量',
      ...
      codeDeleted: '兑换码删除成功',
      codesDeleted: '成功删除 {countplaceholder 个未使用的兑换码',
      noUnusedCodes: '没有未使用的兑换码可删除',
      userPrefix: '用户 #{idplaceholder',
      ...
      codeExpiry: '兑换码过期',
      neverExpires: '永不过期',
      expiryPresetDays: '{daysplaceholder 天',
      customExpiry: '自定义',
      ...
      codesGeneratedSuccess: '兑换码生成成功，共 {countplaceholder 个',
    ...
    announcements: {
      ...
      targetingSummaryCustom: '自定义（{groupsplaceholder 组）',
      timeImmediate: '立即',
      timeNever: '永久',
      readStatus: '已读情况',
      preview: '预览',
    ...
    usage: {
      ...
      tokenRanking: {
        ...
        userCount: '共 {countplaceholder 位用户',
        columns: {
          user: '用户',
          requests: '请求数',
          inputTokens: '输入 Token',
