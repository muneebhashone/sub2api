export default {
    accounts: {
      ...
      autoRefreshCountdown: '自动刷新：{secondsplaceholders',
      ...
      toolActions: '工具',
      viewColumns: '列显示',
      selectedCount: '已选 {countplaceholder',
      dataExportConfirmMessage: '导出的数据包含账号与代理的敏感信息，请妥善保存。',
      dataExportConfirm: '确认导出',
      dataExported: '数据导出成功',
      dataExportedSkippedShadows: '数据已导出。已跳过 {countplaceholder 个 spark 影子账号：其调度配置不在备份内，还原后需在重建的影子上重新调优。',
      ...
      dataImportParseFailedFile: '文件 {nameplaceholder 解析失败',
      dataImportInvalidFile: '文件 {nameplaceholder 不是受支持的导出数据文件',
      dataImportIgnoredFiles: '已忽略 {countplaceholder 个非 JSON 文件',
      dataImportFailed: '数据导入失败',
      dataImportResult: '导入结果',
      dataImportResultSummary: '代理创建 {proxy_createdplaceholder，复用 {proxy_reusedplaceholder，失败 {proxy_failedplaceholder；账号创建 {account_createdplaceholder，失败 {account_failedplaceholder',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号 {account_createdplaceholder，失败 {account_failedplaceholder',
      dataImportCompletedWithErrors: '导入完成但有错误：账号失败 {account_failedplaceholder，代理失败 {proxy_failedplaceholder',
      ...
      syncResult: '同步结果',
      syncResultSummary: '创建 {createdplaceholder，更新 {updatedplaceholder，跳过 {skippedplaceholder，失败 {failedplaceholder',
      syncErrors: '错误/跳过详情',
      syncCompleted: '同步完成：创建 {createdplaceholder，更新 {updatedplaceholder，跳过 {skippedplaceholder',
      syncCompletedWithErrors: '同步完成但有错误：失败 {failedplaceholder（创建 {createdplaceholder，更新 {updatedplaceholder，跳过 {skippedplaceholder）',
      syncFailed: '同步失败',
      crsPreview: '预览',
      crsPreviewing: '预览中...',
      ...
      crsWillUpdate: '将更新 {countplaceholder 个已有账号。',
      crsSelectedCount: '已选择 {countplaceholder 个新账号',
      ...
      groupCountTotal: '共 {countplaceholder 个分组',
      columns: {
        name: '名称',
        id: '账号ID',
        platformType: '平台/类型',
      ...
      ollamaCloud: {
        ...
        unauthorized: '会话已过期',
        failed: '刷新失败',
        windowWithReset: '已用 {percentplaceholder，{resetplaceholder 重置',
        ...
        errors: {
          ...
          OLLAMA_CLOUD_USAGE_REFRESH_RATE_LIMITED: '刷新过于频繁，请在 {retry_after_secondsplaceholder 秒后重试。'
        placeholder
      placeholder,
      upstreamBilling: {
        ...
        failed: '失败',
        notProbed: '未探测',
        groupRate: '分组默认：{valueplaceholderx',
        userRate: '用户专属倍率：{valueplaceholderx',
        peakRate: '高峰：{startplaceholder-{endplaceholder，{valueplaceholderx（{timezoneplaceholder）',
        noPeakRate: '高峰倍率：未启用',
        effectiveRate: '当前倍率：{valueplaceholderx',
        updatedAt: '更新时间：{valueplaceholder',
        nextProbeAt: '下一次探测：{valueplaceholder',
        lastDetectedRate: '上次探测倍率：{valueplaceholderx',
        lastDetectedAt: '上次探测时间：{valueplaceholder',
        elapsedSince: '已过去：{valueplaceholder',
        justNow: '不足 1 分钟',
        minutesAgo: '{countplaceholder 分钟',
        hoursAgo: '{countplaceholder 小时',
        daysAgo: '{countplaceholder 天',
        ...
        batchCompleted: '已完成 {countplaceholder 个账号的倍率探测',
        batchPartial: '倍率探测部分完成：成功 {successplaceholder 个，失败 {failedplaceholder 个'
      placeholder,
      ...
      capacity: {
        ...
        placeholder,
        sessions: {
          full: '活跃会话已满，新会话需等待（空闲超时：{idleplaceholder分钟）',
          normal: '活跃会话正常（空闲超时：{idleplaceholder分钟）'
        placeholder,
        rpm: {
          full: '已达 RPM 上限',
          warning: 'RPM 接近上限',
          ...
          tieredStickyOnly: 'RPM 限制 (三区模型) - 仅粘性会话 | 缓冲区: {bufferplaceholder',
          tieredBlocked: 'RPM 限制 (三区模型) - 已阻塞 | 缓冲区: {bufferplaceholder',
      ...
      quotaDailyLimitHintFixed: '每天 {hourplaceholder:00（{timezoneplaceholder）重置。',
      quotaWeeklyLimitHintFixed: '每{dayplaceholder {hourplaceholder:00（{timezoneplaceholder）重置。',
      dayOfWeek: {
        monday: '周一',
        tuesday: '周二',
        wednesday: '周三',
      ...
      apiKey: 'API Key',
      deleteConfirm: "确定要删除账号 '{nameplaceholder' 吗？此操作无法撤销。",
      ...
      status: {
        ...
        modelCreditOveragesUntil: '{modelplaceholder 正在使用 AI Credits，至 {timeplaceholder',
        creditsExhausted: '积分已用尽',
        creditsExhaustedUntil: 'AI Credits 已用尽，预计 {timeplaceholder 恢复',
        overloadedUntil: '负载过重，重置时间：{timeplaceholder',
        viewTempUnschedDetails: '查看临时不可调度详情',
        tempUnschedulableUntil: '预计 {timeplaceholder 恢复'
      placeholder,
      tempUnschedulable: {
        title: '临时不可调度',
        ...
        addRule: '添加规则',
        ruleOrder: '规则序号',
        multipleErrorTrigger: '{minutesplaceholder 分钟内累计 {countplaceholder 次匹配错误，达到触发阈值（{thresholdplaceholder）。',
        multipleErrorTriggerNoWindow: '累计 {countplaceholder 次匹配错误，达到触发阈值（{thresholdplaceholder）。',
        multipleErrorCountInWindow: '{minutesplaceholder 分钟内累计发生 {countplaceholder 次匹配错误。',
        multipleErrorCount: '本次不可调度由累计 {countplaceholder 次匹配错误触发。',
        ruleIndex: '规则 #{indexplaceholder',
        errorCode: '错误码',
        ...
        expired: '已到期',
        remainingMinutes: '约 {minutesplaceholder 分钟',
        remainingHours: '约 {hoursplaceholder 小时',
        remainingHoursMinutes: '约 {hoursplaceholder 小时 {minutesplaceholder 分钟',
        presets: {
      ...
      openaiQuotaReset: {
        ...
        expiresAt: '到期 {timeplaceholder',
        expiresAtFull: '重置次数到期时间: {timeplaceholder',
        expandExpirations: '展开其余 {countplaceholder 张重置次数到期时间',
        collapseExpirations: '收起重置次数到期时间',
        expirationDetails: '重置次数到期明细',
        noCreditsAvailable: '没有可用的重置次数',
        resetSuccess: '已重置 {windowsplaceholder 个窗口，次数和账号状态已更新',
        ...
        confirmTitle: '确认重置周限',
        confirmMessage: '将消耗 1 次重置次数立即恢复当前窗口，剩余 {countplaceholder 次。此操作不可撤销，确定继续吗？'
      placeholder,
      tier: {
        free: 'Free',
        pro: 'Pro',
      ...
      bulkActions: {
        ...
        selectedAll: '已选择全部 {countplaceholder 个账号',
        selectCurrentPage: '本页全选',
        selectAllResults: '全选所有结果（{countplaceholder）',
        selectingAll: '正在选择全部结果...',
        selectAllFailed: '获取全部账号失败，原有选择未改变',
        clear: '清除选择',
        edit: '批量编辑账号',
        delete: '批量删除',
        confirmDelete: '确认删除选中的 {countplaceholder 个账号吗？此操作不可恢复。',
        deleteSuccess: '已成功删除 {countplaceholder 个账号',
        enableScheduling: '批量启用调度',
        disableScheduling: '批量停止调度',
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        probeUpstreamBilling: '探测上游倍率',
        resetStatusSuccess: '已成功重置 {countplaceholder 个账号状态',
        refreshTokenSuccess: '已成功刷新 {countplaceholder 个账号令牌',
        partialSuccess: '操作部分完成：{successplaceholder 成功，{failedplaceholder 失败'
      placeholder,
      bulkEdit: {
        title: '批量编辑账号',
        selectionInfo: '已选择 {countplaceholder 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
        baseUrlPlaceholder: 'https://api.anthropic.com 或 https://api.openai.com',
        baseUrlNotice: '适用于 API Key 账号及 Grok OAuth 账号的转发端点，留空则不修改',
        submit: '批量更新',
        updating: '更新中...',
        success: '成功更新 {countplaceholder 个账号',
        successWithInherited: '成功更新 {countplaceholder 个账号；其中 {inheritedplaceholder 个影子账号仍跟随母账号。',
        partialSuccess: '部分更新成功：成功 {successplaceholder 个，失败 {failedplaceholder 个',
        partialSuccessWithInherited: '部分更新成功：成功 {successplaceholder 个，失败 {failedplaceholder 个；其中 {inheritedplaceholder 个影子账号仍跟随母账号。',
        failed: '批量更新失败',
        noSelection: '请选择要编辑的账号',
        noFieldsSelected: '请至少选择一个要更新的字段',
        rateSyncWarning: '已开启上游倍率同步的账号不能批量手工修改倍率，请先在账号编辑页关闭同步。',
        rateSyncConflict: '无法修改账号倍率：{countplaceholder 个目标账号已开启上游倍率同步。',
        longContextShadowHint: '长上下文计费归母账号所有。选中的影子账号仍跟随母账号，筛选全量目标时同样如此。',
        longContextParentRequired: '选中的账号全部是影子账号，请选择母账号修改长上下文计费。',
        mixedPlatformWarning: '所选账号跨越多个平台（{platformsplaceholder）。显示的模型映射预设为合并结果——请确保映射对每个平台都适用。'
      placeholder,
      bulkDeleteTitle: '批量删除账号',
      bulkDeleteConfirm: '确定要删除选中的 {countplaceholder 个账号吗？此操作无法撤销。',
      bulkDeleteSuccess: '成功删除 {countplaceholder 个账号',
      bulkDeletePartial: '部分删除成功：成功 {successplaceholder 个，失败 {failedplaceholder 个',
      ...
      fallbackActive: '已回退',
      fallbackActiveTip: '原代理 {originplaceholder 已到期，当前使用备用代理',
      revertProxy: '切回原代理',
      revertProxySuccess: '已成功切回原代理',
      revertProxyFailed: '切回原代理失败',
      createSparkShadow: '创建 Spark 影子账号',
      createSparkShadowConfirm: '为「{nameplaceholder」创建链接型 Spark 影子账号?影子共享母账号凭据、仅服务 spark 模型。',
      createSparkShadowSuccess: 'Spark 影子账号已创建',
      createSparkShadowFailed: '创建 Spark 影子账号失败',
      duplicateAccount: '复制账号',
      duplicateSuccess: '账号已复制为「{nameplaceholder」，已暂停调度，请确认凭据后再启用',
      ...
      grok: {
        ...
        selectedTestMode: '测试模式：{modeplaceholder',
      ...
      selectedModels: '已选择 {countplaceholder 个模型',
      supportsAllModels: '（支持所有模型）',
      requestModel: '请求模型',
      actualModel: '实际模型',
      addMapping: '添加映射',
      mappingExists: '模型 {modelplaceholder 的映射已存在',
      ...
      syncUpstreamModelsSuccess: '已从上游同步 {countplaceholder 个新模型（上游共 {totalplaceholder 个）',
      syncUpstreamModelsNoChanges: '上游 {countplaceholder 个模型均已在白名单中',
      syncUpstreamModelsEmpty: '上游没有返回可同步的模型',
      syncUpstreamModelsFailed: '同步上游模型失败',
      syncUpstreamModelsError: '同步上游模型失败：{messageplaceholder',
      clearAllModels: '清除所有模型',
      customModelName: '自定义模型名称',
      enterCustomModelName: '输入自定义模型名称',
      addModel: '填入',
      modelExists: '该模型已存在',
      modelCount: '{countplaceholder 个模型',
      poolMode: '池模式',
      ...
      poolModeRetryCountHint: '仅在池模式下生效。0 表示不原地重试；默认 {defaultplaceholder，最大 {maxplaceholder。',
      poolModeRetryStatusCodes: '同账号重试状态码',
      poolModeRetryStatusCodesHint: '仅在池模式下生效。以英文逗号分隔的 HTTP 状态码（100-599），命中时触发同账号重试。留空使用默认值（{defaultplaceholder）。',
      ...
      affinityClients: '{countplaceholder 个亲和客户端：',
      ...
      mixedChannelWarning: '警告：分组 "{groupNameplaceholder" 中同时包含 {currentPlatformplaceholder 和 {otherPlatformplaceholder 账号。混合使用不同渠道可能导致 thinking block 签名验证问题，会自动回退到非 thinking 模式。确定要继续吗？',
      ...
      oauth: {
        ...
        keysCount: '{countplaceholder 个密钥',
        batchCreateAccounts: '将批量创建 {countplaceholder 个账号',
        ...
        keyAuthFailed: '密钥 {indexplaceholder: {errorplaceholder',
        successCreated: '成功创建 {countplaceholder 个账号',
        batchSuccess: '成功创建 {countplaceholder 个账号',
        batchPartialSuccess: '部分成功：{successplaceholder 个成功，{failedplaceholder 个失败',
        batchFailed: '批量创建失败',
        // OpenAI specific
        openai: {
          title: 'OpenAI 账户授权',
          ...
          codexSessionImportSuccess: '导入完成：新增 {createdplaceholder，更新 {updatedplaceholder，跳过 {skippedplaceholder',
          codexSessionImportPartial: '部分成功：新增 {createdplaceholder，更新 {updatedplaceholder，跳过 {skippedplaceholder，失败 {failedplaceholder',
      ...
      errorPrefix: '错误：{messageplaceholder',
      imagePreviewAlt: '测试图片 {indexplaceholder',
      ...
      usingModel: '使用模型：{modelplaceholder',
      ...
      imagePreview: '生成结果：',
      imageReceived: '已收到第 {countplaceholder 张测试图片',
      audioPreview: '生成音频：',
      audioReceived: '已收到第 {countplaceholder 段测试音频',
      videoPreview: '生成视频：',
      videoReceived: '已收到第 {countplaceholder 段测试视频',
      // Stats Modal
      viewStats: '查看统计',
      ...
      stats: {
        ...
        totalCalls: '累计调用次数',
        avgDailyCost: '日均费用',
        basedOnActualDays: '基于 {daysplaceholder 天实际使用',
