export default {
    ...
    backup: {
      ...
      actions: {
        ...
        partLabel: '第 {indexplaceholder 卷',
    ...
    users: {
      ...
      createUser: '创建用户',
      bulkLimits: {
        action: '批量设置限制（{countplaceholder）',
        title: '批量设置用户限制',
        selectedCount: '已选择 {countplaceholder 个用户',
        selectionLimit: '一次最多选择 {maxplaceholder 个用户。',
        selectUser: '选择 {emailplaceholder',
        ...
        apply: '应用限制',
        applying: '应用中...',
        concurrencyValue: '并发数：{valueplaceholder',
        rpmValue: 'RPM：{valueplaceholder',
        rpmUnlimitedValue: 'RPM：不限制',
        confirm: '确定覆盖 {countplaceholder 个用户的限制吗？\n{fieldsplaceholder',
        success: '已更新 {countplaceholder 个用户的限制',
        failed: '批量更新用户限制失败'
      placeholder,
      editUser: '编辑用户',
      deleteUser: '删除用户',
      deleteConfirmMessage: "确定要删除用户 '{emailplaceholder' 吗？此操作无法撤销。",
      ...
      noSubscription: '暂无订阅',
      publicGroupCount: '+{countplaceholder 公开',
      exclusiveLabel: '专属',
      publicLabel: '公开',
      daysRemaining: '{daysplaceholder天',
      expired: '已过期',
      disable: '禁用',
      enable: '启用',
      disableUser: '禁用用户',
      ...
      groupChangedWithGrant: '分组修改成功，已自动为用户添加「{groupplaceholder」分组权限',
      ...
      deleteConfirm: "确定要删除用户 '{emailplaceholder' 吗？此操作无法撤销。",
      roles: {
        admin: '管理员',
        user: '用户'
      placeholder,
      ...
      // 用户分组配置
      groupConfig: '用户分组配置',
      groupConfigHint: '为用户 {emailplaceholder 配置专属分组倍率（覆盖分组默认倍率）',
      ...
      replaceGroupHint: '选择新分组替换「{oldplaceholder」，将自动迁移绑定的 Key 并更新分组权限',
      replaceGroupConfirm: '确认替换',
      replaceGroupSuccess: '分组替换成功，已迁移 {countplaceholder 个 Key',
      ...
      attributes: {
        ...
        deleteConfirm: "确定要删除属性 '{nameplaceholder' 吗？所有用户的该属性值将被删除。",
      ...
      platformQuota: {
        menuItem: '平台限额',
        title: '平台限额',
        subtitle: '为用户 {emailplaceholder 配置各上游平台的日 / 周 / 月用量上限',
        columns: {
          platform: '平台',
          daily: '日 (USD)',
          weekly: '周 (USD)',
        ...
        reset: {
          button: '重置该窗口',
          confirm: '确认重置该用户 {platformplaceholder 平台的 {windowplaceholder 用量？此操作立即生效。',
          success: '已重置 {platformplaceholder {windowplaceholder 用量',
          failed: '重置失败',
        placeholder,
        ...
        invalidNumber: '以下字段填写不是合法数字，请修正后再保存：{fieldsplaceholder',
      placeholder
    placeholder,
    ...
    groups: {
      ...
      duplicate: '复制',
      duplicating: '复制中',
      duplicateSuccess: '分组已复制为「{nameplaceholder」，已默认停用，请确认配置后再启用',
      ...
      deleteConfirm: "确定要删除分组 '{nameplaceholder' 吗？所有关联的 API 密钥将不再属于任何分组。",
      deleteConfirmSubscription:
        "确定要删除订阅分组 '{nameplaceholder' 吗？此操作会让所有绑定此订阅的用户的 API Key 失效，并删除所有相关的订阅记录。此操作无法撤销。",
      columns: {
        name: '名称',
        id: 'ID',
        platform: '平台',
      ...
      nonExclusive: '公开',
      public: '公开',
      rateAndAccounts: '{rateplaceholderx 费率 · {countplaceholder 个账号',
      accountsCount: '{countplaceholder 个账号',
      rateLabel: '倍率',
      accountFilters: {
        title: '账号过滤控制',
      ...
      modelPricing: {
        title: '分组逐模型定价',
        description: '匹配模型后覆盖渠道和内置价格。音频可用按次层级配置 realtime、tts、stt。',
        longContext: '启用长上下文阶梯定价',
        longContextHint: '关闭时，Token 模型始终只使用配置的最低档。',
        add: '添加模型价格'
      placeholder,
      voicePricing: {
        title: 'Grok Voice 定价',
      ...
      webSearchPricing: {
        ...
        finalPricePreview: '应用当前倍率后的单次价格：{priceplaceholder'
      placeholder,
      peakRate: {
        enable: '启用高峰倍率',
        peakStart: '高峰开始',
      ...
      modelsList: {
        ...
        loading: '正在加载模型列表...',
        empty: '暂无可展示模型',
        selectedSummary: '已选 {selectedplaceholder / {totalplaceholder',
        selectAll: '全选',
        invertSelection: '反选'
      placeholder,
      compositeRoutes: {
        action: '路由',
        title: 'Composite 路由',
        titleWithGroup: 'Composite 路由：{nameplaceholder',
        routes: '已保存路由',
