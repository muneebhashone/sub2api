export default {
    ...
    channels: {
      ...
      intervalValidation: {
        ...
        multiplierPositive: 'Interval #{indexplaceholder: {fieldplaceholder must be greater than 0',
    ...
    channelMonitor: {
      ...
      duplicateSuccess: 'Monitor duplicated as "{nameplaceholder" and disabled. Review its configuration before enabling it.',
