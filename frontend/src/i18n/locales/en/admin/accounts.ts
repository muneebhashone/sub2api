export default {
    accounts: {
      ...
      autoRefreshCountdown: 'Auto refresh: {secondsplaceholders',
      ...
      dataExportedSkippedShadows: 'Data exported. Skipped {countplaceholder spark shadow account(s): their scheduling config is not included in the backup; recreate and re-tune them after restore.',
      ...
      dataImportParseFailedFile: 'Failed to parse {nameplaceholder',
      dataImportInvalidFile: '{nameplaceholder is not a supported data export file',
      dataImportIgnoredFiles: 'Ignored {countplaceholder non-JSON file(s)',
      dataImportFailed: 'Data import failed',
      dataImportResult: 'Import Result',
      dataImportResultSummary: 'Proxies created {proxy_createdplaceholder, reused {proxy_reusedplaceholder, failed {proxy_failedplaceholder; Accounts created {account_createdplaceholder, failed {account_failedplaceholder',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: accounts {account_createdplaceholder, failed {account_failedplaceholder',
      dataImportCompletedWithErrors: 'Import completed with errors: account failed {account_failedplaceholder, proxy failed {proxy_failedplaceholder',
      ...
      groupCountTotal: '{countplaceholder groups total',
      platforms: {
        anthropic: 'Anthropic',
        claude: 'Claude',
        openai: 'OpenAI',
      ...
      status: {
        ...
        modelCreditOveragesUntil: '{modelplaceholder using AI Credits until {timeplaceholder',
        creditsExhausted: 'Credits Exhausted',
        creditsExhaustedUntil: 'AI Credits exhausted, expected recovery at {timeplaceholder',
        overloadedUntil: 'Overloaded until {timeplaceholder',
        viewTempUnschedDetails: 'View temp unschedulable details',
        tempUnschedulableUntil: 'Resumes {timeplaceholder'
      placeholder,
      columns: {
        name: 'Name',
        id: 'Account ID',
      ...
      ollamaCloud: {
        ...
        windowWithReset: '{percentplaceholder used, resets {resetplaceholder',
        ...
        errors: {
          ...
          OLLAMA_CLOUD_USAGE_REFRESH_RATE_LIMITED: 'Refresh is limited. Try again in {retry_after_secondsplaceholder seconds.'
        placeholder
      placeholder,
      upstreamBilling: {
        ...
        groupRate: 'Group default: {valueplaceholderx',
        userRate: 'User rate: {valueplaceholderx',
        peakRate: 'Peak: {startplaceholder-{endplaceholder, {valueplaceholderx ({timezoneplaceholder)',
        noPeakRate: 'Peak rate: disabled',
        effectiveRate: 'Current rate: {valueplaceholderx',
        updatedAt: 'Updated: {valueplaceholder',
        nextProbeAt: 'Next probe: {valueplaceholder',
        lastDetectedRate: 'Last detected rate: {valueplaceholderx',
        lastDetectedAt: 'Last detected: {valueplaceholder',
        elapsedSince: 'Elapsed: {valueplaceholder',
        justNow: 'less than 1 minute',
        minutesAgo: '{countplaceholder minutes',
        hoursAgo: '{countplaceholder hours',
        daysAgo: '{countplaceholder days',
      ...
      capacity: {
        ...
        placeholder,
        sessions: {
          full: 'Active sessions full, new sessions must wait (idle timeout: {idleplaceholder min)',
          normal: 'Active sessions normal (idle timeout: {idleplaceholder min)'
        placeholder,
        rpm: {
          ...
          tieredStickyOnly: 'RPM limit (Tiered) - Sticky only | Buffer: {bufferplaceholder',
          tieredBlocked: 'RPM limit (Tiered) - Blocked | Buffer: {bufferplaceholder',
      ...
      tempUnschedulable: {
        ...
        multipleErrorTrigger: '{countplaceholder matching errors in {minutesplaceholder minutes reached the trigger threshold ({thresholdplaceholder).',
        multipleErrorTriggerNoWindow: '{countplaceholder matching errors reached the trigger threshold ({thresholdplaceholder).',
        multipleErrorCountInWindow: '{countplaceholder matching errors occurred within {minutesplaceholder minutes.',
        multipleErrorCount: '{countplaceholder matching errors contributed to this block.',
        ruleIndex: 'Rule #{indexplaceholder',
        ...
        expired: 'Expired',
        remainingMinutes: 'About {minutesplaceholder minutes',
        remainingHours: 'About {hoursplaceholder hours',
        remainingHoursMinutes: 'About {hoursplaceholder hours {minutesplaceholder minutes',
        presets: {
      ...
      quotaDailyLimitHintFixed: 'Resets daily at {hourplaceholder:00 ({timezoneplaceholder).',
      quotaWeeklyLimitHintFixed: 'Resets every {dayplaceholder at {hourplaceholder:00 ({timezoneplaceholder).',
      dayOfWeek: {
        monday: 'Monday',
        tuesday: 'Tuesday',
        wednesday: 'Wednesday',
      ...
      bulkActions: {
        ...
        selectedAll: 'All {countplaceholder account(s) selected',
        selectCurrentPage: 'Select this page',
        selectAllResults: 'Select all results ({countplaceholder)',
        selectingAll: 'Selecting all results...',
        selectAllFailed: 'Failed to load all accounts. The previous selection was kept.',
        clear: 'Clear selection',
        edit: 'Bulk Edit',
        delete: 'Bulk Delete',
        confirmDelete: 'Delete the selected {countplaceholder account(s)? This action cannot be undone.',
        deleteSuccess: 'Deleted {countplaceholder account(s)',
        enableScheduling: 'Enable Scheduling',
        disableScheduling: 'Disable Scheduling',
        resetStatus: 'Reset Status',
        refreshToken: 'Refresh Token',
        probeUpstreamBilling: 'Probe Upstream Rate',
        resetStatusSuccess: 'Successfully reset {countplaceholder account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {countplaceholder account(s) token',
        partialSuccess: 'Partially completed: {successplaceholder succeeded, {failedplaceholder failed'
      placeholder,
      bulkEdit: {
        title: 'Bulk Edit Accounts',
        selectionInfo:
          '{countplaceholder account(s) selected. Only checked or filled fields will be updated; others stay unchanged.',
        ...
        updating: 'Updating...',
        success: 'Updated {countplaceholder account(s)',
        successWithInherited: 'Updated {countplaceholder account(s). {inheritedplaceholder selected shadow account(s) still follow their parent account.',
        partialSuccess: 'Partially updated: {successplaceholder succeeded, {failedplaceholder failed',
        partialSuccessWithInherited: 'Partially updated: {successplaceholder succeeded, {failedplaceholder failed. {inheritedplaceholder selected shadow account(s) still follow their parent account.',
        ...
        rateSyncConflict: 'Cannot change account rates: {countplaceholder target account(s) have upstream rate sync enabled.',
      ...
      bulkDeleteSuccess: 'Deleted {countplaceholder account(s)',
      bulkDeletePartial: 'Partially deleted: {successplaceholder succeeded, {failedplaceholder failed',
      ...
      createSparkShadowConfirm: 'Create a spark shadow account linked to "{nameplaceholder"? It shares the parent\'s credentials and serves only spark models.',
      ...
      duplicateSuccess: 'Account duplicated as "{nameplaceholder" and paused. Review its credentials before enabling it.',
      ...
      deleteConfirm: "Are you sure you want to delete '{nameplaceholder'? This action cannot be undone.",
      ...
      grok: {
        ...
        selectedTestMode: 'Test mode: {modeplaceholder',
      ...
      selectedModels: 'Selected {countplaceholder model(s)',
      ...
      syncUpstreamModelsSuccess: 'Synced {countplaceholder new model(s) from upstream ({totalplaceholder upstream total)',
      syncUpstreamModelsNoChanges: 'All {countplaceholder upstream model(s) are already in the whitelist',
      syncUpstreamModelsEmpty: 'Upstream returned no models to sync',
      syncUpstreamModelsFailed: 'Failed to sync upstream models',
      syncUpstreamModelsError: 'Failed to sync upstream models: {messageplaceholder',
      clearAllModels: 'Clear all models',
      customModelName: 'Custom model name',
      enterCustomModelName: 'Enter custom model name',
      addModel: 'Add',
      modelExists: 'Model already exists',
      modelCount: '{countplaceholder models',
      poolMode: 'Pool Mode',
      ...
      poolModeRetryCountHint:
        'Only applies in pool mode. Use 0 to disable in-place retry. Default {defaultplaceholder, maximum {maxplaceholder.',
      poolModeRetryStatusCodes: 'Retry Status Codes',
      poolModeRetryStatusCodesHint:
        'Comma-separated HTTP status codes (100-599) that trigger same-account retry in pool mode. Leave blank to use defaults ({defaultplaceholder).',
      ...
      affinityClients: '{countplaceholder affinity clients:',
      ...
      mixedChannelWarning: 'Warning: Group "{groupNameplaceholder" contains both {currentPlatformplaceholder and {otherPlatformplaceholder accounts. Mixing different channels may cause thinking block signature validation issues, which will fallback to non-thinking mode. Are you sure you want to continue?',
      ...
      oauth: {
        ...
        keysCount: '{countplaceholder keys',
        batchCreateAccounts: 'Will batch create {countplaceholder accounts',
        ...
        openai: {
          ...
          codexSessionImportSuccess: 'Import completed: created {createdplaceholder, updated {updatedplaceholder, skipped {skippedplaceholder',
          codexSessionImportPartial: 'Partial success: created {createdplaceholder, updated {updatedplaceholder, skipped {skippedplaceholder, failed {failedplaceholder',
        ...
        grok: {
          ...
          emailPasswordPlaceholder: "user{'@'placeholderexample.com----your-password\nMultiple lines supported",
          emailPasswordHint:
        ...
        antigravity: {
          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                    ...
                    failedToValidateRT: 'Failed to validate Refresh Token'
                  placeholder
                placeholder,      // Gemini specific (platform-wide)
      gemini: {
        helpButton: 'Help',
        helpDialog: {
      ...
      errorPrefix: 'Error: {messageplaceholder',
      imagePreviewAlt: 'Test image {indexplaceholder',
      ...
      usingModel: 'Using model: {modelplaceholder',
      ...
      imageReceived: 'Received test image #{countplaceholder',
      audioPreview: 'Generated audio:',
      audioReceived: 'Received test audio #{countplaceholder',
      videoPreview: 'Generated video:',
      videoReceived: 'Received test video #{countplaceholder',
      // Stats Modal
      ...
      stats: {
        ...
        basedOnActualDays: 'Based on {daysplaceholder actual usage days',
      ...
      usageWindow: {
        ...
        grokLastStatus: 'Status {statusplaceholder',
        grokLastProbe: 'Probe {timeplaceholder',
        grokLastHeadersSeen: 'Headers {timeplaceholder',
      ...
      openaiQuotaReset: {
        ...
        expiresAt: 'Expires {timeplaceholder',
        expiresAtFull: 'Reset credit expires at {timeplaceholder',
        expandExpirations: 'Expand the other {countplaceholder reset credit expiration(s)',
        ...
        resetSuccess: 'Reset {windowsplaceholder window(s); credits and account state updated',
        ...
        confirmMessage: 'This will consume 1 reset credit to immediately restore the current window ({countplaceholder remaining). This action cannot be undone. Continue?'
      placeholder,
      tier: {
        free: 'Free',
        pro: 'Pro',
