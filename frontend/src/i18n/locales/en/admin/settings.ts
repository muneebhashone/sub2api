export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in 3 blocks. Supports an array or {"blocks": [...]placeholder.',
        claudeOAuthSystemPromptBlocksHint: 'Each block is saved as JSON with enabled, type, text, and optional cache_control. {billing_headerplaceholder stays dynamic per request; the Claude Code identity and expansion prompts can be edited directly or restored from presets.',
