export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          placeholder,
          batchModal: {
            title: 'Batch Set Rate ({countplaceholder users selected)',
      ...
      registration: {
        ...
        emailSuffixWhitelistHint:
          "Emails from allowlist domains can register without a quota. When the allowlist is not empty, every other registrable domain can register one account. Empty the allowlist to remove the quota for all domains (for example, {'@'placeholderqq.com, {'@'placeholdergmail.com, *.edu.cn).",
        emailSuffixWhitelistPlaceholder: "{'@'placeholderexample.com, *.edu.cn",
      ...
      apiKeyAcl: {
        ...
        forwardedClientIpHeadersLimit: 'At most {maxplaceholder custom client-IP headers are allowed.',
        removeForwardedClientIpHeader: 'Remove {headerplaceholder'
      placeholder,
      linuxdo: {
      ...
      defaults: {
        ...
        defaultSubscriptionsDuplicate:
          'Duplicate subscription group: {groupIdplaceholder. Each group can only appear once.',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksHint: "Each block is saved as JSON with enabled, type, text, and optional cache_control. {'{'placeholderbilling_header{'placeholder'placeholder stays dynamic per request; the Claude Code identity and expansion prompts can be edited directly or restored from presets.",
        systemBlockTitle: 'System Block {indexplaceholder',
        ...
        openaiCodexVersionSyncedValue: 'Currently synced: {versionplaceholder',
      ...
      site: {
        ...
        tableDefaultPageSizeRangeError: 'Default rows per page must be between {minplaceholder and {maxplaceholder',
        tablePageSizeOptionsFormatError: 'Invalid options format. Enter comma-separated integers between {minplaceholder and {maxplaceholder',
        customEndpoints: {
          title: 'Custom Endpoints',
          description: 'Add additional API endpoint URLs for users to quickly copy on the API Keys page',
          itemLabel: 'Endpoint #{nplaceholder',
          name: 'Name',
        ...
        logoSizeError: 'Image size exceeds 300KB limit ({sizeplaceholderKB)',
      ...
      customMenu: {
        ...
        itemLabel: 'Menu Item #{nplaceholder',
        name: 'Menu Name',
      ...
      payment: {
        ...
        balanceRechargePreview: 'Preview: 1 CNY = {usdplaceholder USD',
        ...
        rechargeFeePreview: 'Preview: Recharge 100, fee {feeplaceholder',
        ...
        validationFieldRequired: '{fieldplaceholder is required',
        ...
        stripeWebhookApiVersionHint: 'Set this Webhook endpoint API version to match the integrated Stripe SDK. Recommended: {versionplaceholder. A mismatch can cause webhook parsing errors.',
        ...
        enableConflict: '{methodplaceholder already has an enabled provider instance: {providerplaceholder. Disable the existing instance before switching.',
      placeholder,
      balanceNotify: {
      ...
      smtp: {
        ...
        usernamePlaceholder: "your-email{'@'placeholdergmail.com",
        ...
        fromEmailPlaceholder: "noreply{'@'placeholderexample.com",
        fromName: 'From Name',
      ...
      testEmail: {
        ...
        recipientEmailPlaceholder: "test{'@'placeholderexample.com",
      ...
      soraS3: {
        ...
        deleteConfirm: 'Delete storage profile {profileIDplaceholder?',
        columns: {
          profile: 'Profile',
          profileId: 'Profile ID',
          name: 'Name',
      ...
      openaiFastPolicy: {
        ...
        ruleHeader: 'Rule #{indexplaceholder',
      ...
      openaiExperimentalScheduler: {
        ...
        defaultPlaceholder: 'config/default: {valueplaceholder',
        topKLabel: 'TopK',
    ...
    errorPassthrough: {
      ...
      deleteConfirm: 'Are you sure you want to delete rule "{nameplaceholder"?',
    ...
    tlsFingerprintProfiles: {
      ...
      deleteConfirmMessage: 'Are you sure you want to delete profile "{nameplaceholder"? Accounts using this profile will fall back to the built-in default.',
