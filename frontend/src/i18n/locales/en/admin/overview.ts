export default {
    ...
    backup: {
      ...
      actions: {
        ...
        partLabel: 'Part {indexplaceholder',
    ...
    users: {
      ...
      bulkLimits: {
        action: 'Set limits ({countplaceholder)',
        title: 'Set user limits',
        selectedCount: '{countplaceholder users selected',
        selectionLimit: 'Select no more than {maxplaceholder users at a time.',
        selectUser: 'Select {emailplaceholder',
        ...
        apply: 'Apply limits',
        applying: 'Applying...',
        concurrencyValue: 'Concurrency: {valueplaceholder',
        rpmValue: 'RPM: {valueplaceholder',
        rpmUnlimitedValue: 'RPM: Unlimited',
        confirm: 'Overwrite limits for {countplaceholder users?\n{fieldsplaceholder',
        success: 'Updated limits for {countplaceholder users',
        failed: 'Failed to update user limits'
      placeholder,
      editUser: 'Edit User',
      deleteUser: 'Delete User',
      deleteConfirmMessage: "Are you sure you want to delete user '{emailplaceholder'? This action cannot be undone.",
    ...
    groups: {
      ...
      duplicateSuccess: 'Group duplicated as "{nameplaceholder" and disabled. Review its configuration before enabling it.',
      ...
      webSearchPricing: {
        ...
        finalPricePreview: 'Per-call price after current multiplier: {priceplaceholder'
      placeholder,
      peakRate: {
      ...
      compositeRoutes: {
        ...
        titleWithGroup: 'Composite Routes: {nameplaceholder',
        routes: 'Saved Routes',
