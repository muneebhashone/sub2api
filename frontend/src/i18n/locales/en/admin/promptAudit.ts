export default {
  promptAudit: {
    ...
    actions: { refresh: 'Refresh runtime', retry: 'Retry' placeholder,
    ...
    placeholder,
    saveBar: { enabled: 'Enable prompt audit', blocking: 'Synchronous blocking', storePass: 'Store Pass events', dirty: 'Unsaved changes', synced: 'Configuration synced' placeholder,
    blockingConfirm: {
    ...
    events: {
      ...
      startAt: 'Start time', endAt: 'End time', deleteSelected: 'Delete selected ({countplaceholder)', deleteByFilter: 'Delete by filter', deleteRangeHint: 'Filter deletion requires explicit start and end times and a server-generated preview.',
      ...
      detailTitle: 'Prompt audit event details', tabs: { summary: 'Audit summary', risks: 'Specific risks', technical: 'Technical details' placeholder, redactedPreview: 'Irreversible redacted preview', categories: 'Categories', model: 'Model', stage: 'Request stage', noRisks: 'No derived risk summaries for this event.',
      deleteConfirmTitle: 'Delete audit events?', deleteConfirmMessage: 'This permanently deletes {countplaceholder events and eligible orphan jobs.', filterDeleteTitle: 'Confirm filter deletion', filterDeleteCount: 'The server snapshot matches {countplaceholder events.', snapshotMax: 'Snapshot maximum event ID', expiresAt: 'Confirmation token expires', filterDeleteWarning: 'Only events at or below the preview high-water mark are deleted. Newer events survive. Any filter change requires a new preview.', confirmFilterDelete: 'Permanently delete',
    placeholder,
