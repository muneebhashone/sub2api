export default {
    ...
    proxies: {
      ...
      placeholder,
      deleteConfirmMessage: "Are you sure you want to delete proxy '{nameplaceholder'?",
    ...
    redeem: {
      ...
      codesGeneratedSuccess: 'Redeem codes generated successfully, {countplaceholder total',
    ...
    usage: {
      ...
      tokenRanking: {
        ...
        userCount: '{countplaceholder users',
        columns: {
          user: 'User',
          requests: 'Requests',
          inputTokens: 'Input Tokens',
