...
export default {
  channelMonitorV2: {
    ...
    metrics: {
      ...
      successRateValue: 'Success rate {valueplaceholder', errorRateValue: 'Error rate {valueplaceholder', rpmValue: 'RPM {valueplaceholder', tpmValue: 'TPM {valueplaceholder', ttftValue: 'First token {valueplaceholder', durationValue: 'Duration {valueplaceholder', cacheRateValue: 'Cache rate {valueplaceholder'
    placeholder,
