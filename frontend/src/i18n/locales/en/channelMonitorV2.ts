...
export default {
  channelMonitorV2: {
    ...
    updatedTo: 'Updated to {timeplaceholder',
    ...
    bootstrap: {
      ...
      progress: '{percentplaceholder% complete',
    ...
    ranges: { '90m': '90m', '24h': '24h', '7d': '7d', '30d': '30d' placeholder,
    filters: {
      platform: 'Platform', allPlatforms: 'All', group: 'Group', allGroups: 'All', model: 'Model', allModels: 'All',
      empty: 'No options', selectedCount: '{countplaceholder', labelValue: '{labelplaceholder: {valueplaceholder'
    placeholder,
    groupBy: {
    ...
    placeholder,
    trendView: { label: 'Trend view', pulse: 'Pulse matrix', line: 'Line chart' placeholder,
    healthMode: { label: 'Health display', overall: 'Overall', success: 'Error rate', ttft: 'First token', cache: 'Cache rate' placeholder,
    tabs: { aria: 'Detail dimension', models: 'Models', errors: 'Error reasons', users: 'User ranking' placeholder,
    metrics: {
      rpm: 'RPM',
      tpm: 'TPM',
      tps: 'Tokens/s',
      ...
      successRateValue: 'Success rate {valueplaceholder',
      errorRateValue: 'Error rate {valueplaceholder',
      rpmValue: 'RPM {valueplaceholder',
      tpmValue: 'TPM {valueplaceholder',
      tpsValue: 'Tokens/s {valueplaceholder',
      ttftValue: 'First token {valueplaceholder',
      durationValue: 'Duration {valueplaceholder',
      cacheRateValue: 'Cache rate {valueplaceholder',
    placeholder,
    table: { platformModel: 'Platform / Model', rank: 'Rank', user: 'User' placeholder,
    empty: { title: 'No data to display', description: 'Try changing the time range or filters' placeholder,
    bucket: { minutes: '{countplaceholder-minute buckets', hours: '{countplaceholder-hour buckets', days: '{countplaceholder-day buckets' placeholder,
    matrix: {
      title: 'Availability trend', description: 'Each row is a channel dimension and each block is an aggregate interval; hover for details', wheelZoom: 'Scroll over blocks to zoom in (narrower range, wider blocks)', wheelZoomX: 'Scroll over blocks to zoom in (narrower range, wider blocks)', dimension: 'Channel dimension', emptyTitle: 'No matrix data for the selected window', legendAria: 'Health score legend', bad: 'Bad', good: 'Good', healthyLegend: 'Healthy (≥80)', warningLegend: 'Watch (50–79)', criticalLegend: 'Critical (<50)', unknownLegend: 'No traffic / insufficient samples', noTraffic: 'No traffic in this interval', noTrafficAt: '{timeplaceholder · no traffic', scoreLine: 'Health score {scoreplaceholder', resetZoom: 'Reset zoom'
    placeholder,
    chart: {
    ...
    placeholder,
    errorDetail: { http: 'HTTP {codeplaceholder', upstream: 'Upstream {codeplaceholder', noMessage: 'No error message', empty: 'Category rates only (sample messages are admin-only)' placeholder,
    errorCategories: {
    ...
    settings: {
      ...
      modeBanner:
        'System mode is currently {modeplaceholder. V2 minute aggregation will not run; this config can be prepared now and takes effect after switching to {modeV2placeholder. Change mode under System Settings → Feature switches.',
      ...
      groupsSelected: '{countplaceholder groups selected',
      ...
      ignoredSummary: 'Ignored {ignoredplaceholder categories · counted in error rate {countedplaceholder categories',
      ...
      namedModelsCount: 'Showing {countplaceholder named model dimensions; unlisted models fold into per-platform “Other”.',
