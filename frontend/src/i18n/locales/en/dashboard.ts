export default {
  dashboard: {
    ...
    platformCount: '{countplaceholder platforms',
    platformOther: 'Other',
    platformQuota: {
      title: 'Quota Usage',
      daily: 'Daily',
      ...
      resetsAt: 'Resets {timeplaceholder',
      noLimit: 'unlimited',
      disabled: 'Disabled',
    placeholder,
  ...
  keys: {
    ...
    deleteConfirmMessage: "Are you sure you want to delete '{nameplaceholder'? This action cannot be undone.",
    id: 'ID',
    apiKey: 'API Key',
    group: 'Group',
    ...
    resetQuotaConfirmMessage: 'Are you sure you want to reset the used quota (${usedplaceholder) for key "{nameplaceholder" to 0? This action cannot be undone.',
  ...
  usage: {
    ...
    exportedCount: 'Exported {currentplaceholder/{totalplaceholder records',
    estimatedTime: 'Estimated time remaining: {timeplaceholder',
    ...
    ipGeo: {
      ...
      pending: '{countplaceholder IPs pending',
    ...
    placeholder,
    tabs: { usage: 'Usage', errors: 'Error Requests', ranking: 'User Ranking' placeholder,
    errors: {
  ...
  modelPlaza: {
    ...
    detail: {
      ...
      noPricing: 'Pricing not configured',
      peakNote: 'Peak hours {windowplaceholder: billing rate ×{multiplierplaceholder'
    placeholder,
    table: {
      model: 'Model',
      input: 'Input',
  ...
  affiliate: {
    ...
    transfer: {
      ...
      success: '{amountplaceholder has been transferred to your balance'
    placeholder,
    invitees: {
      title: 'Invited Users',
    ...
    tips: {
      ...
      line2: 'When invitees recharge, you receive {rateplaceholder of the recharge as rebate quota.',
  ...
  redeem: {
    ...
    subscriptionAssignedDesc: 'You have been granted access to {groupNameplaceholder',
    subscriptionDays: '{daysplaceholder days',
    days: ' days',
  ...
  profile: {
    ...
    passkey: {
      ...
      synced: 'Synced',
      createdAt: 'Created {dateplaceholder',
      lastUsed: 'Last used {dateplaceholder',
      ...
      deleteConfirm: 'Delete “{nameplaceholder”? You will no longer be able to sign in with it.',
    ...
    balanceNotify: {
      ...
      codeSentTo: 'Code sent to {emailplaceholder',
    ...
    authBindings: {
      ...
      unbindAction: 'Unbind',
      unbindSuccess: '{providerNameplaceholder unbound',
      boundCount: '{countplaceholder linked records',
      status: {
        bound: 'Bound',
        notBound: 'Not bound',
      placeholder,
  ...
  pagination: {
    ...
    results: 'results',
    page: 'Page',
    pageOf: 'Page {pageplaceholder of {totalplaceholder',
    previous: 'Previous',
    next: 'Next',
    perPage: 'Per page',
