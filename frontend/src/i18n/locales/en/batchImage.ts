export default {
  batchImage: {
    ...
    placeholder,
    list: {
      selectedJobs: 'Selected {countplaceholder job | Selected {countplaceholder jobs',
      expandChildren: 'Expand {nplaceholder subtask | Expand {nplaceholder subtasks',
      collapseChildren: 'Collapse subtasks',
      childCount: '{nplaceholder subtask | {nplaceholder subtasks',
      childBadge: 'Subtask',
      keyNotRecorded: 'Not recorded',
      totalCount: 'of {nplaceholder',
      notDownloaded: 'Not downloaded',
      empty: 'No batch jobs yet',
      emptyHint: 'Use the button in the top-right corner to create a batch job.',
    placeholder,
    pagination: {
      pageNumber: 'Page {pageplaceholder',
      pageItems: '{countplaceholder on this page',
    placeholder,
    promptPopover: {
      title: 'Full prompt',
    ...
    detail: {
      ...
      items: 'Items',
      preview: 'Preview',
      previewZoom: 'Zoom compressed preview {idplaceholder',
      ...
      mainTask: 'Main job: {nameplaceholder',
      childTask: 'Subtask: {nameplaceholder',
      holdCost: 'Hold {amountplaceholder',
    placeholder,
    itemResult: {
    ...
    create: {
      ...
      estimatedOutputValue: '{imagesplaceholder images / {promptsplaceholder prompts',
      promptAdded: '{countplaceholder added',
      ...
      outputCountOption: '{nplaceholder image | {nplaceholder images',
      referenceImage: 'Reference images',
      removeReferenceImage: 'Remove reference image',
      limitsHint: 'Up to {maxPerItemplaceholder images per prompt and {maxPerJobplaceholder per job. The current model allows up to {refLimitplaceholder reference images per prompt; reference images consume input tokens once per generated image.',
      referenceCount: '{nplaceholder reference image | {nplaceholder reference images',
      ...
      refLimitReached: 'The current model allows up to {limitplaceholder reference images per prompt.',
      refLimitExceededIgnored: 'The current model allows up to {limitplaceholder reference images per prompt. Extra files were ignored.',
      refFormatUnsupported: 'Reference images must be PNG, JPEG, or WebP.',
      refFileTooLarge: '{nameplaceholder exceeds 10MB and was ignored.',
    placeholder,
    guide: {
    ...
    messages: {
      ...
      errorCodeRef: 'code: {codeplaceholder',
      requestIdRef: 'request ID: {idplaceholder',
      httpStatusRef: 'HTTP status: {statusplaceholder',
    placeholder,
  placeholder,
placeholder
