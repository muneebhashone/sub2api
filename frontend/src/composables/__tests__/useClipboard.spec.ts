...
describe('useClipboard', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'isSecureContext', { value: true, writable: true placeholder)
  ...
  it('空文本返回 false 且不复制', async () => {
    const { copyToClipboard, copied placeholder = useClipboard()
  ...
  it('非安全上下文使用 fallback', async () => {
    Object.defineProperty(window, 'isSecureContext', { value: false, writable: true placeholder)
