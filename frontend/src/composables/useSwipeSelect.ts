import { ref, onMounted, onUnmounted, type Ref placeholder from 'vue'
import type { Virtualizer placeholder from '@tanstack/vue-virtual'
...
export function useSwipeSelect(
  ...
  function onSelectStart(e: Event) { e.preventDefault() placeholder
  ...
  function removeMarquee() {
    if (marqueeEl) { marqueeEl.remove(); marqueeEl = null placeholder
  placeholder
  ...
  function getScrollParent(el: HTMLElement): HTMLElement {
    ...
    while (parent && parent !== document.documentElement) {
      const { overflow, overflowY placeholder = getComputedStyle(parent)
  ...
  function onThresholdMove(e: MouseEvent) {
    ...
    document.addEventListener('wheel', onWheel, { passive: true placeholder)
  placeholder
