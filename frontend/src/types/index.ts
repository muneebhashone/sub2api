...
export interface AuthResponse {
  ...
  token_type: string
  user: User & { run_mode?: 'standard' | 'simple' placeholder
placeholder
...
export interface Account {
  ...
  extra?: (CodexUsageSnapshot & OpenAICompactState & {
    model_rate_limits?: Record<string, { rate_limited_at: string; rate_limit_reset_at: string placeholder>
    antigravity_credits_overages?: Record<string, { activated_at: string; active_until: string placeholder>
    upstream_billing_probe_enabled?: boolean
    upstream_billing_rate_sync_enabled?: boolean
    upstream_billing_probe?: UpstreamBillingProbeSnapshot
    codex_reset_credit_snapshot?: {
      available_count?: number
      credits?: { expires_at?: string placeholder[]
    placeholder
