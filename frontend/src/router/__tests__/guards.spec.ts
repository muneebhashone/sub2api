  ...
  describe('Backend Mode', () => {
    ...
    it('unauthenticated: /key-usage is allowed', () => {
      const authState: MockAuthState = {
        ...
        hasPendingAuthSession: false,
      placeholder
      const redirect = simulateGuard('/key-usage', { requiresAuth: false placeholder, authState)
      expect(redirect).toBeNull()
    placeholder)
    ...
    it('unauthenticated: callback routes are allowed', () => {
      const authState: MockAuthState = {
        ...
        hasPendingAuthSession: false,
      placeholder
      const redirect = simulateGuard('/auth/wechat/callback', { requiresAuth: false placeholder, authState)
      expect(redirect).toBeNull()
    placeholder)
    ...
    it('unauthenticated: WeChat payment callback route is allowed', () => {
      const authState: MockAuthState = {
        ...
        hasPendingAuthSession: false,
      placeholder
      const redirect = simulateGuard('/auth/wechat/payment/callback', { requiresAuth: false placeholder, authState)
      expect(redirect).toBeNull()
    placeholder)
    ...
    it('unauthenticated: /payment/result is allowed', () => {
      const authState: MockAuthState = {
        ...
        hasPendingAuthSession: false,
      placeholder
      const redirect = simulateGuard('/payment/result', { requiresAuth: false placeholder, authState)
      expect(redirect).toBeNull()
    placeholder)
    ...
    it('unauthenticated: /email-verify is blocked without a pending auth session', () => {
      const authState: MockAuthState = {
        ...
        hasPendingAuthSession: false,
      placeholder
      const redirect = simulateGuard('/email-verify', { requiresAuth: false placeholder, authState)
      expect(redirect).toBe('/login')
    placeholder)
  placeholder)
placeholder)
