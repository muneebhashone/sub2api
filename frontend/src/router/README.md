...
router.push({
  path: '/usage',
  query: { filter: 'today' placeholder
placeholder)
...
<template>
  ...
  <!-- Named route -->
  <router-link :to="{ name: 'Keys' placeholder">API Keys</router-link>

  <!-- With query parameters -->
  <router-link :to="{ path: '/usage', query: { page: 1 placeholder placeholder"> Usage </router-link>
</template>
```
