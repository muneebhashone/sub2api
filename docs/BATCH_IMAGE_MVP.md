...
GET    /v1/images/batches/{idplaceholder
GET    /v1/images/batches/{idplaceholder/items
GET    /v1/images/batches/{idplaceholder/items/{custom_idplaceholder/content
GET    /v1/images/batches/{idplaceholder/download
POST   /v1/images/batches/{idplaceholder/cancel
DELETE /v1/images/batches/{idplaceholder/outputs
```
...
- Settlement request id is `batch_image_settlement:{batch_idplaceholder`.
...
batch_image:
  ...
  vertex_managed_gcs_prefix: "batch-image/{envplaceholder/{batch_idplaceholder"
